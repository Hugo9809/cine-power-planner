...
const texts = {
  en: {
    ...
    batteryLifeUnit: "hrs",
    runtimeAverageNote: "Note: runtime estimate based on {count} user-submitted runtimes for this setup.",
  ...
  it: {
    ...
    batteryLifeUnit: "ore",
    runtimeAverageNote: "Nota: la stima della durata si basa su {count} durate inserite dagli utenti per questa configurazione.",
  ...
  es: {
    ...
    batteryLifeUnit: "h",
    runtimeAverageNote: "Nota: la estimación de autonomía se basa en {count} registros de usuarios para esta configuración.",
  ...
  fr: {
    ...
    batteryLifeUnit: "h",
    runtimeAverageNote: "Note : l'estimation de l'autonomie est basée sur {count} saisies utilisateur pour cette configuration.",
  ...
  de: {
    ...
    batteryLifeUnit: "Std.",
    runtimeAverageNote: "Hinweis: Die Laufzeitschätzung basiert auf {count} Nutzereinträgen für dieses Setup.",
