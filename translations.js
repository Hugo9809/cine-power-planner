...
const texts = {
  ...
  it: {
    ...
    helpButtonHelp: "Apri la finestra di aiuto (premi ?, H o F1).",
    helpClose: "Chiudi",
  ...
  es: {
    ...
    helpButtonHelp:
      "Abre el cuadro de ayuda (presiona ?, H o F1).",
    helpClose: "Cerrar",
  ...
  fr: {
    ...
    helpButtonHelp:
      "Ouvrir la fenêtre d'aide (appuyez sur ?, H ou F1).",
    helpClose: "Fermer",
  ...
  de: {
    ...
    helpButtonHelp: "Öffnet den Hilfedialog (drücke ?, H oder F1).",
    helpClose: "Schließen",
