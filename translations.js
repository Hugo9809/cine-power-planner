...
const texts = {
  en: {
    ...
    batteryLifeUnit: "hrs",
    runtimeAverageNote: "Note: runtime estimate uses a weighted average of user-submitted runtimes adjusted for resolution, frame rate, Wi-Fi, codec, monitor brightness and temperature.",
  ...
  it: {
    ...
    deviceManagerHeading: "Gestire il database dei dispositivi",
    ...
    batteryLifeUnit: "ore",
    runtimeAverageNote: "Nota: la stima della durata usa una media ponderata dei tempi inseriti dagli utenti, regolata per risoluzione, codec, frame rate, Wi-Fi, luminosità e temperatura.",
    ...
    helpSearchLabel: "Cerca nell'aiuto",
  ...
  es: {
    ...
    batteryLifeUnit: "h",
    runtimeAverageNote: "Nota: la estimación de autonomía usa un promedio ponderado de las duraciones enviadas por los usuarios, ajustado por resolución, códec, frecuencia de cuadro, Wi-Fi, brillo y temperatura.",
    ...
    helpSearchLabel: "Buscar en la ayuda",
  ...
  fr: {
    ...
    batteryLifeUnit: "h",
    runtimeAverageNote: "Note : l’estimation de l’autonomie utilise une moyenne pondérée des durées saisies par les utilisateurs, ajustée selon la résolution, le codec, la cadence, le Wi-Fi, la luminosité et la température.",
    ...
    helpSearchLabel: "Rechercher dans l'aide",
  ...
  de: {
    ...
    batteryLifeUnit: "Std.",
    runtimeAverageNote: "Hinweis: Die Laufzeitschätzung verwendet einen gewichteten Durchschnitt der Nutzereinträge, angepasst an Auflösung, Codec, Bildrate, WLAN, Helligkeit und Temperatur.",
    ...
    helpSearchLabel: "Hilfe durchsuchen",
