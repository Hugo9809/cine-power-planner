...
const texts = {
  en: {
    ...
    restoreVersionWarning: "Warning: Backup version differs. Some features may not transfer.",
    saveSettings: "Save",
  ...
  it: {
    ...
    restoreVersionWarning: "Attenzione: la versione del backup è diversa. Alcune funzionalità potrebbero non essere trasferite.",
    saveSettings: "Salva",
  ...
  es: {
    ...
    restoreVersionWarning: "Advertencia: la versión de la copia de seguridad es diferente. Algunas funciones podrían no transferirse.",
  ...
  fr: {
    ...
    restoreVersionWarning: "Avertissement : la version de la sauvegarde est différente. Certaines fonctionnalités peuvent ne pas être transférées.",
  ...
  de: {
    ...
    restoreVersionWarning: "Warnung: Backup-Version unterscheidet sich. Einige Funktionen werden möglicherweise nicht übertragen.",
