...
const texts = {
  en: {
    ...
    autoGearScenariosLabel: "Required scenario",
    autoGearScenariosHelp: "Pick the scenario that must be selected for this rule to apply.",
    autoGearScenarioPlaceholder: "Select a scenario",
    ...
    autoGearExport: "Export rules",
    autoGearExportHelp: "Download automatic gear rules as a JSON file.",
    autoGearExportSuccess: "Automatic gear rules exported.",
    autoGearExportError: "Automatic gear rule export failed.",
    autoGearImport: "Import rules",
    autoGearImportHelp: "Load automatic gear rules from a JSON backup.",
    autoGearImportSuccess: "Automatic gear rules imported.",
    autoGearImportError: "Automatic gear rule import failed. Please select a valid file.",
    autoGearBackupsHeading: "Backups",
    autoGearBackupsHelp: "Recent automatic gear rule backups appear here.",
    autoGearBackupsEmpty: "Backups appear here after the planner saves them automatically every 10 minutes.",
    autoGearBackupLoad: "Load backup",
    autoGearBackupLoadConfirm: "Replace your automatic gear rules with this backup?",
    autoGearBackupRestoreSuccess: "Automatic gear rules restored from backup.",
    autoGearBackupRestoreError: "Unable to restore that backup.",
    autoGearBackupSourceAuto: "Auto backup",
    autoGearBackupSourceManual: "Manual snapshot",
    autoGearBackupSourceImport: "Import",
    autoGearBackupSourceSeed: "Generated from project",
    autoGearBackupSourceInitial: "Current rules",
    ...
    storageKeyAutoGearBackups: "Automatic gear backups",
    storageKeyAutoGearBackupsDesc: "Recent snapshots of automatic gear rules saved for recovery.",
    storageAutoGearBackupsCountOne: "%s backup",
    storageAutoGearBackupsCountOther: "%s backups",
  ...
  it: {
    ...
    autoGearScenariosLabel: "Scenario richiesto",
    autoGearScenariosHelp: "Seleziona lo scenario che deve essere attivo affinché la regola si applichi.",
    autoGearScenarioPlaceholder: "Seleziona uno scenario",
    ...
    autoGearExport: "Esporta regole",
    autoGearExportHelp: "Scarica le regole automatiche come file JSON.",
    autoGearExportSuccess: "Regole automatiche esportate.",
    autoGearExportError: "Esportazione delle regole automatiche non riuscita.",
    autoGearImport: "Importa regole",
    autoGearImportHelp: "Carica le regole automatiche da un backup JSON.",
    autoGearImportSuccess: "Regole automatiche importate.",
    autoGearImportError: "Importazione delle regole automatiche non riuscita. Seleziona un file valido.",
    autoGearBackupsHeading: "Backup",
    autoGearBackupsHelp: "I backup recenti delle regole automatiche vengono mostrati qui.",
    autoGearBackupsEmpty: "I backup compaiono qui dopo che il planner li salva automaticamente ogni 10 minuti.",
    autoGearBackupLoad: "Carica backup",
    autoGearBackupLoadConfirm: "Sostituire le regole automatiche con questo backup?",
    autoGearBackupRestoreSuccess: "Regole automatiche ripristinate dal backup.",
    autoGearBackupRestoreError: "Impossibile ripristinare questo backup.",
    autoGearBackupSourceAuto: "Backup automatico",
    autoGearBackupSourceManual: "Istantanea manuale",
    autoGearBackupSourceImport: "Importazione",
    autoGearBackupSourceSeed: "Generato dal progetto",
    autoGearBackupSourceInitial: "Regole attuali",
    ...
    storageKeyAutoGearBackups: "Backup delle regole automatiche",
    storageKeyAutoGearBackupsDesc: "Instantanee recenti delle regole automatiche salvate per il ripristino.",
    storageAutoGearBackupsCountOne: "%s backup",
    storageAutoGearBackupsCountOther: "%s backup",
  ...
  es: {
    ...
    sharedImportAutoGearProject: "Usar las reglas compartidas solo para este proyecto",
    ...
    autoGearScenariosLabel: "Escenario necesario",
    autoGearScenariosHelp: "Selecciona el escenario que debe estar activo para aplicar esta regla.",
    autoGearScenarioPlaceholder: "Selecciona un escenario",
    ...
    autoGearRemoveItemButton: "Agregar eliminación",
    ...
    autoGearExport: "Exportar reglas",
    autoGearExportHelp: "Descarga las reglas automáticas como un archivo JSON.",
    autoGearExportSuccess: "Reglas automáticas exportadas.",
    autoGearExportError: "Error al exportar las reglas automáticas.",
    autoGearImport: "Importar reglas",
    autoGearImportHelp: "Carga las reglas automáticas desde una copia de seguridad JSON.",
    autoGearImportSuccess: "Reglas automáticas importadas.",
    autoGearImportError: "Error al importar las reglas automáticas. Selecciona un archivo válido.",
    autoGearBackupsHeading: "Copias de seguridad",
    autoGearBackupsHelp: "Las copias de seguridad recientes de las reglas automáticas se muestran aquí.",
    autoGearBackupsEmpty: "Las copias aparecen aquí después de que el planificador las guarde automáticamente cada 10 minutos.",
    autoGearBackupLoad: "Cargar copia",
    autoGearBackupLoadConfirm: "¿Reemplazar las reglas automáticas con esta copia de seguridad?",
    autoGearBackupRestoreSuccess: "Reglas automáticas restauradas desde la copia.",
    autoGearBackupRestoreError: "No se pudo restaurar esta copia.",
    autoGearBackupSourceAuto: "Copia automática",
    autoGearBackupSourceManual: "Instantánea manual",
    autoGearBackupSourceImport: "Importación",
    autoGearBackupSourceSeed: "Generado desde el proyecto",
    autoGearBackupSourceInitial: "Reglas actuales",
    ...
    storageKeyAutoGearBackups: "Copias de seguridad de reglas automáticas",
    storageKeyAutoGearBackupsDesc: "Instantáneas recientes de las reglas automáticas guardadas para recuperación.",
    storageAutoGearBackupsCountOne: "%s copia",
    storageAutoGearBackupsCountOther: "%s copias",
  ...
  fr: {
    ...
    sharedImportAutoGearProject: "Utiliser les règles partagées pour ce projet uniquement",
    ...
    autoGearScenariosLabel: "Scénario requis",
    autoGearScenariosHelp: "Sélectionnez le scénario qui doit être actif pour appliquer cette règle.",
    autoGearScenarioPlaceholder: "Sélectionnez un scénario",
    ...
    autoGearExport: "Exporter les règles",
    autoGearExportHelp: "Téléchargez les règles automatiques au format JSON.",
    autoGearExportSuccess: "Règles automatiques exportées.",
    autoGearExportError: "Échec de l’exportation des règles automatiques.",
    autoGearImport: "Importer des règles",
    autoGearImportHelp: "Chargez les règles automatiques depuis une sauvegarde JSON.",
    autoGearImportSuccess: "Règles automatiques importées.",
    autoGearImportError: "Échec de l’importation des règles automatiques. Sélectionnez un fichier valide.",
    autoGearBackupsHeading: "Sauvegardes",
    autoGearBackupsHelp: "Les sauvegardes récentes des règles automatiques apparaissent ici.",
    autoGearBackupsEmpty: "Les sauvegardes apparaissent ici après que le planificateur les a enregistrées automatiquement toutes les 10 minutes.",
    autoGearBackupLoad: "Charger la sauvegarde",
    autoGearBackupLoadConfirm: "Remplacer vos règles automatiques par cette sauvegarde ?",
    autoGearBackupRestoreSuccess: "Règles automatiques restaurées depuis la sauvegarde.",
    autoGearBackupRestoreError: "Impossible de restaurer cette sauvegarde.",
    autoGearBackupSourceAuto: "Sauvegarde automatique",
    autoGearBackupSourceManual: "Capture manuelle",
    autoGearBackupSourceImport: "Importation",
    autoGearBackupSourceSeed: "Généré à partir du projet",
    autoGearBackupSourceInitial: "Règles actuelles",
    ...
    storageKeyAutoGearBackups: "Sauvegardes des règles automatiques",
    storageKeyAutoGearBackupsDesc: "Instantanés récents des règles automatiques enregistrés pour la récupération.",
    storageAutoGearBackupsCountOne: "%s sauvegarde",
    storageAutoGearBackupsCountOther: "%s sauvegardes",
  ...
  de: {
    ...
    autoGearScenariosLabel: "Benötigtes Szenario",
    autoGearScenariosHelp: "Wähle das Szenario, das aktiv sein muss, damit diese Regel greift.",
    autoGearScenarioPlaceholder: "Szenario auswählen",
    ...
    autoGearExport: "Regeln exportieren",
    autoGearExportHelp: "Automatische Gear-Regeln als JSON-Datei herunterladen.",
    autoGearExportSuccess: "Automatische Gear-Regeln exportiert.",
    autoGearExportError: "Export der automatischen Gear-Regeln fehlgeschlagen.",
    autoGearImport: "Regeln importieren",
    autoGearImportHelp: "Automatische Gear-Regeln aus einer JSON-Sicherung laden.",
    autoGearImportSuccess: "Automatische Gear-Regeln importiert.",
    autoGearImportError: "Import der automatischen Gear-Regeln fehlgeschlagen. Bitte eine gültige Datei auswählen.",
    autoGearBackupsHeading: "Backups",
    autoGearBackupsHelp: "Neueste Sicherungen der automatischen Gear-Regeln erscheinen hier.",
    autoGearBackupsEmpty: "Backups erscheinen hier, nachdem der Planer sie alle 10 Minuten automatisch speichert.",
    autoGearBackupLoad: "Backup laden",
    autoGearBackupLoadConfirm: "Automatische Gear-Regeln durch dieses Backup ersetzen?",
    autoGearBackupRestoreSuccess: "Automatische Gear-Regeln aus dem Backup wiederhergestellt.",
    autoGearBackupRestoreError: "Dieses Backup konnte nicht wiederhergestellt werden.",
    autoGearBackupSourceAuto: "Automatisches Backup",
    autoGearBackupSourceManual: "Manuelle Sicherung",
    autoGearBackupSourceImport: "Import",
    autoGearBackupSourceSeed: "Aus Projekt erzeugt",
    autoGearBackupSourceInitial: "Aktuelle Regeln",
    ...
    storageKeyAutoGearBackups: "Backups der automatischen Gear-Regeln",
    storageKeyAutoGearBackupsDesc: "Aktuelle Schnappschüsse der automatischen Gear-Regeln zur Wiederherstellung.",
    storageAutoGearBackupsCountOne: "%s Backup",
    storageAutoGearBackupsCountOther: "%s Backups",
