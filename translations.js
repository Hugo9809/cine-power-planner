...
const texts = {
  en: {
    ...
    helpButtonHelp: "Open the searchable help dialog for guidance on using the app.",
    helpClose: "Close",
    helpCloseHelp: "Close the help dialog (press Esc).",
  ...
  it: {
    ...
    helpButtonHelp: "Apri la finestra di aiuto con ricerca per una guida all'uso dell'app.",
    helpClose: "Chiudi",
    helpCloseHelp: "Chiudi la finestra di aiuto (premi Esc).",
  ...
  es: {
    ...
    helpButtonHelp:
      "Abre el cuadro de ayuda con búsqueda para obtener orientación sobre el uso de la aplicación.",
    helpClose: "Cerrar",
    helpCloseHelp: "Cierra el cuadro de ayuda (pulsa Esc).",
    helpTitle: "Cómo usar",
  ...
  fr: {
    ...
    helpButtonHelp:
      "Ouvrir la fenêtre d'aide avec recherche pour obtenir des conseils sur l'utilisation de l'application.",
    helpClose: "Fermer",
    helpCloseHelp: "Fermer la fenêtre d'aide (appuyez sur Échap).",
  ...
  de: {
    ...
    helpButtonHelp: "Öffnet den durchsuchbaren Hilfedialog mit Anleitungen zur Nutzung der App.",
    helpClose: "Schließen",
    helpCloseHelp: "Schließt den Hilfedialog (Esc drücken).",
    helpTitle: "Bedienung",
