...
const texts = {
  en: {
    ...
    autoGearResetButton: "Reset to factory additions",
    autoGearResetHelp: "Restore the automatic gear rules that ship with the planner.",
    autoGearResetConfirm: "Reset automatic gear rules to the factory additions?",
    autoGearResetSuccess: "Automatic gear rules restored to factory additions.",
    autoGearResetError: "Automatic gear rule reset failed. Try again.",
  ...
  it: {
    ...
    autoGearResetButton: "Ripristina aggiunte di fabbrica",
    autoGearResetHelp: "Ripristina le regole automatiche fornite con il planner.",
    autoGearResetConfirm: "Ripristinare le regole automatiche alle aggiunte di fabbrica?",
    autoGearResetSuccess: "Regole automatiche ripristinate alle aggiunte di fabbrica.",
    autoGearResetError: "Ripristino delle regole automatiche non riuscito. Riprova.",
  ...
  es: {
    ...
    autoGearResetButton: "Restablecer a las adiciones de fábrica",
    autoGearResetHelp: "Restaura las reglas automáticas incluidas con el planificador.",
    autoGearResetConfirm: "¿Restablecer las reglas automáticas a las adiciones de fábrica?",
    autoGearResetSuccess: "Reglas automáticas restablecidas a las adiciones de fábrica.",
    autoGearResetError: "No se pudieron restablecer las reglas automáticas. Inténtalo de nuevo.",
  ...
  fr: {
    ...
    autoGearResetButton: "Réinitialiser aux ajouts d’usine",
    autoGearResetHelp: "Restaure les règles automatiques fournies avec le planificateur.",
    autoGearResetConfirm: "Réinitialiser les règles automatiques aux ajouts d’usine ?",
    autoGearResetSuccess: "Règles automatiques rétablies aux ajouts d’usine.",
    autoGearResetError: "Échec de la réinitialisation des règles automatiques. Réessayez.",
  ...
  de: {
    ...
    autoGearResetButton: "Auf Werksergänzungen zurücksetzen",
    autoGearResetHelp: "Stellt die mit dem Planner gelieferten automatischen Regeln wieder her.",
    autoGearResetConfirm: "Automatische Gear-Regeln auf die Werksergänzungen zurücksetzen?",
    autoGearResetSuccess: "Automatische Gear-Regeln auf Werksergänzungen zurückgesetzt.",
    autoGearResetError: "Zurücksetzen der automatischen Gear-Regeln fehlgeschlagen. Bitte erneut versuchen.",
