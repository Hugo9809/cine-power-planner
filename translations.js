...
const texts = {
  en: {
    ...
    alertNoSetupSelectedRename: "Please select a saved project to rename.",
    promptRenameSetup: "Enter a new name for \"{name}\":",
    alertRenameSetupEmpty: "Please enter a new project name.",
    alertSetupRenamed: "Project \"{old}\" renamed to \"{name}\".",
    alertRenameSetupNoChange: "Project name unchanged.",
    alertRenameSetupMissing: "Project could not be renamed because it no longer exists.",
    ...
    renameSetupHelp:
      "Rename the selected project to create variations without starting over.",
    saveSetupHelp:
  ...
  it: {
    ...
    alertNoSetupSelectedRename: "Seleziona un progetto salvato da rinominare.",
    promptRenameSetup: "Inserisci un nuovo nome per \"{name}\":",
    alertRenameSetupEmpty: "Inserisci un nuovo nome per il progetto.",
    alertSetupRenamed: "Progetto \"{old}\" rinominato in \"{name}\".",
    alertRenameSetupNoChange: "Il nome del progetto non è cambiato.",
    alertRenameSetupMissing: "Impossibile rinominare il progetto perché non esiste più.",
    ...
    renameSetupHelp:
      "Rinomina la configurazione selezionata per creare varianti senza partire da zero.",
  ...
  es: {
    ...
    alertNoSetupSelectedRename: "Selecciona un proyecto guardado para renombrar.",
    promptRenameSetup: "Introduce un nuevo nombre para \"{name}\":",
    alertRenameSetupEmpty: "Introduce un nuevo nombre de proyecto.",
    alertSetupRenamed: "Proyecto \"{old}\" renombrado a \"{name}\".",
    alertRenameSetupNoChange: "El nombre del proyecto no ha cambiado.",
    alertRenameSetupMissing: "No se pudo renombrar el proyecto porque ya no existe.",
    ...
    projectForm: {
      ...
      frameGuides: "Guías de cuadro:",
      aspectMaskOpacity: "Opacidad de máscara:",
      videoDistribution: "Distribución de vídeo:",
      monitorUserButtons: "Botones del monitor onboard:",
      cameraUserButtons: "Botones de la cámara:",
      viewfinderUserButtons: "Botones del visor:",
    ...
    renameSetupHelp:
      "Renombra la configuración seleccionada para crear variaciones sin empezar de cero.",
  ...
  fr: {
    ...
    alertNoSetupSelectedRename: "Sélectionnez un projet enregistré à renommer.",
    promptRenameSetup: "Entrez un nouveau nom pour \"{name}\" :",
    alertRenameSetupEmpty: "Saisissez un nouveau nom de projet.",
    alertSetupRenamed: "Projet \"{old}\" renommé en \"{name}\".",
    alertRenameSetupNoChange: "Le nom du projet est inchangé.",
    alertRenameSetupMissing: "Impossible de renommer le projet car il n'existe plus.",
    ...
    renameSetupHelp:
      "Renomme la configuration sélectionnée pour créer des variantes sans repartir de zéro.",
  ...
  de: {
    ...
    alertNoSetupSelectedRename: "Wählen Sie ein gespeichertes Projekt zum Umbenennen aus.",
    promptRenameSetup: "Neuen Namen für \"{name}\" eingeben:",
    alertRenameSetupEmpty: "Bitte einen neuen Projektnamen eingeben.",
    alertSetupRenamed: "Projekt \"{old}\" wurde in \"{name}\" umbenannt.",
    alertRenameSetupNoChange: "Der Projektname bleibt unverändert.",
    alertRenameSetupMissing: "Projekt konnte nicht umbenannt werden, da es nicht mehr existiert.",
    ...
    renameSetupHelp:
      "Benennt das ausgewählte Projekt um, um Varianten ohne Neustart anzulegen.",
