...
const texts = {
  en: {
    ...
    confirmResetApp: "Reset all stored data?",
    confirmResetAppAgain: "This will delete all custom devices, setups and session data. Are you sure?",
  ...
  it: {
    ...
    confirmResetApp: "Reimpostare tutti i dati memorizzati?",
    confirmResetAppAgain: "Questo eliminerà tutti i dispositivi personalizzati, i setup e i dati di sessione. Sei sicuro?",
  ...
  es: {
    ...
    resetAppBtn: "Restablecer aplicación",
    ...
    confirmResetApp: "¿Restablecer todos los datos almacenados?",
    confirmResetAppAgain: "Esto eliminará todos los dispositivos personalizados, configuraciones y datos de sesión. ¿Estás seguro?",
  ...
  fr: {
    ...
    confirmResetApp: "Réinitialiser toutes les données enregistrées ?",
    confirmResetAppAgain: "Cela supprimera tous les appareils personnalisés, configurations et données de session. Êtes-vous sûr ?",
  ...
  de: {
    ...
    confirmResetApp: "Alle gespeicherten Daten zurücksetzen?",
    confirmResetAppAgain: "Dadurch werden alle eigenen Geräte, Setups und Sitzungsdaten gelöscht. Sind Sie sicher?",
