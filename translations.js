...
const texts = {
  en: {
    ...
    autoGearPresetsLabel: "Preset",
    autoGearPresetsHelp: "Select a saved rules preset or manage your presets.",
    autoGearPresetsCustom: "Custom rules",
    autoGearPresetUnnamed: "Unnamed preset",
    autoGearSavePreset: "Save as preset",
    autoGearSavePresetHelp: "Store the current automatic gear rules as a reusable preset.",
    autoGearPresetNamePrompt: "Name for the new preset",
    autoGearPresetNameRequired: "Enter a preset name first.",
    autoGearPresetSaved: "Automatic gear preset saved.",
    autoGearUpdatePreset: "Update preset",
    autoGearUpdatePresetHelp: "Replace the selected preset with your current rules.",
    autoGearPresetUpdated: "Automatic gear preset updated.",
    autoGearDeletePreset: "Delete preset",
    autoGearDeletePresetHelp: "Remove the selected preset.",
    autoGearDeletePresetConfirm: "Delete the preset \"%s\"?",
    autoGearPresetDeleted: "Automatic gear preset deleted.",
    autoGearPresetApplyConfirm: "Replace your automatic gear rules with this preset?",
    autoGearPresetApplied: "Automatic gear preset applied.",
    ...
    autoGearShowBackupsHelp: "Reveal automatic backup snapshots. Uncheck to hide them again.",
    ...
    shareFilenameLabel: "Shared file name",
  ...
  it: {
    ...
    shareDialogTitle: "Condividi progetto",
    shareFilenameLabel: "Nome del file condiviso",
    ...
    autoGearPresetsLabel: "Preset",
    autoGearPresetsHelp: "Seleziona un preset salvato o gestisci i tuoi preset.",
    autoGearPresetsCustom: "Regole personalizzate",
    autoGearPresetUnnamed: "Preset senza nome",
    autoGearSavePreset: "Salva come preset",
    autoGearSavePresetHelp: "Salva le attuali regole automatiche come preset riutilizzabile.",
    autoGearPresetNamePrompt: "Nome per il nuovo preset",
    autoGearPresetNameRequired: "Inserisci prima un nome per il preset.",
    autoGearPresetSaved: "Preset di regole automatiche salvato.",
    autoGearUpdatePreset: "Aggiorna preset",
    autoGearUpdatePresetHelp: "Sostituisci il preset selezionato con le regole attuali.",
    autoGearPresetUpdated: "Preset di regole automatiche aggiornato.",
    autoGearDeletePreset: "Elimina preset",
    autoGearDeletePresetHelp: "Rimuovi il preset selezionato.",
    autoGearDeletePresetConfirm: "Eliminare il preset \"%s\"?",
    autoGearPresetDeleted: "Preset di regole automatiche eliminato.",
    autoGearPresetApplyConfirm: "Sostituire le regole automatiche con questo preset?",
    autoGearPresetApplied: "Preset di regole automatiche applicato.",
    ...
    autoGearShowBackupsLabel: "Mostra backup automatici",
    autoGearShowBackupsHelp:
      "Mostra le istantanee di backup automatico delle regole. Deseleziona per nasconderle di nuovo.",
  ...
  es: {
    ...
    shareDialogTitle: "Compartir proyecto",
    shareFilenameLabel: "Nombre del archivo compartido",
    ...
    autoGearPresetsLabel: "Preajuste",
    autoGearPresetsHelp: "Selecciona un preajuste de reglas guardado o gestiona tus preajustes.",
    autoGearPresetsCustom: "Reglas personalizadas",
    autoGearPresetUnnamed: "Preajuste sin nombre",
    autoGearSavePreset: "Guardar como preajuste",
    autoGearSavePresetHelp: "Guarda las reglas automáticas actuales como un preajuste reutilizable.",
    autoGearPresetNamePrompt: "Nombre para el nuevo preajuste",
    autoGearPresetNameRequired: "Introduce primero un nombre de preajuste.",
    autoGearPresetSaved: "Preajuste de reglas automáticas guardado.",
    autoGearUpdatePreset: "Actualizar preajuste",
    autoGearUpdatePresetHelp: "Sustituye el preajuste seleccionado por tus reglas actuales.",
    autoGearPresetUpdated: "Preajuste de reglas automáticas actualizado.",
    autoGearDeletePreset: "Eliminar preajuste",
    autoGearDeletePresetHelp: "Elimina el preajuste seleccionado.",
    autoGearDeletePresetConfirm: "¿Eliminar el preajuste \"%s\"?",
    autoGearPresetDeleted: "Preajuste de reglas automáticas eliminado.",
    autoGearPresetApplyConfirm: "¿Sustituir tus reglas automáticas por este preajuste?",
    autoGearPresetApplied: "Preajuste de reglas automáticas aplicado.",
    ...
    autoGearAddMultipleHint: "Separe varios elementos con punto y coma.",
    ...
    autoGearRemoveMultipleHint: "Separe varios elementos con punto y coma.",
    ...
    autoGearShowBackupsLabel: "Mostrar copias de seguridad automáticas",
    autoGearShowBackupsHelp:
      "Muestra las copias de seguridad automáticas de las reglas. Desmarca para ocultarlas de nuevo.",
  ...
  fr: {
    ...
    shareFilenameLabel: "Nom du fichier partagé",
    ...
    autoGearPresetsLabel: "Préréglage",
    autoGearPresetsHelp: "Sélectionnez un préréglage de règles enregistré ou gérez vos préréglages.",
    autoGearPresetsCustom: "Règles personnalisées",
    autoGearPresetUnnamed: "Préréglage sans nom",
    autoGearSavePreset: "Enregistrer comme préréglage",
    autoGearSavePresetHelp: "Enregistrez les règles automatiques actuelles en tant que préréglage réutilisable.",
    autoGearPresetNamePrompt: "Nom du nouveau préréglage",
    autoGearPresetNameRequired: "Saisissez d’abord un nom de préréglage.",
    autoGearPresetSaved: "Préréglage des règles automatiques enregistré.",
    autoGearUpdatePreset: "Mettre à jour le préréglage",
    autoGearUpdatePresetHelp: "Remplace le préréglage sélectionné par vos règles actuelles.",
    autoGearPresetUpdated: "Préréglage des règles automatiques mis à jour.",
    autoGearDeletePreset: "Supprimer le préréglage",
    autoGearDeletePresetHelp: "Supprime le préréglage sélectionné.",
    autoGearDeletePresetConfirm: "Supprimer le préréglage \"%s\" ?",
    autoGearPresetDeleted: "Préréglage des règles automatiques supprimé.",
    autoGearPresetApplyConfirm: "Remplacer vos règles automatiques par ce préréglage ?",
    autoGearPresetApplied: "Préréglage des règles automatiques appliqué.",
    ...
    autoGearShowBackupsHelp:
      "Affiche les instantanés de sauvegarde automatique. Décochez pour les masquer à nouveau.",
  ...
  de: {
    ...
    shareDialogTitle: "Projekt teilen",
    shareFilenameLabel: "Name der geteilten Datei",
    ...
    autoGearPresetsLabel: "Preset",
    autoGearPresetsHelp: "Wähle ein gespeichertes Regel-Preset aus oder verwalte deine Presets.",
    autoGearPresetsCustom: "Eigene Regeln",
    autoGearPresetUnnamed: "Preset ohne Namen",
    autoGearSavePreset: "Als Preset speichern",
    autoGearSavePresetHelp: "Speichere die aktuellen automatischen Regeln als wiederverwendbares Preset.",
    autoGearPresetNamePrompt: "Name für das neue Preset",
    autoGearPresetNameRequired: "Bitte zuerst einen Preset-Namen eingeben.",
    autoGearPresetSaved: "Automatisches Gear-Preset gespeichert.",
    autoGearUpdatePreset: "Preset aktualisieren",
    autoGearUpdatePresetHelp: "Ersetze das ausgewählte Preset durch deine aktuellen Regeln.",
    autoGearPresetUpdated: "Automatisches Gear-Preset aktualisiert.",
    autoGearDeletePreset: "Preset löschen",
    autoGearDeletePresetHelp: "Entfernt das ausgewählte Preset.",
    autoGearDeletePresetConfirm: "Preset \"%s\" löschen?",
    autoGearPresetDeleted: "Automatisches Gear-Preset gelöscht.",
    autoGearPresetApplyConfirm: "Automatische Gear-Regeln durch dieses Preset ersetzen?",
    autoGearPresetApplied: "Automatisches Gear-Preset angewendet.",
    ...
    autoGearShowBackupsHelp:
      "Zeigt die automatischen Sicherungen der Regeln an. Deaktivieren, um sie wieder auszublenden.",
