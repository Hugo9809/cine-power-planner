...
const texts = {
  en: {
    ...
    batteryLifeUnit: "hrs",
    runtimeAverageNote: "Note: runtime estimate based on average of user-submitted runtimes.",
  ...
  it: {
    ...
    batteryLifeUnit: "ore",
    runtimeAverageNote: "Nota: la stima della durata si basa sulla media delle durate inserite dagli utenti.",
  ...
  es: {
    ...
    batteryLifeUnit: "h",
    runtimeAverageNote: "Nota: la estimación de autonomía se basa en el promedio de las entradas de los usuarios.",
  ...
  fr: {
    ...
    batteryLifeUnit: "h",
    runtimeAverageNote: "Note : l'estimation de l'autonomie est basée sur la moyenne des saisies des utilisateurs.",
  ...
  de: {
    ...
    batteryLifeUnit: "Std.",
    runtimeAverageNote: "Hinweis: Die Laufzeitschätzung basiert auf dem Durchschnitt der Nutzereinträge.",
