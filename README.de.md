...
- **Globale Suche** (`/`, `Strg+K`, `⌘K`) springt zu Features, Selektoren oder Hilfethemen – selbst bei versteckter Navigation.
  ...
  landen. Im Dropdown werden passende Wörter hervorgehoben, damit sofort klar ist,
  warum ein Treffer erscheint. Leer das Feld, erscheinen zuletzt genutzte Treffer
  oben und Crew-Routinen lassen sich ohne Umwege wiederholen.
