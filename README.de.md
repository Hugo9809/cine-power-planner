...
- **Geteilte Links lösen ein Sicherheits-Autobackup aus.** Das Öffnen einer geteilten URL oder das Importieren eines Bundles erstellt vor jeder Änderung ein Auto-Backup mit Zeitstempel. Schlägt die Sicherung fehl, wird der Import abgebrochen und deine Daten bleiben unangetastet.
