...
- **I contatti della troupe restano riutilizzabili.** Apri la voce **Contatti** nella barra laterale per mantenere un elenco con
  ruoli, email, numeri di telefono, siti web e foto profilo da inserire in qualsiasi progetto. Il tuo profilo personale nel dialogo salva
  anche nome visualizzato, ruolo, telefono, email, sito web e foto così l’attrezzatura contrassegnata come “User” mantiene l’etichetta nei backup. I contatti vivono nello stesso snapshot di
