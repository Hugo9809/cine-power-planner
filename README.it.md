...
5. Apri **Aiuto → Checklist di avvio rapido** e avvia il tutorial guidato. Copre creazione dei progetti, configurazione dei dispositivi, gear list, contatti, attrezzatura personale, regole automatiche oltre a export, import e backup. Il nuovo navigatore dei passaggi ti permette di rivedere i flussi completati senza ricominciare; se interrompi il percorso, apparirà automaticamente **Riprendi il tutorial guidato** così il progresso offline resta salvato.
