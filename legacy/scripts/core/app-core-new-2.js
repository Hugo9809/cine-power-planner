...
if (CORE_PART2_RUNTIME_SCOPE && CORE_PART2_RUNTIME_SCOPE.__cineCorePart2Initialized) {
  ...
  function corePart2Runtime() {
    ...
    var collectAutoGearSelectedValues = function resolveCollectAutoGearSelectedValues() {
      var candidateScopes = [CORE_SHARED_LOCAL, CORE_PART2_RUNTIME_SCOPE, typeof CORE_GLOBAL_SCOPE !== 'undefined' ? CORE_GLOBAL_SCOPE : null, typeof globalThis !== 'undefined' ? globalThis : null, typeof window !== 'undefined' ? window : null, typeof self !== 'undefined' ? self : null, typeof global !== 'undefined' ? global : null].filter(function (scope) {
      ...
      for (var index = 0; index < candidateScopes.length; index += 1) {
        ...
        try {
          var candidate = scope.autoGear && scope.autoGear.collectAutoGearSelectedValues || scope.autoGearUi && scope.autoGearUi.collectAutoGearSelectedValues || scope.collectAutoGearSelectedValues;
      ...
      return function fallbackCollectAutoGearSelectedValues() {
        return [];
      };
    }();
    ...
    var CORE_RUNTIME_UI_BRIDGE = function resolveCoreRuntimeUiBridgePart2() {
      var candidates = [];
      if (typeof require === 'function') {
        try {
    ...
    var setButtonLabelWithIcon = typeof CORE_RUNTIME_UI_BRIDGE.setButtonLabelWithIcon === 'function' ? CORE_RUNTIME_UI_BRIDGE.setButtonLabelWithIcon : function setButtonLabelWithIconFallback(button, label) {
      if (!button) {
        return;
      }
    ...
    var getAutoGearCameraWeightOperatorLabel = autoGearHelpers && typeof autoGearHelpers.getAutoGearCameraWeightOperatorLabel === 'function' ? autoGearHelpers.getAutoGearCameraWeightOperatorLabel : function getAutoGearCameraWeightOperatorLabel(operator, langTexts) {
      return fallbackGetAutoGearCameraWeightOperatorLabel(operator, langTexts);
    };
    var formatAutoGearCameraWeight = autoGearHelpers && typeof autoGearHelpers.formatAutoGearCameraWeight === 'function' ? autoGearHelpers.formatAutoGearCameraWeight : fallbackFormatAutoGearCameraWeight;
    var runtimeScopeTools = CORE_PART2_HELPERS && typeof CORE_PART2_HELPERS.resolveRuntimeScopeTools === 'function' ? CORE_PART2_HELPERS.resolveRuntimeScopeTools({
      runtimeScope: CORE_PART2_RUNTIME_SCOPE,
      sharedScope: CORE_SHARED_SCOPE_PART2,
      globalScope: typeof CORE_GLOBAL_SCOPE !== 'undefined' && CORE_GLOBAL_SCOPE ? CORE_GLOBAL_SCOPE : null
    }) : null;
    var runtimeScopeCandidatesRef = runtimeScopeTools && Array.isArray(runtimeScopeTools.runtimeScopeCandidates) ? runtimeScopeTools.runtimeScopeCandidates : CORE_PART2_HELPERS && typeof CORE_PART2_HELPERS.fallbackCreateRuntimeScopeCandidates === 'function' ? CORE_PART2_HELPERS.fallbackCreateRuntimeScopeCandidates(CORE_PART2_RUNTIME_SCOPE, CORE_SHARED_SCOPE_PART2, typeof CORE_GLOBAL_SCOPE !== 'undefined' ? CORE_GLOBAL_SCOPE : null) : [];
    var runtimeScopeBridge = runtimeScopeTools && runtimeScopeTools.runtimeScopeBridge ? runtimeScopeTools.runtimeScopeBridge : null;
    var readCoreScopeValue = runtimeScopeTools && typeof runtimeScopeTools.readCoreScopeValue === 'function' ? runtimeScopeTools.readCoreScopeValue : CORE_PART2_HELPERS && typeof CORE_PART2_HELPERS.fallbackReadCoreScopeValue === 'function' ? function readCoreScopeValue(name) {
      return CORE_PART2_HELPERS.fallbackReadCoreScopeValue(name, runtimeScopeCandidatesRef);
    } : function readCoreScopeValue() {
      return undefined;
    };
    var resolveCoreBinding = function resolveCoreBinding(name, fallback) {
      var defaultValue = fallback;
      var candidate = readCoreScopeValue(name);
      if (typeof candidate === 'undefined' || candidate === null) {
        try {
          var globalScope = typeof CORE_PART2_RUNTIME_SCOPE !== 'undefined' && CORE_PART2_RUNTIME_SCOPE || typeof globalThis !== 'undefined' && globalThis || typeof window !== 'undefined' && window || null;
    ...
    var writeCoreScopeValue = runtimeScopeTools && typeof runtimeScopeTools.writeCoreScopeValue === 'function' ? runtimeScopeTools.writeCoreScopeValue : CORE_PART2_HELPERS && typeof CORE_PART2_HELPERS.fallbackWriteCoreScopeValue === 'function' ? function writeCoreScopeValue(name, value) {
      return CORE_PART2_HELPERS.fallbackWriteCoreScopeValue(name, value, runtimeScopeCandidatesRef);
    } : function writeCoreScopeValue() {
      return false;
    };
    var declareCoreFallbackBinding = runtimeScopeTools && typeof runtimeScopeTools.declareCoreFallbackBinding === 'function' ? runtimeScopeTools.declareCoreFallbackBinding : CORE_PART2_HELPERS && typeof CORE_PART2_HELPERS.fallbackDeclareCoreFallbackBinding === 'function' ? function declareCoreFallbackBinding(name, factory) {
      return CORE_PART2_HELPERS.fallbackDeclareCoreFallbackBinding(name, factory, runtimeScopeCandidatesRef);
    } : function declareCoreFallbackBinding(name, factory) {
      return typeof factory === 'function' ? factory() : factory;
    };
    var CORE_RUNTIME_SCOPE_CANDIDATES = runtimeScopeCandidatesRef;
    var normalizePowerPortType = resolveCoreBinding('normalizePowerPortType', function () {
      return [];
    });
    var motorPriority = resolveCoreBinding('motorPriority', function () {
      return 0;
    });
    var controllerPriority = resolveCoreBinding('controllerPriority', function () {
      return 0;
    });
    var isArri = resolveCoreBinding('isArri', function () {
      return false;
    });
    var isArriOrCmotion = resolveCoreBinding('isArriOrCmotion', function () {
      return false;
    });
    var fizNeedsPower = resolveCoreBinding('fizNeedsPower', function () {
      return false;
    });
    var fizPowerPort = resolveCoreBinding('fizPowerPort', function () {
      return '';
    });
    var controllerDistancePort = resolveCoreBinding('controllerDistancePort', function () {
      return '';
    });
    var controllerCamPort = resolveCoreBinding('controllerCamPort', function () {
      return '';
    });
    var cameraFizPort = resolveCoreBinding('cameraFizPort', function () {
      return '';
    });
    var motorFizPort = resolveCoreBinding('motorFizPort', function () {
      return '';
    });
    var getSelectedPlate = resolveCoreBinding('getSelectedPlate', function () {
      return null;
    });
    var isSelectedPlateNative = resolveCoreBinding('isSelectedPlateNative', function () {
      return false;
    });
    var formatConnLabel = resolveCoreBinding('formatConnLabel', function () {
      return '';
    });
    var connectionLabel = resolveCoreBinding('connectionLabel', function () {
      return '';
    });
    var fizPort = resolveCoreBinding('fizPort', function () {
      return '';
    });
    var iconGlyph = resolveCoreBinding('iconGlyph', function () {
      return '';
    });
    var ICON_FONT_KEYS = resolveCoreBinding('ICON_FONT_KEYS', {});
    ...
    var activeDeviceManagerLists = function () {
      var candidateScopes = [CORE_PART2_RUNTIME_SCOPE && (typeof CORE_PART2_RUNTIME_SCOPE === "undefined" ? "undefined" : _typeof(CORE_PART2_RUNTIME_SCOPE)) === 'object' ? CORE_PART2_RUNTIME_SCOPE : null, CORE_SHARED_SCOPE_PART2 && _typeof(CORE_SHARED_SCOPE_PART2) === 'object' ? CORE_SHARED_SCOPE_PART2 : null, typeof CORE_GLOBAL_SCOPE !== 'undefined' && CORE_GLOBAL_SCOPE && (typeof CORE_GLOBAL_SCOPE === "undefined" ? "undefined" : _typeof(CORE_GLOBAL_SCOPE)) === 'object' ? CORE_GLOBAL_SCOPE : null, typeof globalThis !== 'undefined' && (typeof globalThis === "undefined" ? "undefined" : _typeof(globalThis)) === 'object' ? globalThis : null, typeof window !== 'undefined' && (typeof window === "undefined" ? "undefined" : _typeof(window)) === 'object' ? window : null, typeof self !== 'undefined' && (typeof self === "undefined" ? "undefined" : _typeof(self)) === 'object' ? self : null, typeof global !== 'undefined' && (typeof global === "undefined" ? "undefined" : _typeof(global)) === 'object' ? global : null].filter(Boolean);
      for (var index = 0; index < candidateScopes.length; index += 1) {
        var scope = candidateScopes[index];
    ...
    var AUTO_GEAR_CREW_OPTION_TOOLS = resolveCoreSupportModule('cineCoreAppRuntimeAutoGearCrew', './modules/app-core/runtime.js');
    var AUTO_GEAR_CREW_OPTION_NAMESPACE = AUTO_GEAR_CREW_OPTION_TOOLS || typeof globalThis !== 'undefined' && globalThis.cineCoreAppRuntimeAutoGearCrew || typeof window !== 'undefined' && window.cineCoreAppRuntimeAutoGearCrew || typeof self !== 'undefined' && self.cineCoreAppRuntimeAutoGearCrew || typeof global !== 'undefined' && global.cineCoreAppRuntimeAutoGearCrew || (typeof require === 'function' ? function requireAutoGearCrewHelpers() {
      try {
    ...
    var AUTO_GEAR_CREW_HELPERS = AUTO_GEAR_CREW_OPTION_NAMESPACE && typeof AUTO_GEAR_CREW_OPTION_NAMESPACE.createAutoGearCrewOptionHelpers === 'function' ? AUTO_GEAR_CREW_OPTION_NAMESPACE.createAutoGearCrewOptionHelpers({
      documentRef: typeof document !== 'undefined' ? document : null,
      collectSelectedValues: collectAutoGearSelectedValues,
      computeMultiSelectSize: computeAutoGearMultiSelectSize,
      getCrewRoleEntries: getCrewRoleEntries,
      autoGearFlexMinRows: AUTO_GEAR_FLEX_MULTI_SELECT_MIN_ROWS,
      getLocalizedTexts: function getLocalizedTexts() {
        return texts[currentLang] || texts.en || {};
      },
      getDefaultLanguageTexts: function getDefaultLanguageTexts() {
        return texts.en || {};
      }
    }) : null;
    var refreshAutoGearCrewOptions = AUTO_GEAR_CREW_HELPERS && typeof AUTO_GEAR_CREW_HELPERS.refreshCrewOptions === 'function' ? AUTO_GEAR_CREW_HELPERS.refreshCrewOptions : function refreshAutoGearCrewOptionsFallback(selectElement, selected, key) {
    ...
    var getCrewRoleLabel = AUTO_GEAR_CREW_HELPERS && typeof AUTO_GEAR_CREW_HELPERS.getCrewRoleLabel === 'function' ? AUTO_GEAR_CREW_HELPERS.getCrewRoleLabel : function getCrewRoleLabelFallback(value) {
      var _texts$en;
    ...
    function populateAutoGearCategorySelect(select, currentValue) {
      ...
      select.innerHTML = '';
      var sortedCategories = Array.from(GEAR_LIST_CATEGORIES).sort(function (a, b) {
        return a.localeCompare(b, currentLang || 'en', {
          sensitivity: 'base'
        });
      });
    ...
    function handleAutoGearPresetSelection(event) {
      var _texts$currentLang7, _texts$en21;
      ...
      var performApply = function performApply() {
        var _texts$currentLang8, _texts$en22;
      ...
      if (typeof window.cineShowConfirmDialog === 'function') {
        var _texts$currentLang9, _texts$currentLang0, _texts$currentLang1;
        window.cineShowConfirmDialog({
          title: ((_texts$currentLang9 = texts[currentLang]) === null || _texts$currentLang9 === void 0 ? void 0 : _texts$currentLang9.autoGearPresetApplyTitle) || 'Apply Preset',
          message: confirmMessage,
          confirmLabel: ((_texts$currentLang0 = texts[currentLang]) === null || _texts$currentLang0 === void 0 ? void 0 : _texts$currentLang0.apply) || 'Apply',
          cancelLabel: ((_texts$currentLang1 = texts[currentLang]) === null || _texts$currentLang1 === void 0 ? void 0 : _texts$currentLang1.cancel) || 'Cancel',
    ...
    function _handleAutoGearSavePreset() {
      _handleAutoGearSavePreset = _asyncToGenerator(_regenerator().m(function _callee3() {
        var _texts$currentLang108, _texts$en200, _texts$currentLang109, _texts$en201, _texts$currentLang115, _texts$en204;
        var rules, activePreset, previousAutoPresetId, promptTemplate, defaultName, requiredMessage, response, trimmed, normalizedName, existingByName, targetId, _texts$currentLang110, _texts$en202, overwriteTemplate, overwriteMessage, overwriteConfirmed, presetId, normalizedPreset, _texts$currentLang114, _texts$en203, _requiredMessage, existingIndex, autoPresetIndex, savedMessage;
        return _regenerator().w(function (_context3) {
          while (1) switch (_context3.n) {
            case 0:
              ...
              promptTemplate = ((_texts$currentLang108 = texts[currentLang]) === null || _texts$currentLang108 === void 0 ? void 0 : _texts$currentLang108.autoGearPresetNamePrompt) || ((_texts$en200 = texts.en) === null || _texts$en200 === void 0 ? void 0 : _texts$en200.autoGearPresetNamePrompt) || 'Name this preset';
              defaultName = activePreset ? activePreset.label : '';
              requiredMessage = ((_texts$currentLang109 = texts[currentLang]) === null || _texts$currentLang109 === void 0 ? void 0 : _texts$currentLang109.autoGearPresetNameRequired) || ((_texts$en201 = texts.en) === null || _texts$en201 === void 0 ? void 0 : _texts$en201.autoGearPresetNameRequired) || 'Enter a preset name to continue.';
              _context3.n = 1;
            ...
            case 3:
              ...
              overwriteTemplate = ((_texts$currentLang110 = texts[currentLang]) === null || _texts$currentLang110 === void 0 ? void 0 : _texts$currentLang110.autoGearPresetOverwriteConfirm) || ((_texts$en202 = texts.en) === null || _texts$en202 === void 0 ? void 0 : _texts$en202.autoGearPresetOverwriteConfirm) || "Replace the existing preset \"".concat(normalizedName, "\"?");
              ...
              _context3.n = 4;
              return new Promise(function (resolve) {
                var _texts$currentLang111, _texts$currentLang112, _texts$currentLang113;
                window.cineShowConfirmDialog({
                  title: ((_texts$currentLang111 = texts[currentLang]) === null || _texts$currentLang111 === void 0 ? void 0 : _texts$currentLang111.autoGearPresetOverwriteTitle) || 'Overwrite Preset',
                  message: overwriteMessage,
                  confirmLabel: ((_texts$currentLang112 = texts[currentLang]) === null || _texts$currentLang112 === void 0 ? void 0 : _texts$currentLang112.save) || 'Save',
                  cancelLabel: ((_texts$currentLang113 = texts[currentLang]) === null || _texts$currentLang113 === void 0 ? void 0 : _texts$currentLang113.cancel) || 'Cancel',
            ...
            case 4:
              overwriteConfirmed = _context3.v;
              _context3.n = 6;
              break;
            case 5:
            ...
            case 8:
              ...
              _requiredMessage = ((_texts$currentLang114 = texts[currentLang]) === null || _texts$currentLang114 === void 0 ? void 0 : _texts$currentLang114.autoGearPresetNameRequired) || ((_texts$en203 = texts.en) === null || _texts$en203 === void 0 ? void 0 : _texts$en203.autoGearPresetNameRequired) || 'Enter a preset name to continue.';
              if (typeof window.alert === 'function') {
            ...
            case 9:
              ...
              renderAutoGearPresetsControls();
              savedMessage = ((_texts$currentLang115 = texts[currentLang]) === null || _texts$currentLang115 === void 0 ? void 0 : _texts$currentLang115.autoGearPresetSaved) || ((_texts$en204 = texts.en) === null || _texts$en204 === void 0 ? void 0 : _texts$en204.autoGearPresetSaved) || 'Automatic gear preset saved.';
    ...
    function handleAutoGearDeletePreset() {
      var _texts$currentLang10, _texts$en23;
      if (!activeAutoGearPresetId) return;
      var preset = getAutoGearPresetById(activeAutoGearPresetId);
      var label = preset ? preset.label : '';
      var confirmTemplate = ((_texts$currentLang10 = texts[currentLang]) === null || _texts$currentLang10 === void 0 ? void 0 : _texts$currentLang10.autoGearPresetDeleteConfirm) || ((_texts$en23 = texts.en) === null || _texts$en23 === void 0 ? void 0 : _texts$en23.autoGearPresetDeleteConfirm) || 'Delete this preset?';
      ...
      var performDelete = function performDelete() {
        var _texts$currentLang11, _texts$en24;
        ...
        renderAutoGearPresetsControls();
        var deletedMessage = ((_texts$currentLang11 = texts[currentLang]) === null || _texts$currentLang11 === void 0 ? void 0 : _texts$currentLang11.autoGearPresetDeleted) || ((_texts$en24 = texts.en) === null || _texts$en24 === void 0 ? void 0 : _texts$en24.autoGearPresetDeleted) || 'Automatic gear preset deleted.';
        showNotification('success', deletedMessage);
      };
      if (typeof window.cineShowConfirmDialog === 'function') {
        var _texts$currentLang12, _texts$currentLang13, _texts$currentLang14;
        window.cineShowConfirmDialog({
          title: ((_texts$currentLang12 = texts[currentLang]) === null || _texts$currentLang12 === void 0 ? void 0 : _texts$currentLang12.autoGearPresetDeleteTitle) || 'Delete Preset',
          message: confirmMessage,
          confirmLabel: ((_texts$currentLang13 = texts[currentLang]) === null || _texts$currentLang13 === void 0 ? void 0 : _texts$currentLang13.delete) || 'Delete',
          cancelLabel: ((_texts$currentLang14 = texts[currentLang]) === null || _texts$currentLang14 === void 0 ? void 0 : _texts$currentLang14.cancel) || 'Cancel',
          danger: true,
    ...
    function handleAutoGearBackupRetentionChange() {
      var _texts$currentLang28, _texts$en35;
      if (!autoGearBackupRetentionInput) return;
      ...
      if (normalized < previousLimit) {
        var _texts$currentLang15, _texts$en25, _texts$currentLang16, _texts$en26;
        var trimmedEstimate = Math.max(0, autoGearBackups.length - normalized);
        var warningTemplate = ((_texts$currentLang15 = texts[currentLang]) === null || _texts$currentLang15 === void 0 ? void 0 : _texts$currentLang15.autoGearBackupRetentionWarning) || ((_texts$en25 = texts.en) === null || _texts$en25 === void 0 ? void 0 : _texts$en25.autoGearBackupRetentionWarning) || 'Lowering to {limit} will remove {trimmed}. A safety snapshot will be saved first.';
        ...
        var confirmTemplate = ((_texts$currentLang16 = texts[currentLang]) === null || _texts$currentLang16 === void 0 ? void 0 : _texts$currentLang16.autoGearBackupRetentionConfirm) || ((_texts$en26 = texts.en) === null || _texts$en26 === void 0 ? void 0 : _texts$en26.autoGearBackupRetentionConfirm) || 'Save a safety snapshot and trim older backups now?';
        ...
        var proceedWithRetentionChange = function proceedWithRetentionChange() {
          var _texts$currentLang17, _texts$en27, _texts$currentLang18, _texts$en28, _texts$currentLang20, _texts$en30, _texts$currentLang22, _texts$en32, _texts$currentLang23, _texts$en33;
          var safetyBase = ((_texts$currentLang17 = texts[currentLang]) === null || _texts$currentLang17 === void 0 ? void 0 : _texts$currentLang17.autoGearBackupRetentionSafetyNote) || ((_texts$en27 = texts.en) === null || _texts$en27 === void 0 ? void 0 : _texts$en27.autoGearBackupRetentionSafetyNote) || 'Retention lowered to {limit}.';
          var safetyTrimmed = ((_texts$currentLang18 = texts[currentLang]) === null || _texts$currentLang18 === void 0 ? void 0 : _texts$currentLang18.autoGearBackupRetentionSafetyNoteTrimmed) || ((_texts$en28 = texts.en) === null || _texts$en28 === void 0 ? void 0 : _texts$en28.autoGearBackupRetentionSafetyNoteTrimmed) || 'Retention lowered to {limit}. Removed {trimmed} in this change.';
          ...
          if (safetyResult.status !== 'created') {
            var _texts$currentLang19, _texts$en29;
            var failureMessage = ((_texts$currentLang19 = texts[currentLang]) === null || _texts$currentLang19 === void 0 ? void 0 : _texts$currentLang19.autoGearBackupRetentionSafetyFailed) || ((_texts$en29 = texts.en) === null || _texts$en29 === void 0 ? void 0 : _texts$en29.autoGearBackupRetentionSafetyFailed) || 'Safety snapshot failed. Retention was not changed.';
          ...
          var safetySavedMessage = ((_texts$currentLang20 = texts[currentLang]) === null || _texts$currentLang20 === void 0 ? void 0 : _texts$currentLang20.autoGearBackupRetentionSafetySaved) || ((_texts$en30 = texts.en) === null || _texts$en30 === void 0 ? void 0 : _texts$en30.autoGearBackupRetentionSafetySaved) || 'Safety snapshot captured before trimming backups.';
          showNotification('success', safetySavedMessage);
          var trimResult = enforceAutoGearBackupRetentionLimit(normalized);
          if (!trimResult.success) {
            var _texts$currentLang21, _texts$en31;
            var _failureMessage = ((_texts$currentLang21 = texts[currentLang]) === null || _texts$currentLang21 === void 0 ? void 0 : _texts$currentLang21.autoGearBackupRetentionUpdateFailed) || ((_texts$en31 = texts.en) === null || _texts$en31 === void 0 ? void 0 : _texts$en31.autoGearBackupRetentionUpdateFailed) || 'Could not apply the new retention limit.';
          ...
          var successTemplate = trimmedCount > 0 ? ((_texts$currentLang22 = texts[currentLang]) === null || _texts$currentLang22 === void 0 ? void 0 : _texts$currentLang22.autoGearBackupRetentionUpdated) || ((_texts$en32 = texts.en) === null || _texts$en32 === void 0 ? void 0 : _texts$en32.autoGearBackupRetentionUpdated) || 'Retention updated to {limit}. Removed {trimmed}.' : ((_texts$currentLang23 = texts[currentLang]) === null || _texts$currentLang23 === void 0 ? void 0 : _texts$currentLang23.autoGearBackupRetentionUpdatedNoTrim) || ((_texts$en33 = texts.en) === null || _texts$en33 === void 0 ? void 0 : _texts$en33.autoGearBackupRetentionUpdatedNoTrim) || 'Retention updated to {limit}. No backups were removed.';
          var successMessage = successTemplate.replace('{limit}', formatAutoGearBackupCount(normalized)).replace('{trimmed}', formatAutoGearBackupCount(Math.max(trimmedCount, 1)));
        ...
        if (typeof window.cineShowConfirmDialog === 'function') {
          var _texts$currentLang24, _texts$currentLang25, _texts$currentLang26;
          window.cineShowConfirmDialog({
            title: ((_texts$currentLang24 = texts[currentLang]) === null || _texts$currentLang24 === void 0 ? void 0 : _texts$currentLang24.autoGearBackupRetentionTitle) || 'Update Retention Limit',
            message: confirmMessage,
            confirmLabel: ((_texts$currentLang25 = texts[currentLang]) === null || _texts$currentLang25 === void 0 ? void 0 : _texts$currentLang25.confirm) || 'Confirm',
            cancelLabel: ((_texts$currentLang26 = texts[currentLang]) === null || _texts$currentLang26 === void 0 ? void 0 : _texts$currentLang26.cancel) || 'Cancel',
      ...
      if (!increaseResult.success) {
        var _texts$currentLang27, _texts$en34;
        var failureMessage = ((_texts$currentLang27 = texts[currentLang]) === null || _texts$currentLang27 === void 0 ? void 0 : _texts$currentLang27.autoGearBackupRetentionUpdateFailed) || ((_texts$en34 = texts.en) === null || _texts$en34 === void 0 ? void 0 : _texts$en34.autoGearBackupRetentionUpdateFailed) || 'Could not apply the new retention limit.';
        showNotification('error', failureMessage);
        autoGearBackupRetentionInput.value = String(autoGearBackupRetention);
        updateAutoGearBackupRetentionWarning('');
        return;
      }
      var successTemplate = ((_texts$currentLang28 = texts[currentLang]) === null || _texts$currentLang28 === void 0 ? void 0 : _texts$currentLang28.autoGearBackupRetentionExpanded) || ((_texts$en35 = texts.en) === null || _texts$en35 === void 0 ? void 0 : _texts$en35.autoGearBackupRetentionExpanded) || 'Retention updated to {limit}.';
    ...
    function getAutoGearRuleCoverageSummary() {
      ...
      var activeSnapshots = snapshots.filter(function (rule) {
        return rule.enabled !== false;
      });
      var disabledSnapshots = snapshots.filter(function (rule) {
        return rule.enabled === false;
      });
      var summary = {
        ...
        disabledRules: dedupeAutoGearRuleReferences(disabledSnapshots.map(createAutoGearRuleReference).filter(Boolean))
      };
      ...
      activeSnapshots.forEach(function (snapshot) {
      ...
      var rulesWithoutScenarios = dedupeAutoGearRuleReferences(activeSnapshots.filter(function (rule) {
    ...
    function formatAutoGearRuleReference(ref, langTexts) {
      var _texts$en36, _texts$en37, _texts$en39;
      if (!ref || _typeof(ref) !== 'object') return '';
      ...
      var disabledLabel = ref.enabled === false ? langTexts.autoGearRuleDisabledLabel || ((_texts$en37 = texts.en) === null || _texts$en37 === void 0 ? void 0 : _texts$en37.autoGearRuleDisabledLabel) || 'Disabled' : '';
      var labeled = disabledLabel ? "".concat(baseLabel, " \u2014 ").concat(disabledLabel) : baseLabel;
      var positionText = formatNumberForLang(currentLang, ref.position || 1);
      if (ref.label) {
        var _texts$en38;
        var _template4 = langTexts.autoGearSummaryRuleReference || ((_texts$en38 = texts.en) === null || _texts$en38 === void 0 ? void 0 : _texts$en38.autoGearSummaryRuleReference) || 'Rule {position}: {label}';
        return _template4.replace('{position}', positionText).replace('{label}', labeled);
      }
      var template = langTexts.autoGearSummaryRuleReferenceUntitled || ((_texts$en39 = texts.en) === null || _texts$en39 === void 0 ? void 0 : _texts$en39.autoGearSummaryRuleReferenceUntitled) || 'Rule {position}';
    ...
    function formatAutoGearTriggerDescription(triggers, analysis, langTexts) {
      ...
      if (triggers.always) {
        var _texts$en40;
        parts.push(langTexts.autoGearAlwaysMeta || ((_texts$en40 = texts.en) === null || _texts$en40 === void 0 ? void 0 : _texts$en40.autoGearAlwaysMeta) || 'Always active');
      }
      ...
      if (Array.isArray(triggers.scenarios) && triggers.scenarios.length) {
        ...
        var label = langTexts.autoGearScenariosLabel || ((_texts$en41 = texts.en) === null || _texts$en41 === void 0 ? void 0 : _texts$en41.autoGearScenariosLabel) || 'Required scenarios';
      ...
      if (scenarioLogic) {
        var _texts$en42, _texts$en43, _texts$en44, _texts$en45;
        var modeLabel = scenarioLogic === 'any' ? langTexts.autoGearScenarioModeAny || ((_texts$en42 = texts.en) === null || _texts$en42 === void 0 ? void 0 : _texts$en42.autoGearScenarioModeAny) || 'Match any selected scenario' : scenarioLogic === 'multiplier' ? langTexts.autoGearScenarioModeMultiplier || ((_texts$en43 = texts.en) === null || _texts$en43 === void 0 ? void 0 : _texts$en43.autoGearScenarioModeMultiplier) || 'Multiply when combined' : langTexts.autoGearScenarioModeAll || ((_texts$en44 = texts.en) === null || _texts$en44 === void 0 ? void 0 : _texts$en44.autoGearScenarioModeAll) || 'Require every selected scenario';
        var modeHeading = langTexts.autoGearScenarioModeLabel || ((_texts$en45 = texts.en) === null || _texts$en45 === void 0 ? void 0 : _texts$en45.autoGearScenarioModeLabel) || 'Scenario matching';
        var detail = modeLabel;
        if (scenarioLogic === 'multiplier') {
          var _texts$en46;
          var factorLabel = langTexts.autoGearScenarioFactorLabel || ((_texts$en46 = texts.en) === null || _texts$en46 === void 0 ? void 0 : _texts$en46.autoGearScenarioFactorLabel) || 'Multiplier factor';
      ...
      var triggerConfigs = [{
        ...
        formatter: function formatter(value) {
          ...
          var missingLabel = langTexts.autoGearOwnGearMissing || ((_texts$en47 = texts.en) === null || _texts$en47 === void 0 ? void 0 : _texts$en47.autoGearOwnGearMissing) || 'Missing own gear';
      ...
      triggerConfigs.forEach(function (config) {
        ...
        var label = langTexts[config.labelKey] || ((_texts$en48 = texts.en) === null || _texts$en48 === void 0 ? void 0 : _texts$en48[config.labelKey]) || config.labelKey;
      ...
      if (Array.isArray(triggers.ownGear) && triggers.ownGear.length) {
        ...
        if (ownGearLogic && ownGearLogic !== 'all') {
          var _texts$en49;
          var logicLabel = langTexts.autoGearConditionLogicLabel || ((_texts$en49 = texts.en) === null || _texts$en49 === void 0 ? void 0 : _texts$en49.autoGearConditionLogicLabel) || 'Match behavior';
          var logicText = '';
          if (ownGearLogic === 'none') {
            var _texts$en50;
            logicText = langTexts.autoGearConditionLogicNone || ((_texts$en50 = texts.en) === null || _texts$en50 === void 0 ? void 0 : _texts$en50.autoGearConditionLogicNone) || '';
          } else if (ownGearLogic === 'any') {
            var _texts$en51;
            logicText = langTexts.autoGearConditionLogicAny || ((_texts$en51 = texts.en) === null || _texts$en51 === void 0 ? void 0 : _texts$en51.autoGearConditionLogicAny) || '';
          } else if (ownGearLogic === 'or') {
            var _texts$en52;
            logicText = langTexts.autoGearConditionLogicOr || ((_texts$en52 = texts.en) === null || _texts$en52 === void 0 ? void 0 : _texts$en52.autoGearConditionLogicOr) || '';
          } else if (ownGearLogic === 'multiplier') {
            var _texts$en53;
            logicText = langTexts.autoGearConditionLogicMultiplier || ((_texts$en53 = texts.en) === null || _texts$en53 === void 0 ? void 0 : _texts$en53.autoGearConditionLogicMultiplier) || '';
          }
          if (logicText) {
      ...
      if (triggers.shootingDays && triggers.shootingDays.value) {
        ...
        var _label = langTexts.autoGearShootingDaysLabel || ((_texts$en54 = texts.en) === null || _texts$en54 === void 0 ? void 0 : _texts$en54.autoGearShootingDaysLabel) || 'Shooting days condition';
        ...
        var _modeLabel = langTexts[modeKey] || ((_texts$en55 = texts.en) === null || _texts$en55 === void 0 ? void 0 : _texts$en55[modeKey]) || triggers.shootingDays.mode;
    ...
    function renderAutoGearRuleSummary(analysis) {
      var _texts$en56, _analysis$scenarios3, _analysis$scenarios4, _analysis$scenarios5, _analysis$scenarios6, _analysis$scenarios7, _texts$en64, _texts$en65, _texts$en66, _texts$en67, _texts$en68, _texts$en69, _texts$en70, _texts$en71, _texts$en72, _texts$en73, _texts$en74, _texts$en75, _texts$en76, _texts$en77, _texts$en78, _texts$en79, _texts$en80, _texts$en81, _texts$en82, _texts$en83;
      ...
      var langTexts = texts[currentLang] || texts.en || {};
      var heading = langTexts.autoGearSummaryHeading || ((_texts$en56 = texts.en) === null || _texts$en56 === void 0 ? void 0 : _texts$en56.autoGearSummaryHeading) || autoGearSummaryHeadingElem.textContent || 'Rule coverage overview';
      ...
      var disabledRules = Array.isArray(analysis.disabledRules) ? analysis.disabledRules : [];
      var disabledCount = disabledRules.length;
      var allRules = typeof analysis.allRules === 'number' ? analysis.allRules : totalRules + disabledCount;
      ...
      if (!totalRules && !disabledCount) {
        var _texts$en57;
        autoGearSummaryDescriptionElem.textContent = langTexts.autoGearSummaryEmpty || ((_texts$en57 = texts.en) === null || _texts$en57 === void 0 ? void 0 : _texts$en57.autoGearSummaryEmpty) || 'Add a rule to unlock coverage insights.';
        return;
      }
      if (!totalRules && disabledCount) {
        var _texts$en58;
        autoGearSummaryDescriptionElem.textContent = langTexts.autoGearSummaryAllDisabled || ((_texts$en58 = texts.en) === null || _texts$en58 === void 0 ? void 0 : _texts$en58.autoGearSummaryAllDisabled) || 'All automatic gear rules are disabled.';
      } else if (hasSearchFilters || focus !== 'all' && focus !== 'uncovered' || focusApplied) {
        var _texts$en59;
        var template = langTexts.autoGearSummaryFilteredDescription || ((_texts$en59 = texts.en) === null || _texts$en59 === void 0 ? void 0 : _texts$en59.autoGearSummaryFilteredDescription) || 'Showing {visible} of {total} rules after filters.';
        ...
        var _texts$en60;
        autoGearSummaryDescriptionElem.textContent = langTexts.autoGearSummaryDescription || ((_texts$en60 = texts.en) === null || _texts$en60 === void 0 ? void 0 : _texts$en60.autoGearSummaryDescription) || 'Review duplicates, coverage gaps and conflicts before exporting or printing.';
      }
      if (disabledCount && totalRules) {
        var _texts$en61;
        var disabledTemplate = langTexts.autoGearSummaryDisabledSuffix || ((_texts$en61 = texts.en) === null || _texts$en61 === void 0 ? void 0 : _texts$en61.autoGearSummaryDisabledSuffix) || '{count} disabled rules are ignored in coverage.';
        autoGearSummaryDescriptionElem.textContent = "".concat(autoGearSummaryDescriptionElem.textContent, " ").concat(disabledTemplate.replace('{count}', formatNumberForLang(currentLang, disabledCount))).trim();
      }
      var formatRulesCount = function formatRulesCount(count) {
        var _texts$en62, _texts$en63;
        var template = count === 1 ? langTexts.autoGearRulesCountOne || ((_texts$en62 = texts.en) === null || _texts$en62 === void 0 ? void 0 : _texts$en62.autoGearRulesCountOne) || '%s rule' : langTexts.autoGearRulesCountOther || ((_texts$en63 = texts.en) === null || _texts$en63 === void 0 ? void 0 : _texts$en63.autoGearRulesCountOther) || '%s rules';
      ...
      var coverageDescription = hasScenarioCatalog ? (langTexts.autoGearSummaryCoverageDescription || ((_texts$en64 = texts.en) === null || _texts$en64 === void 0 ? void 0 : _texts$en64.autoGearSummaryCoverageDescription) || '{covered} of {total} scenarios covered').replace('{covered}', formatNumberForLang(currentLang, scenarioCovered)).replace('{total}', formatNumberForLang(currentLang, scenarioTotal)) : langTexts.autoGearSummaryCoverageEmpty || ((_texts$en65 = texts.en) === null || _texts$en65 === void 0 ? void 0 : _texts$en65.autoGearSummaryCoverageEmpty) || 'Add scenarios to measure coverage.';
      ...
      buildCard({
        label: langTexts.autoGearSummaryTotalLabel || ((_texts$en66 = texts.en) === null || _texts$en66 === void 0 ? void 0 : _texts$en66.autoGearSummaryTotalLabel) || 'Rules',
        value: formatNumberForLang(currentLang, totalRules),
        description: langTexts.autoGearSummaryTotalDescription || ((_texts$en67 = texts.en) === null || _texts$en67 === void 0 ? void 0 : _texts$en67.autoGearSummaryTotalDescription) || 'Saved in this setup'
      });
      buildCard({
        label: langTexts.autoGearSummaryCoverageLabel || ((_texts$en68 = texts.en) === null || _texts$en68 === void 0 ? void 0 : _texts$en68.autoGearSummaryCoverageLabel) || 'Scenario coverage',
        value: coverageValue,
        description: coverageDescription
      });
      buildCard({
        label: langTexts.autoGearSummaryNetLabel || ((_texts$en69 = texts.en) === null || _texts$en69 === void 0 ? void 0 : _texts$en69.autoGearSummaryNetLabel) || 'Net change',
        value: netValue,
        description: (langTexts.autoGearSummaryNetDescription || ((_texts$en70 = texts.en) === null || _texts$en70 === void 0 ? void 0 : _texts$en70.autoGearSummaryNetDescription) || 'Adds {adds} · Removes {removes}').replace('{adds}', formatNumberForLang(currentLang, analysis.net.addItems)).replace('{removes}', formatNumberForLang(currentLang, analysis.net.removeItems))
      });
      buildCard({
        label: langTexts.autoGearSummaryDuplicatesLabel || ((_texts$en71 = texts.en) === null || _texts$en71 === void 0 ? void 0 : _texts$en71.autoGearSummaryDuplicatesLabel) || 'Duplicated triggers',
        value: formatNumberForLang(currentLang, analysis.duplicates.totalGroups),
        description: analysis.duplicates.totalGroups ? (langTexts.autoGearSummaryDuplicatesSome || ((_texts$en72 = texts.en) === null || _texts$en72 === void 0 ? void 0 : _texts$en72.autoGearSummaryDuplicatesSome) || '{rules} across {groups} groups').replace('{rules}', formatRulesCount(analysis.duplicates.totalRules)).replace('{groups}', formatNumberForLang(currentLang, analysis.duplicates.totalGroups)) : langTexts.autoGearSummaryDuplicatesNone || ((_texts$en73 = texts.en) === null || _texts$en73 === void 0 ? void 0 : _texts$en73.autoGearSummaryDuplicatesNone) || 'No duplicate triggers.',
        focusKey: 'duplicates'
      });
      buildCard({
        label: langTexts.autoGearSummaryConflictsLabel || ((_texts$en74 = texts.en) === null || _texts$en74 === void 0 ? void 0 : _texts$en74.autoGearSummaryConflictsLabel) || 'Potential conflicts',
        value: formatNumberForLang(currentLang, analysis.conflicts.totalItems),
        description: analysis.conflicts.totalItems ? (langTexts.autoGearSummaryConflictsSome || ((_texts$en75 = texts.en) === null || _texts$en75 === void 0 ? void 0 : _texts$en75.autoGearSummaryConflictsSome) || '{rules} affected across {items} items').replace('{rules}', formatRulesCount(analysis.conflicts.totalRules)).replace('{items}', formatNumberForLang(currentLang, analysis.conflicts.totalItems)) : langTexts.autoGearSummaryConflictsNone || ((_texts$en76 = texts.en) === null || _texts$en76 === void 0 ? void 0 : _texts$en76.autoGearSummaryConflictsNone) || 'No conflicting adds/removes.',
        focusKey: 'conflicts'
      });
      buildCard({
        label: langTexts.autoGearSummaryOverlapsLabel || ((_texts$en77 = texts.en) === null || _texts$en77 === void 0 ? void 0 : _texts$en77.autoGearSummaryOverlapsLabel) || 'Stacked scenarios',
        value: formatNumberForLang(currentLang, overlapCount),
        description: overlapCount ? (langTexts.autoGearSummaryOverlapsSome || ((_texts$en78 = texts.en) === null || _texts$en78 === void 0 ? void 0 : _texts$en78.autoGearSummaryOverlapsSome) || '{count} scenarios touched by multiple rules').replace('{count}', formatNumberForLang(currentLang, overlapCount)) : langTexts.autoGearSummaryOverlapsNone || ((_texts$en79 = texts.en) === null || _texts$en79 === void 0 ? void 0 : _texts$en79.autoGearSummaryOverlapsNone) || 'No scenarios currently stack multiple rules.',
        focusKey: 'overlaps'
      });
      buildCard({
        label: langTexts.autoGearSummaryUncoveredLabel || ((_texts$en80 = texts.en) === null || _texts$en80 === void 0 ? void 0 : _texts$en80.autoGearSummaryUncoveredLabel) || 'Uncovered scenarios',
        value: formatNumberForLang(currentLang, analysis.scenarios.uncovered.length),
        description: analysis.scenarios.uncovered.length ? (langTexts.autoGearSummaryUncoveredSome || ((_texts$en81 = texts.en) === null || _texts$en81 === void 0 ? void 0 : _texts$en81.autoGearSummaryUncoveredSome) || 'Review {count} scenario gaps').replace('{count}', formatNumberForLang(currentLang, analysis.scenarios.uncovered.length)) : langTexts.autoGearSummaryUncoveredNone || ((_texts$en82 = texts.en) === null || _texts$en82 === void 0 ? void 0 : _texts$en82.autoGearSummaryUncoveredNone) || 'All required scenarios covered.',
        focusKey: 'uncovered'
      });
      var detailsFragment = document.createDocumentFragment();
      var intro = document.createElement('p');
      intro.className = 'auto-gear-summary-detail-text';
      intro.textContent = langTexts.autoGearSummaryDetailsIntro || ((_texts$en83 = texts.en) === null || _texts$en83 === void 0 ? void 0 : _texts$en83.autoGearSummaryDetailsIntro) || 'Use the dashboard to audit coverage, overlaps and conflicts before exporting or printing.';
      detailsFragment.appendChild(intro);
      var appendRuleButtons = function appendRuleButtons(container, rules) {
        var _texts$en84;
        var jumpHelp = langTexts.autoGearSummaryJumpToRule || ((_texts$en84 = texts.en) === null || _texts$en84 === void 0 ? void 0 : _texts$en84.autoGearSummaryJumpToRule) || 'Show rule';
        rules.forEach(function (ref, index) {
          var _texts$en85;
          var button = document.createElement('button');
          button.type = 'button';
          button.dataset.autoGearRule = ref.id;
          var label = formatAutoGearRuleReference(ref, langTexts);
          var disabledLabel = langTexts.autoGearRuleDisabledLabel || ((_texts$en85 = texts.en) === null || _texts$en85 === void 0 ? void 0 : _texts$en85.autoGearRuleDisabledLabel) || 'Disabled';
          button.textContent = label;
          button.setAttribute('title', jumpHelp);
          if (ref.enabled === false) {
            button.dataset.disabled = 'true';
            button.setAttribute('aria-label', "".concat(label, " \u2014 ").concat(disabledLabel));
          }
      ...
      if (disabledCount) {
        var _texts$en86;
        var disabledIntro = document.createElement('p');
        disabledIntro.className = 'auto-gear-summary-detail-text auto-gear-summary-disabled-note';
        disabledIntro.textContent = langTexts.autoGearSummaryDisabledNote || ((_texts$en86 = texts.en) === null || _texts$en86 === void 0 ? void 0 : _texts$en86.autoGearSummaryDisabledNote) || 'Disabled rules are visible below but ignored until re-enabled.';
        detailsFragment.appendChild(disabledIntro);
        if (disabledRules.length) {
          var disabledList = document.createElement('ul');
      ...
      if (focus === 'duplicates') {
        ...
        headingElem.textContent = langTexts.autoGearSummaryDetailsDuplicatesHeading || ((_texts$en87 = texts.en) === null || _texts$en87 === void 0 ? void 0 : _texts$en87.autoGearSummaryDetailsDuplicatesHeading) || 'Rules sharing the same triggers';
        ...
        if (!analysis.duplicates.groups.length) {
          ...
          empty.textContent = langTexts.autoGearSummaryDuplicatesNone || ((_texts$en88 = texts.en) === null || _texts$en88 === void 0 ? void 0 : _texts$en88.autoGearSummaryDuplicatesNone) || 'No duplicate triggers.';
          ...
          analysis.duplicates.groups.forEach(function (group) {
            ...
            descriptionElem.textContent = (langTexts.autoGearSummaryDuplicateGroupTitle || ((_texts$en89 = texts.en) === null || _texts$en89 === void 0 ? void 0 : _texts$en89.autoGearSummaryDuplicateGroupTitle) || 'Matching triggers') + (description ? " \u2014 ".concat(description) : '');
            detailsFragment.appendChild(descriptionElem);
            if (group.rules.length) {
              var list = document.createElement('ul');
              list.className = 'auto-gear-summary-list';
              var _item = document.createElement('li');
              appendRuleButtons(_item, group.rules);
        ...
        _headingElem.textContent = langTexts.autoGearSummaryDetailsConflictsHeading || ((_texts$en90 = texts.en) === null || _texts$en90 === void 0 ? void 0 : _texts$en90.autoGearSummaryDetailsConflictsHeading) || 'Gear touched by adds and removes';
        ...
        if (!analysis.conflicts.items.length) {
          ...
          _empty.textContent = langTexts.autoGearSummaryConflictsNone || ((_texts$en91 = texts.en) === null || _texts$en91 === void 0 ? void 0 : _texts$en91.autoGearSummaryConflictsNone) || 'No conflicting adds/removes.';
          ...
          analysis.conflicts.items.forEach(function (entry) {
            ...
            addsItem.textContent = (langTexts.autoGearSummaryConflictAddsLabel || ((_texts$en92 = texts.en) === null || _texts$en92 === void 0 ? void 0 : _texts$en92.autoGearSummaryConflictAddsLabel) || 'Added by') + ': ';
            appendRuleButtons(addsItem, entry.adds);
            list.appendChild(addsItem);
            var removesItem = document.createElement('li');
            removesItem.textContent = (langTexts.autoGearSummaryConflictRemovesLabel || ((_texts$en93 = texts.en) === null || _texts$en93 === void 0 ? void 0 : _texts$en93.autoGearSummaryConflictRemovesLabel) || 'Removed by') + ': ';
        ...
        _headingElem2.textContent = langTexts.autoGearSummaryDetailsOverlapsHeading || ((_texts$en94 = texts.en) === null || _texts$en94 === void 0 ? void 0 : _texts$en94.autoGearSummaryDetailsOverlapsHeading) || 'Scenarios with stacked rules';
        ...
        if (!analysis.scenarios.overlaps.length) {
          ...
          _empty2.textContent = langTexts.autoGearSummaryDetailsOverlapsNone || ((_texts$en95 = texts.en) === null || _texts$en95 === void 0 ? void 0 : _texts$en95.autoGearSummaryDetailsOverlapsNone) || 'No scenarios currently stack multiple rules.';
        ...
        _headingElem3.textContent = langTexts.autoGearSummaryDetailsUncoveredHeading || ((_texts$en97 = texts.en) === null || _texts$en97 === void 0 ? void 0 : _texts$en97.autoGearSummaryDetailsUncoveredHeading) || 'Scenarios without dedicated rules';
        ...
        if (!analysis.scenarios.uncovered.length) {
          ...
          _empty3.textContent = langTexts.autoGearSummaryUncoveredNone || ((_texts$en98 = texts.en) === null || _texts$en98 === void 0 ? void 0 : _texts$en98.autoGearSummaryUncoveredNone) || 'All required scenarios covered.';
        ...
        if (analysis.scenarios.overlaps.length) {
          ...
          _headingElem4.textContent = langTexts.autoGearSummaryDetailsOverlapsHeading || ((_texts$en100 = texts.en) === null || _texts$en100 === void 0 ? void 0 : _texts$en100.autoGearSummaryDetailsOverlapsHeading) || 'Scenarios with stacked rules';
          ...
          analysis.scenarios.overlaps.forEach(function (entry) {
            ...
            button.dataset.autoGearScenario = entry.value;
            button.textContent = "".concat(entry.label, " \u2014 ").concat(formatRulesCount(entry.rules.length));
            button.setAttribute('title', (langTexts.autoGearSummarySetScenarioFilter || ((_texts$en101 = texts.en) === null || _texts$en101 === void 0 ? void 0 : _texts$en101.autoGearSummarySetScenarioFilter) || 'Filter to scenario').replace('{scenario}', entry.label));
            li.appendChild(button);
            if (entry.rules.length) {
              li.appendChild(document.createTextNode(' · '));
              appendRuleButtons(li, entry.rules);
          ...
          note.textContent = langTexts.autoGearSummaryDetailsOverlapsNone || ((_texts$en102 = texts.en) === null || _texts$en102 === void 0 ? void 0 : _texts$en102.autoGearSummaryDetailsOverlapsNone) || 'No scenarios currently stack multiple rules.';
        ...
        if (analysis.scenarios.uncovered.length) {
          ...
          _headingElem5.textContent = langTexts.autoGearSummaryDetailsUncoveredHeading || ((_texts$en103 = texts.en) === null || _texts$en103 === void 0 ? void 0 : _texts$en103.autoGearSummaryDetailsUncoveredHeading) || 'Scenarios without dedicated rules';
          ...
          analysis.scenarios.uncovered.forEach(function (entry) {
            ...
            button.dataset.autoGearScenario = entry.value;
            button.textContent = entry.label;
            button.setAttribute('title', (langTexts.autoGearSummarySetScenarioFilter || ((_texts$en104 = texts.en) === null || _texts$en104 === void 0 ? void 0 : _texts$en104.autoGearSummarySetScenarioFilter) || 'Filter to scenario').replace('{scenario}', entry.label));
            li.appendChild(button);
      ...
      if (focus !== 'all') {
        ...
        resetButton.textContent = langTexts.autoGearSummaryResetFocus || ((_texts$en105 = texts.en) === null || _texts$en105 === void 0 ? void 0 : _texts$en105.autoGearSummaryResetFocus) || 'Clear dashboard filter';
        ...
        _empty4.textContent = langTexts.autoGearSummaryDetailsFocusEmpty || ((_texts$en106 = texts.en) === null || _texts$en106 === void 0 ? void 0 : _texts$en106.autoGearSummaryDetailsFocusEmpty) || 'Everything looks covered—no overlaps or conflicts detected.';
    ...
    function renderAutoGearRulesList() {
      ...
      if (!visibleRules.length) {
        ...
        if (!rules.length && !hasFilters) {
          var _texts$currentLang29, _texts$en107;
          empty.textContent = ((_texts$currentLang29 = texts[currentLang]) === null || _texts$currentLang29 === void 0 ? void 0 : _texts$currentLang29.autoGearNoRules) || ((_texts$en107 = texts.en) === null || _texts$en107 === void 0 ? void 0 : _texts$en107.autoGearNoRules) || 'No custom rules yet.';
        } else if (focusRuleIds && filteredRules.length) {
          var _texts$currentLang30, _texts$en108;
          empty.textContent = ((_texts$currentLang30 = texts[currentLang]) === null || _texts$currentLang30 === void 0 ? void 0 : _texts$currentLang30.autoGearNoFocusMatches) || ((_texts$en108 = texts.en) === null || _texts$en108 === void 0 ? void 0 : _texts$en108.autoGearNoFocusMatches) || 'No rules match the selected dashboard filter.';
        } else {
          var _texts$currentLang31, _texts$en109;
          empty.textContent = ((_texts$currentLang31 = texts[currentLang]) === null || _texts$currentLang31 === void 0 ? void 0 : _texts$currentLang31.autoGearNoMatches) || ((_texts$en109 = texts.en) === null || _texts$en109 === void 0 ? void 0 : _texts$en109.autoGearNoMatches) || 'No rules match your filters.';
        }
        autoGearRulesList.appendChild(empty);
        return;
      }
      visibleRules.forEach(function (rule) {
        var _texts$en110, _texts$currentLang61, _texts$en140, _texts$currentLang62, _texts$en141, _texts$currentLang63, _texts$en142, _texts$currentLang64, _texts$en143, _texts$currentLang65, _texts$en144, _texts$currentLang66, _texts$en145, _texts$currentLang67, _texts$en146;
        var index = ruleIndexByObject.get(rule);
        ...
        var ownGearMissingLabel = langTexts.autoGearOwnGearMissing || ((_texts$en110 = texts.en) === null || _texts$en110 === void 0 ? void 0 : _texts$en110.autoGearOwnGearMissing) || 'Missing own gear';
        ...
        if (!isEnabled) {
          var _texts$currentLang32, _texts$en111;
          var disabledMeta = document.createElement('p');
          disabledMeta.className = 'auto-gear-rule-meta auto-gear-rule-disabled-meta';
          disabledMeta.textContent = ((_texts$currentLang32 = texts[currentLang]) === null || _texts$currentLang32 === void 0 ? void 0 : _texts$currentLang32.autoGearRuleDisabledLabel) || ((_texts$en111 = texts.en) === null || _texts$en111 === void 0 ? void 0 : _texts$en111.autoGearRuleDisabledLabel) || 'Disabled';
          info.appendChild(disabledMeta);
        }
        if (rule.always) {
          var _texts$currentLang33, _texts$en112;
          var alwaysLabel = ((_texts$currentLang33 = texts[currentLang]) === null || _texts$currentLang33 === void 0 ? void 0 : _texts$currentLang33.autoGearAlwaysMeta) || ((_texts$en112 = texts.en) === null || _texts$en112 === void 0 ? void 0 : _texts$en112.autoGearAlwaysMeta) || 'Always active';
        ...
        if (scenarioList.length) {
          var _texts$currentLang34, _texts$en113;
          var scenarioLabel = ((_texts$currentLang34 = texts[currentLang]) === null || _texts$currentLang34 === void 0 || (_texts$currentLang34 = _texts$currentLang34.projectFields) === null || _texts$currentLang34 === void 0 ? void 0 : _texts$currentLang34.requiredScenarios) || ((_texts$en113 = texts.en) === null || _texts$en113 === void 0 || (_texts$en113 = _texts$en113.projectFields) === null || _texts$en113 === void 0 ? void 0 : _texts$en113.requiredScenarios) || 'Required Scenarios';
        ...
        if (cameraList.length) {
          var _texts$currentLang35, _texts$en114;
          var cameraLabelText = ((_texts$currentLang35 = texts[currentLang]) === null || _texts$currentLang35 === void 0 ? void 0 : _texts$currentLang35.autoGearCameraLabel) || ((_texts$en114 = texts.en) === null || _texts$en114 === void 0 ? void 0 : _texts$en114.autoGearCameraLabel) || 'Camera selection';
        ...
        if (ownGearList.length) {
          var _texts$currentLang36, _texts$currentLang37, _texts$en115, _texts$en116;
          var ownGearLabelText = ((_texts$currentLang36 = texts[currentLang]) === null || _texts$currentLang36 === void 0 ? void 0 : _texts$currentLang36.autoGearConditionOwnGearLabel) || ((_texts$currentLang37 = texts[currentLang]) === null || _texts$currentLang37 === void 0 ? void 0 : _texts$currentLang37.autoGearOwnGearLabel) || ((_texts$en115 = texts.en) === null || _texts$en115 === void 0 ? void 0 : _texts$en115.autoGearConditionOwnGearLabel) || ((_texts$en116 = texts.en) === null || _texts$en116 === void 0 ? void 0 : _texts$en116.autoGearOwnGearLabel) || 'Own gear';
          ...
          if (ownGearLogic && ownGearLogic !== 'all') {
            var _texts$currentLang38, _texts$en117;
            var logicLabel = ((_texts$currentLang38 = texts[currentLang]) === null || _texts$currentLang38 === void 0 ? void 0 : _texts$currentLang38.autoGearConditionLogicLabel) || ((_texts$en117 = texts.en) === null || _texts$en117 === void 0 ? void 0 : _texts$en117.autoGearConditionLogicLabel) || 'Match behavior';
            var logicText = '';
            if (ownGearLogic === 'none') {
              var _texts$currentLang39, _texts$en118;
              logicText = ((_texts$currentLang39 = texts[currentLang]) === null || _texts$currentLang39 === void 0 ? void 0 : _texts$currentLang39.autoGearConditionLogicNone) || ((_texts$en118 = texts.en) === null || _texts$en118 === void 0 ? void 0 : _texts$en118.autoGearConditionLogicNone) || '';
            } else if (ownGearLogic === 'any') {
              var _texts$currentLang40, _texts$en119;
              logicText = ((_texts$currentLang40 = texts[currentLang]) === null || _texts$currentLang40 === void 0 ? void 0 : _texts$currentLang40.autoGearConditionLogicAny) || ((_texts$en119 = texts.en) === null || _texts$en119 === void 0 ? void 0 : _texts$en119.autoGearConditionLogicAny) || '';
            } else if (ownGearLogic === 'or') {
              var _texts$currentLang41, _texts$en120;
              logicText = ((_texts$currentLang41 = texts[currentLang]) === null || _texts$currentLang41 === void 0 ? void 0 : _texts$currentLang41.autoGearConditionLogicOr) || ((_texts$en120 = texts.en) === null || _texts$en120 === void 0 ? void 0 : _texts$en120.autoGearConditionLogicOr) || '';
            } else if (ownGearLogic === 'multiplier') {
              var _texts$currentLang42, _texts$en121;
              logicText = ((_texts$currentLang42 = texts[currentLang]) === null || _texts$currentLang42 === void 0 ? void 0 : _texts$currentLang42.autoGearConditionLogicMultiplier) || ((_texts$en121 = texts.en) === null || _texts$en121 === void 0 ? void 0 : _texts$en121.autoGearConditionLogicMultiplier) || '';
            }
            if (logicText) {
        ...
        if (cameraWeightCondition && cameraWeightDisplay) {
          var _texts$currentLang43, _texts$en122;
          var weightLabelText = ((_texts$currentLang43 = texts[currentLang]) === null || _texts$currentLang43 === void 0 ? void 0 : _texts$currentLang43.autoGearCameraWeightLabel) || ((_texts$en122 = texts.en) === null || _texts$en122 === void 0 ? void 0 : _texts$en122.autoGearCameraWeightLabel) || 'Camera weight';
        ...
        if (monitorList.length) {
          var _texts$currentLang44, _texts$en123;
          var monitorLabelText = ((_texts$currentLang44 = texts[currentLang]) === null || _texts$currentLang44 === void 0 ? void 0 : _texts$currentLang44.autoGearMonitorLabel) || ((_texts$en123 = texts.en) === null || _texts$en123 === void 0 ? void 0 : _texts$en123.autoGearMonitorLabel) || 'Onboard monitors';
        ...
        if (crewPresentList.length) {
          var _texts$currentLang45, _texts$en124;
          var crewPresentLabelText = ((_texts$currentLang45 = texts[currentLang]) === null || _texts$currentLang45 === void 0 ? void 0 : _texts$currentLang45.autoGearCrewPresentLabel) || ((_texts$en124 = texts.en) === null || _texts$en124 === void 0 ? void 0 : _texts$en124.autoGearCrewPresentLabel) || 'Crew present';
        ...
        if (crewAbsentList.length) {
          var _texts$currentLang46, _texts$en125;
          var crewAbsentLabelText = ((_texts$currentLang46 = texts[currentLang]) === null || _texts$currentLang46 === void 0 ? void 0 : _texts$currentLang46.autoGearCrewAbsentLabel) || ((_texts$en125 = texts.en) === null || _texts$en125 === void 0 ? void 0 : _texts$en125.autoGearCrewAbsentLabel) || 'Crew absent';
        ...
        if (wirelessList.length) {
          var _texts$currentLang47, _texts$en126;
          var wirelessLabelText = ((_texts$currentLang47 = texts[currentLang]) === null || _texts$currentLang47 === void 0 ? void 0 : _texts$currentLang47.autoGearWirelessLabel) || ((_texts$en126 = texts.en) === null || _texts$en126 === void 0 ? void 0 : _texts$en126.autoGearWirelessLabel) || 'Wireless transmitters';
        ...
        if (motorsList.length) {
          var _texts$currentLang48, _texts$en127;
          var motorsLabelText = ((_texts$currentLang48 = texts[currentLang]) === null || _texts$currentLang48 === void 0 ? void 0 : _texts$currentLang48.autoGearMotorsLabel) || ((_texts$en127 = texts.en) === null || _texts$en127 === void 0 ? void 0 : _texts$en127.autoGearMotorsLabel) || 'FIZ motors';
        ...
        if (controllersList.length) {
          var _texts$currentLang49, _texts$en128;
          var controllersLabelText = ((_texts$currentLang49 = texts[currentLang]) === null || _texts$currentLang49 === void 0 ? void 0 : _texts$currentLang49.autoGearControllersLabel) || ((_texts$en128 = texts.en) === null || _texts$en128 === void 0 ? void 0 : _texts$en128.autoGearControllersLabel) || 'FIZ controllers';
        ...
        if (distanceList.length) {
          var _texts$currentLang50, _texts$en129;
          var distanceLabelText = ((_texts$currentLang50 = texts[currentLang]) === null || _texts$currentLang50 === void 0 ? void 0 : _texts$currentLang50.autoGearDistanceLabel) || ((_texts$en129 = texts.en) === null || _texts$en129 === void 0 ? void 0 : _texts$en129.autoGearDistanceLabel) || 'FIZ distance devices';
        ...
        if (shootingCondition) {
          var _texts$currentLang51, _texts$en130, _texts$currentLang52, _texts$en131, _texts$currentLang53, _texts$en132, _texts$currentLang54, _texts$en133;
          var shootingLabelText = ((_texts$currentLang51 = texts[currentLang]) === null || _texts$currentLang51 === void 0 ? void 0 : _texts$currentLang51.autoGearShootingDaysLabel) || ((_texts$en130 = texts.en) === null || _texts$en130 === void 0 ? void 0 : _texts$en130.autoGearShootingDaysLabel) || 'Shooting days condition';
          var minimumLabel = ((_texts$currentLang52 = texts[currentLang]) === null || _texts$currentLang52 === void 0 ? void 0 : _texts$currentLang52.autoGearShootingDaysModeMinimum) || ((_texts$en131 = texts.en) === null || _texts$en131 === void 0 ? void 0 : _texts$en131.autoGearShootingDaysModeMinimum) || 'Minimum';
          var maximumLabel = ((_texts$currentLang53 = texts[currentLang]) === null || _texts$currentLang53 === void 0 ? void 0 : _texts$currentLang53.autoGearShootingDaysModeMaximum) || ((_texts$en132 = texts.en) === null || _texts$en132 === void 0 ? void 0 : _texts$en132.autoGearShootingDaysModeMaximum) || 'Maximum';
          var everyLabel = ((_texts$currentLang54 = texts[currentLang]) === null || _texts$currentLang54 === void 0 ? void 0 : _texts$currentLang54.autoGearShootingDaysModeEvery) || ((_texts$en133 = texts.en) === null || _texts$en133 === void 0 ? void 0 : _texts$en133.autoGearShootingDaysModeEvery) || 'Every';
        ...
        if (matteboxList.length) {
          var _texts$currentLang55, _texts$en134;
          var matteboxLabelText = ((_texts$currentLang55 = texts[currentLang]) === null || _texts$currentLang55 === void 0 ? void 0 : _texts$currentLang55.autoGearMatteboxLabel) || ((_texts$en134 = texts.en) === null || _texts$en134 === void 0 ? void 0 : _texts$en134.autoGearMatteboxLabel) || 'Mattebox options';
        ...
        if (cameraHandleList.length) {
          var _texts$currentLang56, _texts$en135;
          var cameraHandleLabelText = ((_texts$currentLang56 = texts[currentLang]) === null || _texts$currentLang56 === void 0 ? void 0 : _texts$currentLang56.autoGearCameraHandleLabel) || ((_texts$en135 = texts.en) === null || _texts$en135 === void 0 ? void 0 : _texts$en135.autoGearCameraHandleLabel) || 'Camera handles';
        ...
        if (rawViewfinderList.length) {
          var _texts$currentLang57, _texts$en136;
          var viewfinderLabelText = ((_texts$currentLang57 = texts[currentLang]) === null || _texts$currentLang57 === void 0 ? void 0 : _texts$currentLang57.autoGearViewfinderExtensionLabel) || ((_texts$en136 = texts.en) === null || _texts$en136 === void 0 ? void 0 : _texts$en136.autoGearViewfinderExtensionLabel) || 'Viewfinder extension';
        ...
        if (videoDistributionDisplayList.length) {
          var _texts$currentLang58, _texts$en137;
          var videoDistLabelText = ((_texts$currentLang58 = texts[currentLang]) === null || _texts$currentLang58 === void 0 ? void 0 : _texts$currentLang58.autoGearVideoDistributionLabel) || ((_texts$en137 = texts.en) === null || _texts$en137 === void 0 ? void 0 : _texts$en137.autoGearVideoDistributionLabel) || 'Video distribution';
        ...
        if (deliveryResolutionList.length) {
          var _texts$currentLang59, _texts$en138;
          var deliveryLabelText = ((_texts$currentLang59 = texts[currentLang]) === null || _texts$currentLang59 === void 0 ? void 0 : _texts$currentLang59.autoGearDeliveryResolutionLabel) || ((_texts$en138 = texts.en) === null || _texts$en138 === void 0 ? void 0 : _texts$en138.autoGearDeliveryResolutionLabel) || 'Delivery resolution';
        ...
        if (rule.add.length) {
          var _texts$currentLang60, _texts$en139;
          var addsLabel = document.createElement('p');
          addsLabel.className = 'auto-gear-rule-meta auto-gear-rule-items-label';
          addsLabel.textContent = ((_texts$currentLang60 = texts[currentLang]) === null || _texts$currentLang60 === void 0 ? void 0 : _texts$currentLang60.autoGearAddsListLabel) || ((_texts$en139 = texts.en) === null || _texts$en139 === void 0 ? void 0 : _texts$en139.autoGearAddsListLabel) || 'Adds';
        ...
        var toggleOnLabel = ((_texts$currentLang61 = texts[currentLang]) === null || _texts$currentLang61 === void 0 ? void 0 : _texts$currentLang61.autoGearRuleToggleEnable) || ((_texts$en140 = texts.en) === null || _texts$en140 === void 0 ? void 0 : _texts$en140.autoGearRuleToggleEnable) || 'Enable rule';
        var toggleOffLabel = ((_texts$currentLang62 = texts[currentLang]) === null || _texts$currentLang62 === void 0 ? void 0 : _texts$currentLang62.autoGearRuleToggleDisable) || ((_texts$en141 = texts.en) === null || _texts$en141 === void 0 ? void 0 : _texts$en141.autoGearRuleToggleDisable) || 'Disable rule';
        var toggleLabel = isEnabled ? toggleOffLabel : toggleOnLabel;
        toggle.setAttribute('aria-label', toggleLabel);
        toggle.title = toggleLabel;
        var toggleStatus = document.createElement('span');
        toggleStatus.textContent = isEnabled ? ((_texts$currentLang63 = texts[currentLang]) === null || _texts$currentLang63 === void 0 ? void 0 : _texts$currentLang63.autoGearRuleEnabledLabel) || ((_texts$en142 = texts.en) === null || _texts$en142 === void 0 ? void 0 : _texts$en142.autoGearRuleEnabledLabel) || 'Enabled' : ((_texts$currentLang64 = texts[currentLang]) === null || _texts$currentLang64 === void 0 ? void 0 : _texts$currentLang64.autoGearRuleDisabledLabel) || ((_texts$en143 = texts.en) === null || _texts$en143 === void 0 ? void 0 : _texts$en143.autoGearRuleDisabledLabel) || 'Disabled';
        ...
        var editLabel = ((_texts$currentLang65 = texts[currentLang]) === null || _texts$currentLang65 === void 0 ? void 0 : _texts$currentLang65.editBtn) || ((_texts$en144 = texts.en) === null || _texts$en144 === void 0 ? void 0 : _texts$en144.editBtn) || 'Edit';
        ...
        var duplicateLabel = ((_texts$currentLang66 = texts[currentLang]) === null || _texts$currentLang66 === void 0 ? void 0 : _texts$currentLang66.autoGearDuplicateRule) || ((_texts$en145 = texts.en) === null || _texts$en145 === void 0 ? void 0 : _texts$en145.autoGearDuplicateRule) || 'Duplicate';
        ...
        var deleteLabel = ((_texts$currentLang67 = texts[currentLang]) === null || _texts$currentLang67 === void 0 ? void 0 : _texts$currentLang67.autoGearDeleteRule) || ((_texts$en146 = texts.en) === null || _texts$en146 === void 0 ? void 0 : _texts$en146.autoGearDeleteRule) || 'Delete';
    ...
    function updateAutoGearItemButtonState(type) {
      var _autoGearEditorActive, _texts$en147, _texts$en148;
      var normalizedType = type === 'remove' ? 'remove' : 'add';
      ...
      var defaultLabel = langTexts[defaultKey] || ((_texts$en147 = texts.en) === null || _texts$en147 === void 0 ? void 0 : _texts$en147[defaultKey]) || button.textContent || '';
      var updateLabel = langTexts.autoGearUpdateItemButton || ((_texts$en148 = texts.en) === null || _texts$en148 === void 0 ? void 0 : _texts$en148.autoGearUpdateItemButton) || defaultLabel;
    ...
    function renderAutoGearDraftImpact() {
      ...
      if (!autoGearEditorDraft) {
        var _texts$en149;
        var message = langTexts.autoGearDraftImpactUnavailable || ((_texts$en149 = texts.en) === null || _texts$en149 === void 0 ? void 0 : _texts$en149.autoGearDraftImpactUnavailable) || '';
        if (message) {
      ...
      if (!impact.available) {
        var _texts$en150;
        var _message = langTexts.autoGearDraftImpactUnavailable || ((_texts$en150 = texts.en) === null || _texts$en150 === void 0 ? void 0 : _texts$en150.autoGearDraftImpactUnavailable) || '';
        if (_message) {
      ...
      if (!impact.entries.length) {
        var _texts$en151;
        var _message2 = langTexts.autoGearDraftImpactEmpty || ((_texts$en151 = texts.en) === null || _texts$en151 === void 0 ? void 0 : _texts$en151.autoGearDraftImpactEmpty) || '';
        if (_message2) {
        ...
        var totalsTemplate = langTexts.autoGearDraftImpactTotals || ((_texts$en152 = texts.en) === null || _texts$en152 === void 0 ? void 0 : _texts$en152.autoGearDraftImpactTotals) || 'Current total: %s → After save: %s';
        var changeTemplate = langTexts.autoGearDraftImpactChange || ((_texts$en153 = texts.en) === null || _texts$en153 === void 0 ? void 0 : _texts$en153.autoGearDraftImpactChange) || 'Change: %s';
        impact.entries.forEach(function (entry) {
          ...
          if (entry.stacked) {
            ...
            var stackTemplate = langTexts[stackKey] || ((_texts$en154 = texts.en) === null || _texts$en154 === void 0 ? void 0 : _texts$en154[stackKey]);
            if (stackTemplate) {
          ...
          if (entry.conflict && entry.removeRulesCount > 0) {
            ...
            var conflictTemplate = langTexts[conflictKey] || ((_texts$en155 = texts.en) === null || _texts$en155 === void 0 ? void 0 : _texts$en155[conflictKey]);
            if (conflictTemplate) {
    ...
    function renderAutoGearDraftLists() {
      ...
      var renderList = function renderList(element, items, type) {
        ...
        element.innerHTML = '';
        if (!items.length) {
          var _texts$currentLang68, _texts$en156;
          var empty = document.createElement('li');
          empty.className = 'auto-gear-empty';
          empty.textContent = ((_texts$currentLang68 = texts[currentLang]) === null || _texts$currentLang68 === void 0 ? void 0 : _texts$currentLang68.autoGearEmptyList) || ((_texts$en156 = texts.en) === null || _texts$en156 === void 0 ? void 0 : _texts$en156.autoGearEmptyList) || 'No items yet.';
          element.appendChild(empty);
          return;
        }
        items.forEach(function (item) {
          var _texts$currentLang69, _texts$en157, _texts$currentLang70, _texts$en158;
          var li = document.createElement('li');
          ...
          var editLabel = ((_texts$currentLang69 = texts[currentLang]) === null || _texts$currentLang69 === void 0 ? void 0 : _texts$currentLang69.autoGearListEdit) || ((_texts$en157 = texts.en) === null || _texts$en157 === void 0 ? void 0 : _texts$en157.autoGearListEdit) || 'Edit';
          editBtn.textContent = editLabel;
          editBtn.setAttribute('data-help', editLabel);
          ...
          var removeLabel = ((_texts$currentLang70 = texts[currentLang]) === null || _texts$currentLang70 === void 0 ? void 0 : _texts$currentLang70.autoGearListRemove) || ((_texts$en158 = texts.en) === null || _texts$en158 === void 0 ? void 0 : _texts$en158.autoGearListRemove) || 'Remove';
    ...
    function addAutoGearDraftItem(type) {
      ...
      if (!parsedNames.length) {
        var _texts$currentLang71, _texts$en159;
        var message = ((_texts$currentLang71 = texts[currentLang]) === null || _texts$currentLang71 === void 0 ? void 0 : _texts$currentLang71.autoGearItemNameRequired) || ((_texts$en159 = texts.en) === null || _texts$en159 === void 0 ? void 0 : _texts$en159.autoGearItemNameRequired) || 'Enter an item name first.';
      ...
      if (editingTarget) {
        if (parsedNames.length !== 1) {
          var _texts$currentLang72, _texts$en160;
          var warning = ((_texts$currentLang72 = texts[currentLang]) === null || _texts$currentLang72 === void 0 ? void 0 : _texts$currentLang72.autoGearEditSingleItemWarning) || ((_texts$en160 = texts.en) === null || _texts$en160 === void 0 ? void 0 : _texts$en160.autoGearEditSingleItemWarning) || 'Edit one item at a time.';
    ...
    function saveAutoGearRuleFromEditor() {
      ...
      if (!alwaysActive && !scenarios.length && !matteboxSelections.length && !cameraHandleSelections.length && !viewfinderSelections.length && !deliveryResolutionSelections.length && !videoDistributionSelections.length && !cameraSelections.length && !ownGearSelections.length && !cameraWeightCondition && !monitorSelections.length && !crewPresentSelections.length && !crewAbsentSelections.length && !wirelessSelections.length && !motorSelections.length && !controllerSelections.length && !distanceSelections.length && !shootingDaysRequirement) {
        var _texts$currentLang73, _texts$en161, _texts$currentLang74, _texts$en162;
        var message = ((_texts$currentLang73 = texts[currentLang]) === null || _texts$currentLang73 === void 0 ? void 0 : _texts$currentLang73.autoGearRuleConditionRequired) || ((_texts$en161 = texts.en) === null || _texts$en161 === void 0 ? void 0 : _texts$en161.autoGearRuleConditionRequired) || ((_texts$currentLang74 = texts[currentLang]) === null || _texts$currentLang74 === void 0 ? void 0 : _texts$currentLang74.autoGearRuleScenarioRequired) || ((_texts$en162 = texts.en) === null || _texts$en162 === void 0 ? void 0 : _texts$en162.autoGearRuleScenarioRequired) || 'Select at least one scenario, mattebox option, camera handle, viewfinder extension, delivery resolution or video distribution before saving.';
        window.alert(message);
        return;
      }
      if (isAutoGearConditionActive('cameraWeight') && (!cameraWeightCondition || !Number.isFinite(cameraWeightCondition.value))) {
        var _texts$currentLang75, _texts$en163;
        var _message3 = ((_texts$currentLang75 = texts[currentLang]) === null || _texts$currentLang75 === void 0 ? void 0 : _texts$currentLang75.autoGearCameraWeightValueRequired) || ((_texts$en163 = texts.en) === null || _texts$en163 === void 0 ? void 0 : _texts$en163.autoGearCameraWeightValueRequired) || 'Enter a camera weight threshold before saving.';
      ...
      if (!autoGearEditorDraft.add.length && !autoGearEditorDraft.remove.length) {
        var _texts$currentLang76, _texts$en164;
        var _message4 = ((_texts$currentLang76 = texts[currentLang]) === null || _texts$currentLang76 === void 0 ? void 0 : _texts$currentLang76.autoGearRuleNeedsItems) || ((_texts$en164 = texts.en) === null || _texts$en164 === void 0 ? void 0 : _texts$en164.autoGearRuleNeedsItems) || 'Add at least one item to add or remove.';
      ...
      var langTexts = texts[currentLang] || texts.en || {};
      var warningMessages = buildAutoGearDraftWarningMessages(autoGearDraftPendingWarnings, langTexts);
      var performSave = function performSave() {
        var _texts$currentLang77, _texts$en165;
        var rules = getAutoGearRules();
        ...
        updateAutoGearCatalogOptions();
        renderAutoGearRulesList();
        var successMessage = ((_texts$currentLang77 = texts[currentLang]) === null || _texts$currentLang77 === void 0 ? void 0 : _texts$currentLang77.autoGearRuleSaved) || ((_texts$en165 = texts.en) === null || _texts$en165 === void 0 ? void 0 : _texts$en165.autoGearRuleSaved) || 'Automatic gear rule saved.';
        showNotification('success', successMessage);
        closeAutoGearEditor();
      };
      if (warningMessages.length) {
        var _texts$en166;
        var confirmBase = langTexts.autoGearDraftWarningConfirm || ((_texts$en166 = texts.en) === null || _texts$en166 === void 0 ? void 0 : _texts$en166.autoGearDraftWarningConfirm) || 'Save anyway? Review the impact warnings below before confirming.';
    ...
    function duplicateAutoGearRule(ruleId, ruleIndex) {
      ...
      var fallbackSuffix = typeof ((_texts$en167 = texts.en) === null || _texts$en167 === void 0 ? void 0 : _texts$en167.autoGearDuplicateSuffix) === 'string' ? texts.en.autoGearDuplicateSuffix.trim() : '';
    ...
    function setAutoGearRuleEnabled(ruleId, enabled, ruleIndex) {
      ...
      var updatedRule = normalizeAutoGearRule(_objectSpread(_objectSpread({}, rules[index]), {}, {
    ...
    function deleteAutoGearRule(ruleId, ruleIndex) {
      var _texts$currentLang78, _texts$en168;
      var rules = getAutoGearRules();
      var index = -1;
      if (ruleId) {
        index = rules.findIndex(function (rule) {
      ...
      if (index < 0) return;
      var confirmation = ((_texts$currentLang78 = texts[currentLang]) === null || _texts$currentLang78 === void 0 ? void 0 : _texts$currentLang78.autoGearDeleteConfirm) || ((_texts$en168 = texts.en) === null || _texts$en168 === void 0 ? void 0 : _texts$en168.autoGearDeleteConfirm) || 'Delete this rule?';
      var performRuleDelete = function performRuleDelete() {
      ...
      if (typeof window.cineShowConfirmDialog === 'function') {
        var _texts$currentLang79, _texts$currentLang80, _texts$currentLang81;
        window.cineShowConfirmDialog({
          title: ((_texts$currentLang79 = texts[currentLang]) === null || _texts$currentLang79 === void 0 ? void 0 : _texts$currentLang79.autoGearDeleteTitle) || 'Delete Rule',
          message: confirmation,
          confirmLabel: ((_texts$currentLang80 = texts[currentLang]) === null || _texts$currentLang80 === void 0 ? void 0 : _texts$currentLang80.delete) || 'Delete',
          cancelLabel: ((_texts$currentLang81 = texts[currentLang]) === null || _texts$currentLang81 === void 0 ? void 0 : _texts$currentLang81.cancel) || 'Cancel',
          danger: true,
    ...
    function importAutoGearRulesFromData(data) {
      ...
      if (!parsed || !Array.isArray(parsed.rules)) {
        var _texts$currentLang82, _texts$en169;
        var error = new Error('Invalid automatic gear rules import payload');
        error.userMessage = ((_texts$currentLang82 = texts[currentLang]) === null || _texts$currentLang82 === void 0 ? void 0 : _texts$currentLang82.autoGearImportSchemaError) || ((_texts$en169 = texts.en) === null || _texts$en169 === void 0 ? void 0 : _texts$en169.autoGearImportSchemaError) || 'Import failed. The file does not match the automatic gear rules export format.';
      ...
      if (validation.errors.length) {
        var _texts$currentLang83, _texts$en170;
        var message = ((_texts$currentLang83 = texts[currentLang]) === null || _texts$currentLang83 === void 0 ? void 0 : _texts$currentLang83.autoGearImportSchemaError) || ((_texts$en170 = texts.en) === null || _texts$en170 === void 0 ? void 0 : _texts$en170.autoGearImportSchemaError) || 'Import failed. The file does not match the automatic gear rules export format.';
      ...
      if (!options.silent) {
        var _texts$currentLang84, _texts$en171;
        var _message5 = ((_texts$currentLang84 = texts[currentLang]) === null || _texts$currentLang84 === void 0 ? void 0 : _texts$currentLang84.autoGearImportSuccess) || ((_texts$en171 = texts.en) === null || _texts$en171 === void 0 ? void 0 : _texts$en171.autoGearImportSuccess) || 'Automatic gear rules imported.';
    ...
    function exportAutoGearRules() {
      ...
      try {
        var _texts$currentLang85, _texts$en172;
        ...
        var message = ((_texts$currentLang85 = texts[currentLang]) === null || _texts$currentLang85 === void 0 ? void 0 : _texts$currentLang85.autoGearExportSuccess) || ((_texts$en172 = texts.en) === null || _texts$en172 === void 0 ? void 0 : _texts$en172.autoGearExportSuccess) || 'Automatic gear rules downloaded.';
        showNotification('success', message);
        return fileName;
      } catch (error) {
        var _texts$currentLang86, _texts$en173;
        console.warn('Automatic gear rules export failed', error);
        var _message6 = ((_texts$currentLang86 = texts[currentLang]) === null || _texts$currentLang86 === void 0 ? void 0 : _texts$currentLang86.autoGearExportError) || ((_texts$en173 = texts.en) === null || _texts$en173 === void 0 ? void 0 : _texts$en173.autoGearExportError) || 'Automatic gear rules export failed.';
    ...
    function exportAutoGearPresets() {
      ...
      if (typeof document === 'undefined' || typeof Blob !== 'function' || !URL || typeof URL.createObjectURL !== 'function') {
        if (notifyFailure) {
          var _texts$currentLang87, _texts$en174;
          var message = ((_texts$currentLang87 = texts[currentLang]) === null || _texts$currentLang87 === void 0 ? void 0 : _texts$currentLang87.autoGearPresetExportError) || ((_texts$en174 = texts.en) === null || _texts$en174 === void 0 ? void 0 : _texts$en174.autoGearPresetExportError) || 'Automatic gear preset export failed.';
      ...
      try {
        ...
        if (notifySuccess) {
          var _texts$currentLang88, _texts$en175;
          var _message7 = ((_texts$currentLang88 = texts[currentLang]) === null || _texts$currentLang88 === void 0 ? void 0 : _texts$currentLang88.autoGearPresetExportSuccess) || ((_texts$en175 = texts.en) === null || _texts$en175 === void 0 ? void 0 : _texts$en175.autoGearPresetExportSuccess) || 'Automatic gear presets downloaded.';
        ...
        if (notifyFailure) {
          var _texts$currentLang89, _texts$en176;
          var _message8 = ((_texts$currentLang89 = texts[currentLang]) === null || _texts$currentLang89 === void 0 ? void 0 : _texts$currentLang89.autoGearPresetExportError) || ((_texts$en176 = texts.en) === null || _texts$en176 === void 0 ? void 0 : _texts$en176.autoGearPresetExportError) || 'Automatic gear preset export failed.';
    ...
    function captureAutoGearBackupSnapshot() {
      ...
      try {
        ...
        renderAutoGearBackupRetentionControls();
        if (notifySuccess) {
          var _texts$currentLang90, _texts$en177;
          var message = ((_texts$currentLang90 = texts[currentLang]) === null || _texts$currentLang90 === void 0 ? void 0 : _texts$currentLang90.autoGearBackupSaved) || ((_texts$en177 = texts.en) === null || _texts$en177 === void 0 ? void 0 : _texts$en177.autoGearBackupSaved) || 'Automatic gear backup saved.';
          showNotification('success', message);
        }
        return {
          status: 'created',
        ...
        if (notifyFailure) {
          var _texts$currentLang91, _texts$en178;
          var _message9 = ((_texts$currentLang91 = texts[currentLang]) === null || _texts$currentLang91 === void 0 ? void 0 : _texts$currentLang91.autoGearBackupFailed) || ((_texts$en178 = texts.en) === null || _texts$en178 === void 0 ? void 0 : _texts$en178.autoGearBackupFailed) || 'Automatic gear backup failed.';
    ...
    function restoreAutoGearBackup(backupId) {
      var _texts$currentLang92, _texts$en179;
      if (!backupId) return false;
      var backup = autoGearBackups.find(function (entry) {
        return entry.id === backupId;
      });
      if (!backup) return false;
      var confirmation = ((_texts$currentLang92 = texts[currentLang]) === null || _texts$currentLang92 === void 0 ? void 0 : _texts$currentLang92.autoGearBackupRestoreConfirm) || ((_texts$en179 = texts.en) === null || _texts$en179 === void 0 ? void 0 : _texts$en179.autoGearBackupRestoreConfirm) || 'Replace your automatic gear rules with this backup?';
      var performRestore = function performRestore() {
        try {
          var _texts$currentLang93, _texts$en180;
          ...
          autoGearRulesDirtySinceBackup = false;
          var message = ((_texts$currentLang93 = texts[currentLang]) === null || _texts$currentLang93 === void 0 ? void 0 : _texts$currentLang93.autoGearBackupRestoreSuccess) || ((_texts$en180 = texts.en) === null || _texts$en180 === void 0 ? void 0 : _texts$en180.autoGearBackupRestoreSuccess) || 'Automatic gear backup restored.';
          showNotification('success', message);
        } catch (error) {
          var _texts$currentLang94, _texts$en181;
          console.warn('Failed to restore automatic gear backup', error);
          var _message0 = ((_texts$currentLang94 = texts[currentLang]) === null || _texts$currentLang94 === void 0 ? void 0 : _texts$currentLang94.autoGearBackupRestoreError) || ((_texts$en181 = texts.en) === null || _texts$en181 === void 0 ? void 0 : _texts$en181.autoGearBackupRestoreError) || 'Automatic gear backup restore failed.';
          showNotification('error', _message0);
        }
      };
      if (typeof window.cineShowConfirmDialog === 'function') {
        var _texts$currentLang95, _texts$currentLang96, _texts$currentLang97;
        window.cineShowConfirmDialog({
          title: ((_texts$currentLang95 = texts[currentLang]) === null || _texts$currentLang95 === void 0 ? void 0 : _texts$currentLang95.autoGearBackupRestoreTitle) || 'Restore Backup',
          message: confirmation,
          confirmLabel: ((_texts$currentLang96 = texts[currentLang]) === null || _texts$currentLang96 === void 0 ? void 0 : _texts$currentLang96.restore) || 'Restore',
          cancelLabel: ((_texts$currentLang97 = texts[currentLang]) === null || _texts$currentLang97 === void 0 ? void 0 : _texts$currentLang97.cancel) || 'Cancel',
          danger: true,
    ...
    function handleAutoGearImportSelection(event) {
      var _texts$currentLang98, _texts$en182;
      var input = event === null || event === void 0 ? void 0 : event.target;
      var file = input && input.files && input.files[0];
      if (!file) return;
      var confirmation = ((_texts$currentLang98 = texts[currentLang]) === null || _texts$currentLang98 === void 0 ? void 0 : _texts$currentLang98.autoGearImportConfirm) || ((_texts$en182 = texts.en) === null || _texts$en182 === void 0 ? void 0 : _texts$en182.autoGearImportConfirm) || 'Replace your automatic gear rules with the imported file?';
      var performImport = function performImport() {
        if (typeof FileReader === 'undefined') {
          var _texts$currentLang99, _texts$en183;
          var errorMsg = ((_texts$currentLang99 = texts[currentLang]) === null || _texts$currentLang99 === void 0 ? void 0 : _texts$currentLang99.autoGearImportError) || ((_texts$en183 = texts.en) === null || _texts$en183 === void 0 ? void 0 : _texts$en183.autoGearImportError) || 'Import failed. Please choose a valid automatic gear rules file.';
        ...
        reader.onload = function (e) {
          try {
            ...
            var _texts$currentLang100, _texts$en184;
            ...
            var fallbackErrorMsg = ((_texts$currentLang100 = texts[currentLang]) === null || _texts$currentLang100 === void 0 ? void 0 : _texts$currentLang100.autoGearImportError) || ((_texts$en184 = texts.en) === null || _texts$en184 === void 0 ? void 0 : _texts$en184.autoGearImportError) || 'Import failed. Please choose a valid automatic gear rules file.';
        ...
        reader.onerror = function () {
          var _texts$currentLang101, _texts$en185;
          var errorMsg = ((_texts$currentLang101 = texts[currentLang]) === null || _texts$currentLang101 === void 0 ? void 0 : _texts$currentLang101.autoGearImportError) || ((_texts$en185 = texts.en) === null || _texts$en185 === void 0 ? void 0 : _texts$en185.autoGearImportError) || 'Import failed. Please choose a valid automatic gear rules file.';
          showNotification('error', errorMsg);
          if (input) input.value = '';
        };
      ...
      if (typeof window.cineShowConfirmDialog === 'function') {
        var _texts$currentLang102, _texts$currentLang103, _texts$currentLang104;
        window.cineShowConfirmDialog({
          title: ((_texts$currentLang102 = texts[currentLang]) === null || _texts$currentLang102 === void 0 ? void 0 : _texts$currentLang102.autoGearImportTitle) || 'Import Rules',
          message: confirmation,
          confirmLabel: ((_texts$currentLang103 = texts[currentLang]) === null || _texts$currentLang103 === void 0 ? void 0 : _texts$currentLang103.import) || 'Import',
          cancelLabel: ((_texts$currentLang104 = texts[currentLang]) === null || _texts$currentLang104 === void 0 ? void 0 : _texts$currentLang104.cancel) || 'Cancel',
          danger: true,
    ...
    var FEATURE_SEARCH_NORMALIZATION_MODULE_CACHE_KEY = '__cineResolvedFeatureSearchNormalizationModule';
    function resolveFeatureSearchNormalizationApi() {
      ...
      if (!resolvedApi) {
        ...
        for (var index = 0; index < scopeCandidates.length; index += 1) {
          ...
          try {
            var exposed = scope.cineFeaturesFeatureSearchNormalization;
            if (exposed) {
              resolvedApi = exposed;
              break;
            }
    ...
    function resolveFeatureSearchNormalizationFunction() {
      var normalizationApi = resolveFeatureSearchNormalizationApi();
    ...
    function createFeatureSearchFallback() {
      var _normalizeSearchValue = resolveFeatureSearchNormalizationFunction();
      return {
    ...
    function hasDismissedInstallBanner() {
      ...
      try {
        var storedValue = localStorage.getItem(globalThis.INSTALL_BANNER_DISMISSED_KEY);
    ...
    function formatSizeText(lang, langTexts, bytes) {
      ...
      if (!Number.isFinite(bytes) || bytes <= 0) {
        ...
        var _template9 = langTexts.storageTotalSizeValue || ((_texts$en186 = texts.en) === null || _texts$en186 === void 0 ? void 0 : _texts$en186.storageTotalSizeValue) || '~%s KB';
      ...
      var template = langTexts.storageTotalSizeValue || ((_texts$en187 = texts.en) === null || _texts$en187 === void 0 ? void 0 : _texts$en187.storageTotalSizeValue) || '~%s KB';
      return template.replace('%s', formatted);
    }
    ...
    function formatStatusTimestamp(date, lang, langTexts) {
      ...
      if (relative) {
        var _texts$en188;
        var template = langTexts.storageStatusTimestamp || ((_texts$en188 = texts.en) === null || _texts$en188 === void 0 ? void 0 : _texts$en188.storageStatusTimestamp) || '{relative} ({absolute})';
        return template.replace('{relative}', relative).replace('{absolute}', absolute);
      }
      var fallbackTemplate = langTexts.storageStatusTimestampAbsolute || ((_texts$en189 = texts.en) === null || _texts$en189 === void 0 ? void 0 : _texts$en189.storageStatusTimestampAbsolute) || '{absolute}';
    ...
    function applyStorageStatus(element, info, lang, langTexts, hasAny) {
      ...
      if (info && info.date instanceof Date && !Number.isNaN(info.date.getTime())) {
        ...
        var display = info.name ? (langTexts.storageStatusWithName || ((_texts$en190 = texts.en) === null || _texts$en190 === void 0 ? void 0 : _texts$en190.storageStatusWithName) || '{name} — {time}').replace('{name}', info.name).replace('{time}', timeText) : timeText;
      ...
      if (hasAny) {
        var _texts$en191, _texts$en192;
        var fallback = langTexts.storageStatusStoredWithoutTimestamp || ((_texts$en191 = texts.en) === null || _texts$en191 === void 0 ? void 0 : _texts$en191.storageStatusStoredWithoutTimestamp) || langTexts.storageStatusNever || ((_texts$en192 = texts.en) === null || _texts$en192 === void 0 ? void 0 : _texts$en192.storageStatusNever) || '';
      ...
      var emptyText = langTexts.storageStatusNever || ((_texts$en193 = texts.en) === null || _texts$en193 === void 0 ? void 0 : _texts$en193.storageStatusNever) || '';
    ...
    function updateStorageSummary() {
      ...
      var summaryListEl = document.getElementById('storageSummaryList');
      ...
      var items = [{
        ...
        extra: deviceSummary.total > 0 && deviceSummary.categories.length ? (langTexts.storageDeviceCategories || ((_texts$en194 = texts.en) === null || _texts$en194 === void 0 ? void 0 : _texts$en194.storageDeviceCategories) || 'Affected categories: %s').replace('%s', formatDeviceCategories(lang, deviceSummary.categories)) : null
      }, {
        ...
        value: hasSession ? langTexts.storageSessionStored || ((_texts$en195 = texts.en) === null || _texts$en195 === void 0 ? void 0 : _texts$en195.storageSessionStored) || 'Stored' : langTexts.storageSessionNotStored || ((_texts$en196 = texts.en) === null || _texts$en196 === void 0 ? void 0 : _texts$en196.storageSessionNotStored) || 'Not stored',
    ...
    var buildFeatureSearchOptionData = function buildFeatureSearchOptionData(entry) {
      ...
      var optionKey = _typeof(entry) === 'object' && entry !== null ? entry.key || '' : '';
      var optionType = _typeof(entry) === 'object' && entry !== null ? entry.type || 'feature' : 'feature';
      var baseOption = {
        value: value,
        label: label || value,
        id: id,
    ...
    var renderFeatureSearchDropdown = function renderFeatureSearchDropdown(options) {
      ...
      var optionEntryMap = featureSearchDropdown.__optionEntries instanceof Map ? featureSearchDropdown.__optionEntries : new Map();
    ...
    var cachedFeatureSearchLocaleKey = null;
    var cachedFeatureSearchFilterAliases = null;
    var cachedFeatureSearchStopWords = null;
    var resolveFeatureSearchLocaleConfig = function resolveFeatureSearchLocaleConfig() {
      var _texts, _texts2, _texts3;
      var resolvedLang = typeof currentLang === 'string' && currentLang.trim() ? currentLang.trim() : 'en';
      if (cachedFeatureSearchLocaleKey === resolvedLang && cachedFeatureSearchFilterAliases && cachedFeatureSearchStopWords) {
        return {
          filterAliases: cachedFeatureSearchFilterAliases,
          stopWords: cachedFeatureSearchStopWords
        };
      }
      var localeTexts = typeof getLanguageTexts === 'function' ? getLanguageTexts(resolvedLang) : ((_texts = texts) === null || _texts === void 0 ? void 0 : _texts[resolvedLang]) || ((_texts2 = texts) === null || _texts2 === void 0 ? void 0 : _texts2.en) || {};
      var fallbackTexts = typeof getLanguageTexts === 'function' ? getLanguageTexts('en') : ((_texts3 = texts) === null || _texts3 === void 0 ? void 0 : _texts3.en) || {};
      var localeAliasConfig = localeTexts && _typeof(localeTexts.featureSearchFilterAliases) === 'object' ? localeTexts.featureSearchFilterAliases : null;
      var fallbackAliasConfig = fallbackTexts && _typeof(fallbackTexts.featureSearchFilterAliases) === 'object' ? fallbackTexts.featureSearchFilterAliases : null;
      var aliasConfigKeys = new Set([].concat(_toConsumableArray(Object.keys(fallbackAliasConfig || {})), _toConsumableArray(Object.keys(localeAliasConfig || {}))));
      var aliasMap = new Map();
      var _iterator11 = _createForOfIteratorHelper(aliasConfigKeys),
        _step11;
      try {
        for (_iterator11.s(); !(_step11 = _iterator11.n()).done;) {
          var typeKey = _step11.value;
          var normalizedType = String(typeKey || '').trim().toLowerCase();
          if (!normalizedType) {
            continue;
          }
          var localeList = localeAliasConfig && Array.isArray(localeAliasConfig[typeKey]) ? localeAliasConfig[typeKey] : null;
          var fallbackList = fallbackAliasConfig && Array.isArray(fallbackAliasConfig[typeKey]) ? fallbackAliasConfig[typeKey] : null;
          var list = localeList && localeList.length ? localeList : fallbackList || [];
      ...
      var localeStopWords = Array.isArray(localeTexts === null || localeTexts === void 0 ? void 0 : localeTexts.featureSearchStopWords) ? localeTexts.featureSearchStopWords : null;
      var fallbackStopWords = Array.isArray(fallbackTexts === null || fallbackTexts === void 0 ? void 0 : fallbackTexts.featureSearchStopWords) ? fallbackTexts.featureSearchStopWords : [];
      var resolvedStopWords = localeStopWords && localeStopWords.length ? localeStopWords : fallbackStopWords;
      var stopWordsSet = new Set();
      var _iterator12 = _createForOfIteratorHelper(resolvedStopWords),
        _step12;
      try {
    ...
    var filterFeatureSearchQueryTokens = function filterFeatureSearchQueryTokens(tokens) {
      ...
      var filtered = tokens.filter(function (token) {
        ...
        var normalizedToken = typeof token === 'string' ? token.trim().toLowerCase() : String(token).trim().toLowerCase();
        if (!normalizedToken) {
          return false;
        }
        var _resolveFeatureSearch = resolveFeatureSearchLocaleConfig(),
          stopWords = _resolveFeatureSearch.stopWords;
        var isStopWord = stopWords.has(normalizedToken);
    ...
    var extractFeatureSearchFilter = function extractFeatureSearchFilter(query) {
      ...
      var _resolveFeatureSearch2 = resolveFeatureSearchLocaleConfig(),
        filterAliases = _resolveFeatureSearch2.filterAliases;
      var filterType = filterAliases.get(alias) || null;
      if (!filterType) {
        return {
          filterType: null,
          queryText: trimmed
    ...
    function renderFeatureSearchFilteredDefaults(filterType) {
      ...
      if (filterType === 'recent') {
        ...
        var _values2 = [];
        var _seen = new Set();
        var _iterator14 = _createForOfIteratorHelper(recentEntries),
          _step14;
        try {
      ...
      var values = [];
      var seen = new Set();
      var _iterator15 = _createForOfIteratorHelper(scored),
        _step15;
      try {
      ...
      if (values.length === 0) {
        ...
        var _iterator16 = _createForOfIteratorHelper(fallback),
          _step16;
        try {
          for (_iterator16.s(); !(_step16 = _iterator16.n()).done;) {
            var _entry2 = _step16.value;
            if (values.length >= FEATURE_SEARCH_MAX_RESULTS) break;
    ...
    function updateFeatureSearchSuggestions(query) {
      ...
      var values = [];
      var seen = new Set();
      var _iterator17 = _createForOfIteratorHelper(candidates),
        _step17;
      try {
      ...
      while (current && contexts.length < FEATURE_CONTEXT_LIMIT) {
        ...
        if (labelledBy) {
          labelledBy.split(/\s+/).map(function (id) {
            return id && typeof document !== 'undefined' && document && typeof document.getElementById === 'function' ? document.getElementById(id) : null;
    ...
    var collectFeatureSearchHelpTexts = function collectFeatureSearchHelpTexts(element) {
      ...
      var processIdRefs = function processIdRefs(attrName, collector) {
        ...
        attrValue.split(/\s+/).map(function (id) {
          return id && typeof ownerDoc.getElementById === 'function' ? ownerDoc.getElementById(id) : null;
    ...
    var buildDeviceEntryDetailText = function buildDeviceEntryDetailText(entry) {
      ...
      var _iterator18 = _createForOfIteratorHelper(helpTexts),
        _step18;
      try {
    ...
    var buildFeatureSearchEntry = function buildFeatureSearchEntry(element, _ref24) {
      ...
      var targetMap = entryType === 'action' ? actionMap : featureMap;
      var existing = targetMap.get(baseKey);
      if (!existing) {
    ...
    var computePhraseMatchDetails = function computePhraseMatchDetails(entry) {
      ...
      var matched = false;
      if (normalizedQuery) {
        var _iterator19 = _createForOfIteratorHelper(texts),
          _step19;
        try {
          for (_iterator19.s(); !(_step19 = _iterator19.n()).done;) {
            var text = _step19.value;
      ...
      if (validTokens.length > 1) {
        ...
        if (pattern) {
          ...
          var _iterator20 = _createForOfIteratorHelper(texts),
            _step20;
          try {
            for (_iterator20.s(); !(_step20 = _iterator20.n()).done;) {
              var _text3 = _step20.value;
    ...
    var computeQuotedPhraseMatchDetails = function computeQuotedPhraseMatchDetails(entry) {
      ...
      normalizedPhrases.forEach(function (phrase) {
        var found = false;
        var _iterator21 = _createForOfIteratorHelper(texts),
          _step21;
        try {
    ...
    var getAdaptiveFuzzyMaxDistance = function getAdaptiveFuzzyMaxDistance(maxLength) {
    ...
    var isAcceptableFuzzyMatch = function isAcceptableFuzzyMatch(entryKey, queryKey, distance) {
      ...
      var maxDistance = getAdaptiveFuzzyMaxDistance(maxLength);
    ...
    function _loadStoredCustomFonts() {
      _loadStoredCustomFonts = _asyncToGenerator(_regenerator().m(function _callee6() {
        var stored, _iterator25, _step25, entry, normalized, _t5, _t6;
    ...
    function _handleLocalFontFiles() {
      _handleLocalFontFiles = _asyncToGenerator(_regenerator().m(function _callee8(fileList) {
        var added, unsupported, failed, persistFailure, _i11, _Array$from, file, dataUrl, result, message, _message1, _message10, _t7;
    ...
    function _requestLocalFonts() {
      _requestLocalFonts = _asyncToGenerator(_regenerator().m(function _callee0() {
        var fonts, added, duplicates, seenValues, _iterator26, _step26, font, rawName, name, _value6, _ensureFontFamilyOpti3, option, created, _t9, _t0;
        return _regenerator().w(function (_context0) {
          while (1) switch (_context0.p = _context0.n) {
            ...
            case 7:
              _value6 = buildFontFamilyValue(name);
              if (!seenValues.has(_value6)) {
                _context0.n = 8;
                break;
              }
              ...
              return _context0.a(3, 10);
            case 8:
              _ensureFontFamilyOpti3 = ensureFontFamilyOption(_value6, name, localFontsGroup, 'local'), option = _ensureFontFamilyOpti3.option, created = _ensureFontFamilyOpti3.created;
              if (option) {
                _context0.n = 9;
                break;
              }
    ...
    function populateFeatureSearch() {
      ...
      var registerDeviceMapEntry = function registerDeviceMapEntry(key, entry) {
        var options = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : {};
        if (!key || !entry) return false;
        var skipIfExists = options && options.skipIfExists === true;
        ...
        var existing = deviceMap.get(key);
      ...
      var registerDeviceLibraryEntriesForSearch = function registerDeviceLibraryEntriesForSearch() {
        ...
        deviceLibrarySearchEntries.forEach(function (entry) {
          if (!entry || !entry.label) return;
          var key = entry.key || searchKey(entry.label);
          var tokens = entry.tokens || searchTokens(entry.label);
          var primaryTokens = entry.primaryTokens || searchTokens(entry.label);
          var deviceEntry = {
            ...
            focusLibraryEntry: function focusLibraryEntry() {
              return focusDeviceLibraryEntry(entry, {
                skipScroll: true
              });
            },
            highlightLibraryEntry: function highlightLibraryEntry() {
              return highlightDeviceLibraryElement(entry.focusTarget || entry.element);
            }
          };
          registerDeviceMapEntry(key, deviceEntry);
          var optionLabel = "".concat(entry.label, " \xB7 ").concat(entry.categoryLabel);
          var detail = buildDeviceEntryDetailText(deviceEntry) || entry.summary || entry.categoryLabel;
          var deviceData = {
            type: 'device',
            key: key,
            display: optionLabel,
      ...
      try {
        var extraElements = document.querySelectorAll(FEATURE_SEARCH_EXTRA_SELECTOR);
      ...
      document.querySelectorAll('select').forEach(function (sel) {
        sel.querySelectorAll('option').forEach(function (opt) {
          ...
          var added = registerDeviceMapEntry(key, deviceEntry, {
            skipIfExists: true
          });
          if (!added) {
            return;
    ...
    function normalizeGearTableCategoryLabel(rawLabel) {
      ...
      var label = rawLabel.replace(/\s+/g, ' ').trim();
      if (label.endsWith('+')) {
    ...
    function resolveGearTableCategoryLabel(group) {
      ...
      if (headingCell) {
        var labelNode = headingCell.querySelector('.gear-category-label');
        if (labelNode && labelNode.textContent) {
          label = labelNode.textContent;
        } else {
          var dataLabel = headingCell.getAttribute('data-gear-category-label');
          if (dataLabel) {
            label = dataLabel;
    ...
    function syncGearTableGroupCustomMeta(group, label, key) {
      if (!group) return;
      var normalizedLabel = normalizeGearTableCategoryLabel(label);
      var normalizedKey = typeof key === 'string' ? key.trim() : '';
      if (normalizedKey) {
        group.setAttribute('data-gear-custom-key', normalizedKey);
      }
      group.querySelectorAll('[data-gear-custom-category]').forEach(function (node) {
        if (normalizedLabel) {
    ...
    function mergeDuplicateGearTableCategories(table) {
      if (!table) return;
      var mergeCellNodes = function mergeCellNodes(targetCell, sourceCell) {
        if (!targetCell || !sourceCell || targetCell === sourceCell) return;
        var doc = targetCell.ownerDocument || (typeof document !== 'undefined' ? document : null);
        var appendWithSeparator = function appendWithSeparator(node) {
          if (!node) return;
          var hasContent = targetCell.childNodes.length > 0;
          if (hasContent) {
            var lastEl = targetCell.lastElementChild;
            var lastIsBreak = lastEl && lastEl.tagName && lastEl.tagName.toLowerCase() === 'br';
            var isText = node.nodeType === 3 && node.textContent.trim();
            var isElement = node.nodeType === 1;
            var tag = isElement && node.tagName ? node.tagName.toLowerCase() : '';
            var isBlock = tag === 'div' || tag === 'section' || tag === 'table' || tag === 'ul' || tag === 'ol';
        ...
        var targetStandard = targetCell.querySelector('.gear-standard-items');
        sourceCell.querySelectorAll('.gear-standard-items').forEach(function (sourceStandard) {
          if (targetStandard) {
            ...
            var customSection = targetCell.querySelector('.gear-custom-section');
            if (customSection) {
        ...
        var targetCustom = targetCell.querySelector('.gear-custom-section');
        sourceCell.querySelectorAll('.gear-custom-section').forEach(function (sourceCustom) {
          if (!targetCustom) {
            targetCell.appendChild(sourceCustom);
            return;
          }
          var targetItems = targetCustom.querySelector('.gear-custom-items');
          if (!targetItems && doc) {
            targetItems = doc.createElement('div');
            targetItems.className = 'gear-custom-items';
            targetCustom.appendChild(targetItems);
          }
          var sourceItems = sourceCustom.querySelector('.gear-custom-items');
          if (sourceItems && targetItems) {
            while (sourceItems.firstChild) {
              targetItems.appendChild(sourceItems.firstChild);
            }
          }
          sourceCustom.querySelectorAll('.gear-custom-item').forEach(function (item) {
            if (targetItems) {
      ...
      var normalizeCategoryGroupRows = function normalizeCategoryGroupRows(group) {
        if (!group) return null;
        var rows = Array.from(group.querySelectorAll('tr')).filter(function (row) {
          return !row.classList.contains('category-row');
        });
        var doc = group.ownerDocument || (typeof document !== 'undefined' ? document : null);
        var primaryRow = rows.shift();
        if (!primaryRow && doc) {
          primaryRow = doc.createElement('tr');
          group.appendChild(primaryRow);
        }
        if (!primaryRow) return null;
        var primaryCell = primaryRow.querySelector('td');
        if (!primaryCell && doc) {
      ...
      var groups = Array.from(table.querySelectorAll('tbody.category-group'));
      var seen = new Map();
      groups.forEach(function (group) {
        var label = resolveGearTableCategoryLabel(group);
        if (!label) return;
        ...
        var existingKey = existing.getAttribute('data-gear-custom-key') || '';
        var incomingKey = group.getAttribute('data-gear-custom-key') || '';
        var resolvedKey = existingKey || incomingKey;
        if (resolvedKey && existingKey !== resolvedKey) {
          existing.setAttribute('data-gear-custom-key', resolvedKey);
        }
        var existingCell = normalizeCategoryGroupRows(existing);
        var incomingRows = Array.from(group.querySelectorAll('tr')).filter(function (row) {
          return !row.classList.contains('category-row');
        });
        if (existingCell) {
          ...
          incomingRows.forEach(function (row) {
            return existing.appendChild(row);
          });
        }
    ...
    function handleRequirementBoxKeydown(event) {
      var key = event === null || event === void 0 ? void 0 : event.key;
      if (!key) return;
    ...
    function displayGearAndRequirements(html) {
      ...
      if (gearListOutput) {
        if (safeGearHtml) {
          ...
          var gearTable = gearListOutput.querySelector('.gear-table') || gearListOutput.querySelector('table');
          if (gearTable) {
    ...
    function getCurrentSetupState() {
      ...
      var addIfChanged = function addIfChanged(key, value) {
        if (value === null || value === undefined) return;
        if (typeof value === 'string') {
          var trimmed = value.trim();
      ...
      if (Array.isArray(motorSelects)) {
        addIfChanged('motors', motorSelects.map(function (sel) {
          return sel.value;
        }));
      }
      if (Array.isArray(controllerSelects)) {
        addIfChanged('controllers', controllerSelects.map(function (sel) {
          return sel.value;
        }));
      }
    ...
    if (feedbackCancelBtn) {
      var _feedbackCancelBtn$te, _texts$currentLang105, _texts$en197;
      var cancelLabel = ((_feedbackCancelBtn$te = feedbackCancelBtn.textContent) === null || _feedbackCancelBtn$te === void 0 ? void 0 : _feedbackCancelBtn$te.trim()) || ((_texts$currentLang105 = texts[currentLang]) === null || _texts$currentLang105 === void 0 ? void 0 : _texts$currentLang105.cancelEditBtn) || ((_texts$en197 = texts.en) === null || _texts$en197 === void 0 ? void 0 : _texts$en197.cancelEditBtn) || 'Cancel';
    ...
    if (feedbackSubmitBtn) {
      var _feedbackSubmitBtn$te, _texts$currentLang106, _texts$en198;
      var submitLabel = ((_feedbackSubmitBtn$te = feedbackSubmitBtn.textContent) === null || _feedbackSubmitBtn$te === void 0 ? void 0 : _feedbackSubmitBtn$te.trim()) || ((_texts$currentLang106 = texts[currentLang]) === null || _texts$currentLang106 === void 0 ? void 0 : _texts$currentLang106.feedbackSubmit) || ((_texts$en198 = texts.en) === null || _texts$en198 === void 0 ? void 0 : _texts$en198.feedbackSubmit) || 'Save & Submit';
    ...
    function getAllPowerPortTypes() {
      ...
      Object.values(((_devices$fiz3 = devices.fiz) === null || _devices$fiz3 === void 0 ? void 0 : _devices$fiz3.distance) || {}).forEach(function (d) {
    ...
    if (connectionDiagramModule && typeof connectionDiagramModule.createConnectionDiagram === 'function') {
      try {
        ...
        var _connectionDiagram = connectionDiagramModule.createConnectionDiagram({
          document: document,
          window: window,
          navigator: navigator,
        ...
        if (_connectionDiagram && _typeof(_connectionDiagram) === 'object') {
          if (typeof _connectionDiagram.renderSetupDiagram === 'function') {
            renderSetupDiagram = _connectionDiagram.renderSetupDiagram;
          }
          if (typeof _connectionDiagram.enableDiagramInteractions === 'function') {
            enableDiagramInteractions = _connectionDiagram.enableDiagramInteractions;
          }
          if (typeof _connectionDiagram.updateDiagramLegend === 'function') {
            updateDiagramLegend = _connectionDiagram.updateDiagramLegend;
          }
          if (typeof _connectionDiagram.getDiagramManualPositions === 'function') {
            getDiagramManualPositions = _connectionDiagram.getDiagramManualPositions;
          }
          if (typeof _connectionDiagram.setManualDiagramPositions === 'function') {
            setManualDiagramPositions = _connectionDiagram.setManualDiagramPositions;
          }
          if (typeof _connectionDiagram.getDiagramCss === 'function') {
            getDiagramCss = _connectionDiagram.getDiagramCss;
          }
          if (_connectionDiagram.diagramConnectorIcons) {
            diagramConnectorIcons = _connectionDiagram.diagramConnectorIcons;
            if (typeof window !== 'undefined') window.diagramConnectorIcons = diagramConnectorIcons;else if (typeof globalThis !== 'undefined') globalThis.diagramConnectorIcons = diagramConnectorIcons;
          }
          if (_connectionDiagram.overviewSectionIcons) {
            overviewSectionIcons = _connectionDiagram.overviewSectionIcons;
          }
          if (_connectionDiagram.diagramIcons) {
            diagramIcons = _connectionDiagram.diagramIcons;
          }
          if (_connectionDiagram.DIAGRAM_MONITOR_ICON) {
            DIAGRAM_MONITOR_ICON = _connectionDiagram.DIAGRAM_MONITOR_ICON;
          }
        }
    ...
    function getAllMotorConnectorTypes() {
      var _devices$fiz4;
      var types = new Set();
      Object.values(((_devices$fiz4 = devices.fiz) === null || _devices$fiz4 === void 0 ? void 0 : _devices$fiz4.motors) || {}).forEach(function (m) {
    ...
    function getAllControllerPowerSources() {
      var _devices$fiz6;
      var types = new Set();
      Object.values(((_devices$fiz6 = devices.fiz) === null || _devices$fiz6 === void 0 ? void 0 : _devices$fiz6.controllers) || {}).forEach(function (c) {
    ...
    function getAllControllerBatteryTypes() {
      var _devices$fiz7;
      var types = new Set();
      Object.values(((_devices$fiz7 = devices.fiz) === null || _devices$fiz7 === void 0 ? void 0 : _devices$fiz7.controllers) || {}).forEach(function (c) {
    ...
    function getAllControllerConnectivity() {
      var _devices$fiz8;
      var types = new Set();
      Object.values(((_devices$fiz8 = devices.fiz) === null || _devices$fiz8 === void 0 ? void 0 : _devices$fiz8.controllers) || {}).forEach(function (c) {
    ...
    function getAllDistanceConnections() {
      var _devices$fiz9;
      var types = new Set();
      Object.values(((_devices$fiz9 = devices.fiz) === null || _devices$fiz9 === void 0 ? void 0 : _devices$fiz9.distance) || {}).forEach(function (d) {
    ...
    function getAllDistanceMethods() {
      var _devices$fiz0;
      var types = new Set();
      Object.values(((_devices$fiz0 = devices.fiz) === null || _devices$fiz0 === void 0 ? void 0 : _devices$fiz0.distance) || {}).forEach(function (d) {
    ...
    setViewfinderVideoInputs([]);
    setViewfinderVideoOutputs([]);
    var videoPowerInputHelpers = function resolveVideoPowerInputHelpers() {
      if (typeof require === 'function') {
        try {
    ...
    var cachedVideoPowerInputsContainer = null;
    function resolveVideoPowerInputsContainer() {
      if (cachedVideoPowerInputsContainer && typeof cachedVideoPowerInputsContainer.querySelector === 'function') {
    ...
    function resolveVideoPowerText(key, fallback) {
      var _texts4, _texts5;
      var localeTexts = typeof getLanguageTexts === 'function' ? getLanguageTexts(currentLang) : (_texts4 = texts) === null || _texts4 === void 0 ? void 0 : _texts4[currentLang];
      var englishTexts = typeof getLanguageTexts === 'function' ? getLanguageTexts('en') : (_texts5 = texts) === null || _texts5 === void 0 ? void 0 : _texts5.en;
      return localeTexts && localeTexts[key] || englishTexts && englishTexts[key] || fallback;
    }
    function fallbackNormalizePowerInputList(raw) {
      ...
      var list = [];
      var appendEntry = function appendEntry(value) {
        if (!value) {
          return;
        }
        var typeSource = Array.isArray(value.type) ? value.type : [value.type || value.portType || value.connectorType];
        var typeValues = (typeSource || []).filter(function (item) {
          return typeof item === 'string' && item.trim();
        }).map(function (item) {
          return item.trim();
        });
        var voltageRange = typeof value.voltageRange === 'string' ? value.voltageRange : '';
        var notes = typeof value.notes === 'string' ? value.notes : '';
    ...
    var normalizePowerInputList = typeof videoPowerInputHelpers.normalizePowerInputList === 'function' ? videoPowerInputHelpers.normalizePowerInputList : fallbackNormalizePowerInputList;
    function createVideoPowerInputRow() {
      var initialEntry = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
      var currentPowerPortOptions = ensurePowerPortOptionsInitialized();
      var storedTypeValues = Array.isArray(initialEntry.type) ? initialEntry.type.filter(Boolean) : [];
      var primaryType = storedTypeValues.length ? storedTypeValues[0] : '';
      var voltageValue = typeof initialEntry.voltageRange === 'string' ? initialEntry.voltageRange : '';
      var notesValue = typeof initialEntry.notes === 'string' ? initialEntry.notes : '';
      var row = document.createElement('div');
      ...
      currentPowerPortOptions.forEach(function (optVal) {
        var opt = document.createElement('option');
        opt.value = optVal;
        opt.textContent = optVal;
      ...
      var voltageInput = document.createElement('input');
      ...
      removeBtn.addEventListener('click', function () {
        var container = resolveVideoPowerInputsContainer();
    ...
    function setVideoPowerInputs(raw) {
      ...
      container.innerHTML = '';
      var entries = normalizePowerInputList(raw);
      if (entries.length) {
        entries.forEach(function (entry) {
    ...
    function getVideoPowerInputs() {
      ...
      var rows = Array.from(container.querySelectorAll('.video-power-row'));
      var entries = rows.map(function (row) {
        var select = row.querySelector('.video-power-type-select');
        if (!select) {
          return null;
        }
        var stored = row.dataset.originalTypeValues;
        var typeValues;
        if (stored && select.value === (select.dataset.originalValue || '')) {
          try {
            var parsed = JSON.parse(stored);
            if (Array.isArray(parsed) && parsed.length) {
              typeValues = parsed.filter(function (value) {
                return typeof value === 'string' && value.trim();
              });
            }
          } catch (parseError) {
        ...
        var voltageInput = row.querySelector('.video-power-voltage-input');
        var notesInput = row.querySelector('.video-power-notes-input');
        var voltageValue = voltageInput && typeof voltageInput.value === 'string' ? voltageInput.value.trim() : '';
        var notesValue = notesInput && typeof notesInput.value === 'string' ? notesInput.value.trim() : '';
        var entry = {
          type: typeValues.slice()
        };
        if (voltageValue) {
    ...
    function resolveRecordingMediaPlaceholder() {
      var _texts6, _texts7;
      var fallbackProjectForm = ((_texts6 = texts) === null || _texts6 === void 0 ? void 0 : _texts6.en) && texts.en.projectForm || {};
      var projectFormTexts = ((_texts7 = texts) === null || _texts7 === void 0 ? void 0 : _texts7[currentLang]) && texts[currentLang].projectForm || fallbackProjectForm;
    ...
    function createRecordingMediaRow() {
      ...
      var brand = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : '';
      var row = document.createElement('div');
      row.className = 'form-row';
      var select = document.createElement('select');
      ...
      if (filtered.length) {
        filtered.forEach(function (item) {
          var _ref31 = item || {},
            ...
            _ref31$brand = _ref31.brand,
            brand = _ref31$brand === void 0 ? '' : _ref31$brand;
    ...
    function updatePowerPortOptions() {
      ...
      if (typeof document !== 'undefined') {
        document.querySelectorAll('.video-power-type-select').forEach(function (sel) {
    ...
    function restoreSelectSelection(selectElem, previousValue, hadSelection, includeNone) {
      if (!selectElem) return;
      var options = Array.from(selectElem.options || []);
      if (hadSelection) {
        var optionExists = options.some(function (option) {
          return option && option.value === previousValue;
        });
        if (optionExists) {
          applySelectValueAfterPopulate(selectElem, previousValue, includeNone);
          return;
        }
        if (includeNone && options.some(function (option) {
    ...
    function populateMonitorSelect() {
      var target = typeof monitorSelect !== 'undefined' ? monitorSelect : typeof document !== 'undefined' ? document.getElementById('monitorSelect') : null;
      if (!target) return;
    ...
    function getCompatibleCagesForCamera(cameraName) {
      ...
      return Object.fromEntries(Object.entries(allCages).filter(function (_ref37) {
    ...
    var deviceLibrarySearchEntries = [];
    var deviceLibrarySearchMap = new Map();
    var deviceLibraryHighlightTimers = new WeakMap();
    var deviceLibrarySearchInput = document.getElementById('deviceLibrarySearch');
    var deviceLibrarySearchStatus = document.getElementById('deviceLibrarySearchStatus');
    function ensureDeviceLibraryEntryContext(entry) {
      ...
      var categoryEntry = activeDeviceManagerLists.get(entry.categoryKey);
      if (!categoryEntry) return;
      var list = categoryEntry.list,
        filterInput = categoryEntry.filterInput;
    ...
    function highlightDeviceLibraryElement(element) {
      ...
      if (!element || typeof ((_element$classList = element.classList) === null || _element$classList === void 0 ? void 0 : _element$classList.add) !== 'function') return;
      var existing = deviceLibraryHighlightTimers.get(element);
      if (existing) {
    ...
    function rebuildDeviceLibrarySearchIndex() {
      ...
      activeDeviceManagerLists.forEach(function (_ref39, categoryKey) {
        var list = _ref39.list,
          heading = _ref39.heading;
        if (!list) return;
        var categoryLabel = heading && heading.textContent ? heading.textContent.trim() : categoryKey;
        Array.from(list.querySelectorAll('li')).forEach(function (item) {
          var nameEl = item.querySelector('.device-summary span');
          if (!nameEl) return;
          var label = nameEl.textContent ? nameEl.textContent.trim() : '';
          if (!label || label === 'None') return;
          var summary = nameEl.getAttribute('title') || '';
          var key = searchKey(label);
          var focusTarget = nameEl;
          var entry = {
            key: key,
            label: label,
            summary: summary,
            ...
            tokens: searchTokens("".concat(label, " ").concat(summary, " ").concat(categoryLabel).trim()),
            primaryTokens: searchTokens(label)
          };
          deviceLibrarySearchEntries.push(entry);
          var existing = deviceLibrarySearchMap.get(key);
          if (!existing) {
    ...
    function applyDeviceLibrarySearchStatus(queryText, visibleCount) {
      ...
      var total = deviceLibrarySearchEntries.length;
      var langTexts = texts && texts[currentLang] || texts && texts.en || {};
      var formattedTotal = formatNumberForLang(currentLang, total);
      if (!queryText) {
        var _template11 = langTexts.deviceLibrarySearchStatusDefault || 'Showing all {total} devices.';
        deviceLibrarySearchStatus.textContent = _template11.replace('{total}', formattedTotal);
        return;
      }
      if (!visibleCount) {
        var _template12 = langTexts.deviceLibrarySearchNoResults || 'No devices match “{query}”.';
        deviceLibrarySearchStatus.textContent = _template12.replace('{query}', queryText);
        return;
      }
      var template = visibleCount === 1 ? langTexts.deviceLibrarySearchResultOne || 'Showing {visible} of {total} devices.' : langTexts.deviceLibrarySearchResultOther || 'Showing {visible} of {total} devices.';
      var formattedVisible = formatNumberForLang(currentLang, visibleCount);
      deviceLibrarySearchStatus.textContent = template.replace('{visible}', formattedVisible).replace('{total}', formattedTotal).replace('{query}', queryText);
    }
    function focusDeviceLibraryEntry(entry) {
      var options = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
      if (!entry || !entry.element) return;
      ensureDeviceLibraryEntryContext(entry);
      entry.element.hidden = false;
      var section = entry.element.closest('.device-category');
      if (section) {
        section.classList.remove('device-category--global-empty');
      }
      var target = entry.focusTarget || entry.element;
      if (typeof target.scrollIntoView === 'function') {
        try {
          target.scrollIntoView({
    ...
    function focusDeviceLibraryMatch(query) {
      ...
      var match = findBestSearchMatch(deviceLibrarySearchMap, key, tokens);
      var entry = match && match.value;
      if (entry) {
        focusDeviceLibraryEntry(entry);
      }
    }
    function applyDeviceLibrarySearchFilter() {
      var options = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
      if (!deviceLibrarySearchInput) return;
      if (!deviceLibrarySearchEntries.length) {
        rebuildDeviceLibrarySearchIndex();
      }
      var query = deviceLibrarySearchInput.value ? deviceLibrarySearchInput.value.trim() : '';
      var normalized = query.toLowerCase();
      var visibleCount = 0;
      deviceLibrarySearchEntries.forEach(function (entry) {
        var matches = !normalized || entry.labelLower.includes(normalized) || entry.categoryLabelLower.includes(normalized) || entry.summaryLower && entry.summaryLower.includes(normalized);
    ...
    function updateDeviceLibrarySearchLocalization() {
      applyDeviceLibrarySearchFilter({
        scrollToMatch: false
      });
    }
    if (deviceLibrarySearchInput) {
      bindFilterInput(deviceLibrarySearchInput, function () {
        return applyDeviceLibrarySearchFilter({
          scrollToMatch: false
        });
      });
      deviceLibrarySearchInput.addEventListener('keydown', function (event) {
        if (event.key === 'Enter') {
          event.preventDefault();
          var _value4 = deviceLibrarySearchInput.value ? deviceLibrarySearchInput.value.trim() : '';
          if (_value4) {
            focusDeviceLibraryMatch(_value4);
          }
        }
      });
      deviceLibrarySearchInput.addEventListener('search', function () {
        applyDeviceLibrarySearchFilter({
          scrollToMatch: false
        });
        var value = deviceLibrarySearchInput.value ? deviceLibrarySearchInput.value.trim() : '';
        if (value) {
    ...
    if (filterHelperScope) {
      ...
      if (typeof filterHelperScope.applyDeviceLibrarySearchFilter !== 'function') {
        filterHelperScope.applyDeviceLibrarySearchFilter = function (options) {
          return applyDeviceLibrarySearchFilter(options || {});
        };
      }
      if (typeof filterHelperScope.updateDeviceLibrarySearchLocalization !== 'function') {
        filterHelperScope.updateDeviceLibrarySearchLocalization = function () {
          return updateDeviceLibrarySearchLocalization();
        };
      }
    }
      ...
      try {
        runModuleUpdate({
          ...
          elements: {
            ...
            connectionDiagram: typeof connectionDiagram !== 'undefined' ? connectionDiagram : null
          },
          state: {
    ...
    function renderFeedbackTable(currentKey) {
      var _devices3, _cameraSelect, _devices4, _monitorSelect, _devices5, _videoSelect, _devices8, _distanceSelect, _devices9, _monitorSelect2, _texts$currentLang107, _texts$en199;
      ...
      var deleteFeedbackLabel = ((_texts$currentLang107 = texts[currentLang]) === null || _texts$currentLang107 === void 0 ? void 0 : _texts$currentLang107.deleteSetupBtn) || ((_texts$en199 = texts.en) === null || _texts$en199 === void 0 ? void 0 : _texts$en199.deleteSetupBtn) || 'Delete';
    ...
    function renderDeviceList(categoryKey, ulElement) {
      ...
      if (categoryKey === "accessories.cables" && categoryDevices && _typeof(categoryDevices) === 'object') {
        Object.keys(categoryDevices).sort(localeSort).forEach(function (subcat) {
          var devs = categoryDevices[subcat] || {};
          Object.keys(devs).filter(function (name) {
            return name !== 'None';
          }).sort(localeSort).forEach(function (name) {
            buildItem(name, devs[name], subcat);
          });
        });
      } else if (categoryDevices && _typeof(categoryDevices) === 'object') {
        Object.keys(categoryDevices).filter(function (name) {
          return name !== 'None';
        }).sort(localeSort).forEach(function (name) {
    ...
    var CORE_PART2_GLOBAL_EXPORTS = {
      ...
      setAutoGearRuleEnabled: setAutoGearRuleEnabled,
    ...
    }], ['updatePowerPortOptions', function () {
      return updatePowerPortOptions;
    }], ['updatePowerDistTypeOptions', function () {
      return updatePowerDistTypeOptions;
    }], ['updatePowerDistVoltageOptions', function () {
    ...
    }], ['ensureDefaultProjectInfoSnapshot', function () {
      return ensureDefaultProjectInfoSnapshot;
    }], ['attachSelectSearch', function () {
      return attachSelectSearch;
    ...
    }], ['setVideoPowerInputs', function () {
      return setVideoPowerInputs;
    }], ['getVideoPowerInputs', function () {
      return getVideoPowerInputs;
    }], ['clearVideoPowerInputs', function () {
      return clearVideoPowerInputs;
    ...
    }], ['updateFizConnectorOptions', function () {
      return updateFizConnectorOptions;
    }], ['updateMotorConnectorOptions', function () {
      return updateMotorConnectorOptions;
    ...
    }], ['updateMountTypeOptions', function () {
      return updateMountTypeOptions;
