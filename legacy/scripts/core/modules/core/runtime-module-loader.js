...
(function () {
  ...
  function readRuntimeModulesThroughRequire() {
    ...
    try {
      ...
      if (runtimeModules && _typeof(runtimeModules) === 'object') {
  ...
  var loader = readLoaderFromNamespace(readRuntimeModulesThroughRequire()) || readLoaderFromNamespace(readRuntimeModulesFromScopes());
  if (!loader && typeof cineCoreRuntimeModuleLoader !== 'undefined' && cineCoreRuntimeModuleLoader && (typeof cineCoreRuntimeModuleLoader === "undefined" ? "undefined" : _typeof(cineCoreRuntimeModuleLoader)) === 'object') {
