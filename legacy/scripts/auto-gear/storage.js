...
var AUTO_GEAR_BACKUP_GLOBAL_SCOPE = typeof globalThis !== 'undefined' && globalThis || typeof window !== 'undefined' && window || typeof self !== 'undefined' && self || typeof global !== 'undefined' && global || null;
...
function resolveAutoGearBackupRetentionDefaultValue() {
  ...
  var candidates = [readScopedNumericAutoGearValue('AUTO_GEAR_BACKUP_RETENTION_DEFAULT'), readScopedNumericAutoGearValue('AUTO_GEAR_BACKUP_RETENTION_DEFAULT_VALUE'), AUTO_GEAR_BACKUP_RETENTION_FALLBACK_DEFAULT];
...
function readAutoGearBackupsFromStorage(retentionLimit) {
  if (retentionLimit === void 0) {
    retentionLimit = resolveAutoGearBackupRetentionDefaultValue();
  }
  var stored = [];
