var texts = {
  en: {
    ...
    featureSearchHelp: "Type to jump to features, devices or help topics. Press Enter to navigate, / or Ctrl+K (Cmd+K on Mac) to focus the search from anywhere, and use Escape or × to clear the query.",
    ...
    autoGearMatteboxHelp: "Apply this rule when these mattebox choices are selected.",
    autoGearMatteboxPlaceholder: "Select mattebox options",
    autoGearRuleConditionRequired: "Select at least one scenario or mattebox option before saving.",
    ...
    autoGearBackupsDescription: "Backups save your rules every 10 minutes when changes occur. Restore a snapshot if something goes wrong.",
    ...
    backupSettingsHelp: "Download a JSON snapshot of settings, projects, custom devices, favorites and runtime data.",
    restoreSettings: "Restore",
    restoreSettingsHelp: "Load a previously exported JSON snapshot to restore your planner data.",
    ...
    preDeleteBackupSuccess: "Automatic backup saved. Restore it anytime from Saved Projects.",
    ...
    sharedImportAutoGearNone: "Don't import automatic gear rules",
    sharedImportAutoGearNoneHelp: "Load the project without applying the shared automatic additions.",
    ...
    helpButtonHelp: "Open the help dialog for step-by-step guidance (press ?, H, F1 or Ctrl+/).",
    helpClose: "Close (Esc)",
    ...
    hoverHelpButtonHelp: "Activate hover help so moving the cursor over buttons, fields, dropdowns or headers reveals brief explanations. You can open Settings while hover help is active to explore preferences without leaving this mode.",
    ...
    saveSetupHelp: "Store the devices and battery you have selected so the project can be recalled later. Press Enter or Ctrl+S (Cmd+S on Mac) to save quickly; the Save button stays disabled until a name is entered.",
    generateOverviewHelp: "Generate a print-ready summary of any saved project, including power and connection details.",
    ...
    shareSetupHelp: "Download a JSON file of the current project to share with others.",
    applySharedLinkHelp: "Load the configuration from the selected project file.",
    sharedLinkHelp: "Choose a previously saved project JSON file to load.",
  ...
  it: {
    ...
    offlineIndicatorHelp: "Compare quando il planner è offline. Tutti i progetti, i backup e i dati dei dispositivi restano salvati su questo dispositivo così puoi continuare a lavorare.",
    ...
    menuToggleLabel: "Menu",
    menuToggleHelp: "Apri la barra laterale per raggiungere rapidamente le sezioni del planner o mostrare i controlli sugli schermi piccoli. Premi di nuovo per chiuderla.",
    sideMenuHelp: "Navigazione laterale con le sezioni del planner. Seleziona una sezione per scorrere fino a essa e chiudere automaticamente il menu.",
    featureSearchPlaceholder: "Cerca funzionalità o dispositivi...",
    featureSearchLabel: "Cerca funzionalità, dispositivi e aiuto",
    featureSearchHelp: "Digita per andare alle funzionalità, ai dispositivi o aprire gli argomenti di aiuto correlati. Premi Invio per navigare, / o Ctrl+K (Cmd+K su Mac) per mettere a fuoco la ricerca ovunque e usa Esc o × per cancellare la ricerca.",
    ...
    sharedImportAutoGearNoneHelp: "Carica il progetto senza applicare le aggiunte automatiche condivise.",
    ...
    autoGearMatteboxHelp: "Applica la regola quando sono selezionate queste opzioni di matte box.",
    autoGearMatteboxPlaceholder: "Seleziona opzioni matte box",
    autoGearRuleConditionRequired: "Seleziona almeno uno scenario o un'opzione di matte box prima di salvare.",
    ...
    autoGearResetFactoryHelp: "Ripristina le regole automatiche generate dagli scenari predefiniti del planner.",
    ...
    autoGearBackupsDescription: "Viene salvato un backup ogni 10 minuti quando ci sono modifiche. Ripristina una versione se qualcosa va storto.",
    ...
    backupSettings: "Backup",
    backupSettingsHelp: "Scarica uno snapshot JSON con impostazioni, progetti, dispositivi personalizzati, preferiti e dati runtime.",
    restoreSettings: "Ripristina",
    restoreSettingsHelp: "Carica uno snapshot JSON esportato in precedenza per ripristinare dati e impostazioni.",
    factoryResetButton: "Ripristino di fabbrica",
    factoryResetButtonHelp: "Crea un backup e cancella tutti i dati del planner dopo la conferma.",
    ...
    factoryResetSuccess: "Backup scaricato. Tutti i dati del planner sono stati cancellati. Ricaricamento in corso…",
    factoryResetError: "Ripristino di fabbrica non riuscito. Riprova.",
    preDeleteBackupSuccess: "Backup automatico salvato. Puoi ripristinarlo da Progetti salvati.",
    ...
    helpSearchHelp: "Digita parole chiave o grafie alternative per filtrare all'istante gli argomenti dell'aiuto. I collegamenti rapidi si aggiornano mentre scrivi. Premi '/' o Ctrl+F (Cmd+F su Mac) per focalizzare rapidamente la casella di ricerca.",
    ...
    helpQuickLinksHelp: "Vai direttamente a una sezione della guida. I pulsanti mostrano solo gli argomenti visibili alla ricerca corrente.",
    helpQuickLinkButtonHelp: "Scorri fino alla sezione “%s” nella finestra di aiuto.",
    hoverHelpButtonLabel: "Passa il mouse per aiuto",
    hoverHelpButtonHelp: "Attiva l'aiuto al passaggio del mouse così, spostando il cursore su pulsanti, campi, menu a discesa o intestazioni, vengono mostrate brevi spiegazioni. Puoi aprire Impostazioni mentre l'aiuto è attivo per esplorare le preferenze senza uscire da questa modalità.",
    ...
    generateOverviewHelp: "Crea un riepilogo stampabile delle configurazioni salvate.",
    ...
    shareSetupHelp: "Scarica un file JSON del progetto corrente per condividerlo.",
    applySharedLinkHelp: "Carica la configurazione dal file di progetto selezionato.",
    sharedLinkHelp: "Seleziona un file JSON di progetto condiviso da caricare.",
    ...
    clearSetupHelp: "Rimuove tutti i dispositivi dalla configurazione corrente.",
  ...
  es: {
    ...
    featureSearchHelp: "Escribe para ir a funciones, dispositivos o temas de ayuda relacionados. Pulsa Enter para navegar, / o Ctrl+K (Cmd+K en Mac) para enfocar la búsqueda desde cualquier lugar y usa Esc o × para borrar la búsqueda.",
    ...
    sharedImportAutoGearNoneHelp: "Carga el proyecto sin aplicar las adiciones automáticas compartidas.",
    ...
    autoGearMatteboxHelp: "Aplica la regla cuando se eligen estas opciones de matte box.",
    autoGearMatteboxPlaceholder: "Selecciona opciones de matte box",
    autoGearRuleConditionRequired: "Selecciona al menos un escenario u opción de matte box antes de guardar.",
    ...
    autoGearBackupsDescription: "Guarda una copia cada 10 minutos cuando hay cambios. Restaura una versión si algo sale mal.",
    ...
    backupSettingsHelp: "Descarga una instantánea JSON con ajustes, proyectos, dispositivos personalizados, favoritos y datos de autonomía.",
    restoreSettings: "Restaurar",
    restoreSettingsHelp: "Carga una instantánea JSON exportada previamente para restaurar datos y ajustes.",
    ...
    preDeleteBackupSuccess: "Copia de seguridad automática guardada. Puedes restaurarla desde Proyectos guardados.",
    ...
    helpButtonHelp: "Abre el cuadro de ayuda (presiona ?, H, F1 o Ctrl+/).",
    ...
    helpSearchHelp: "Escribe palabras clave o variantes ortográficas para filtrar al instante los temas de ayuda. Los accesos rápidos se actualizan mientras escribes. Pulsa '/' o Ctrl+F (Cmd+F en Mac) para enfocar rápidamente el campo de búsqueda.",
    ...
    helpQuickLinksHelp: "Ve directamente a una sección de la ayuda. Los botones solo muestran los temas que coinciden con la búsqueda actual.",
    helpQuickLinkButtonHelp: "Desplázate a la sección “%s” dentro del cuadro de ayuda.",
    hoverHelpButtonLabel: "Pasa el cursor para ayuda",
    hoverHelpButtonHelp: "Activa la ayuda al pasar el cursor para que al moverlo sobre botones, campos, menús desplegables o encabezados aparezcan breves explicaciones. Puedes abrir Ajustes mientras la ayuda está activa para explorar las preferencias sin salir de este modo.",
    ...
    generateOverviewHelp: "Crea un resumen imprimible de las configuraciones guardadas.",
    ...
    shareSetupHelp: "Descarga un archivo JSON del proyecto actual para compartirlo.",
    applySharedLinkHelp: "Carga la configuración desde el archivo de proyecto seleccionado.",
    sharedLinkHelp: "Selecciona un archivo JSON de proyecto compartido para cargarlo.",
    ...
    clearSetupHelp: "Borra todos los dispositivos de la configuración actual.",
    ...
    downloadDiagramHelp: "Descarga el diagrama de configuración como imagen.",
  ...
  fr: {
    ...
    featureSearchHelp: "Tapez pour accéder aux fonctionnalités, appareils ou sujets d’aide associés. Appuyez sur Entrée pour naviguer, sur / ou Ctrl+K (Cmd+K sur Mac) pour placer le focus sur la recherche où que vous soyez, puis sur Échap ou × pour effacer la requête.",
    ...
    sharedImportAutoGearNoneHelp: "Charger le projet sans appliquer les ajouts automatiques partagés.",
    ...
    autoGearMatteboxHelp: "Appliquer la règle lorsque ces options de matte box sont sélectionnées.",
    autoGearMatteboxPlaceholder: "Sélectionnez des options de matte box",
    autoGearRuleConditionRequired: "Sélectionnez au moins un scénario ou une option de matte box avant d’enregistrer.",
    ...
    autoGearBackupsDescription: "Une sauvegarde est créée toutes les 10 minutes en cas de changement. Restaurez une version si nécessaire.",
    ...
    backupSettingsHelp: "Téléchargez une sauvegarde JSON comprenant réglages, projets, appareils personnalisés, favoris et données d’autonomie.",
    restoreSettings: "Restaurer",
    restoreSettingsHelp: "Chargez une sauvegarde JSON exportée auparavant pour restaurer données et réglages.",
    ...
    preDeleteBackupSuccess: "Sauvegarde automatique enregistrée. Vous pouvez la restaurer depuis Projets enregistrés.",
    ...
    helpButtonHelp: "Ouvrir la fenêtre d'aide (appuyez sur ?, H, F1 ou Ctrl+/).",
    ...
    helpSearchHelp: "Saisissez des mots-clés ou des variantes orthographiques pour filtrer instantanément les sujets d'aide. Les liens rapides se mettent à jour pendant la saisie. Appuyez sur '/' ou Ctrl+F (Cmd+F sur Mac) pour cibler rapidement le champ de recherche.",
    ...
    helpQuickLinksHelp: "Accédez directement à une section de l'aide. Les boutons n'affichent que les sujets correspondant à votre recherche actuelle.",
    ...
    hoverHelpButtonHelp: "Active l'aide au survol pour qu'en déplaçant le curseur sur les boutons, champs, menus déroulants ou en-têtes, des explications brèves apparaissent. Vous pouvez ouvrir Paramètres pendant que l'aide au survol est active afin d'explorer les préférences sans quitter ce mode.",
    ...
    generateOverviewHelp: "Crée un aperçu imprimable des configurations enregistrées.",
    ...
    shareSetupHelp: "Téléchargez un fichier JSON du projet actuel pour le partager.",
    applySharedLinkHelp: "Chargez la configuration depuis le fichier projet sélectionné.",
    sharedLinkHelp: "Choisissez un fichier JSON de projet partagé à charger.",
    ...
    clearSetupHelp: "Efface tous les appareils de la configuration actuelle.",
  ...
  de: {
    ...
    featureSearchHelp: "Tippen, um zu Funktionen, Geräten oder Hilfethemen zu springen. Drücke Enter zum Navigieren, / oder Strg+K (Cmd+K auf dem Mac), um die Suche überall zu fokussieren, und verwende Esc oder ×, um die Eingabe zu löschen.",
    ...
    sharedImportAutoGearNoneHelp: "Projekt ohne die geteilten automatischen Ergänzungen laden.",
    ...
    fontFamilySettingHelp: "Wähle die im Planner verwendete Schrift. Hinzugefügte lokale Fonts erscheinen in der Liste.",
    ...
    autoGearMatteboxHelp: "Regel anwenden, wenn diese Mattebox-Optionen gewählt sind.",
    autoGearMatteboxPlaceholder: "Mattebox-Optionen auswählen",
    autoGearRuleConditionRequired: "Wähle mindestens ein Szenario oder eine Mattebox-Option, bevor du speicherst.",
    ...
    autoGearResetFactoryHelp: "Stellt die automatisch erzeugten Regeln aus den Standardszenarien des Planners wieder her.",
    ...
    autoGearBackupsDescription: "Alle 10 Minuten wird bei Änderungen eine Sicherung erstellt. Stelle eine Version wieder her, falls etwas schiefgeht.",
    ...
    backupSettingsHelp: "Lade eine JSON-Sicherung mit Einstellungen, Projekten, eigenen Geräten, Favoriten und Laufzeitdaten herunter.",
    restoreSettings: "Wiederherstellen",
    restoreSettingsHelp: "Importiere eine zuvor exportierte JSON-Sicherung, um Daten und Einstellungen wiederherzustellen.",
    factoryResetButton: "Werkseinstellungen",
    factoryResetButtonHelp: "Erstellt ein Backup und löscht nach Bestätigung alle Planner-Daten.",
    ...
    factoryResetSuccess: "Backup heruntergeladen. Alle Planner-Daten wurden gelöscht. Seite wird neu geladen…",
    factoryResetError: "Zurücksetzen auf Werkseinstellungen fehlgeschlagen. Bitte erneut versuchen.",
    preDeleteBackupSuccess: "Automatische Sicherung gespeichert. Du kannst sie in Gespeicherte Projekte wiederherstellen.",
    ...
    dataHeadingHelp: "Zeigt, welche Planner-Daten lokal gespeichert sind und wie groß Sicherungen werden.",
    ...
    helpSearchHelp: "Gib Stichwörter oder alternative Schreibweisen ein, um die Hilfethemen sofort zu filtern. Die Schnelllinks aktualisieren sich beim Tippen. Drücke '/' oder Strg+F (Cmd+F auf dem Mac), um das Suchfeld schnell zu fokussieren.",
    ...
    hoverHelpButtonHelp: "Aktiviere die Hover-Hilfe, damit beim Überfahren von Schaltflächen, Feldern, Dropdowns oder Überschriften kurze Erklärungen erscheinen. Du kannst die Einstellungen öffnen, während die Hover-Hilfe aktiv ist, um Optionen zu erkunden, ohne den Modus zu verlassen.",
    ...
    generateOverviewHelp: "Erstellt eine druckbare Übersicht eines gespeicherten Projekts.",
    ...
    shareSetupHelp: "Lädt eine JSON-Datei des aktuellen Projekts zum Teilen herunter.",
    applySharedLinkHelp: "Lädt die Konfiguration aus der ausgewählten Projektdatei.",
    sharedLinkHelp: "Wähle eine zuvor geteilte Projektdatei aus, um sie zu laden.",
    ...
    clearSetupHelp: "Entfernt alle Geräte aus dem aktuellen Projekt.",
