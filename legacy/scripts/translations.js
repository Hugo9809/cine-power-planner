...
var texts = {
  en: {
    ...
    gearListEditCameraIdentityHelp: "Choose which camera (A, B, C, D or E) this item represents. Linked gear uses the matching color.",
  ...
  it: {
    ...
    gearListEditCameraIdentityHelp: "Scegli quale camera (A, B, C, D o E) rappresenta questa voce. Gli accessori collegati useranno il colore corrispondente.",
  ...
  es: {
    ...
    gearListEditCameraIdentityHelp: "Elige qué cámara (A, B, C, D o E) representa este elemento. El equipo vinculado usa el color correspondiente.",
  ...
  fr: {
    ...
    gearListEditCameraIdentityHelp: "Choisissez quelle caméra (A, B, C, D ou E) correspond à cet élément. Les accessoires liés utiliseront la couleur associée.",
  ...
  de: {
    ...
    gearListEditCameraIdentityHelp: "Wählen Sie, welche Kamera (A, B, C, D oder E) dieser Eintrag repräsentiert. Verknüpftes Zubehör übernimmt die passende Farbe.",
