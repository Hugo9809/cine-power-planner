...
var texts = {
  en: {
    ...
    helpDataAuditStep1: "Open %1$s, switch to %2$s, and run %3$s to capture a fresh snapshot before auditing downloads.",
  ...
  it: {
    ...
    helpDataAuditStep1: "Apri %1$s, passa a %2$s ed esegui %3$s per acquisire un nuovo snapshot prima di verificare i download.",
  ...
  es: {
    ...
    helpDataAuditStep1: "Abre %1$s, cambia a %2$s y ejecuta %3$s para capturar una instantánea nueva antes de auditar las descargas.",
  ...
  fr: {
    ...
    helpDataAuditStep1: "Ouvrez %1$s, passez à %2$s et lancez %3$s afin de créer une nouvelle sauvegarde avant d'auditer les téléchargements.",
  ...
  de: {
    ...
    helpDataAuditStep1: "Öffne %1$s, wechsle zu %2$s und führe %3$s aus, um vor der Download-Prüfung einen frischen Schnappschuss zu erstellen.",
