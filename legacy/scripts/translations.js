...
var texts = {
  en: {
    ...
    contacts: {
      ...
      userProfileHint: "Shared with the “User” entry so teams see your name, role and contact links in gear lists, exports and backups.",
  ...
  it: {
    ...
    contacts: {
      ...
      userProfileHint: "Condivisi con la voce \"Utente\" così nome, ruolo e recapiti compaiono in liste, esportazioni e backup.",
  ...
  es: {
    ...
    contacts: {
      ...
      userProfileHint: "Se comparte con la opción \"Usuario\" para que tu nombre, rol y datos de contacto aparezcan en listas, exportaciones y copias de seguridad.",
  ...
  fr: {
    ...
    contacts: {
      ...
      userProfileHint: "Partagés avec l’entrée \"Utilisateur\" pour que vos nom, rôle et coordonnées apparaissent dans les listes, exports et sauvegardes.",
  ...
  de: {
    ...
    contacts: {
      ...
      userProfileHint: "Wird mit dem Eintrag \"User\" geteilt, damit Name, Rolle und Kontaktwege in Listen, Exporten und Backups erscheinen.",
