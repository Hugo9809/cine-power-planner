var texts = {
  en: {
    ...
    generateOverviewHelp: "Rebuilds the print-ready summary for the selected saved project and automatically opens the print dialog with power and connection details.",
  ...
  it: {
    ...
    autoGearSummaryDetailsRulesWithoutScenariosDescription: "Queste regole si attivano senza filtri scenario.",
    ...
    generateOverviewHelp: "Ricostruisce il riepilogo pronto per la stampa del progetto salvato selezionato e apre automaticamente la finestra di stampa.",
  ...
  es: {
    ...
    autoGearSummaryDetailsRulesWithoutScenariosDescription: "Estas reglas se activan sin filtros de escenario.",
    ...
    generateOverviewHelp: "Reconstruye el resumen listo para imprimir del proyecto guardado seleccionado y abre automáticamente el cuadro de diálogo de impresión.",
  ...
  fr: {
    ...
    autoGearSummaryDetailsRulesWithoutScenariosDescription: "Ces règles se déclenchent sans filtres de scénario.",
    ...
    generateOverviewHelp: "Reconstruit le résumé prêt à l'impression du projet enregistré sélectionné et ouvre automatiquement la boîte de dialogue d'impression.",
  ...
  de: {
    ...
    autoGearSummaryDetailsRulesWithoutScenariosDescription: "Diese Regeln werden ohne Szenariofilter ausgelöst.",
    ...
    generateOverviewHelp: "Erstellt die druckfertige Übersicht für das ausgewählte gespeicherte Projekt neu und öffnet automatisch den Druckdialog.",
