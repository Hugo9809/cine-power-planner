var texts = {
  en: {
    ...
    autoGearSummaryDescription: "Review automatic gear rules for duplicate triggers, conflicts and uncovered scenarios.",
    ...
    autoGearSummaryDetailsIntro: "Focus cards to inspect overlaps, jump to rules or apply filters for offline reviews.",
    ...
    autoGearSummaryDetailsRulesWithoutScenariosDescription: "These rules never run because they are missing required scenarios.",
    ...
    sharedImportAutoBackupSuccess: "Saved a safety auto-backup before applying the shared project. Restore it anytime from Saved Projects.",
    sharedImportAutoBackupFailed: "Automatic backup failed, so the shared project was not applied. Save a manual backup and try again.",
    sharedImportAutoBackupSkipped: "Safety auto-backup skipped. Switch away from an auto-backup project and try again.",
    cameraLabel: "Camera:",
    ...
    applySharedLinkHelp: "Load the configuration from the selected project file. Cine Power Planner saves a safety auto-backup before applying it so you can undo the import instantly.",
    sharedLinkHelp: "Choose a previously saved project JSON file to load. A safety auto-backup is created before the shared project replaces your current data.",
  ...
  it: {
    ...
    reloadAppHelp: "Svuota la cache ed esegue una ricarica forzata dell'app senza eliminare i dati salvati.",
    ...
    sharedImportAutoBackupSuccess: "Backup di sicurezza salvato prima di applicare il progetto condiviso. Puoi ripristinarlo in qualsiasi momento da Progetti salvati.",
    sharedImportAutoBackupFailed: "Il backup automatico non è riuscito, quindi il progetto condiviso non è stato applicato. Salva un backup manuale e riprova.",
    sharedImportAutoBackupSkipped: "Backup di sicurezza saltato. Esci da un progetto auto-backup e riprova.",
    ...
    autoGearSummaryDetailsIntro: "Usa le schede focalizzate per analizzare sovrapposizioni, aprire le regole o applicare filtri offline.",
    ...
    autoGearSummaryDetailsRulesWithoutScenariosDescription: "Queste regole non vengono mai eseguite perché mancano gli scenari richiesti.",
    ...
    helpButtonHelp: "Apri la guida integrata passo per passo (premi ?, H, F1 o Ctrl+/).",
    ...
    applySharedLinkHelp: "Carica la configurazione dal file di progetto selezionato. Cine Power Planner salva un backup di sicurezza prima di applicarlo così puoi annullare subito l'importazione.",
    sharedLinkHelp: "Seleziona un file JSON di progetto salvato da caricare. Viene creata una copia di sicurezza prima che il progetto condiviso sostituisca i tuoi dati attuali.",
  ...
  es: {
    ...
    sharedImportAutoBackupSuccess: "Copia de seguridad guardada antes de aplicar el proyecto compartido. Puedes restaurarla en cualquier momento desde Proyectos guardados.",
    sharedImportAutoBackupFailed: "El respaldo automático falló, por lo que el proyecto compartido no se aplicó. Guarda un respaldo manual y vuelve a intentarlo.",
    sharedImportAutoBackupSkipped: "Copia de seguridad omitida. Sal de un proyecto de auto-respaldo y vuelve a intentarlo.",
    cameraLabel: "Cámara:",
    monitorLabel: "Monitor:",
    ...
    autoGearSummaryDetailsIntro: "Use las tarjetas enfocadas para ver solapamientos, saltar a reglas o aplicar filtros sin conexión.",
    ...
    autoGearSummaryDetailsRulesWithoutScenariosDescription: "Estas reglas nunca se ejecutan porque faltan escenarios requeridos.",
    ...
    helpButtonHelp: "Abre la guía integrada paso a paso (presiona ?, H, F1 o Ctrl+/).",
    ...
    applySharedLinkHelp: "Carga la configuración desde el archivo de proyecto seleccionado. Cine Power Planner guarda una copia de seguridad antes de aplicarla para que puedas deshacer la importación al instante.",
    sharedLinkHelp: "Selecciona un archivo JSON de proyecto guardado para cargarlo. Se crea una copia de seguridad antes de que el proyecto compartido reemplace tus datos actuales.",
  ...
  fr: {
    ...
    sharedImportAutoBackupSuccess: "Sauvegarde de sécurité enregistrée avant d’appliquer le projet partagé. Vous pouvez la restaurer à tout moment depuis Projets enregistrés.",
    sharedImportAutoBackupFailed: "La sauvegarde automatique a échoué, le projet partagé n’a pas été appliqué. Enregistrez une sauvegarde manuelle puis réessayez.",
    sharedImportAutoBackupSkipped: "Sauvegarde de sécurité ignorée. Quittez un projet d’auto-sauvegarde puis réessayez.",
    cameraLabel: "Caméra:",
    ...
    autoGearSummaryDetailsIntro: "Focalisez une carte pour inspecter les recouvrements, accéder aux règles ou appliquer des filtres hors ligne.",
    ...
    autoGearSummaryDetailsRulesWithoutScenariosDescription: "Ces règles ne s'exécutent jamais car il manque des scénarios requis.",
    ...
    helpButtonHelp: "Ouvrez la fenêtre d'aide détaillée (appuyez sur ?, H, F1 ou Ctrl+/).",
    ...
    applySharedLinkHelp: "Chargez la configuration depuis le fichier projet sélectionné. Cine Power Planner enregistre une sauvegarde de sécurité avant de l’appliquer pour annuler l’importation instantanément.",
    sharedLinkHelp: "Choisissez un fichier JSON de projet enregistré à charger. Une sauvegarde de sécurité est créée avant que le projet partagé ne remplace vos données actuelles.",
  ...
  de: {
    ...
    reloadAppHelp: "Leert den Cache und erzwingt ein Neuladen, ohne gespeicherte Daten zu entfernen.",
    ...
    sharedImportAutoBackupSuccess: "Sicherheits-Autobackup wurde vor dem Übernehmen des geteilten Projekts gespeichert. Du findest es jederzeit unter Gespeicherte Projekte.",
    sharedImportAutoBackupFailed: "Das automatische Backup ist fehlgeschlagen, daher wurde das geteilte Projekt nicht übernommen. Erstelle ein manuelles Backup und versuche es erneut.",
    sharedImportAutoBackupSkipped: "Sicherheits-Backup übersprungen. Wechsle von einem Auto-Backup-Projekt weg und versuche es erneut.",
    cameraLabel: "Kamera:",
    monitorLabel: "Monitor:",
    ...
    autoGearSummaryDetailsIntro: "Fokuskarten öffnen Details zu Überschneidungen, springen zu Regeln oder setzen Filter für Offline-Prüfungen.",
    ...
    autoGearSummaryDetailsRulesWithoutScenariosDescription: "Diese Regeln werden nie ausgeführt, da erforderliche Szenarien fehlen.",
    ...
    helpButtonHelp: "Öffnet die integrierte Schritt-für-Schritt-Hilfe (drücke ?, H, F1 oder Strg+/).",
    ...
    applySharedLinkHelp: "Lädt die Konfiguration aus der ausgewählten Projektdatei. Cine Power Planner speichert vorher ein Sicherheits-Backup, damit du den Import sofort rückgängig machen kannst.",
    sharedLinkHelp: "Wähle eine gespeicherte Projekt-JSON-Datei zum Laden. Vor dem Ersetzen deiner aktuellen Daten durch das geteilte Projekt wird ein Sicherheits-Backup erstellt.",
