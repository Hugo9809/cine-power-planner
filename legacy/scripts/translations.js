var texts = {
  en: {
    ...
    installHelpNoteIos: "Once installed, launch Cine Power Planner from your Home Screen. On iOS/iPadOS Safari the Home Screen app starts with separate storage—open Keep your data when installing on iOS from the help dialog to migrate your projects safely.",
  ...
  it: {
    ...
    installHelpNoteIos: "Dopo l'installazione, avvia Cine Power Planner dalla schermata Home. Su iOS/iPadOS Safari l'app aggiunta alla schermata Home usa uno spazio di archiviazione separato: apri \"Mantieni i tuoi dati dopo l’installazione su iOS\" dal centro assistenza per migrare in sicurezza i tuoi progetti.",
  ...
  es: {
    ...
    installHelpNoteIos: "Después de la instalación, abre Cine Power Planner desde la pantalla de inicio. En iOS/iPadOS Safari la app de la pantalla de inicio utiliza un almacenamiento separado; abre \"Mantén tus datos al instalar en iOS\" desde la ayuda para migrar tus proyectos de forma segura.",
  ...
  fr: {
    ...
    installHelpNoteIos: "Une fois installée, lancez Cine Power Planner depuis l’écran d’accueil. Sur iOS/iPadOS Safari, l’app ajoutée à l’écran d’accueil utilise un espace de stockage séparé : ouvrez \"Conservez vos données lors de l’installation sur iOS\" depuis l’aide pour migrer vos projets en toute sécurité.",
  ...
  de: {
    ...
    installHelpNoteIos: "Nach der Installation startest du Cine Power Planner über den Home-Bildschirm. Unter iOS/iPadOS Safari verwendet die installierte App einen eigenen Speicherbereich – öffne \"So bleiben deine Daten nach der iOS-Installation erhalten\" über die Hilfe, um deine Projekte sicher zu migrieren.",
