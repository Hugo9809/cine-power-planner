    ...
    onboardingTour: {
      ...
      steps: {
        intro: {
          ...
          body: "Inizia con il planner dell’alimentazione progettato offline-first per le troupe. Questo tour guidato evidenzia le salvaguardie che mantengono ogni progetto pronto al ripristino prima della prima ripresa.",
          hero: {
            badgeIcon: "\uE9C3",
            badgeLabel: "Offline · Senza abbonamento",
            badgeDescription: "Nessun server, nessun account. Salvataggi, autosalvataggi, backup, ripristini, condivisioni e importazioni restano su questo dispositivo.",
            highlights: [
              {
                icon: "\uE1A6",
                title: "Pianifica carichi di potenza sicuri",
                body: "Modella assorbimenti, runtime e cambi turno per fissare i margini di sicurezza delle batterie con sicurezza."
              },
              {
                icon: "\uE467",
                title: "AutoGear crea kit riutilizzabili",
                body: "Assembla liste complete, regola al volo le regole di automazione e riusa i preset tra i progetti."
              },
              {
                icon: "\uE469",
                title: "Condividi requisiti con contesto",
                body: "Raccogli deliverable, copertura crew e note per il noleggio, poi esporta PDF affidabili per troupe e rental."
              }
            ],
            languageLabel: "Lingua",
            languageHint: "Scegli la lingua dell’interfaccia. Tutorial, guida ed export si aggiornano subito in tutti i salvataggi offline.",
            offlineSummary: "Cine Power Planner funziona interamente offline con una PWA mobile installabile: le stesse salvaguardie per salvataggi, backup, condivisioni e prove di ripristino arrivano sul set senza abbonamenti."
          }
        },
        userProfile: {
    ...
    onboardingTour: {
      ...
      steps: {
        intro: {
          ...
          body: "Comienza con el planificador de energía pensado para trabajar sin conexión. Este recorrido guiado destaca las salvaguardas que mantienen cada proyecto listo para restaurarse antes del primer día de rodaje.",
          hero: {
            badgeIcon: "\uE9C3",
            badgeLabel: "Sin conexión · Sin suscripción",
            badgeDescription: "Sin servidores ni cuentas. Los guardados, autoguardados, copias, restauraciones, compartidos e importaciones permanecen en este dispositivo.",
            highlights: [
              {
                icon: "\uE1A6",
                title: "Planifica cargas seguras de energía",
                body: "Modela consumos, autonomías y relevos para asegurar márgenes de seguridad de las baterías con confianza."
              },
              {
                icon: "\uE467",
                title: "AutoGear arma kits reutilizables",
                body: "Arma listas completas, ajusta reglas automáticas al vuelo y reutiliza preajustes entre proyectos."
              },
              {
                icon: "\uE469",
                title: "Comparte requisitos con contexto",
                body: "Registra entregables, cobertura del equipo y notas para rental, luego exporta PDFs confiables para la crew y las casas de alquiler."
              }
            ],
            languageLabel: "Idioma",
            languageHint: "Elige el idioma de la interfaz. El tutorial, la ayuda y los exportes se actualizan al instante en todos los guardados sin conexión.",
            offlineSummary: "Cine Power Planner funciona totalmente sin conexión con una PWA móvil instalable: las mismas salvaguardas para guardados, copias, compartidos y ensayos de restauración te acompañan en el set sin suscripciones."
          }
        },
        userProfile: {
    ...
    onboardingTour: {
      ...
      steps: {
        intro: {
          ...
          body: "Commencez avec le planificateur d’énergie conçu pour fonctionner hors ligne. Ce tutoriel guidé met en avant les garde-fous qui gardent chaque projet prêt à être restauré avant le premier jour de tournage.",
          hero: {
            badgeIcon: "\uE9C3",
            badgeLabel: "Hors ligne · Sans abonnement",
            badgeDescription: "Sans serveur ni compte. Les enregistrements, auto-sauvegardes, sauvegardes, restaurations, partages et importations restent sur cet appareil.",
            highlights: [
              {
                icon: "\uE1A6",
                title: "Planifiez des charges d’alimentation sûres",
                body: "Modélisez consommation, autonomie et relèves pour verrouiller les marges de sécurité des batteries en toute confiance."
              },
              {
                icon: "\uE467",
                title: "AutoGear compose des kits réutilisables",
                body: "Assemblez des listes complètes, ajustez les règles automatiques à la volée et réutilisez les préréglages d’un projet à l’autre."
              },
              {
                icon: "\uE469",
                title: "Partagez les exigences avec le contexte",
                body: "Consignez livrables, couverture d’équipe et notes location, puis exportez des PDF fiables pour l’équipe et les loueurs."
              }
            ],
            languageLabel: "Langue",
            languageHint: "Choisissez la langue de l’interface. Le tutoriel, l’aide et les exports se mettent à jour instantanément dans toutes les sauvegardes hors ligne.",
            offlineSummary: "Cine Power Planner fonctionne entièrement hors ligne avec une PWA mobile installable : les mêmes sauvegardes, partages et répétitions de restauration vous accompagnent sur le plateau sans abonnement."
          }
        },
        userProfile: {
    ...
    onboardingTour: {
      ...
      steps: {
        intro: {
          ...
          body: "Starte mit dem offline-first Power-Planer für Crews. Diese geführte Tour zeigt die Schutzmechanismen, die jedes Projekt noch vor dem ersten Drehtag wiederherstellbar halten.",
          hero: {
            badgeIcon: "\uE9C3",
            badgeLabel: "Offline · Ohne Abonnement",
            badgeDescription: "Keine Server, keine Konten. Speichern, Autosaves, Backups, Wiederherstellungen, Freigaben und Importe bleiben auf diesem Gerät.",
            highlights: [
              {
                icon: "\uE1A6",
                title: "Sichere Leistungsbudgets planen",
                body: "Simuliere Verbrauch, Laufzeit und Wechsel, um Batteriereserven mit Vertrauen abzusichern."
              },
              {
                icon: "\uE467",
                title: "AutoGear baut wiederverwendbare Kits",
                body: "Stelle komplette Listen zusammen, passe Regeln unterwegs an und nutze Presets mehrfach."
              },
              {
                icon: "\uE469",
                title: "Anforderungen mit Kontext teilen",
                body: "Erfasse Deliverables, Crew-Abdeckung und Rental-Notizen und exportiere PDFs, denen Team und Verleiher vertrauen."
              }
            ],
            languageLabel: "Sprache",
            languageHint: "Wähle die Oberflächensprache. Tutorial, Hilfe und Exporte aktualisieren sich sofort in allen Offline-Sicherungen.",
            offlineSummary: "Cine Power Planner läuft vollständig offline und bietet eine installierbare mobile PWA – dieselben gesicherten Speicherstände, Backups, Freigaben und Wiederherstellungsproben auch am Set, ganz ohne Abonnement."
          }
        },
        userProfile: {
