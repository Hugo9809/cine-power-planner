var texts = {
  en: {
    ...
    featureSearchHelp: "Type to jump to features, devices, quick actions like Save or Backup, or help topics. Press Enter to navigate, / or Ctrl+K (Cmd+K on Mac) to focus the search from anywhere, and use Escape or × to clear the query.",
    ...
    autoGearCameraWeightHelp: "Activate this rule when the selected camera is heavier, lighter or exactly the weight you specify.",
  ...
  it: {
    ...
    featureSearchHelp: "Digita per andare alle funzionalità, ai dispositivi, alle azioni rapide come Salva o Backup o aprire gli argomenti di aiuto correlati. Premi Invio per navigare, / o Ctrl+K (Cmd+K su Mac) per mettere a fuoco la ricerca ovunque e usa Esc o × per cancellare la ricerca.",
    ...
    autoGearCameraWeightHelp: "Attiva questa regola quando la camera selezionata è più pesante, più leggera o esattamente il peso che imposti.",
  ...
  es: {
    ...
    featureSearchHelp: "Escribe para ir a funciones, dispositivos, acciones rápidas como Guardar o Copia de seguridad, o temas de ayuda relacionados. Pulsa Enter para navegar, / o Ctrl+K (Cmd+K en Mac) para enfocar la búsqueda desde cualquier lugar y usa Esc o × para borrar la búsqueda.",
    ...
    autoGearCameraWeightHelp: "Activa esta regla cuando la cámara seleccionada sea más pesada, más ligera o exactamente el peso que indiques.",
  ...
  fr: {
    ...
    featureSearchHelp: "Tapez pour accéder aux fonctionnalités, appareils, actions rapides comme Enregistrer ou Sauvegarde, ou aux sujets d’aide associés. Appuyez sur Entrée pour naviguer, sur / ou Ctrl+K (Cmd+K sur Mac) pour placer le focus sur la recherche où que vous soyez, puis sur Échap ou × pour effacer la requête.",
    ...
    autoGearCameraWeightHelp: "Activez cette règle lorsque la caméra sélectionnée est plus lourde, plus légère ou exactement le poids que vous indiquez.",
  ...
  de: {
    ...
    featureSearchHelp: "Tippen, um zu Funktionen, Geräten, Schnellaktionen wie Speichern oder Backup oder zu passenden Hilfethemen zu springen. Drücke Enter zum Navigieren, / oder Strg+K (Cmd+K auf dem Mac), um die Suche überall zu fokussieren, und verwende Esc oder ×, um die Eingabe zu löschen.",
    ...
    autoGearCameraWeightHelp: "Aktiviere diese Regel, wenn die ausgewählte Kamera schwerer, leichter oder genau so schwer ist wie der eingestellte Wert.",
