var texts = {
  en: {
    ...
    autoGearSummaryDetailsRulesWithoutScenariosDescription: "These rules are inactive because the project details are missing required inputs for their conditions.",
  ...
  it: {
    ...
    autoGearSummaryDetailsRulesWithoutScenariosDescription: "Queste regole sono inattive perché ai dettagli del progetto mancano gli input richiesti per le loro condizioni.",
  ...
  es: {
    ...
    autoGearSummaryDetailsRulesWithoutScenariosDescription: "Estas reglas están inactivas porque en los detalles del proyecto faltan los datos requeridos para sus condiciones.",
  ...
  fr: {
    ...
    autoGearSummaryDetailsRulesWithoutScenariosDescription: "Ces règles sont inactives car les détails du projet n'incluent pas encore toutes les données requises pour leurs conditions.",
  ...
  de: {
    ...
    autoGearSummaryDetailsRulesWithoutScenariosDescription: "Diese Regeln sind inaktiv, weil in den Projektdetails die für ihre Bedingungen erforderlichen Angaben fehlen.",
