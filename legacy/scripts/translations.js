var texts = {
  en: {
    ...
    menuToggleHelp: "Open the navigation menu to jump between planner sections or reveal controls on smaller screens. On phones it opens as a bottom drawer so controls stay within reach. Click again to close it.",
  ...
  it: {
    ...
    menuToggleLabel: "Menu",
    menuToggleHelp: "Apri il menu di navigazione per passare tra le sezioni del planner o mostrare i controlli sui dispositivi più piccoli. Su telefono si apre come un pannello dal basso per restare a portata. Tocca di nuovo per chiuderlo.",
  ...
  es: {
    ...
    menuToggleHelp: "Abre el menú de navegación para saltar entre las secciones del planificador o mostrar controles en pantallas pequeñas. En el teléfono se abre como un panel inferior para mantener los controles a mano. Pulsa de nuevo para cerrarlo.",
  ...
  fr: {
    ...
    menuToggleLabel: "Menu",
    menuToggleHelp: "Ouvrez le menu de navigation pour passer d’une section du planificateur à l’autre ou afficher les commandes sur les petits écrans. Sur téléphone, il s’ouvre en tiroir depuis le bas pour garder les commandes à portée. Touchez à nouveau pour le fermer.",
  ...
  de: {
    ...
    menuToggleHelp: "Öffnet das Navigationsmenü, um zwischen den Planerbereichen zu springen oder Steuerungen auf kleineren Bildschirmen einzublenden. Auf dem Smartphone öffnet es sich als untere Schublade, damit alles erreichbar bleibt. Tippen Sie erneut, um es zu schließen.",
