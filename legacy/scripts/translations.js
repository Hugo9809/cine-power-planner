var texts = {
  en: {
    ...
    autoGearCameraWeightHelp: "Activate this rule when the selected camera’s weight in grams is greater than, less than or equal to your threshold.",
    ...
    autoGearRuleConditionRequired: "Select at least one scenario, camera, monitor, wireless transmitter, motor, controller, distance device, mattebox option, camera handle, viewfinder extension, delivery resolution, video distribution or camera weight before saving.",
  ...
  it: {
    ...
    autoGearCameraWeightHelp: "Attiva questa regola quando il peso della camera selezionata in grammi è maggiore, minore o uguale alla soglia impostata.",
    ...
    autoGearRuleConditionRequired: "Seleziona almeno uno scenario, una camera, un monitor, un trasmettitore wireless, un motore, un controller, un dispositivo di distanza, un'opzione di matte box, una maniglia camera, una prolunga mirino, una risoluzione di consegna, una distribuzione video o una condizione sul peso della camera prima di salvare.",
    ...
    hoverHelpButtonHelp: "Attiva i suggerimenti al passaggio del mouse: spostando il cursore su pulsanti, campi, menu a discesa o intestazioni compaiono brevi spiegazioni. Puoi aprire Impostazioni mentre la modalità è attiva per esplorare le preferenze senza uscirne.",
  ...
  es: {
    ...
    autoGearCameraWeightHelp: "Activa esta regla cuando el peso de la cámara seleccionada en gramos sea mayor, menor o igual a tu umbral.",
    ...
    hoverHelpButtonHelp: "Activa la ayuda al pasar el cursor para que, al moverlo sobre botones, campos, menús desplegables o encabezados, aparezcan explicaciones breves. Puedes abrir Ajustes mientras el modo está activo para explorar las preferencias sin salir de él.",
  ...
  fr: {
    ...
    diagramPdfNote: "Le schéma de connexion n'est pas inclus dans l'export PDF. Ouvrez la vue d'impression pour consulter la mise en page.",
    ...
    autoGearCameraWeightHelp: "Active cette règle lorsque le poids de la caméra sélectionnée en grammes est supérieur, inférieur ou égal à ton seuil.",
    ...
    autoGearRuleConditionRequired: "Sélectionne au moins un scénario, une caméra, un moniteur, un émetteur sans fil, un moteur, un contrôleur, un capteur de distance, une option de matte box, une poignée caméra, une extension de viseur, une résolution de livraison, une distribution vidéo ou une condition de poids de caméra avant d’enregistrer.",
    ...
    hoverHelpButtonHelp: "Activez l'aide contextuelle au survol : en déplaçant le curseur sur les boutons, champs, menus déroulants ou en-têtes, de brèves explications apparaissent. Vous pouvez ouvrir Paramètres pendant que le mode est actif afin d'explorer les préférences sans quitter cette vue.",
  ...
  de: {
    ...
    autoGearCameraWeightHelp: "Aktiviere diese Regel, wenn das Gewicht der ausgewählten Kamera in Gramm größer, kleiner oder gleich deinem Grenzwert ist.",
    ...
    autoGearRuleConditionRequired: "Wähle mindestens ein Szenario, eine Kamera, einen Monitor, einen Funksender, einen Motor, einen Controller, ein Distanzgerät, eine Mattebox-Option, einen Kamera-Handgriff, eine Sucher-Verlängerung, eine Auslieferungsauflösung, eine Videoverteilung oder eine Kameragewicht-Bedingung, bevor du speicherst.",
    ...
    hoverHelpButtonHelp: "Aktiviere die Hover-Hilfe: Beim Überfahren von Schaltflächen, Feldern, Dropdowns oder Überschriften erscheinen kurze Erklärungen. Du kannst die Einstellungen öffnen, während der Modus aktiv ist, um Optionen zu erkunden, ohne ihn zu verlassen.",
