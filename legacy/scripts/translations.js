...
var texts = {
  en: {
    ...
    autoGearBackupsDescription: "Backups save your rules every 10 minutes when changes occur and keep up to 30 incremental steps between full snapshots. Restore a snapshot if something goes wrong.",
    ...
    loggingIntro: "The log updates live while Settings stay open. Nothing leaves this device.",
    ...
    generateOverviewHelp: "Rebuilds the print-ready summary for the selected saved project and opens the overview dialog so you can review power and connection details before printing when ready.",
    ...
    shareSetupHelp: "Download a JSON backup of the current project so you can share or restore it later. Store the file with your crew backups before closing the planner.",
    applySharedLinkHelp: "Load the configuration from a JSON backup exported via Save & Share. Review the preview before applying so nothing overwrites the wrong project.",
  ...
  it: {
    ...
    autoGearBackupsDescription: "Viene salvato un backup ogni 10 minuti quando ci sono modifiche e vengono conservati fino a 30 passaggi incrementali tra due snapshot completi. Ripristina una versione se qualcosa va storto.",
    ...
    loggingIntro: "Il registro si aggiorna in tempo reale finché Impostazioni resta aperto. I dati non lasciano questo dispositivo.",
    ...
    generateOverviewHelp: "Ricostruisce il riepilogo pronto per la stampa del progetto salvato selezionato e apre la finestra panoramica così puoi rivedere i dettagli di alimentazione e connessione prima di stampare quando preferisci.",
    ...
    shareSetupHelp: "Scarica un backup JSON del progetto corrente così puoi condividerlo o ripristinarlo in seguito. Salva il file insieme ai backup della troupe prima di chiudere il planner.",
    applySharedLinkHelp: "Carica la configurazione da un backup JSON esportato tramite Salva e condividi. Controlla l’anteprima prima di applicarlo per evitare di sovrascrivere il progetto sbagliato.",
  ...
  es: {
    ...
    autoGearBackupsDescription: "Guarda una copia cada 10 minutos cuando hay cambios y mantiene hasta 30 pasos incrementales entre instantáneas completas. Restaura una versión si algo sale mal.",
    ...
    loggingIntro: "El registro se actualiza en vivo mientras Ajustes permanece abierto. Nada sale de este dispositivo.",
    ...
    generateOverviewHelp: "Reconstruye el resumen listo para imprimir del proyecto guardado seleccionado y abre la ventana de overview para que revises los detalles de alimentación y conexión antes de imprimir cuando quieras.",
    ...
    shareSetupHelp: "Descarga una copia de seguridad JSON del proyecto actual para compartirla o restaurarla más tarde. Guarda el archivo junto con los respaldos del equipo antes de cerrar el planificador.",
    applySharedLinkHelp: "Carga la configuración desde un respaldo JSON exportado con Guardar y compartir. Revisa la vista previa antes de aplicarlo para no sobrescribir el proyecto equivocado.",
  ...
  fr: {
    ...
    autoGearBackupsDescription: "Une sauvegarde est créée toutes les 10 minutes en cas de changement et conserve jusqu’à 30 étapes incrémentales entre deux instantanés complets. Restaurez une version si nécessaire.",
    ...
    loggingIntro: "Le journal se met à jour en direct tant que la fenêtre Paramètres reste ouverte. Rien ne quitte cet appareil.",
    ...
    generateOverviewHelp: "Reconstruit le résumé prêt à l'impression du projet enregistré sélectionné et ouvre la fenêtre d'aperçu pour examiner les détails d'alimentation et de connexion avant d'imprimer quand vous êtes prêt.",
    ...
    shareSetupHelp: "Téléchargez une sauvegarde JSON du projet en cours afin de pouvoir le partager ou le restaurer plus tard. Rangez le fichier avec les sauvegardes de l’équipe avant de fermer le planner.",
    applySharedLinkHelp: "Chargez la configuration depuis une sauvegarde JSON exportée via Enregistrer et partager. Vérifiez l’aperçu avant d’appliquer pour éviter d’écraser le mauvais projet.",
  ...
  de: {
    ...
    autoGearBackupsDescription: "Alle 10 Minuten wird bei Änderungen eine Sicherung erstellt und bis zu 30 inkrementelle Schritte zwischen vollständigen Snapshots behalten. Stelle eine Version wieder her, falls etwas schiefgeht.",
    ...
    loggingIntro: "Das Protokoll aktualisiert sich live, solange die Einstellungen geöffnet bleiben. Es verlässt nie dieses Gerät.",
    ...
    generateOverviewHelp: "Erstellt die druckfertige Übersicht für das ausgewählte gespeicherte Projekt neu und öffnet das Übersichtsfenster, damit du Strom- und Verbindungsdetails prüfen kannst, bevor du bei Bedarf druckst.",
    ...
    shareSetupHelp: "Lade eine JSON-Sicherung des aktuellen Projekts herunter, damit du sie später teilen oder wiederherstellen kannst. Lege die Datei vor dem Schließen des Planners zu den Team-Backups.",
    applySharedLinkHelp: "Lade die Konfiguration aus einer JSON-Sicherung, die über Speichern & Teilen exportiert wurde. Prüfe die Vorschau, bevor du anwendest, damit kein falsches Projekt überschrieben wird.",
