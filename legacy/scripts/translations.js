var texts = {
  en: {
    ...
    autoGearDeliveryResolutionHelp: "Apply this rule when the project delivery resolution matches any of these selections.",
    ...
    autoGearRuleConditionRequired: "Select at least one scenario, delivery resolution, camera, monitor, wireless transmitter, motor, controller, distance device, mattebox option, camera handle, viewfinder extension or video distribution before saving.",
  ...
  it: {
    ...
    autoGearDeliveryResolutionHelp: "Applica questa regola quando la risoluzione di consegna del progetto corrisponde a una di queste selezioni.",
    ...
    autoGearRuleConditionRequired: "Seleziona almeno uno scenario, una risoluzione di consegna, una camera, un monitor, un trasmettitore wireless, un motore, un controller, un dispositivo di distanza, un'opzione di matte box, una maniglia camera, una prolunga mirino o una distribuzione video prima di salvare.",
  ...
  es: {
    ...
    autoGearDeliveryResolutionHelp: "Aplica esta regla cuando la resolución de entrega del proyecto coincida con cualquiera de estas selecciones.",
    ...
    autoGearRuleConditionRequired: "Selecciona al menos un escenario, una resolución de entrega, una cámara, un monitor, un transmisor inalámbrico, un motor, un controlador, un dispositivo de distancia, una opción de matte box, una empuñadura de cámara, una extensión de visor o una distribución de vídeo antes de guardar.",
  ...
  fr: {
    ...
    autoGearDeliveryResolutionHelp: "Appliquez cette règle lorsque la résolution de livraison du projet correspond à l'une de ces sélections.",
    ...
    autoGearRuleConditionRequired: "Sélectionnez au moins un scénario, une résolution de livraison, une caméra, un moniteur, un émetteur sans fil, un moteur, un contrôleur, un capteur de distance, une option de matte box, une poignée caméra, une extension de viseur ou une distribution vidéo avant d’enregistrer.",
  ...
  de: {
    ...
    autoGearDeliveryResolutionHelp: "Regel anwenden, wenn die Auslieferungsauflösung des Projekts einer dieser Auswahlmöglichkeiten entspricht.",
    ...
    autoGearRuleConditionRequired: "Wähle mindestens ein Szenario, eine Auslieferungsauflösung, eine Kamera, einen Monitor, einen Funk-Sender, einen Motor, einen Controller, ein Distanzgerät, eine Mattebox-Option, einen Kamera-Handgriff, eine Sucher-Verlängerung oder eine Videoverteilung, bevor du speicherst.",
