...
var texts = {
  en: {
    ...
    storageKeyAutoBackupsDesc: "Timestamped safety copies saved every 10 minutes, when you switch projects, import or export data, before reloads, and after 50 tracked changes.",
  ...
  it: {
    ...
    storageKeyAutoBackupsDesc: "Copie di sicurezza con timestamp ogni 10 minuti, quando cambi progetto, importi o esporti dati, prima dei ricaricamenti e dopo 50 modifiche tracciate.",
  ...
  es: {
    ...
    storageKeyAutoBackupsDesc: "Copias de seguridad con marca de tiempo cada 10 minutos, al cambiar de proyecto, al importar o exportar datos, antes de recargar y después de 50 cambios registrados.",
  ...
  fr: {
    ...
    storageKeyAutoBackupsDesc: "Copies horodatées enregistrées toutes les 10 minutes, lors d'un changement de projet, d'une importation ou d'une exportation, avant un rechargement et après 50 modifications suivies.",
  ...
  de: {
    ...
    storageKeyAutoBackupsDesc: "Zeitgestempelte Sicherungskopien alle 10 Minuten, beim Projektwechsel, beim Import oder Export, vor dem Neuladen und nach 50 protokollierten Änderungen.",
    storageAutoBackupsCountOne: "%s Auto-Backup",
    storageAutoBackupsCountOther: "%s Auto-Backups",
