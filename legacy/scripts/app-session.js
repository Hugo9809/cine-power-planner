...
function getSessionRuntimeValue(name, fallbackValue) {
  if (typeof name !== 'string' || !name) {
...
function applyDarkMode(enabled) {
  if (enabled) {
    ...
    if (darkModeToggle) {
      var sunGlyph = getIconGlyphSafe('sun');
      if (sunGlyph) {
    ...
    if (darkModeToggle) {
      var moonGlyph = getIconGlyphSafe('moon');
      if (moonGlyph) {
    ...
    try {
      ...
      if (restoredSettings && _typeof(restoredSettings) === 'object') {
        if (safeStorage && typeof safeStorage.setItem === 'function') {
          restoreMutated = true;
          Object.entries(restoredSettings).forEach(function (_ref0) {
      ...
      if (restoredSession && typeof sessionStorage !== 'undefined') {
        restoreMutated = true;
        Object.entries(restoredSession).forEach(function (_ref10) {
...
if (typeof module !== "undefined" && module.exports) {
  var featureSearchInternals = {};
  var sessionModuleExports = {
  ...
  var defineRuntimeGetter = function defineRuntimeGetter(target, property, resolver) {
  ...
  defineRuntimeGetter(sessionModuleExports, 'searchKey', function () {
    var runtime = getSessionRuntimeFunction('searchKey');
  ...
  defineRuntimeGetter(sessionModuleExports, 'searchTokens', function () {
    var runtime = getSessionRuntimeFunction('searchTokens');
    if (typeof runtime === 'function') {
      return runtime;
    }
    return function (value) {
  ...
  defineRuntimeGetter(sessionModuleExports, 'findBestSearchMatch', function () {
    var runtime = getSessionRuntimeFunction('findBestSearchMatch');
    if (typeof runtime === 'function') {
      return runtime;
    }
    return function () {
  ...
  defineRuntimeGetter(sessionModuleExports, 'runFeatureSearch', function () {
    var runtime = getSessionRuntimeFunction('runFeatureSearch');
    if (typeof runtime === 'function') {
      return function () {
        return runtime.apply(void 0, arguments);
      };
    }
    return function () {
      console.warn('Feature search runtime is not available yet.');
      return null;
    };
  });
  defineRuntimeGetter(featureSearchInternals, 'featureMap', function () {
    return getSessionRuntimeValue('featureMap', function () {
      return new Map();
    });
  });
  defineRuntimeGetter(featureSearchInternals, 'deviceMap', function () {
    return getSessionRuntimeValue('deviceMap', function () {
      return new Map();
    });
  });
  defineRuntimeGetter(featureSearchInternals, 'helpMap', function () {
    return getSessionRuntimeValue('helpMap', function () {
      return new Map();
    });
  });
  defineRuntimeGetter(featureSearchInternals, 'featureSearchEntries', function () {
    return getSessionRuntimeValue('featureSearchEntries', function () {
      return [];
    });
  });
  defineRuntimeGetter(featureSearchInternals, 'featureSearchDefaultOptions', function () {
    return getSessionRuntimeValue('featureSearchDefaultOptions', function () {
      return [];
    });
  });
  defineRuntimeGetter(featureSearchInternals, 'featureSearchInput', function () {
    return getSessionRuntimeValue('featureSearch', function () {
      return null;
    });
  });
  defineRuntimeGetter(featureSearchInternals, 'featureListElement', function () {
    return getSessionRuntimeValue('featureList', function () {
      return null;
    });
  });
  defineRuntimeGetter(featureSearchInternals, 'restoreFeatureSearchDefaults', function () {
    var runtime = getSessionRuntimeFunction('restoreFeatureSearchDefaults');
    if (typeof runtime === 'function') {
      return runtime;
    }
    return function () {};
  });
  defineRuntimeGetter(featureSearchInternals, 'updateFeatureSearchSuggestions', function () {
    var runtime = getSessionRuntimeFunction('updateFeatureSearchSuggestions');
    if (typeof runtime === 'function') {
      return runtime;
    }
    return function () {};
  });
  module.exports = sessionModuleExports;
}
