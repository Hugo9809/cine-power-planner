...
function scheduleScriptRetry(url, retryCallback) {
  ...
  if (typeof setTimeout === 'function') {
    try {
      ...
      state.timerId = null;
      if (typeof console !== 'undefined' && typeof console.warn === 'function') {
        console.warn('Falling back to immediate script retry after scheduling failure:', url, scheduleError);
      }
      invokeRetry();
    }
  } else {
...
(function () {
  ...
  function supportsModernFeatures(callback) {
    ...
    if (hasUrlSearchParamsSupport) {
      try {
        ...
        hasUrlSearchParamsSupport = !!urlSearchParamsProbe && typeof urlSearchParamsProbe.get === 'function';
  ...
  var modernScriptBundle = {
    core: ['src/scripts/globalthis-polyfill.js', 'src/scripts/modules/base.js', 'src/scripts/modules/registry.js', 'src/data/devices/index.js', {
      parallel: ['src/data/rental-houses.js', 'src/data/devices/cameras.js', 'src/data/devices/monitors.js', 'src/data/devices/video.js', 'src/data/devices/fiz.js', 'src/data/devices/batteries.js', 'src/data/devices/batteryHotswaps.js', 'src/data/devices/chargers.js', 'src/data/devices/cages.js', 'src/data/devices/gearList.js', 'src/data/devices/wirelessReceivers.js', 'src/scripts/translations/en.js', 'src/vendor/lz-string.min.js', 'src/scripts/auto-gear-weight.js', 'src/scripts/modules/environment-bridge.js', 'src/scripts/modules/runtime-environment-helpers.js', 'src/scripts/modules/globals.js', 'src/scripts/modules/localization.js', 'src/scripts/modules/offline.js']
    }, 'src/scripts/storage.js', 'src/scripts/translations.js', 'src/scripts/modules/core-shared.js', 'src/scripts/modules/core/runtime.js', 'src/scripts/modules/core/localization.js', 'src/scripts/modules/core/pink-mode.js', 'src/scripts/modules/core/device-schema.js', 'src/scripts/modules/core/project-intelligence.js', 'src/scripts/modules/core/persistence-guard.js', 'src/scripts/modules/core/mount-voltage.js', 'src/scripts/modules/core/experience.js', 'src/scripts/modules/logging.js', 'src/scripts/modules/settings-and-appearance.js', 'src/scripts/modules/features/auto-gear-rules.js', 'src/scripts/modules/features/connection-diagram.js', 'src/scripts/modules/features/backup.js', 'src/scripts/modules/features/onboarding-loader-hook.js', 'src/scripts/modules/features/print-workflow.js', 'src/scripts/modules/ui.js', 'src/scripts/modules/runtime-guard.js', 'src/scripts/modules/results.js', 'src/scripts/modules/app-core/bootstrap.js', 'src/scripts/modules/app-core/pink-mode.js', 'src/scripts/modules/app-core/localization.js', 'src/scripts/app-core-text.js', 'src/scripts/app-core-runtime-scopes.js', 'src/scripts/app-core-runtime-support.js', 'src/scripts/app-core-runtime-helpers.js', 'src/scripts/runtime/bootstrap.js', 'src/scripts/app-core-environment.js', 'src/scripts/app-core-bootstrap.js', 'src/scripts/app-core-runtime-shared.js', 'src/scripts/app-core-pink-mode.js', 'src/scripts/app-core-runtime-candidate-scopes.js', 'src/scripts/app-core-runtime-global-tools.js', 'src/scripts/app-core-ui-helpers.js', 'src/scripts/app-core-runtime-ui.js', 'src/scripts/auto-gear/normalizers.js', 'src/scripts/auto-gear/storage.js', 'src/scripts/auto-gear/ui.js', 'src/scripts/own-gear/store.js', 'src/scripts/own-gear/view.js', 'src/scripts/contacts/list.js', 'src/scripts/contacts/profile.js', 'src/scripts/app-core-new-1.js', 'src/scripts/app-core-localization-accessors.js', 'src/scripts/app-core-new-2.js', 'src/scripts/app-events.js', 'src/scripts/app-setups.js', 'src/scripts/restore-verification.js', 'src/scripts/app-session.js', 'src/scripts/modules/persistence.js', 'src/scripts/modules/runtime.js', 'src/scripts/script.js'],
    deferred: ['src/scripts/auto-gear-monitoring.js', 'src/scripts/overview.js', 'src/scripts/autosave-overlay.js', 'src/scripts/modules/features/onboarding-tour.js', 'src/scripts/data/pink-mode-animated-icons.js']
  };
  var legacyScriptBundle = {
    ...
    }, 'legacy/scripts/storage.js', 'src/scripts/translations/en.js', 'legacy/scripts/translations.js', 'src/vendor/lz-string.min.js', 'legacy/scripts/auto-gear-weight.js', 'legacy/scripts/modules/base.js', 'legacy/scripts/modules/registry.js', 'legacy/scripts/modules/environment-bridge.js', 'legacy/scripts/modules/runtime-environment-helpers.js', 'legacy/scripts/modules/globals.js', 'legacy/scripts/modules/localization.js', 'legacy/scripts/modules/offline.js', 'legacy/scripts/modules/core-shared.js', 'legacy/scripts/modules/core/runtime.js', 'legacy/scripts/modules/core/localization-runtime-environment.js', 'legacy/scripts/modules/core/pink-mode.js', 'legacy/scripts/modules/core/device-schema.js', 'legacy/scripts/modules/core/project-intelligence.js', 'legacy/scripts/modules/core/persistence-guard.js', 'legacy/scripts/modules/core/mount-voltage.js', 'legacy/scripts/modules/core/experience.js', 'legacy/scripts/modules/logging.js', 'legacy/scripts/modules/settings-and-appearance.js', 'legacy/scripts/app-core-auto-gear-ui.js', 'legacy/scripts/modules/features/auto-gear-rules.js', 'legacy/scripts/modules/features/connection-diagram.js', 'legacy/scripts/modules/features/backup.js', 'legacy/scripts/modules/features/onboarding-loader-hook.js', 'legacy/scripts/modules/features/print-workflow.js', 'legacy/scripts/modules/ui.js', 'legacy/scripts/modules/runtime-guard.js', 'legacy/scripts/modules/results.js', 'legacy/scripts/modules/app-core/bootstrap.js', 'legacy/scripts/modules/app-core/pink-mode.js', 'legacy/scripts/modules/app-core/localization.js', 'legacy/scripts/modules/app-core/runtime.js', 'legacy/scripts/modules/app-core/settings-documentation-tracker.js', 'legacy/scripts/app-core-text.js', 'legacy/scripts/app-core-runtime-scopes.js', 'legacy/scripts/app-core-runtime-support.js', 'legacy/scripts/app-core-runtime-helpers.js', 'legacy/scripts/runtime/bootstrap.js', 'legacy/scripts/app-core-environment.js', 'legacy/scripts/app-core-bootstrap.js', 'legacy/scripts/app-core-runtime-shared.js', 'legacy/scripts/app-core-pink-mode.js', 'legacy/scripts/app-core-runtime-candidate-scopes.js', 'legacy/scripts/app-core-runtime-global-tools.js', 'legacy/scripts/app-core-ui-helpers.js', 'legacy/scripts/app-core-runtime-ui.js', 'legacy/scripts/app-core-localization-accessors.js', 'src/scripts/auto-gear/normalizers.js', 'legacy/scripts/auto-gear/storage.js', 'legacy/scripts/auto-gear/ui.js', 'legacy/scripts/app-core-new-1.js', 'legacy/scripts/app-core-new-2.js', 'legacy/scripts/app-events.js', 'legacy/scripts/app-setups.js', 'legacy/scripts/restore-verification.js', 'legacy/scripts/app-session.js', 'legacy/scripts/modules/persistence.js', 'legacy/scripts/modules/runtime.js', 'legacy/scripts/script.js'],
    deferred: ['legacy/scripts/auto-gear-monitoring.js', 'legacy/scripts/overview.js', 'legacy/scripts/autosave-overlay.js', 'legacy/scripts/modules/features/onboarding-tour.js', 'legacy/scripts/data/pink-mode-animated-icons.js']
  };
