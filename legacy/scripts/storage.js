...
(function initializeStorageModule() {
  ...
  function attemptStorageCompressionSweep(storage, options) {
    ...
    var _ref3 = options || {},
      _ref3$skipKeys = _ref3.skipKeys,
      skipKeys = _ref3$skipKeys === void 0 ? [] : _ref3$skipKeys,
      _ref3$limit = _ref3.limit,
      limit = _ref3$limit === void 0 ? STORAGE_COMPRESSION_SWEEP_LIMIT : _ref3$limit,
      _ref3$minSavings = _ref3.minSavings,
      minSavings = _ref3$minSavings === void 0 ? STORAGE_COMPRESSION_SWEEP_MIN_SAVINGS : _ref3$minSavings;
    var skipSet = new Set();
  ...
  function createStorageMigrationBackup(storage, key, originalValue) {
    ...
    var _tryStoreSerialized = function tryStoreSerialized(candidate) {
      var options = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
      var _ref4 = options || {},
        _ref4$logCompression = _ref4.logCompression,
        logCompression = _ref4$logCompression === void 0 ? false : _ref4$logCompression,
        _ref4$info = _ref4.info,
        info = _ref4$info === void 0 ? null : _ref4$info;
      try {
  ...
  function snapshotStorageEntries(storage) {
    ...
    var _ref5 = options || {},
      _ref5$suppressAlerts = _ref5.suppressAlerts,
      suppressAlerts = _ref5$suppressAlerts === void 0 ? false : _ref5$suppressAlerts;
  ...
  function migrateLegacyStorageKeys() {
    ...
    mappings.forEach(function (_ref7) {
      var legacy = _ref7.legacy,
        modern = _ref7.modern,
        _ref7$includeSession = _ref7.includeSession,
        includeSession = _ref7$includeSession === void 0 ? false : _ref7$includeSession,
        _ref7$updateFontKey = _ref7.updateFontKey,
        updateFontKey = _ref7$updateFontKey === void 0 ? false : _ref7$updateFontKey;
  ...
  function loadJSONFromStorage(storage, key, errorMessage) {
    ...
    var _ref8 = options || {},
      ...
      _ref8$restoreIfMissin = _ref8.restoreIfMissing,
      restoreIfMissing = _ref8$restoreIfMissin === void 0 ? false : _ref8$restoreIfMissin,
      _ref8$alertOnFailure = _ref8.alertOnFailure,
      alertOnFailure = _ref8$alertOnFailure === void 0 ? null : _ref8$alertOnFailure,
      migrationBackupKey = _ref8.migrationBackupKey;
  ...
  function saveJSONToStorage(storage, key, value, errorMessage) {
    ...
    var _ref9 = options || {},
      ...
      onQuotaExceeded = _ref9.onQuotaExceeded,
      _ref9$enableCompressi = _ref9.enableCompressionSweep,
      enableCompressionSweep = _ref9$enableCompressi === void 0 ? true : _ref9$enableCompressi,
      _ref9$disableCompress = _ref9.disableCompression,
      disableCompression = _ref9$disableCompress === void 0 ? false : _ref9$disableCompress,
      _ref9$forceCompressio = _ref9.forceCompressionOnQuota,
      forceCompressionOnQuota = _ref9$forceCompressio === void 0 ? false : _ref9$forceCompressio;
    var fallbackKey = typeof backupKey === 'string' && backupKey ? backupKey : "".concat(key).concat(STORAGE_BACKUP_SUFFIX);
    var useBackup = !disableBackup && fallbackKey && fallbackKey !== key;
  ...
  function updateSetups(callback) {
    ...
    var _ref10 = callback(setups) || {},
      result = _ref10.result,
      _ref10$changed = _ref10.changed,
      changed = _ref10$changed === void 0 ? true : _ref10$changed;
    if (changed) {
      saveSetups(setups);
    }
    return result;
  ...
  var LEGACY_PROJECT_LABEL_FIELD_MAP = function () {
    ...
    Object.entries(LEGACY_PROJECT_FIELD_LABELS).forEach(function (_ref11) {
  ...
  function sanitizeImportedProjectInfo(info) {
    ...
    var normalized = {};
    Object.entries(info).forEach(function (_ref15) {
  ...
  function cloneProjectGearSelectors(selectors) {
    ...
    var clone = {};
    Object.entries(selectors).forEach(function (_ref17) {
  ...
  function readAllProjectsFromStorage() {
    var options = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
    var _ref19 = options || {},
      _ref19$forceRefresh = _ref19.forceRefresh,
      forceRefresh = _ref19$forceRefresh === void 0 ? false : _ref19$forceRefresh,
      _ref19$forMutation = _ref19.forMutation,
      forMutation = _ref19$forMutation === void 0 ? false : _ref19$forMutation;
    applyLegacyStorageMigrations();
    if (!forceRefresh) {
  ...
  function importProjectCollection(collection, ensureImporter) {
    ...
    if (Array.isArray(collection)) {
      ...
      var count = 0;
      entries.forEach(function (_ref20) {
    ...
    if (isPlainObject(collection)) {
      ...
      Object.entries(collection).forEach(function (_ref21) {
  ...
  function saveAutoGearBackups(backups) {
    ...
    var _ref23 = skipNormalization ? {
        normalized: safeBackups,
        changed: false
      } : normalizeLegacyLongGopBackups(safeBackups),
      normalizedBackups = _ref23.normalized;
    var safeStorage = getSafeLocalStorage();
  ...
  function importAllData(allData) {
    ...
    var _ref26 = options || {},
      _ref26$skipSnapshotCo = _ref26.skipSnapshotConversion,
      skipSnapshotConversion = _ref26$skipSnapshotCo === void 0 ? false : _ref26$skipSnapshotCo;
