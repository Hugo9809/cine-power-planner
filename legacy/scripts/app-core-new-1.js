...
function fallbackResolveCoreSupportModule(namespaceName, requirePath, primaryScope) {
  ...
  if (typeof require === 'function' && typeof requirePath === 'string' && requirePath) {
    try {
      var requiredModule = require(requirePath);
      if (requiredModule && (_typeof(requiredModule) === 'object' || typeof requiredModule === 'function')) {
        return requiredModule;
      }
    } catch (supportModuleRequireError) {
      void supportModuleRequireError;
    }
  }
...
var CORE_SUPPORT_RESOLVER = function ensureCoreSupportResolver() {
  ...
  var primaryScope = typeof CORE_GLOBAL_SCOPE !== 'undefined' && CORE_GLOBAL_SCOPE && _typeof(CORE_GLOBAL_SCOPE) === 'object'
    ? CORE_GLOBAL_SCOPE
    : null;
...
var detectRuntimeScope = CORE_SUPPORT_RESOLVER && typeof CORE_SUPPORT_RESOLVER.detectRuntimeScope === 'function'
  ? CORE_SUPPORT_RESOLVER.detectRuntimeScope
  : fallbackDetectRuntimeScope;

var resolveSupportModuleFromResolver = CORE_SUPPORT_RESOLVER && typeof CORE_SUPPORT_RESOLVER.resolveCoreSupportModule === 'function'
  ? CORE_SUPPORT_RESOLVER.resolveCoreSupportModule
  : fallbackResolveCoreSupportModule;

var CORE_PART1_RUNTIME_SCOPE = detectRuntimeScope(typeof CORE_GLOBAL_SCOPE !== 'undefined' && _typeof(CORE_GLOBAL_SCOPE) === 'object'
  ? CORE_GLOBAL_SCOPE
  : null);
...
var CORE_RUNTIME_CANDIDATE_SCOPE_BRIDGE = resolveCoreSupportModule(
...
var CORE_RUNTIME_CANDIDATE_SCOPES = function ensureCoreRuntimeCandidateScopes() {
  var primaryScope = typeof CORE_GLOBAL_SCOPE !== 'undefined' && CORE_GLOBAL_SCOPE && _typeof(CORE_GLOBAL_SCOPE) === 'object'
    ? CORE_GLOBAL_SCOPE
    : null;
