...
(function registerLocale() {
  ...
  var data = {
    "texts": {
      ...
      "backupSettingsHelp": "Download a full JSON backup containing every project, device edit, preference, auto-gear rule and runtime log stored on this device. Keep multiple copies in your offline archive.",
      ...
      "storageKeyFullBackupsDesc": "Downloads created from Backup & Restore or hourly safety copies.",
      ...
      "videoPowerInputsHeading": "Power Connectors",
      "videoPowerInputsLabel": "Connectors:",
      "videoPowerInputsHelp": "List every power connector the device accepts. Use one connector per line and include notes such as voltage ranges or adapter requirements.",
      "videoPowerInputTypeFieldLabel": "Connector(s)",
      "videoPowerInputTypePlaceholder": "LEMO 2-pin",
      "videoPowerInputNotesFieldLabel": "Notes",
      "videoPowerInputNotesPlaceholder": "Voltage range, adapter notes…",
