...
(function registerLocale() {
  ...
  var data = {
    "texts": {
      ...
      "offlineIndicatorHelp": "Appears when the planner is offline. All projects, backups and device data stay stored on this device so you can keep working.",
