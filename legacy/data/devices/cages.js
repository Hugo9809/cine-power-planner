(function () {
  var cageData = {
    "Tilta Full Camera Cage for BMPCC 6K Pro/G2 (TA-T11-FCC)": {
      ...
      "batteryMount": "none",
      "kNumber": "TA-T11-FCC",
      "rodStandard": ["15mm LWS (via bracket in kit)"],
    ...
    "Tilta Full Camera Cage for Sony FX3/FX30 V2": {
      ...
      "rodStandard": ["15mm LWS (via single-rod holder / base options)"],
    ...
    "Tilta Camera Cage for RED V-RAPTOR / V-RAPTOR X Basic Kit": {
      "brand": "Tilta",
      "compatible": ["RED V-RAPTOR", "RED V-RAPTOR X", "RED V-RAPTOR 8K VV", "RED V-RAPTOR 8K S35"],
      "material": null,
      "weight_g": null,
    ...
    "Arri K0.0049871 ALEXA Mini LF Production Set 19": {
      ...
      "material": null,
      "weight_g": null,
      "mounting_points": ["19mm Studio", "15mm LWS", "ARRI locating", "3/8\"-16", "1/4\"-20"],
      "top_handle_included": true,
      "side_plates": true,
    ...
    "Arri KK.0043759 Cine Pro Set for Sony Venice 1/2": {
      "brand": "ARRI",
      "kNumber": "KK.0043759",
      "compatible": ["Sony Venice 1", "Sony Venice 2"],
      "handle_extension_compatible": true
    },
    "Tilta Camera Cage Advanced Kit for Sony Burano (V-Mount)": {
      "brand": "Tilta",
      "compatible": ["Sony Burano"],
      "material": "aluminum alloy",
      "weight_g": 2200,
      "batteryMount": "V-Mount",
      "mounting_points": ["1/4\"-20", "3/8\"-16", "ARRI rosette", "15mm LWS"],
      "top_handle_included": true,
      "side_plates": true,
    ...
    "SmallRig Advanced Cage Kit for RED Komodo-X (4335)": {
      ...
      "weight_g": 1008,
      "mounting_points": ["1/4\"-20", "3/8\"-16", "NATO rail", "ARRI rosette", "15mm rod clamp"],
      "top_handle_included": true,
      "side_plates": true,
    ...
    "SmallRig Advanced Cage Kit for Canon C400 (4946)": {
      "brand": "SmallRig",
      "compatible": ["Canon C400"],
      "material": "aluminum alloy, silicone, stainless steel",
      "weight_g": 1440,
      "batteryMount": "V-Mount",
      "mounting_points": ["1/4\"-20", "3/8\"-16", "ARRI rosette", "NATO rail", "15mm LWS"],
      "top_handle_included": false,
      "side_plates": true,
