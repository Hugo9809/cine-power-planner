...
4. **Rassembler les exigences.** Renseignez équipe, scénarios, poignées, matte box et configuration de monitoring. Votre profil utilisateur enregistré apparaît automatiquement dans la liste de l’équipe ; adaptez rôle ou coordonnées pour chaque projet. Les boutons dupliquer accélèrent la saisie. Utilisez **Paramètres → Règles automatiques** pour ajouter/retraiter du matériel spécifique avant export.
