...
- **Les contacts d’équipe restent réutilisables.** Ouvrez l’entrée **Contacts** de la barre latérale pour tenir un annuaire avec
  rôles, adresses e-mail, numéros, sites web et photos prêts à être injectés dans n’importe quel projet. Votre profil personnel
  dans ce dialogue conserve aussi votre nom d’affichage, votre rôle, votre téléphone, votre e-mail, votre site web et votre
  photo afin que le matériel marqué « User » reste annoté dans les sauvegardes. Les contacts partagent le même
