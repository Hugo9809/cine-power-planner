...
- **Les liens partagés déclenchent une sauvegarde automatique de sécurité.** L’ouverture d’une URL partagée ou l’import d’un bundle crée une sauvegarde automatique horodatée avant de modifier vos projets ou listes. En cas d’échec, l’import est annulé et vos données restent intactes.
