...
5. Ouvrez **Aide → Liste de démarrage rapide** et lancez le tutoriel guidé. Il couvre création de projets, sélection d’appareils, vérification du Résumé d’alimentation avec son point de contrôle Résumé rapide, listes de matériel, contacts, matériel personnel, règles automatiques ainsi que les flux d’export, d’import et de sauvegarde. Le navigateur d’étapes et l’indicateur de progression permettent de revisiter les flux terminés sans recommencer et, si vous interrompez la session, l’option **Reprendre le tutoriel guidé** apparaît automatiquement avec vos compteurs enregistrés pour préserver la progression hors ligne.
