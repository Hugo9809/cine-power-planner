...
const texts = {
  ...
  es: {
    ...
    shareSetupPrompt: "Archivo de proyecto listo para exportar.",
    ...
    shareIncludeAutoGearConfirm:
      "¿Quieres incluir las reglas automáticas de equipo en el archivo exportado? Selecciona Aceptar para incluirlas o Cancelar para omitirlas.",
  ...
  fr: {
    ...
    shareSetupPrompt: "Fichier projet prêt à être exporté.",
    ...
    shareIncludeAutoGearConfirm:
      "Souhaitez-vous inclure les règles automatiques d’équipement dans le fichier exporté ? Sélectionnez OK pour les inclure ou Annuler pour les ignorer.",
