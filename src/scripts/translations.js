...
const texts = {
  en: {
    ...
    autoGearScenariosLabel: "Triggers",
    autoGearScenariosHelp:
      "Pick the scenarios or mattebox options that must be selected for this rule to apply. Hold Ctrl (Cmd on Mac) to choose multiple.",
    autoGearScenarioPlaceholder: "Select triggers",
    ...
    autoGearRuleScenarioRequired: "Select at least one trigger before saving.",
  ...
  it: {
    ...
    autoGearScenariosLabel: "Condizioni",
    autoGearScenariosHelp:
      "Seleziona gli scenari o le opzioni di mattebox che attivano questa regola. Tieni premuto Ctrl (Cmd su Mac) per sceglierne più di uno.",
    autoGearScenarioPlaceholder: "Seleziona condizioni",
    ...
    autoGearRuleScenarioRequired: "Seleziona almeno una condizione prima di salvare.",
  ...
  es: {
    ...
    autoGearScenariosLabel: "Condiciones",
    autoGearScenariosHelp:
      "Selecciona los escenarios o las opciones de mattebox que activan esta regla. Mantén pulsado Ctrl (Cmd en Mac) para elegir varios.",
    autoGearScenarioPlaceholder: "Selecciona condiciones",
    ...
    autoGearRuleScenarioRequired: "Selecciona al menos una condición antes de guardar.",
  ...
  fr: {
    ...
    autoGearScenariosLabel: "Déclencheurs",
    autoGearScenariosHelp:
      "Sélectionnez les scénarios ou les options de mattebox qui activent cette règle. Maintenez Ctrl (Cmd sur Mac) pour en choisir plusieurs.",
    autoGearScenarioPlaceholder: "Sélectionnez des déclencheurs",
    ...
    autoGearRuleScenarioRequired: "Sélectionnez au moins un déclencheur avant d’enregistrer.",
  ...
  de: {
    ...
    autoGearScenariosLabel: "Auslöser",
    autoGearScenariosHelp:
      "Wähle die Szenarien oder Mattebox-Optionen, die diese Regel aktivieren. Halte Strg (Cmd auf dem Mac) gedrückt, um mehrere auszuwählen.",
    autoGearScenarioPlaceholder: "Auslöser auswählen",
    ...
    autoGearRuleScenarioRequired: "Wähle mindestens einen Auslöser aus, bevor du speicherst.",
