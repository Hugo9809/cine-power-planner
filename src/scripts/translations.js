...
const texts = {
  en: {
    ...
    autoGearConditionLogicLabel: "Value matching",
    autoGearConditionLogicHelp: "Choose how the selected values combine before this condition is satisfied.",
    autoGearConditionLogicAll: "All — require every selected value",
    autoGearConditionLogicAny: "Any — allow any selected value to match",
    autoGearConditionLogicMultiplier: "Multiplier — repeat items for every match",
    autoGearConditionInteractionLabel: "Default condition interaction",
    autoGearConditionInteractionHelp:
      "Set the default way conditions combine before the rule activates. Choose All to keep every match required, Any to allow one condition to satisfy the rule, or Or to begin fresh OR groups between blocks. Override the joiner beside each condition when you need a different relationship.",
    autoGearConditionInteractionAll: "All — require every active condition",
    autoGearConditionInteractionAny: "Any — allow a single condition to match",
    autoGearConditionInteractionOr: "Or — start new OR groups by default",
    autoGearConditionJoinerLabel: "Combine {condition} with the previous condition",
    autoGearConditionJoinerHelp: "Choose whether {condition} keeps matching with everything before it, can satisfy the rule on its own, or begins a fresh OR group.",
    autoGearConditionJoinerAll: "All — keep previous matches required",
    autoGearConditionJoinerAny: "Any — allow either condition to match",
    autoGearConditionJoinerOr: "Or — start a new OR group",
  ...
  it: {
    ...
    autoGearSummaryDetailsIntro:
      "Usa le schede focalizzate per analizzare sovrapposizioni, aprire le regole o applicare filtri offline.",
    ...
    autoGearConditionLogicLabel: "Corrispondenza dei valori",
    autoGearConditionLogicHelp:
      "Scegli come si combinano i valori selezionati prima che questa condizione sia soddisfatta.",
    autoGearConditionLogicAll: "Tutte — richiedi ogni valore selezionato",
    autoGearConditionLogicAny: "Qualsiasi — consenti che corrisponda un valore selezionato",
    autoGearConditionLogicMultiplier: "Moltiplicatore — ripeti gli elementi per ogni corrispondenza",
    autoGearConditionInteractionLabel: "Interazione predefinita delle condizioni",
    autoGearConditionInteractionHelp:
      "Imposta il modo predefinito in cui le condizioni si combinano prima che la regola si attivi. Scegli Tutte per richiedere ogni corrispondenza, Qualsiasi per consentire che basti una condizione oppure Oppure per avviare nuovi gruppi OR tra i blocchi. Personalizza il collegamento accanto a ogni condizione quando serve una relazione diversa.",
    autoGearConditionInteractionAll: "Tutte — richiedi tutte le condizioni attive",
    autoGearConditionInteractionAny: "Qualsiasi — consenti che basti una condizione",
    autoGearConditionInteractionOr: "Oppure — avvia nuovi gruppi OR per impostazione predefinita",
    autoGearConditionJoinerLabel: "Abbina {condition} alla condizione precedente",
    autoGearConditionJoinerHelp:
      "Scegli se {condition} deve continuare a rispettare tutto ciò che la precede, se può soddisfare la regola da sola oppure se deve avviare un nuovo gruppo OR.",
    autoGearConditionJoinerAll: "Tutte — richiedi anche le corrispondenze precedenti",
    autoGearConditionJoinerAny: "Qualsiasi — consenti che basti una delle condizioni",
    autoGearConditionJoinerOr: "Oppure — avvia un nuovo gruppo OR",
    autoGearConditionRepeatHint:
  ...
  es: {
    ...
    autoGearSummaryDetailsIntro:
      "Use las tarjetas enfocadas para ver solapamientos, saltar a reglas o aplicar filtros sin conexión.",
    ...
    autoGearConditionLogicLabel: "Coincidencia de valores",
    autoGearConditionLogicHelp:
      "Elige cómo se combinan los valores seleccionados antes de que se cumpla esta condición.",
    autoGearConditionLogicAll: "Todas — exige cada valor seleccionado",
    autoGearConditionLogicAny: "Cualquiera — permite que coincida un valor seleccionado",
    autoGearConditionLogicMultiplier: "Multiplicador — repite los elementos por cada coincidencia",
    autoGearConditionInteractionLabel: "Interacción predeterminada de condiciones",
    autoGearConditionInteractionHelp:
      "Define cómo se combinan las condiciones de forma predeterminada antes de ejecutar la regla. Elige Todas para exigir cada coincidencia, Cualquiera para permitir que baste una condición u O para iniciar nuevos grupos OR entre bloques. Ajusta el desplegable junto a cada condición cuando necesites una relación distinta.",
    autoGearConditionInteractionAll: "Todas — requiere todas las condiciones activas",
    autoGearConditionInteractionAny: "Cualquiera — permite que baste una condición",
    autoGearConditionInteractionOr: "O — inicia nuevos grupos OR de forma predeterminada",
    autoGearConditionJoinerLabel: "Combina {condition} con la condición anterior",
    autoGearConditionJoinerHelp:
      "Elige si {condition} debe seguir cumpliendo todo lo anterior, si basta por sí sola o si debe iniciar un nuevo grupo OR.",
    autoGearConditionJoinerAll: "Todas — requiere también las coincidencias anteriores",
    autoGearConditionJoinerAny: "Cualquiera — permite que coincida cualquiera de las condiciones",
    autoGearConditionJoinerOr: "O — inicia un nuevo grupo OR",
    autoGearConditionRepeatHint:
  ...
  fr: {
    ...
    autoGearSummaryDetailsIntro:
      "Focalisez une carte pour inspecter les recouvrements, accéder aux règles ou appliquer des filtres hors ligne.",
    ...
    autoGearConditionLogicLabel: "Correspondance des valeurs",
    autoGearConditionLogicHelp:
      "Choisissez comment les valeurs sélectionnées se combinent avant que cette condition soit satisfaite.",
    autoGearConditionLogicAll: "Toutes — exiger chaque valeur sélectionnée",
    autoGearConditionLogicAny: "N’importe laquelle — autoriser qu’une valeur sélectionnée corresponde",
    autoGearConditionLogicMultiplier: "Multiplicateur — répéter les éléments pour chaque correspondance",
    autoGearConditionInteractionLabel: "Interaction par défaut des conditions",
    autoGearConditionInteractionHelp:
      "Définissez la façon dont les conditions se combinent par défaut avant d’appliquer la règle. Choisissez Toutes pour exiger chaque correspondance, N’importe laquelle pour autoriser qu’une condition suffise ou Ou pour démarrer de nouveaux groupes OU entre les blocs. Ajustez le menu déroulant à côté de chaque condition lorsque vous avez besoin d’une relation différente.",
    autoGearConditionInteractionAll: "Toutes — exiger toutes les conditions actives",
    autoGearConditionInteractionAny: "N’importe laquelle — autoriser qu’une condition suffise",
    autoGearConditionInteractionOr: "Ou — démarrer de nouveaux groupes OU par défaut",
    autoGearConditionJoinerLabel: "Associer {condition} à la condition précédente",
    autoGearConditionJoinerHelp:
      "Choisissez si {condition} doit continuer à respecter tout ce qui précède, peut suffire à elle seule ou doit démarrer un nouveau groupe OU.",
    autoGearConditionJoinerAll: "Toutes — exiger aussi les correspondances précédentes",
    autoGearConditionJoinerAny: "N’importe laquelle — autoriser qu’une seule condition corresponde",
    autoGearConditionJoinerOr: "Ou — démarrer un nouveau groupe OU",
    autoGearConditionRepeatHint:
  ...
  de: {
    ...
    autoGearSummaryDetailsIntro:
      "Fokuskarten öffnen Details zu Überschneidungen, springen zu Regeln oder setzen Filter für Offline-Prüfungen.",
    ...
    autoGearConditionLogicLabel: "Wertabgleich",
    autoGearConditionLogicHelp:
      "Legt fest, wie die ausgewählten Werte kombiniert werden, bevor diese Bedingung erfüllt ist.",
    autoGearConditionLogicAll: "Alle – jeden ausgewählten Wert erforderlich",
    autoGearConditionLogicAny: "Beliebig – ein ausgewählter Wert genügt",
    autoGearConditionLogicMultiplier: "Multiplikator – Elemente pro Treffer wiederholen",
    autoGearConditionInteractionLabel: "Standardmäßige Bedingungsinteraktion",
    autoGearConditionInteractionHelp:
      "Lege fest, wie Bedingungen standardmäßig kombiniert werden, bevor die Regel aktiv wird. Wähle Alle, um jede Übereinstimmung erforderlich zu machen, Beliebig, damit eine Bedingung genügt, oder Oder, um zwischen den Blöcken neue ODER-Gruppen zu starten. Passe das Dropdown neben jeder Bedingung an, wenn du eine andere Verknüpfung brauchst.",
    autoGearConditionInteractionAll: "Alle – alle aktiven Bedingungen erforderlich",
    autoGearConditionInteractionAny: "Beliebig – eine Bedingung genügt",
    autoGearConditionInteractionOr: "Oder – neue ODER-Gruppen standardmäßig starten",
    autoGearConditionJoinerLabel: "{condition} mit der vorherigen Bedingung verknüpfen",
    autoGearConditionJoinerHelp:
      "Wähle, ob {condition} weiterhin mit allem zuvor übereinstimmen muss, die Regel allein erfüllen kann oder eine neue ODER-Gruppe starten soll.",
    autoGearConditionJoinerAll: "Alle – auch vorherige Treffer erforderlich",
    autoGearConditionJoinerAny: "Beliebig – eine der Bedingungen genügt",
    autoGearConditionJoinerOr: "Oder – neue ODER-Gruppe starten",
    autoGearConditionRepeatHint:
