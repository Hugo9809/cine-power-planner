...
const texts = {
  en: {
    ...
    projectForm: {
      ...
      lensesLabel: "Step 3: Select lenses:",
      lensManufacturerFilterLabel: "Step 1: Choose a manufacturer",
      lensManufacturerFilterPlaceholder: "Select a manufacturer",
      lensManufacturerFilterAll: "All manufacturers",
      lensSeriesFilterLabel: "Step 2: Choose a series",
      lensSeriesFilterPlaceholder: "Select a series",
      lensSeriesFilterAll: "All series",
      lensFilterRetainedSuffix: "— currently selected",
      selectedLensesHeading: "Selected lenses",
      selectedLensEmpty: "Selected lenses appear here after you add them.",
      lensMountSelectLabel: "Mount",
      lensMountNativeTag: "native",
      lensMountAdaptedTag: "adapted",
      removeSelectedLens: "Remove lens",
  ...
  it: {
    ...
    projectForm: {
      ...
      lensesLabel: "Passo 3: Seleziona gli obiettivi:",
      lensManufacturerFilterLabel: "Passo 1: Scegli il produttore",
      lensManufacturerFilterPlaceholder: "Seleziona un produttore",
      lensManufacturerFilterAll: "Tutti i produttori",
      lensSeriesFilterLabel: "Passo 2: Scegli la serie",
      lensSeriesFilterPlaceholder: "Seleziona una serie",
      lensSeriesFilterAll: "Tutte le serie",
      lensFilterRetainedSuffix: "— attualmente selezionato",
      selectedLensesHeading: "Obiettivi selezionati",
      selectedLensEmpty: "Gli obiettivi selezionati verranno mostrati qui.",
      lensMountSelectLabel: "Attacco",
      lensMountNativeTag: "nativo",
      lensMountAdaptedTag: "adattato",
      removeSelectedLens: "Rimuovi obiettivo",
  ...
  es: {
    ...
    projectForm: {
      ...
      lensesLabel: "Paso 3: Selecciona las ópticas:",
      lensManufacturerFilterLabel: "Paso 1: Elige el fabricante",
      lensManufacturerFilterPlaceholder: "Selecciona un fabricante",
      lensManufacturerFilterAll: "Todos los fabricantes",
      lensSeriesFilterLabel: "Paso 2: Elige la serie",
      lensSeriesFilterPlaceholder: "Selecciona una serie",
      lensSeriesFilterAll: "Todas las series",
      lensFilterRetainedSuffix: "— actualmente seleccionado",
      selectedLensesHeading: "Ópticas seleccionadas",
      selectedLensEmpty: "Las ópticas seleccionadas aparecerán aquí.",
      lensMountSelectLabel: "Montura",
      lensMountNativeTag: "nativa",
      lensMountAdaptedTag: "adaptada",
      removeSelectedLens: "Quitar óptica",
  ...
  fr: {
    ...
    projectForm: {
      ...
      lensesLabel: "Étape 3 : Sélectionner les objectifs :",
      lensManufacturerFilterLabel: "Étape 1 : Choisir un fabricant :",
      lensManufacturerFilterPlaceholder: "Sélectionnez un fabricant",
      lensManufacturerFilterAll: "Tous les fabricants",
      lensSeriesFilterLabel: "Étape 2 : Choisir une série :",
      lensSeriesFilterPlaceholder: "Sélectionnez une série",
      lensSeriesFilterAll: "Toutes les séries",
      lensFilterRetainedSuffix: "— actuellement sélectionné",
      selectedLensesHeading: "Objectifs sélectionnés",
      selectedLensEmpty: "Les objectifs sélectionnés apparaîtront ici.",
      lensMountSelectLabel: "Monture",
      lensMountNativeTag: "native",
      lensMountAdaptedTag: "adaptée",
      removeSelectedLens: "Retirer l’objectif",
  ...
  de: {
    ...
    projectForm: {
      ...
      lensManufacturerFilterLabel: "Schritt 1: Hersteller wählen",
      lensManufacturerFilterPlaceholder: "Hersteller auswählen",
      lensManufacturerFilterAll: "Alle Hersteller",
      lensSeriesFilterLabel: "Schritt 2: Serie auswählen",
      lensSeriesFilterPlaceholder: "Serie auswählen",
      lensSeriesFilterAll: "Alle Serien",
      lensFilterRetainedSuffix: "— aktuell ausgewählt",
      selectedLensesHeading: "Ausgewählte Objektive",
      selectedLensEmpty: "Ausgewählte Objektive werden hier angezeigt.",
      lensMountSelectLabel: "Anschluss",
      lensMountNativeTag: "native",
      lensMountAdaptedTag: "adaptiert",
      removeSelectedLens: "Objektiv entfernen",
      riggingHeading: "Rigging",
