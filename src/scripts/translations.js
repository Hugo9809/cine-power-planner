...
const texts = {
  en: {
    ...
    hoverHelpStatePressedOn: "Toggle is currently on.",
    hoverHelpStatePressedOff: "Toggle is currently off.",
    hoverHelpStatePressedMixed: "Toggle is partially on.",
    hoverHelpStateCheckedOn: "Checkbox is selected.",
    hoverHelpStateCheckedOff: "Checkbox is not selected.",
    hoverHelpStateCheckedMixed: "Checkbox is partially selected.",
    hoverHelpStateExpanded: "Section is expanded.",
    hoverHelpStateCollapsed: "Section is collapsed.",
    hoverHelpStateDisabled: "Control is disabled.",
    hoverHelpStateRequired: "This field is required.",
    hoverHelpStateHasPopup: "Opens an additional panel: %s.",
    hoverHelpCurrentValue: "Current value: %s.",
    hoverHelpRange: "Allowed range: %1$s to %2$s.",
    hoverHelpStep: "Step size: %s.",
    hoverHelpPlaceholder: "Placeholder: %s.",
    hoverHelpSelection: "Selected: %s.",
    hoverHelpSelectionEmpty: "No option selected.",
    helpClose: "Close (Esc)",
  ...
  it: {
    ...
    hoverHelpStatePressedOn: "Il comando è attivo.",
    hoverHelpStatePressedOff: "Il comando è disattivato.",
    hoverHelpStatePressedMixed: "Il comando è parzialmente attivo.",
    hoverHelpStateCheckedOn: "La casella è selezionata.",
    hoverHelpStateCheckedOff: "La casella non è selezionata.",
    hoverHelpStateCheckedMixed: "La casella è parzialmente selezionata.",
    hoverHelpStateExpanded: "La sezione è espansa.",
    hoverHelpStateCollapsed: "La sezione è compressa.",
    hoverHelpStateDisabled: "Il controllo è disabilitato.",
    hoverHelpStateRequired: "Questo campo è obbligatorio.",
    hoverHelpStateHasPopup: "Apre un pannello aggiuntivo: %s.",
    hoverHelpCurrentValue: "Valore corrente: %s.",
    hoverHelpRange: "Intervallo consentito: da %1$s a %2$s.",
    hoverHelpStep: "Incremento: %s.",
    hoverHelpPlaceholder: "Segnaposto: %s.",
    hoverHelpSelection: "Selezionato: %s.",
    hoverHelpSelectionEmpty: "Nessuna opzione selezionata.",
    setupSelectHelp:
  ...
  es: {
    ...
    hoverHelpStatePressedOn: "El interruptor está activado.",
    hoverHelpStatePressedOff: "El interruptor está desactivado.",
    hoverHelpStatePressedMixed: "El interruptor está parcialmente activado.",
    hoverHelpStateCheckedOn: "La casilla está seleccionada.",
    hoverHelpStateCheckedOff: "La casilla no está seleccionada.",
    hoverHelpStateCheckedMixed: "La casilla está parcialmente seleccionada.",
    hoverHelpStateExpanded: "La sección está expandida.",
    hoverHelpStateCollapsed: "La sección está contraída.",
    hoverHelpStateDisabled: "El control está deshabilitado.",
    hoverHelpStateRequired: "Este campo es obligatorio.",
    hoverHelpStateHasPopup: "Abre un panel adicional: %s.",
    hoverHelpCurrentValue: "Valor actual: %s.",
    hoverHelpRange: "Rango permitido: %1$s a %2$s.",
    hoverHelpStep: "Incremento: %s.",
    hoverHelpPlaceholder: "Texto sugerido: %s.",
    hoverHelpSelection: "Seleccionado: %s.",
    hoverHelpSelectionEmpty: "Ninguna opción seleccionada.",
    setupSelectHelp:
  ...
  fr: {
    ...
    hoverHelpStatePressedOn: "Le commutateur est activé.",
    hoverHelpStatePressedOff: "Le commutateur est désactivé.",
    hoverHelpStatePressedMixed: "Le commutateur est partiellement activé.",
    hoverHelpStateCheckedOn: "La case est cochée.",
    hoverHelpStateCheckedOff: "La case n’est pas cochée.",
    hoverHelpStateCheckedMixed: "La case est partiellement cochée.",
    hoverHelpStateExpanded: "La section est développée.",
    hoverHelpStateCollapsed: "La section est réduite.",
    hoverHelpStateDisabled: "Le contrôle est désactivé.",
    hoverHelpStateRequired: "Ce champ est obligatoire.",
    hoverHelpStateHasPopup: "Ouvre un panneau supplémentaire : %s.",
    hoverHelpCurrentValue: "Valeur actuelle : %s.",
    hoverHelpRange: "Plage autorisée : %1$s à %2$s.",
    hoverHelpStep: "Pas : %s.",
    hoverHelpPlaceholder: "Indication : %s.",
    hoverHelpSelection: "Sélection : %s.",
    hoverHelpSelectionEmpty: "Aucune option sélectionnée.",
    setupSelectHelp:
  ...
  de: {
   ...
   autoGearSelectorDirectorOption: "Regie-Monitor-Auswahl",
    ...
    hoverHelpStatePressedOn: "Schalter ist aktiviert.",
    hoverHelpStatePressedOff: "Schalter ist deaktiviert.",
    hoverHelpStatePressedMixed: "Schalter ist teilweise aktiviert.",
    hoverHelpStateCheckedOn: "Kontrollkästchen ist ausgewählt.",
    hoverHelpStateCheckedOff: "Kontrollkästchen ist nicht ausgewählt.",
    hoverHelpStateCheckedMixed: "Kontrollkästchen ist teilweise ausgewählt.",
    hoverHelpStateExpanded: "Bereich ist ausgeklappt.",
    hoverHelpStateCollapsed: "Bereich ist eingeklappt.",
    hoverHelpStateDisabled: "Steuerelement ist deaktiviert.",
    hoverHelpStateRequired: "Dieses Feld ist erforderlich.",
    hoverHelpStateHasPopup: "Öffnet ein zusätzliches Fenster: %s.",
    hoverHelpCurrentValue: "Aktueller Wert: %s.",
    hoverHelpRange: "Zulässiger Bereich: %1$s bis %2$s.",
    hoverHelpStep: "Schrittweite: %s.",
    hoverHelpPlaceholder: "Platzhalter: %s.",
    hoverHelpSelection: "Ausgewählt: %s.",
    hoverHelpSelectionEmpty: "Keine Auswahl getroffen.",
    setupSelectHelp:
