...
const texts = {
  en: {
    ...
    autoGearSummaryDescription:
      "Review automatic gear rules for duplicate triggers, conflicts and uncovered scenarios.",
    ...
    autoGearSummaryDetailsIntro:
      "Focus cards to inspect overlaps, jump to rules or apply filters for offline reviews.",
    ...
    autoGearSummaryDetailsOverlapsHeading: "Scenario overlaps",
