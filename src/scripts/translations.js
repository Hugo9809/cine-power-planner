...
const texts = {
  en: {
    ...
    contacts: {
      navLabel: "Contacts",
      navHelp: "Open the crew contact manager to reuse saved team members.",
      dialogTitle: "Crew contacts",
      dialogDescription:
        "Save crew members with roles and contact details for future projects. Contacts stay offline and are included in backups.",
      formTitle: "Save contact",
      ...
      listHelp: "Contacts stay stored offline and are included in backups and exports.",
      emptyState: "No contacts saved yet. Save crew details to reuse them later.",
      nameRequired: "Enter a name to save the contact.",
      saveFailed: "Unable to save contact.",
      savedContact: "Contact saved.",
      savedAndLinked: "Contact saved and applied to this crew member.",
      savedAndAdded: "Contact saved and added to the project.",
      imageTooLarge: "Profile picture is too large (max 512 KB).",
      imageReadError: "Unable to read image file. Try a different picture.",
      saveFromCrew: "Save to contacts",
      useForCrew: "Use for this crew slot",
      addToProject: "Add to project",
      useSuccess: "Contact added to crew list.",
      addedToProject: "Contact added to project.",
      editContact: "Edit",
      deleteContact: "Delete",
      deleteConfirm: "Remove this contact? Linked crew entries will be cleared.",
      deletedContact: "Contact removed.",
  ...
  it: {
    ...
    contacts: {
      navLabel: "Contatti",
      navHelp: "Apri la rubrica della crew per riutilizzare i membri salvati.",
      dialogTitle: "Contatti crew",
      dialogDescription:
        "Salva i membri della crew con ruoli e dati di contatto per i progetti futuri. I contatti restano offline e inclusi nei backup.",
      formTitle: "Salva contatto",
      namePlaceholder: "Nome",
      nameLabel: "Nome",
      roleLabel: "Ruolo crew",
      ...
      listHelp:
        "I contatti restano memorizzati offline e vengono inclusi in backup ed esportazioni.",
      emptyState:
        "Ancora nessun contatto salvato. Salva i dati della crew per riutilizzarli più tardi.",
      nameRequired: "Inserisci un nome per salvare il contatto.",
      saveFailed: "Impossibile salvare il contatto.",
      savedContact: "Contatto salvato.",
      savedAndLinked: "Contatto salvato e assegnato a questo membro della crew.",
      savedAndAdded: "Contatto salvato e aggiunto al progetto.",
      imageTooLarge: "La foto profilo è troppo grande (max 512 KB).",
      imageReadError: "Impossibile leggere la foto profilo. Prova con un altro file.",
      saveFromCrew: "Salva nei contatti",
      useForCrew: "Usa per questo membro della crew",
      addToProject: "Aggiungi al progetto",
      useSuccess: "Contatto aggiunto alla crew.",
      addedToProject: "Contatto aggiunto al progetto.",
      editContact: "Modifica",
      deleteContact: "Elimina",
      deleteConfirm: "Rimuovere questo contatto? I collegamenti ai membri verranno cancellati.",
      deletedContact: "Contatto rimosso.",
  ...
  es: {
    ...
    contacts: {
      navLabel: "Contactos",
      navHelp: "Abrir la libreta de contactos de la crew para reutilizar miembros guardados.",
      dialogTitle: "Contactos de la crew",
      dialogDescription:
        "Guarda miembros de la crew con roles y datos de contacto para futuros proyectos. Los contactos permanecen sin conexión e incluidos en las copias de seguridad.",
      formTitle: "Guardar contacto",
      namePlaceholder: "Nombre",
      nameLabel: "Nombre",
      roleLabel: "Rol de la crew",
      ...
      listHelp:
        "Los contactos se guardan sin conexión y se incluyen en las copias de seguridad y exportaciones.",
      emptyState:
        "Todavía no hay contactos guardados. Guarda los datos de tu crew para reutilizarlos después.",
      nameRequired: "Introduce un nombre para guardar el contacto.",
      saveFailed: "No se pudo guardar el contacto.",
      savedContact: "Contacto guardado.",
      savedAndLinked: "Contacto guardado y aplicado a este miembro de la crew.",
      savedAndAdded: "Contacto guardado y añadido al proyecto.",
      imageTooLarge: "La foto de perfil es demasiado grande (máx. 512 KB).",
      imageReadError: "No se pudo leer la foto de perfil. Prueba con otro archivo.",
      saveFromCrew: "Guardar como contacto",
      useForCrew: "Usar para este miembro de la crew",
      addToProject: "Añadir al proyecto",
      useSuccess: "Contacto añadido a la crew.",
      addedToProject: "Contacto añadido al proyecto.",
      editContact: "Editar",
      deleteContact: "Eliminar",
      deleteConfirm: "¿Eliminar este contacto? Se quitará de los miembros vinculados.",
  ...
  fr: {
    ...
    contacts: {
      navLabel: "Contacts",
      navHelp: "Ouvrir les contacts de l'équipe pour réutiliser les membres enregistrés.",
      dialogTitle: "Contacts de l'équipe",
      dialogDescription:
        "Enregistrez les membres de l'équipe avec leurs rôles et coordonnées pour les futurs projets. Les contacts restent disponibles hors ligne et inclus dans les sauvegardes.",
      formTitle: "Enregistrer un contact",
      namePlaceholder: "Nom",
      nameLabel: "Nom",
      ...
      listHelp:
        "Les contacts restent stockés hors ligne et sont inclus dans les sauvegardes et les exports.",
      emptyState:
        "Aucun contact enregistré pour le moment. Enregistrez les membres de l'équipe pour les réutiliser plus tard.",
      nameRequired: "Saisissez un nom pour enregistrer le contact.",
      saveFailed: "Impossible d'enregistrer le contact.",
      savedContact: "Contact enregistré.",
      savedAndLinked: "Contact enregistré et appliqué à ce membre de l'équipe.",
      savedAndAdded: "Contact enregistré et ajouté au projet.",
      imageTooLarge: "La photo de profil est trop volumineuse (max. 512 Ko).",
      imageReadError: "Impossible de lire la photo de profil. Essayez un autre fichier.",
      saveFromCrew: "Enregistrer comme contact",
      useForCrew: "Utiliser pour ce membre",
      addToProject: "Ajouter au projet",
      useSuccess: "Contact ajouté à l'équipe.",
      addedToProject: "Contact ajouté au projet.",
      editContact: "Modifier",
      deleteContact: "Supprimer",
      deleteConfirm: "Supprimer ce contact ? Les liens avec l'équipe seront retirés.",
  ...
  de: {
    ...
    contacts: {
      navLabel: "Kontakte",
      navHelp:
        "Kontaktverwaltung für Crewmitglieder öffnen, um gespeicherte Personen erneut zu verwenden.",
      dialogTitle: "Crew-Kontakte",
      dialogDescription:
        "Speichere Crewmitglieder mit Rollen und Kontaktdaten für zukünftige Projekte. Kontakte bleiben offline verfügbar und werden in Backups übernommen.",
      formTitle: "Kontakt speichern",
      namePlaceholder: "Name",
      nameLabel: "Name",
      roleLabel: "Crewrolle",
      ...
      listHelp:
        "Kontakte bleiben offline gespeichert und werden in Backups und Exporten berücksichtigt.",
      emptyState:
        "Noch keine Kontakte gespeichert. Lege Crewdetails an, um sie später erneut zu nutzen.",
      nameRequired: "Bitte gib einen Namen ein, um den Kontakt zu speichern.",
      saveFailed: "Kontakt konnte nicht gespeichert werden.",
      savedContact: "Kontakt gespeichert.",
      savedAndLinked: "Kontakt gespeichert und diesem Crewplatz zugewiesen.",
      savedAndAdded: "Kontakt gespeichert und zum Projekt hinzugefügt.",
      imageTooLarge: "Profilbild ist zu groß (max. 512 KB).",
      imageReadError:
        "Profilbild konnte nicht gelesen werden. Bitte versuche es mit einer anderen Datei.",
      saveFromCrew: "Als Kontakt speichern",
      useForCrew: "Für diesen Crewplatz verwenden",
      addToProject: "Zum Projekt hinzufügen",
      useSuccess: "Kontakt zur Crew hinzugefügt.",
      addedToProject: "Kontakt zum Projekt hinzugefügt.",
      editContact: "Bearbeiten",
      deleteContact: "Löschen",
      deleteConfirm: "Diesen Kontakt entfernen? Zugeordnete Crewplätze werden gelöst.",
      deletedContact: "Kontakt entfernt.",
