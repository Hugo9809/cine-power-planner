...
const texts = {
      ...
      steps: {
        intro: {
          ...
          hero: {
            ...
            summary:
              "Plan safe camera setups, verify power limits, auto-build gear lists from project requirements, and export rental-ready PDFs—every save stays local before call time.",
            badgeIcon: "\uE9C3",
  ...
  it: {
    ...
    gearListEditProviderHelp:
      "Scegli chi fornisce questo elemento. Il service di noleggio resta l'opzione predefinita, a meno che l'elemento sia nella tua lista di attrezzatura personale.",
      ...
      steps: {
        ...
        resultsBatteryPacks: {
          title: "Power Summary: Autonomie delle batterie",
            body:
              "Esamina la proiezione di autonomia di ogni pacco sapendo che riflette uno scenario di consumo massimo, così la maggior parte dei setup durerà di più—ti aiuta a capire quante batterie portare, a sentirti tranquillo che il rig non richiederà cambi continui e ad aggiungere automaticamente i pacchi giusti insieme a ogni camera.",
        },
        resultsChangeover: {
  ...
  es: {
    ...
    contacts: {
      heading: "Contactos",
      description:
        "Guarda a los miembros del equipo de rodaje una vez, consérvalos sin conexión y reutilízalos en cada proyecto.",
      ...
      userProfileHint:
        "Sirve para mostrar tu nombre y la inicial del apellido en la opción \"Usuario\" del desplegable Proveedor. El teléfono y el correo aparecen en exportaciones y copias de seguridad para que el equipo de rodaje pueda localizarte sin conexión.",
   ...
   gearListEditReset: "Restablecer nombre",
    ...
    autoGearCrewPresentHelp:
      "Aplica esta regla cuando estos perfiles del equipo de rodaje figuren en el proyecto.",
    autoGearCrewAbsentLabel: "Equipo de rodaje ausente",
    autoGearCrewAbsentHelp:
      "Aplica esta regla cuando estos perfiles del equipo de rodaje no figuren en el proyecto.",
      ...
      steps: {
        ...
        resultsBatteryPacks: {
          title: "Power Summary: Autonomías de baterías",
            body:
              "Revisa la autonomía prevista de cada batería sabiendo que representa un escenario de consumo máximo, de modo que en la práctica la mayoría de los equipos durará más; así sabrás cuántas baterías llevar, tendrás la tranquilidad de que el rig no exigirá cambios constantes y añadirás automáticamente los paquetes correctos junto a cada cámara.",
        },
        resultsChangeover: {
      ...
      steps: {
        ...
        resultsBatteryPacks: {
          title: "Power Summary : Autonomie des batteries",
            body:
              "Consultez la durée prévue de chaque bloc en sachant qu’elle repose sur un scénario de charge maximale, de sorte qu’en pratique la plupart des configurations dureront plus longtemps ; cela vous aide à savoir combien de batteries emporter, à rester serein sans changements incessants et à associer automatiquement les bons blocs à chaque caméra.",
        },
        resultsChangeover: {
  ...
  de: {
    ...
    gearListEditProviderHelp:
      "Wähle, wer diesen Artikel bereitstellt. Standard ist das Rentalhaus, außer der Artikel steht in deiner Eigengear-Liste.",
