...
const texts = {
  en: {
    ...
    contacts: {
      ...
      avatarAdjustHint: "Drag to adjust framing",
      avatarAdjusted: "Photo framing updated.",
      ...
      userProfileHint: "Used for the “User” option in provided by dropdown.",
  ...
  it: {
    ...
    contacts: {
      ...
      avatarAdjustHint: "Trascina per regolare l'inquadratura",
      avatarAdjusted: "Inquadratura aggiornata.",
      ...
      userProfileHint: "Usato per l'opzione \"Utente\" nel menu Fornito da.",
  ...
  es: {
    ...
    contacts: {
      ...
      avatarAdjustHint: "Arrastra para ajustar el encuadre",
      avatarAdjusted: "Encuadre actualizado.",
      ...
      userProfileHint: "Se usa para la opción \"Usuario\" en el desplegable de proveedor.",
  ...
  fr: {
    ...
    contacts: {
      ...
      avatarAdjustHint: "Faites glisser pour ajuster le cadrage",
      avatarAdjusted: "Cadre de la photo mis à jour.",
      ...
      userProfileHint: "Utilisé pour l’option \"Utilisateur\" dans le menu Fournisseur.",
  ...
  de: {
    ...
    contacts: {
      ...
      avatarAdjustHint: "Zum Anpassen des Bildausschnitts ziehen",
      avatarAdjusted: "Bildausschnitt aktualisiert.",
      ...
      userProfileHint: "Wird für die Option \"User\" im Menü Bereitgestellt von verwendet.",
