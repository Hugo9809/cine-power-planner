...
const texts = {
  en: {
    ...
    versionCompareFullBackupLabel: "Full backup",
    versionCompareLoadFullBackup: "Load full backup (.json)…",
    versionCompareFullBackupLoaded: "Full backup ready for comparison.",
    versionCompareFullBackupLoadError: "Unable to load full backup for comparison.",
  ...
  it: {
    ...
    versionCompareFullBackupLabel: "Backup completo",
    versionCompareLoadFullBackup: "Carica backup completo (.json)…",
    versionCompareFullBackupLoaded: "Backup completo pronto per il confronto.",
    versionCompareFullBackupLoadError: "Impossibile caricare il backup completo per il confronto.",
    backupSettings: "Backup",
    backupSettingsHelp:
  ...
  es: {
    ...
    versionCompareFullBackupLabel: "Copia de seguridad completa",
    versionCompareLoadFullBackup: "Cargar copia de seguridad completa (.json)…",
    versionCompareFullBackupLoaded: "Copia de seguridad completa lista para comparar.",
    versionCompareFullBackupLoadError: "No se pudo cargar la copia de seguridad completa para la comparación.",
  ...
  fr: {
    ...
    versionCompareFullBackupLabel: "Sauvegarde complète",
    versionCompareLoadFullBackup: "Charger une sauvegarde complète (.json)…",
    versionCompareFullBackupLoaded: "Sauvegarde complète prête pour la comparaison.",
    versionCompareFullBackupLoadError: "Impossible de charger la sauvegarde complète pour la comparaison.",
  ...
  de: {
    ...
    versionCompareFullBackupLabel: "Vollsicherung",
    versionCompareLoadFullBackup: "Vollsicherung (.json) laden…",
    versionCompareFullBackupLoaded: "Vollsicherung bereit zum Vergleichen.",
    versionCompareFullBackupLoadError: "Vollsicherung konnte für den Vergleich nicht geladen werden.",
