...
const texts = {
  en: {
    ...
    storageKeyAutoBackups: "Automatic project backups",
    storageKeyAutoBackupsDesc: "Auto-saved snapshots created before deletions or on a schedule.",
    storageAutoBackupsTotalOne: "%s auto backup",
    storageAutoBackupsTotalOther: "%s auto backups",
    ...
    storageKeyFullBackupsDesc: "Download history created with Backup & Restore.",
    storageFullBackupsCountOne: "%s backup saved",
    storageFullBackupsCountOther: "%s backups saved",
    storageFullBackupsLatest: "Latest backup: %s",
    storageTabSummaryAuto: "Auto backups: %s",
    storageTabSummaryFull: "Full backups: %s",
    storageTabSummary: "%s • %s",
  ...
  it: {
    ...
    storageKeyAutoBackups: "Backup automatici del progetto",
    storageKeyAutoBackupsDesc: "Copie automatiche create prima delle eliminazioni o a intervalli programmati.",
    storageAutoBackupsTotalOne: "%s backup automatico",
    storageAutoBackupsTotalOther: "%s backup automatici",
    ...
    storageKeyFullBackupsDesc: "Cronologia dei download creata da Backup e ripristino.",
    storageFullBackupsCountOne: "%s backup salvato",
    storageFullBackupsCountOther: "%s backup salvati",
    storageFullBackupsLatest: "Ultimo backup: %s",
    storageTabSummaryAuto: "Backup automatici: %s",
    storageTabSummaryFull: "Backup completi: %s",
    storageTabSummary: "%s • %s",
  ...
  es: {
    ...
    storageKeyAutoBackups: "Copias automáticas del proyecto",
    storageKeyAutoBackupsDesc: "Instantáneas automáticas antes de eliminar o en los intervalos programados.",
    storageAutoBackupsTotalOne: "%s copia automática",
    storageAutoBackupsTotalOther: "%s copias automáticas",
    ...
    storageKeyFullBackupsDesc: "Historial de descargas creado desde Copia de seguridad y restaurar.",
    storageFullBackupsCountOne: "%s copia guardada",
    storageFullBackupsCountOther: "%s copias guardadas",
    storageFullBackupsLatest: "Última copia: %s",
    storageTabSummaryAuto: "Copias automáticas: %s",
    storageTabSummaryFull: "Copias completas: %s",
    storageTabSummary: "%s • %s",
  ...
  fr: {
    ...
    storageKeyAutoBackups: "Sauvegardes automatiques du projet",
    storageKeyAutoBackupsDesc: "Instantanés créés avant les suppressions ou à intervalles programmés.",
    storageAutoBackupsTotalOne: "%s sauvegarde automatique",
    storageAutoBackupsTotalOther: "%s sauvegardes automatiques",
    ...
    storageKeyFullBackupsDesc: "Historique des téléchargements créé via Sauvegarde et restauration.",
    storageFullBackupsCountOne: "%s sauvegarde enregistrée",
    storageFullBackupsCountOther: "%s sauvegardes enregistrées",
    storageFullBackupsLatest: "Dernière sauvegarde : %s",
    storageTabSummaryAuto: "Sauvegardes automatiques : %s",
    storageTabSummaryFull: "Sauvegardes complètes : %s",
    storageTabSummary: "%s • %s",
  ...
  de: {
    ...
    storageKeyAutoBackups: "Automatische Projekt-Backups",
    storageKeyAutoBackupsDesc: "Automatisch erstellte Sicherungen vor Löschungen oder in regelmäßigen Abständen.",
    storageAutoBackupsTotalOne: "%s Auto-Backup",
    storageAutoBackupsTotalOther: "%s Auto-Backups",
    ...
    storageKeyFullBackupsDesc: "Downloadverlauf aus Sichern & Wiederherstellen.",
    storageFullBackupsCountOne: "%s Backup gespeichert",
    storageFullBackupsCountOther: "%s Backups gespeichert",
    storageFullBackupsLatest: "Letztes Backup: %s",
    storageTabSummaryAuto: "Auto-Backups: %s",
    storageTabSummaryFull: "Vollständige Backups: %s",
    storageTabSummary: "%s • %s",
