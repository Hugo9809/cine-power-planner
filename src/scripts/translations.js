...
const texts = {
  en: {
    ...
    autoGearCoverageHeading: "Rule coverage overview",
    autoGearCoverageScenarioLabel: "Focus scenario",
    autoGearCoverageScenarioHelp: "Focus the dashboard on a single scenario.",
    autoGearCoverageScenarioAll: "All scenarios",
    autoGearCoverageOnlyDuplicates: "Only overlaps",
    autoGearCoverageOnlyConflicts: "Only conflicts",
    autoGearCoverageOnlyUncovered: "Only uncovered",
    autoGearCoverageTableScenario: "Scenario",
    autoGearCoverageTableRules: "Rules",
    autoGearCoverageTableAdds: "Adds",
    autoGearCoverageTableRemovals: "Removals",
    autoGearCoverageTableNet: "Net",
    autoGearCoverageTableNotes: "Notes",
    autoGearCoverageEmpty: "No coverage insights match the current filters.",
    autoGearCoverageDuplicatesHeading: "Overlapping triggers",
    autoGearCoverageDuplicatesEmpty: "No overlapping triggers detected.",
    autoGearCoverageDuplicateRulesLabel: "Rules",
    autoGearCoverageConflictsHeading: "Potential conflicts",
    autoGearCoverageConflictsEmpty: "No conflicts detected.",
    autoGearCoverageConflictAdds: "Adds",
    autoGearCoverageConflictRemovals: "Removals",
    autoGearCoverageAlwaysLabel: "Always active",
    autoGearCoverageNoScenarioLabel: "Other triggers",
    autoGearCoverageNoteOverlap: "Overlapping triggers",
    autoGearCoverageNoteConflict: "Adds and removals overlap",
    autoGearCoverageNoteUncovered: "No rules yet",
    autoGearRuleUnnamed: "Unnamed rule",
  ...
  it: {
    ...
    autoGearCoverageHeading: "Panoramica copertura regole",
    autoGearCoverageScenarioLabel: "Scenario di riferimento",
    autoGearCoverageScenarioHelp: "Concentra il pannello su uno scenario specifico.",
    autoGearCoverageScenarioAll: "Tutti gli scenari",
    autoGearCoverageOnlyDuplicates: "Solo sovrapposizioni",
    autoGearCoverageOnlyConflicts: "Solo conflitti",
    autoGearCoverageOnlyUncovered: "Solo scoperti",
    autoGearCoverageTableScenario: "Scenario",
    autoGearCoverageTableRules: "Regole",
    autoGearCoverageTableAdds: "Aggiunte",
    autoGearCoverageTableRemovals: "Rimozioni",
    autoGearCoverageTableNet: "Saldo",
    autoGearCoverageTableNotes: "Note",
    autoGearCoverageEmpty:
      "Nessuna analisi di copertura corrisponde ai filtri correnti.",
    autoGearCoverageDuplicatesHeading: "Trigger sovrapposti",
    autoGearCoverageDuplicatesEmpty: "Nessun trigger sovrapposto rilevato.",
    autoGearCoverageDuplicateRulesLabel: "Regole",
    autoGearCoverageConflictsHeading: "Conflitti potenziali",
    autoGearCoverageConflictsEmpty: "Nessun conflitto rilevato.",
    autoGearCoverageConflictAdds: "Aggiunte",
    autoGearCoverageConflictRemovals: "Rimozioni",
    autoGearCoverageAlwaysLabel: "Sempre attivo",
    autoGearCoverageNoScenarioLabel: "Altri trigger",
    autoGearCoverageNoteOverlap: "Trigger sovrapposti",
    autoGearCoverageNoteConflict: "Aggiunte e rimozioni si sovrappongono",
    autoGearCoverageNoteUncovered: "Nessuna regola",
    autoGearRuleUnnamed: "Regola senza nome",
  ...
  es: {
    ...
    autoGearCoverageHeading: "Resumen de cobertura de reglas",
    autoGearCoverageScenarioLabel: "Escenario enfocado",
    autoGearCoverageScenarioHelp: "Enfoca el panel en un escenario concreto.",
    autoGearCoverageScenarioAll: "Todos los escenarios",
    autoGearCoverageOnlyDuplicates: "Solo solapamientos",
    autoGearCoverageOnlyConflicts: "Solo conflictos",
    autoGearCoverageOnlyUncovered: "Solo sin cobertura",
    autoGearCoverageTableScenario: "Escenario",
    autoGearCoverageTableRules: "Reglas",
    autoGearCoverageTableAdds: "Añadidos",
    autoGearCoverageTableRemovals: "Eliminaciones",
    autoGearCoverageTableNet: "Saldo",
    autoGearCoverageTableNotes: "Notas",
    autoGearCoverageEmpty:
      "Ninguna vista de cobertura coincide con los filtros actuales.",
    autoGearCoverageDuplicatesHeading: "Disparadores solapados",
    autoGearCoverageDuplicatesEmpty: "No se detectaron disparadores solapados.",
    autoGearCoverageDuplicateRulesLabel: "Reglas",
    autoGearCoverageConflictsHeading: "Conflictos potenciales",
    autoGearCoverageConflictsEmpty: "No se detectaron conflictos.",
    autoGearCoverageConflictAdds: "Añadidos",
    autoGearCoverageConflictRemovals: "Eliminaciones",
    autoGearCoverageAlwaysLabel: "Siempre activo",
    autoGearCoverageNoScenarioLabel: "Otros disparadores",
    autoGearCoverageNoteOverlap: "Disparadores solapados",
    autoGearCoverageNoteConflict: "Añadidos y eliminaciones se solapan",
    autoGearCoverageNoteUncovered: "Sin reglas",
    autoGearRuleUnnamed: "Regla sin nombre",
  ...
  fr: {
    ...
    autoGearCoverageHeading: "Synthèse de couverture des règles",
    autoGearCoverageScenarioLabel: "Scénario ciblé",
    autoGearCoverageScenarioHelp: "Focalisez le tableau de bord sur un scénario précis.",
    autoGearCoverageScenarioAll: "Tous les scénarios",
    autoGearCoverageOnlyDuplicates: "Chevauchements uniquement",
    autoGearCoverageOnlyConflicts: "Conflits uniquement",
    autoGearCoverageOnlyUncovered: "Uniquement sans couverture",
    autoGearCoverageTableScenario: "Scénario",
    autoGearCoverageTableRules: "Règles",
    autoGearCoverageTableAdds: "Ajouts",
    autoGearCoverageTableRemovals: "Retraits",
    autoGearCoverageTableNet: "Solde",
    autoGearCoverageTableNotes: "Notes",
    autoGearCoverageEmpty:
      "Aucun aperçu de couverture ne correspond aux filtres en cours.",
    autoGearCoverageDuplicatesHeading: "Déclencheurs en doublon",
    autoGearCoverageDuplicatesEmpty: "Aucun déclencheur en doublon détecté.",
    autoGearCoverageDuplicateRulesLabel: "Règles",
    autoGearCoverageConflictsHeading: "Conflits potentiels",
    autoGearCoverageConflictsEmpty: "Aucun conflit détecté.",
    autoGearCoverageConflictAdds: "Ajouts",
    autoGearCoverageConflictRemovals: "Retraits",
    autoGearCoverageAlwaysLabel: "Toujours actif",
    autoGearCoverageNoScenarioLabel: "Autres déclencheurs",
    autoGearCoverageNoteOverlap: "Déclencheurs en doublon",
    autoGearCoverageNoteConflict: "Ajouts et retraits se chevauchent",
    autoGearCoverageNoteUncovered: "Aucune règle",
    autoGearRuleUnnamed: "Règle sans nom",
  ...
  de: {
    ...
    autoGearCoverageHeading: "Übersicht der Regelabdeckung",
    autoGearCoverageScenarioLabel: "Fokussiertes Szenario",
    autoGearCoverageScenarioHelp: "Fokussiere die Übersicht auf ein bestimmtes Szenario.",
    autoGearCoverageScenarioAll: "Alle Szenarien",
    autoGearCoverageOnlyDuplicates: "Nur Überschneidungen",
    autoGearCoverageOnlyConflicts: "Nur Konflikte",
    autoGearCoverageOnlyUncovered: "Nur ohne Abdeckung",
    autoGearCoverageTableScenario: "Szenario",
    autoGearCoverageTableRules: "Regeln",
    autoGearCoverageTableAdds: "Ergänzungen",
    autoGearCoverageTableRemovals: "Entfernungen",
    autoGearCoverageTableNet: "Saldo",
    autoGearCoverageTableNotes: "Hinweise",
    autoGearCoverageEmpty:
      "Keine Abdeckungsinformationen passen zu den aktuellen Filtern.",
    autoGearCoverageDuplicatesHeading: "Überlappende Auslöser",
    autoGearCoverageDuplicatesEmpty: "Keine überlappenden Auslöser erkannt.",
    autoGearCoverageDuplicateRulesLabel: "Regeln",
    autoGearCoverageConflictsHeading: "Potenzielle Konflikte",
    autoGearCoverageConflictsEmpty: "Keine Konflikte erkannt.",
    autoGearCoverageConflictAdds: "Ergänzungen",
    autoGearCoverageConflictRemovals: "Entfernungen",
    autoGearCoverageAlwaysLabel: "Immer aktiv",
    autoGearCoverageNoScenarioLabel: "Weitere Auslöser",
    autoGearCoverageNoteOverlap: "Überlappende Auslöser",
    autoGearCoverageNoteConflict: "Ergänzungen und Entfernungen überschneiden sich",
    autoGearCoverageNoteUncovered: "Keine Regel",
    autoGearRuleUnnamed: "Unbenannte Regel",
