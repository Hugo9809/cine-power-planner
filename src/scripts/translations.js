...
const texts = {
  en: {
    ...
    storageKeyAutoBackups: "Automatic backups",
    storageKeyAutoBackupsDesc: "Copies the planner keeps before replacing a project.",
    storageKeyFullBackups: "Full backup downloads",
    storageKeyFullBackupsDesc: "Files saved through Backup & Restore → Backup.",
    storageProjectsCountOne: "%s project",
    storageProjectsCountOther: "%s projects",
    storageAutoBackupsCountOne: "Auto backups: %s",
    storageAutoBackupsCountOther: "Auto backups: %s",
    storageFullBackupsCountOne: "Full backups: %s",
    storageFullBackupsCountOther: "Full backups: %s",
  ...
  it: {
    ...
    storageKeyAutoBackupsDesc: "Copie salvate dal planner prima di sostituire un progetto.",
    storageKeyFullBackups: "Download backup completi",
    storageKeyFullBackupsDesc: "File salvati da Backup e ripristino → Backup.",
    storageProjectsCountOne: "%s progetto",
    storageProjectsCountOther: "%s progetti",
    storageAutoBackupsCountOne: "Backup automatici: %s",
    storageAutoBackupsCountOther: "Backup automatici: %s",
    storageFullBackupsCountOne: "Backup completi: %s",
    storageFullBackupsCountOther: "Backup completi: %s",
  ...
  es: {
    ...
    storageKeyAutoBackupsDesc: "Copias que guarda el planificador antes de reemplazar un proyecto.",
    storageKeyFullBackups: "Descargas de copias completas",
    storageKeyFullBackupsDesc: "Archivos guardados desde Copia y restauración → Copia de seguridad.",
    storageProjectsCountOne: "%s proyecto",
    storageProjectsCountOther: "%s proyectos",
    storageAutoBackupsCountOne: "Copias automáticas: %s",
    storageAutoBackupsCountOther: "Copias automáticas: %s",
    storageFullBackupsCountOne: "Copias de seguridad completas: %s",
    storageFullBackupsCountOther: "Copias de seguridad completas: %s",
  ...
  fr: {
    ...
    storageKeyAutoBackupsDesc: "Copies conservées avant de remplacer un projet.",
    storageKeyFullBackups: "Téléchargements de sauvegardes complètes",
    storageKeyFullBackupsDesc: "Fichiers enregistrés via Sauvegarde et restauration → Sauvegarder.",
    storageProjectsCountOne: "%s projet",
    storageProjectsCountOther: "%s projets",
    storageAutoBackupsCountOne: "Sauvegardes automatiques : %s",
    storageAutoBackupsCountOther: "Sauvegardes automatiques : %s",
    storageFullBackupsCountOne: "Sauvegardes complètes : %s",
    storageFullBackupsCountOther: "Sauvegardes complètes : %s",
  ...
  de: {
    ...
    storageKeyAutoBackupsDesc: "Kopien, die der Planer vor dem Ersetzen eines Projekts aufbewahrt.",
    storageKeyFullBackups: "Downloads vollständiger Sicherungen",
    storageKeyFullBackupsDesc: "Dateien aus Sichern & Wiederherstellen → Sichern.",
    storageProjectsCountOne: "%s Projekt",
    storageProjectsCountOther: "%s Projekte",
    storageAutoBackupsCountOne: "Auto-Backups: %s",
    storageAutoBackupsCountOther: "Auto-Backups: %s",
    storageFullBackupsCountOne: "Vollsicherungen: %s",
    storageFullBackupsCountOther: "Vollsicherungen: %s",
