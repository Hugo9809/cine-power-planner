...
const texts = {
  en: {
    ...
    contacts: {
      ...
      userProfileHint:
        "Used to show your first name and last initial for the “User” option in the provided by dropdown. Phone and email appear on exports and backups so crews can reach you offline.",
    ...
    documentationTrackerDescription:
      "Log translation, help center and print guide updates before packaging an offline release.",
    documentationTrackerAddRelease: "New release log",
    documentationTrackerEmpty:
      "No releases tracked yet. Add the upcoming release to start logging updates.",
    documentationTrackerSummaryIntro:
      "Use the tracker to record documentation refresh progress.",
    ...
    documentationTrackerNotesPlaceholder:
      "Record what changed, who reviewed it and where the artifacts were stored.",
    ...
    documentationTrackerArchiveConfirm:
      'Archive "{name}"? Completed checkmarks stay logged for audits.',
    documentationTrackerSummaryPending:
      '{remaining} of {total} documentation tasks remain for "{name}".',
    documentationTrackerSummaryComplete:
      'All {total} documentation tasks for "{name}" are complete.',
    ...
    loggingIntro:
      "The log updates live while Settings stay open. Console capture runs by default so transcripts stay local; adjust the toggles below if you need to change diagnostics behavior. Nothing leaves this device.",
    ...
    loggingCaptureConsoleHelp:
      "Record console messages for diagnostics. Leave this enabled unless you need to reduce logging overhead.",
    ...
    onboardingTour: {
      ...
      introTagline:
        "Plan every camera build offline with automated safeguards from prep through wrap.",
      introHighlights: [
      ...
      introHint:
        "Pick your interface language here so the tour, planner UI, exports, and mobile PWA stay in sync even when you are fully offline.",
      ...
      helpStatusCompleted:
        "Tutorial completed. Replay any step anytime for a refresher.",
    ...
    saveSetupHelp:
      "Capture a full snapshot of the current project—devices, requirements, notes, runtime logs and diagram layout—and store it in your local library. The autosave status dot beside Project Name pulses while the write finishes, and the background auto-backup queue schedules the matching timestamped snapshot right after the save so redundancy stays current. Press Enter or Ctrl+S (⌘S on Mac) for the same result; the Save button stays disabled until you enter a project name.",
  ...
  it: {
    ...
    contacts: {
      ...
      userProfileHint:
        "Usato per mostrare il nome e l'iniziale del cognome nell'opzione \"Utente\" del menu Fornito da. Telefono ed email compaiono in esportazioni e backup così la troupe può contattarti offline.",
    ...
    documentationTrackerDescription:
      "Registra gli aggiornamenti di traduzioni, help center e guide stampabili prima di distribuire una release offline.",
    documentationTrackerAddRelease: "Nuovo registro release",
    documentationTrackerEmpty:
      "Nessuna release tracciata. Aggiungi la prossima release per iniziare a registrare gli aggiornamenti.",
    documentationTrackerSummaryIntro:
      "Usa il registro per tenere traccia dello stato degli aggiornamenti della documentazione.",
    ...
    documentationTrackerNotesPlaceholder:
      "Annota cosa è cambiato, chi ha revisionato e dove sono archiviati gli artefatti.",
    ...
    documentationTrackerArchiveConfirm:
      'Archivia "{name}"? I segni di completamento restano registrati per gli audit.',
    documentationTrackerSummaryPending:
      'Restano {remaining} attività documentazione su {total} per "{name}".',
    documentationTrackerSummaryComplete:
      'Tutte le {total} attività documentazione per "{name}" sono complete.',
    ...
    loggingIntro:
      "Il registro si aggiorna in tempo reale finché Impostazioni resta aperto. La cattura della console è attiva per impostazione predefinita così le trascrizioni restano locali; usa i controlli qui sotto solo se devi modificare il comportamento diagnostico. I dati non lasciano questo dispositivo.",
    ...
    loggingCaptureConsoleHelp:
      "Registra i messaggi della console per la diagnostica. Lascia questa opzione attiva a meno che tu non debba ridurre il carico del logging.",
    ...
    onboardingTour: {
      ...
      introTagline:
        "Pianifica ogni configurazione camera offline con salvaguardie automatizzate dall'allestimento al wrap.",
      introHighlights: [
      ...
      introHint:
        "Scegli qui la lingua dell'interfaccia così tour, planner, esportazioni e PWA mobile restano sincronizzati anche senza connessione.",
  ...
  es: {
    ...
    contacts: {
      ...
      userProfileHint:
        "Sirve para mostrar tu nombre y la inicial del apellido en la opción \"Usuario\" del desplegable Proveedor. El teléfono y el correo aparecen en exportaciones y copias de seguridad para que la crew pueda localizarte sin conexión.",
   ...
   gearListEditReset: "Restablecer nombre",
    ...
    documentationTrackerDescription:
      "Registra las actualizaciones de traducciones, ayuda y guías impresas antes de distribuir una versión offline.",
    documentationTrackerAddRelease: "Nuevo registro de versión",
    documentationTrackerEmpty:
      "No hay versiones registradas aún. Añade la próxima versión para empezar a registrar las actualizaciones.",
    documentationTrackerSummaryIntro:
      "Usa el registro para seguir el progreso de las actualizaciones de documentación.",
    ...
    documentationTrackerNotesPlaceholder:
      "Anota qué cambió, quién lo revisó y dónde se almacenaron los artefactos.",
    ...
    documentationTrackerArchiveConfirm:
      '¿Archivar "{name}"? Las marcas completadas se conservarán para las auditorías.',
    documentationTrackerSummaryPending:
      'Quedan {remaining} de {total} tareas de documentación para "{name}".',
    documentationTrackerSummaryComplete:
      'Todas las {total} tareas de documentación de "{name}" están completas.',
    ...
    loggingIntro:
      "El registro se actualiza en vivo mientras Ajustes permanece abierto. La captura de la consola está activa de forma predeterminada para que las transcripciones permanezcan locales; ajusta los controles siguientes solo si necesitas cambiar el comportamiento del diagnóstico. Nada sale de este dispositivo.",
    ...
    loggingCaptureConsoleHelp:
      "Registra los mensajes de la consola para diagnósticos. Manténlo activado salvo que necesites reducir la carga del registro.",
  ...
  fr: {
    ...
    contacts: {
      ...
      userProfileHint:
        "Utilisé pour afficher votre prénom et l’initiale du nom dans l’option \"Utilisateur\" du menu Fournisseur. Le téléphone et l’e-mail figurent dans les exports et sauvegardes afin que l’équipe puisse vous joindre hors ligne.",
    ...
    documentationTrackerDescription:
      "Consignez les mises à jour des traductions, de l'aide et des guides imprimés avant de livrer une version hors ligne.",
    documentationTrackerAddRelease: "Nouveau journal de version",
    documentationTrackerEmpty:
      "Aucune version suivie pour le moment. Ajoutez la prochaine version pour commencer à consigner les mises à jour.",
    documentationTrackerSummaryIntro:
      "Utilisez le journal pour suivre l'avancement des mises à jour de la documentation.",
    ...
    documentationTrackerPrintSaveShare:
      "Référence Sauvegarder, partager, importer, sauvegarder et restaurer",
    ...
    documentationTrackerNotesPlaceholder:
      "Indiquez ce qui a changé, qui l'a vérifié et où les artefacts ont été stockés.",
    ...
    documentationTrackerArchiveConfirm:
      'Archiver «\u00a0{name}\u00a0» ? Les coches terminées resteront consignées pour les audits.',
    documentationTrackerSummaryPending:
      'Il reste {remaining} tâches de documentation sur {total} pour «\u00a0{name}\u00a0».',
    documentationTrackerSummaryComplete:
      'Les {total} tâches de documentation pour «\u00a0{name}\u00a0» sont terminées.',
    ...
    loggingIntro:
      "Le journal se met à jour en direct tant que la fenêtre Paramètres reste ouverte. La capture de la console est active par défaut pour que les transcriptions restent locales ; ajustez les commandes ci-dessous uniquement si vous devez modifier le comportement du diagnostic. Rien ne quitte cet appareil.",
    ...
    loggingCaptureConsoleHelp:
      "Enregistre les messages de console pour le diagnostic. Laissez cette option activée sauf si vous devez réduire la charge de journalisation.",
    ...
    onboardingTour: {
      ...
      introTagline:
        "Planifiez chaque configuration caméra hors ligne avec des garde-fous automatisés du repérage au wrap.",
      introHighlights: [
        "Cartographiez la consommation, les marges d’autonomie et la sécurité batteries sans vous reconnecter.",
        "Les règles AutoGear génèrent des listes complètes à partir des scénarios de tournage et restent entièrement personnalisables.",
        "Suivez les exigences projet, partagez des sauvegardes hors ligne et générez des PDF pour l’équipe et la location.",
        "Travaillez entièrement hors ligne sans abonnement sur ordinateur ou via la PWA installable.",
      ],
      introHint:
        "Choisissez ici la langue de l’interface pour que le tutoriel, l’app, les exports et la PWA mobile restent synchronisés même hors ligne.",
      ...
      steps: {
        intro: {
          ...
          body:
            "Suivez ce tutoriel guidé pour voir comment Cine Power Planner garde l’équipe aux commandes : cartographiez la consommation du rig, sécurisez les marges d’autonomie et consignez les exigences du projet sans rien oublier. Les règles AutoGear bâtissent des listes complètes à partir des scénarios de tournage et restent entièrement personnalisables. Générez des PDF pour l’équipe et la location, partagez des sauvegardes hors ligne et utilisez la PWA installable sans abonnement ni serveur, afin que chaque pause reprenne toutes les protections.",
        },
        userProfile: {
          title: "Configurez votre profil d’équipe",
          body:
            "Ajoutez nom d’affichage, fonction, téléphone, e-mail et photo pour personnaliser Contacts et les exports. Chaque modification se synchronise immédiatement avec Contacts, reste dans les sauvegardes hors ligne et figure dans les exports.",
        },
        unitsPreferences: {
  ...
  de: {
    ...
    contacts: {
      ...
      userProfileHint:
        "Zeigt im Eintrag \"User\" im Menü \"Bereitgestellt von\" deinen Vornamen und den Anfangsbuchstaben des Nachnamens. Telefon und E-Mail erscheinen in Exporten und Backups, damit die Crew dich offline erreichen kann.",
    ...
    documentationTrackerDescription:
      "Protokollieren Sie Übersetzungen, Hilfeinhalte und Druckleitfäden, bevor Sie eine Offline-Version ausgeben.",
    documentationTrackerAddRelease: "Neues Versionsprotokoll",
    documentationTrackerEmpty:
      "Noch keine Version protokolliert. Fügen Sie die nächste Version hinzu, um mit dem Protokoll zu beginnen.",
    documentationTrackerSummaryIntro:
      "Nutzen Sie das Protokoll, um den Fortschritt der Dokumentationsupdates nachzuhalten.",
    ...
    documentationTrackerNotesPlaceholder:
      "Notieren Sie, was sich geändert hat, wer geprüft hat und wo die Artefakte abgelegt wurden.",
    ...
    documentationTrackerArchiveConfirm:
      '„{name}“ archivieren? Erledigte Häkchen bleiben für Audits erhalten.',
    documentationTrackerSummaryPending:
      'Für „{name}“ sind noch {remaining} von {total} Dokumentationsaufgaben offen.',
    documentationTrackerSummaryComplete:
      'Alle {total} Dokumentationsaufgaben für „{name}“ sind erledigt.',
   ...
   autoGearSelectorDirectorOption: "Regie-Monitor-Auswahl",
    ...
    loggingIntro:
      "Das Protokoll aktualisiert sich live, solange die Einstellungen geöffnet bleiben. Die Konsolenerfassung ist standardmäßig aktiv, damit Transkripte lokal bleiben; passen Sie die folgenden Schalter nur an, wenn Sie das Diagnoseverhalten ändern müssen. Es verlässt nie dieses Gerät.",
    ...
    loggingCaptureConsoleHelp:
      "Protokolliert Konsolennachrichten für die Diagnose. Lassen Sie diese Option aktiviert, es sei denn, Sie müssen die Protokollierungsbelastung reduzieren.",
    ...
    onboardingTour: {
      ...
      introTagline:
        "Plane jede Kamerakonfiguration offline mit automatisierten Schutzmaßnahmen vom Setup bis zum Wrap.",
      introHighlights: [
        "Erfasse Leistungsaufnahme, Laufzeitreserven und Batteriesicherheit ohne Onlineverbindung.",
        "AutoGear-Regeln bauen vollständige Gerätelisten aus Drehszenarien und bleiben vollständig anpassbar.",
        "Verfolge Projektanforderungen, teile Offline-Backups und erstelle PDFs für Crew und Verleih.",
        "Arbeite komplett offline ohne Abogebühren – am Desktop oder mit der installierbaren PWA.",
      ],
      introHint:
        "Wähle hier die Oberflächensprache, damit Tour, Planner, Exporte und mobile PWA auch offline synchron bleiben.",
      ...
      steps: {
        intro: {
          ...
          body:
            "Nutze dieses geführte Tutorial, um zu erleben, wie Cine Power Planner Teams die Kontrolle gibt: erfasse die Leistungsaufnahme des Rigs, sichere Laufzeitreserven ab und halte Projektanforderungen ohne Lücken fest. AutoGear-Regeln bauen vollständige Gerätelisten aus Drehszenarien auf und bleiben vollständig anpassbar. Erstelle PDFs für Crew und Verleih, teile Offline-Backups und nutze die installierbare PWA ohne Abos oder Server – so setzt du nach jeder Pause mit allen Schutzmaßnahmen fort.",
        },
        userProfile: {
          title: "Teamprofil einrichten",
          body:
            "Hinterlege Anzeigename, Rolle, Telefon, E-Mail und Foto, damit Kontakte und Exporte personalisiert bleiben. Änderungen synchronisieren sich sofort mit Kontakte, werden offline gesichert und erscheinen in Exporten.",
        },
        unitsPreferences: {
