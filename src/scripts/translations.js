...
const texts = {
  en: {
    ...
    gearListEditCameraIdentityLabel: "Camera identity",
    gearListEditCameraIdentityHelp:
      "Choose which camera (A, B, C, D or E) this item represents. Linked gear uses the matching color.",
    gearListEditCameraIdentityOptionA: "Camera A — Red",
    gearListEditCameraIdentityOptionB: "Camera B — Blue",
    gearListEditCameraIdentityOptionC: "Camera C — Yellow",
    gearListEditCameraIdentityOptionD: "Camera D — Green",
    gearListEditCameraIdentityOptionE: "Camera E — Z Cam (random color)",
  ...
  it: {
    ...
    gearListEditCameraIdentityLabel: "Identità della camera",
    gearListEditCameraIdentityHelp:
      "Scegli quale camera (A, B, C, D o E) rappresenta questa voce. Gli accessori collegati useranno il colore corrispondente.",
    gearListEditCameraIdentityOptionA: "Camera A — Rosso",
    gearListEditCameraIdentityOptionB: "Camera B — Blu",
    gearListEditCameraIdentityOptionC: "Camera C — Giallo",
    gearListEditCameraIdentityOptionD: "Camera D — Verde",
    gearListEditCameraIdentityOptionE: "Camera E — Z Cam (colore casuale)",
  ...
  es: {
    ...
    gearListEditCameraIdentityLabel: "Identidad de cámara",
    gearListEditCameraIdentityHelp:
      "Elige qué cámara (A, B, C, D o E) representa este elemento. Los accesorios vinculados usarán el color correspondiente.",
    gearListEditCameraIdentityOptionA: "Cámara A — Roja",
    gearListEditCameraIdentityOptionB: "Cámara B — Azul",
    gearListEditCameraIdentityOptionC: "Cámara C — Amarilla",
    gearListEditCameraIdentityOptionD: "Cámara D — Verde",
    gearListEditCameraIdentityOptionE: "Cámara E — Z Cam (color aleatorio)",
  ...
  fr: {
    ...
    gearListEditCameraIdentityLabel: "Identité caméra",
    gearListEditCameraIdentityHelp:
      "Choisissez quelle caméra (A, B, C, D ou E) correspond à cet élément. Les accessoires liés utiliseront la couleur associée.",
    gearListEditCameraIdentityOptionA: "Caméra A — Rouge",
    gearListEditCameraIdentityOptionB: "Caméra B — Bleue",
    gearListEditCameraIdentityOptionC: "Caméra C — Jaune",
    gearListEditCameraIdentityOptionD: "Caméra D — Verte",
    gearListEditCameraIdentityOptionE: "Caméra E — Z Cam (couleur aléatoire)",
  ...
  de: {
    ...
    gearListEditCameraIdentityLabel: "Kamera-Kennung",
    gearListEditCameraIdentityHelp:
      "Wählen Sie, welche Kamera (A, B, C, D oder E) dieser Eintrag repräsentiert. Verknüpftes Zubehör übernimmt die passende Farbe.",
    gearListEditCameraIdentityOptionA: "Kamera A — Rot",
    gearListEditCameraIdentityOptionB: "Kamera B — Blau",
    gearListEditCameraIdentityOptionC: "Kamera C — Gelb",
    gearListEditCameraIdentityOptionD: "Kamera D — Grün",
    gearListEditCameraIdentityOptionE: "Kamera E — Z Cam (zufällige Farbe)",
