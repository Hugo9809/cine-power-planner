...
const texts = {
  en: {
    ...
    contacts: {
      ...
      contactMissingDetails: "Enter a name, email, phone or website before saving this contact.",
      ...
      userProfileDescription: "Add your details so your gear shows as “User” and stays reachable.",
      userProfileNameLabel: "Display name",
      userProfileNamePlaceholder: "Your name",
      userProfileRoleLabel: "Role",
      userProfileRolePlaceholder: "Your role",
      userProfilePhoneLabel: "Phone",
      userProfilePhonePlaceholder: "Your phone number",
      userProfileEmailLabel: "Email",
      userProfileEmailPlaceholder: "Your email",
      userProfileWebsiteLabel: "Website",
      userProfileWebsitePlaceholder: "Personal or project site",
      userProfileHint:
        "Shared with the “User” entry so teams see your name, role and contact links in gear lists, exports and backups.",
  ...
  it: {
    ...
    contacts: {
      ...
      userProfileDescription: "Aggiungi i tuoi dati così la tua attrezzatura appare come \"Utente\" e resta contattabile.",
      userProfileNameLabel: "Nome visualizzato",
      userProfileNamePlaceholder: "Il tuo nome",
      userProfileRoleLabel: "Ruolo",
      userProfileRolePlaceholder: "Il tuo ruolo",
      userProfilePhoneLabel: "Telefono",
      userProfilePhonePlaceholder: "Il tuo numero di telefono",
      userProfileEmailLabel: "Email",
      userProfileEmailPlaceholder: "La tua email",
      userProfileWebsiteLabel: "Sito web",
      userProfileWebsitePlaceholder: "Sito personale o del progetto",
      userProfileHint:
        "Condivisi con la voce \"Utente\" così nome, ruolo e recapiti compaiono in liste, esportazioni e backup.",
    ...
    projectForm: {
      ...
      crewWebsiteLabel: "Sito web del membro della troupe"
    },
    projectFields: {
      productionCompany: "Casa di produzione",
  ...
  es: {
    ...
    contacts: {
      ...
      userProfileDescription: "Añade tus datos para que tu equipo aparezca como \"Usuario\" y sea fácil de contactar.",
      userProfileNameLabel: "Nombre visible",
      userProfileNamePlaceholder: "Tu nombre",
      userProfileRoleLabel: "Rol",
      userProfileRolePlaceholder: "Tu rol",
      userProfilePhoneLabel: "Teléfono",
      userProfilePhonePlaceholder: "Tu número de teléfono",
      userProfileEmailLabel: "Correo",
      userProfileEmailPlaceholder: "Tu correo electrónico",
      userProfileWebsiteLabel: "Sitio web",
      userProfileWebsitePlaceholder: "Sitio personal o del proyecto",
      userProfileHint:
        "Se comparte con la opción \"Usuario\" para que tu nombre, rol y datos de contacto aparezcan en listas, exportaciones y copias de seguridad.",
  ...
  fr: {
    ...
    contacts: {
      ...
      contactMissingDetails: "Saisissez un nom, une adresse e-mail, un numéro de téléphone ou un site web avant d’enregistrer ce contact.",
      ...
      userProfileDescription: "Ajoutez vos informations pour que votre matériel s’affiche comme \"Utilisateur\" et reste joignable.",
      userProfileNameLabel: "Nom affiché",
      userProfileNamePlaceholder: "Votre nom",
      userProfileRoleLabel: "Rôle",
      userProfileRolePlaceholder: "Votre rôle",
      userProfilePhoneLabel: "Téléphone",
      userProfilePhonePlaceholder: "Votre numéro de téléphone",
      userProfileEmailLabel: "E-mail",
      userProfileEmailPlaceholder: "Votre e-mail",
      userProfileWebsiteLabel: "Site web",
      userProfileWebsitePlaceholder: "Site personnel ou du projet",
      userProfileHint:
        "Partagés avec l’entrée \"Utilisateur\" pour que vos nom, rôle et coordonnées apparaissent dans les listes, exports et sauvegardes.",
  ...
  de: {
    ...
    contacts: {
      ...
      contactMissingDetails: "Gib einen Namen, eine E-Mail-Adresse, Telefonnummer oder Website an, bevor du diesen Kontakt speicherst.",
      ...
      userProfileDescription: "Füge deine Angaben hinzu, damit dein Equipment als \"User\" angezeigt wird und erreichbar bleibt.",
      userProfileNameLabel: "Anzeigename",
      userProfileNamePlaceholder: "Dein Name",
      userProfileRoleLabel: "Rolle",
      userProfileRolePlaceholder: "Deine Rolle",
      userProfilePhoneLabel: "Telefon",
      userProfilePhonePlaceholder: "Deine Telefonnummer",
      userProfileEmailLabel: "E-Mail",
      userProfileEmailPlaceholder: "Deine E-Mail-Adresse",
      userProfileWebsiteLabel: "Website",
      userProfileWebsitePlaceholder: "Eigene oder Projekt-Website",
      userProfileHint:
        "Wird mit dem Eintrag \"User\" geteilt, damit Name, Rolle und Kontaktwege in Listen, Exporten und Backups erscheinen.",
