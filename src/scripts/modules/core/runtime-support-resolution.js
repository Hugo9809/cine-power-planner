(function () {
  ...
  var namespace =
    runtimeModules &&
    Object.prototype.hasOwnProperty.call(runtimeModules, 'modules/core/runtime-support-resolution.js')
      ? runtimeModules['modules/core/runtime-support-resolution.js']
      : null;
  ...
  if (globalScope) {
    ...
    existing['modules/core/runtime-support-resolution.js'] = namespace;
