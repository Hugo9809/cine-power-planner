(function () {
  ...
  var namespace =
    runtimeModules &&
    Object.prototype.hasOwnProperty.call(runtimeModules, 'modules/core/runtime-tools.js')
      ? runtimeModules['modules/core/runtime-tools.js']
      : null;
  ...
  if (globalScope) {
    ...
    existing['modules/core/runtime-tools.js'] = namespace;
