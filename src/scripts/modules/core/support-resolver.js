(function () {
  ...
  var namespace =
    runtimeModules &&
    Object.prototype.hasOwnProperty.call(runtimeModules, 'modules/core/support-resolver.js')
      ? runtimeModules['modules/core/support-resolver.js']
      : null;
  ...
  if (globalScope) {
    ...
    existing['modules/core/support-resolver.js'] = namespace;
