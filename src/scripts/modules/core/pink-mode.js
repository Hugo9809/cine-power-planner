  ...
  const MODULE_FACTORIES = {
    'modules/core/pink-mode-animations.js': function (module, exports, require) {
      ...
      (function () {
        ...
        // Create pink/unicorn variants by replacing brown colors with pink/purple shades
        const UNICORN_1_MARKUP = HORSE_SVG_MARKUP
        ...
        const UNICORN_2_MARKUP = HORSE_SVG_MARKUP
        ...
        const UNICORN_3_MARKUP = HORSE_SVG_MARKUP
        ...
        const PINK_MODE_TOGGLE_SEQUENCE = [
          { className: 'icon-svg pink-mode-icon', markup: UNICORN_1_MARKUP },
          { className: 'icon-svg pink-mode-icon', markup: UNICORN_2_MARKUP },
          { className: 'icon-svg pink-mode-icon', markup: UNICORN_3_MARKUP }
        ];
