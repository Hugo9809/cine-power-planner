(function () {
  ...
  var namespace =
    localizationModules &&
    Object.prototype.hasOwnProperty.call(localizationModules, 'modules/core/localization-bridge.js')
      ? localizationModules['modules/core/localization-bridge.js']
      : null;
  ...
  if (globalScope) {
    ...
    existing['modules/core/localization-bridge.js'] = namespace;
