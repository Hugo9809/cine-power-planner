(function () {
  ...
  var namespace =
    runtimeModules &&
    Object.prototype.hasOwnProperty.call(runtimeModules, 'modules/core/runtime-state/temperature-keys.js')
      ? runtimeModules['modules/core/runtime-state/temperature-keys.js']
      : null;
  ...
  if (globalScope) {
    ...
    existing['modules/core/runtime-state/temperature-keys.js'] = namespace;
