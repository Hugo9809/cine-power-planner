(function () {
  ...
  var namespace =
    runtimeModules &&
    Object.prototype.hasOwnProperty.call(runtimeModules, 'modules/core/runtime-state/local-runtime-state.js')
      ? runtimeModules['modules/core/runtime-state/local-runtime-state.js']
      : null;
  ...
  if (globalScope) {
    ...
    existing['modules/core/runtime-state/local-runtime-state.js'] = namespace;
