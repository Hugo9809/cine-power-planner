(function () {
  ...
  function applyPreferences() {
    ...
    var screenReaderEnabled = safeGet('screenReaderAnnouncements') === 'true';
    root.classList.toggle('screen-reader-mode', screenReaderEnabled);
    body.classList.toggle('screen-reader-mode', screenReaderEnabled);
