...
if (CORE_PART2_RUNTIME_SCOPE && CORE_PART2_RUNTIME_SCOPE.__cineCorePart2Initialized) {
  ...
  function corePart2Runtime() {
    ...
    const defaultFeatureSearchNormalizer = createDefaultSearchNormalizer();
      ...
      return {
        ...
        sanitizeHighlightTokens(tokens) {
          ...
          for (let index = 0; index < tokens.length; index += 1) {
            ...
            const normalized = defaultFeatureSearchNormalizer(token);
            if (!normalized) {
              continue;
            }
    ...
    const fallbackNormalizeSearchValue = defaultFeatureSearchNormalizer;
