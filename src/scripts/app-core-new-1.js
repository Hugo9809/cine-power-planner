...
const coreSetButtonLabelWithIcon =
...
if (CORE_GLOBAL_SCOPE && typeof CORE_GLOBAL_SCOPE === 'object') {
  try {
    CORE_GLOBAL_SCOPE.setButtonLabelWithIcon = coreSetButtonLabelWithIcon;
...
function updateAutoGearItemButtonState(type) {
  ...
  coreSetButtonLabelWithIcon(button, label, glyph);
...
function updateOwnGearSaveButtonState() {
  ...
  if (ownGearEditingId) {
    ...
    coreSetButtonLabelWithIcon(ownGearSaveButton, label, ICON_GLYPHS.save);
  } else {
    const label = langTexts.ownGearSaveButton || fallbackTexts.ownGearSaveButton || 'Save item';
    coreSetButtonLabelWithIcon(ownGearSaveButton, label, ICON_GLYPHS.add);
  }
}
...
function applyOwnGearLocalization(lang) {
  ...
  if (ownGearResetButton) {
    ...
    coreSetButtonLabelWithIcon(ownGearResetButton, label, ICON_GLYPHS.reload);
  }
  if (ownGearCloseButton) {
    const label = resolveTextEntryInternal(langTexts, fallbackTexts, 'ownGearCloseButton', 'Close');
    coreSetButtonLabelWithIcon(ownGearCloseButton, label, ICON_GLYPHS.circleX);
  }
...
function setLanguage(lang) {
  ...
  sideMenuLinks.forEach((link) => {
    ...
    if (label) {
      if (
        navKey === 'contactsNav' &&
        typeof coreSetButtonLabelWithIcon === 'function' &&
        link?.tagName === 'BUTTON'
      ) {
        coreSetButtonLabelWithIcon(
          link,
          label,
  ...
  coreSetButtonLabelWithIcon(deleteSetupBtn, texts[lang].deleteSetupBtn, ICON_GLYPHS.trash);
  ...
  if (shareConfirmBtn) {
    ...
    coreSetButtonLabelWithIcon(shareConfirmBtn, confirmLabel, ICON_GLYPHS.fileExport);
  ...
  if (shareCancelBtn) {
    ...
    coreSetButtonLabelWithIcon(shareCancelBtn, cancelLabel, ICON_GLYPHS.circleX);
  ...
  if (sharedImportConfirmBtn) {
    ...
    coreSetButtonLabelWithIcon(sharedImportConfirmBtn, label, ICON_GLYPHS.check);
  ...
  if (sharedImportCancelBtn) {
    ...
    coreSetButtonLabelWithIcon(sharedImportCancelBtn, label, ICON_GLYPHS.circleX);
  ...
  coreSetButtonLabelWithIcon(runtimeFeedbackBtn, texts[lang].runtimeFeedbackBtn, ICON_GLYPHS.feedback);
    ...
    try {
      resultsLocalizationApplied = cineResultsModule.localizeResultsSection({
        ...
        setButtonLabelWithIcon:
          typeof coreSetButtonLabelWithIcon === 'function' ? coreSetButtonLabelWithIcon : null,
  ...
  if (powerWarningCloseBtn)
    coreSetButtonLabelWithIcon(powerWarningCloseBtn, texts[lang].powerWarningClose, ICON_GLYPHS.check);
  ...
  if (addDeviceBtn.dataset.mode === "edit") {
    coreSetButtonLabelWithIcon(addDeviceBtn, updateDeviceLabel, ICON_GLYPHS.save);
    addDeviceBtn.setAttribute('data-help', texts[lang].updateDeviceBtnHelp);
  } else {
    coreSetButtonLabelWithIcon(addDeviceBtn, addDeviceLabel, ICON_GLYPHS.add);
    addDeviceBtn.setAttribute('data-help', texts[lang].addDeviceBtnHelp);
  }
  coreSetButtonLabelWithIcon(cancelEditBtn, texts[lang].cancelEditBtn, ICON_GLYPHS.circleX);
  cancelEditBtn.setAttribute('data-help', texts[lang].cancelEditBtnHelp);
  coreSetButtonLabelWithIcon(exportBtn, texts[lang].exportDataBtn, ICON_GLYPHS.fileExport);
  exportBtn.setAttribute('data-help', texts[lang].exportDataBtnHelp);
  coreSetButtonLabelWithIcon(importDataBtn, texts[lang].importDataBtn, ICON_GLYPHS.fileImport);
  ...
  if (deviceManagerSection.classList.contains('hidden')) {
    coreSetButtonLabelWithIcon(toggleDeviceBtn, texts[lang].toggleDeviceManager, ICON_GLYPHS.gears);
    ...
    coreSetButtonLabelWithIcon(toggleDeviceBtn, texts[lang].hideDeviceManager, ICON_GLYPHS.minus);
  ...
  if (localFontsButton) {
    ...
    if (localFontsLabel) {
      coreSetButtonLabelWithIcon(localFontsButton, localFontsLabel, ICON_GLYPHS.add);
  ...
  if (autoGearSavePresetButton) {
    ...
    coreSetButtonLabelWithIcon(autoGearSavePresetButton, label, ICON_GLYPHS.save);
  ...
  if (autoGearDeletePresetButton) {
    ...
    coreSetButtonLabelWithIcon(autoGearDeletePresetButton, label, ICON_GLYPHS.trash);
  ...
  if (autoGearAddRuleBtn) {
    ...
    coreSetButtonLabelWithIcon(autoGearAddRuleBtn, label, ICON_GLYPHS.add);
  ...
  if (autoGearResetFactoryButton) {
    ...
    const help = texts[lang].autoGearResetFactoryHelp
      ...
      || label;
    coreSetButtonLabelWithIcon(autoGearResetFactoryButton, label, ICON_GLYPHS.reload);
  ...
  if (autoGearExportButton) {
    ...
    const help = texts[lang].autoGearExportHelp
      ...
      || label;
    coreSetButtonLabelWithIcon(autoGearExportButton, label, ICON_GLYPHS.fileExport);
  ...
  if (autoGearImportButton) {
    ...
    const help = texts[lang].autoGearImportHelp
      ...
      || label;
    coreSetButtonLabelWithIcon(autoGearImportButton, label, ICON_GLYPHS.fileImport);
  ...
  if (autoGearFilterClearButton) {
    ...
    coreSetButtonLabelWithIcon(autoGearFilterClearButton, label, ICON_GLYPHS.circleX);
  ...
  if (autoGearBackupRestoreButton) {
    ...
    coreSetButtonLabelWithIcon(autoGearBackupRestoreButton, label, ICON_GLYPHS.fileImport);
  ...
  if (autoGearConditionAddButton) {
    const label = texts[lang].autoGearAddCondition
      ...
      || 'Add condition';
    coreSetButtonLabelWithIcon(autoGearConditionAddButton, label, ICON_GLYPHS.add);
  ...
  if (autoGearSaveRuleButton) {
    ...
    coreSetButtonLabelWithIcon(autoGearSaveRuleButton, label);
  ...
  if (autoGearCancelEditButton) {
    ...
    coreSetButtonLabelWithIcon(autoGearCancelEditButton, label, ICON_GLYPHS.circleX);
  ...
  if (storagePersistenceRequestButton) {
    ...
    coreSetButtonLabelWithIcon(storagePersistenceRequestButton, requestLabel, ICON_GLYPHS.save);
  ...
  if (storageBackupNowButton) {
    ...
    coreSetButtonLabelWithIcon(storageBackupNowButton, backupLabel, ICON_GLYPHS.fileExport);
  ...
  if (storageOpenBackupTabButton) {
    ...
    coreSetButtonLabelWithIcon(storageOpenBackupTabButton, openLabel, ICON_GLYPHS.settingsBackup);
  ...
  if (loggingExportButton) {
    ...
    coreSetButtonLabelWithIcon(loggingExportButton, exportLabel, ICON_GLYPHS.fileExport);
  ...
  if (backupDiffToggleButtonEl) {
    ...
    coreSetButtonLabelWithIcon(backupDiffToggleButtonEl, compareLabel, ICON_GLYPHS.note);
  ...
  if (backupDiffExportButtonEl) {
    ...
    coreSetButtonLabelWithIcon(backupDiffExportButtonEl, exportLabel, ICON_GLYPHS.fileExport);
  ...
  if (backupDiffCloseButtonEl) {
    const closeLabel = texts[lang].versionCompareClose
      ...
      || 'Close';
    coreSetButtonLabelWithIcon(backupDiffCloseButtonEl, closeLabel, ICON_GLYPHS.circleX);
  }
  if (backupSettingsButton) {
    const backupLabel = texts[lang].backupSettings;
    coreSetButtonLabelWithIcon(backupSettingsButton, backupLabel, ICON_GLYPHS.fileExport);
    const backupHelp =
  ...
  if (restoreSettings) {
    ...
    coreSetButtonLabelWithIcon(restoreSettings, restoreLabel, ICON_GLYPHS.fileImport);
    const restoreHelp =
  ...
  if (restoreRehearsalButton) {
    ...
    coreSetButtonLabelWithIcon(restoreRehearsalButton, rehearsalLabel, ICON_GLYPHS.load);
  ...
  if (restoreRehearsalBrowse) {
    ...
    coreSetButtonLabelWithIcon(restoreRehearsalBrowse, browseLabel, ICON_GLYPHS.fileImport);
  ...
  if (resolvedRestoreRehearsalCloseButton) {
    ...
    coreSetButtonLabelWithIcon(resolvedRestoreRehearsalCloseButton, closeLabel, ICON_GLYPHS.circleX);
  ...
  if (restoreRehearsalProceedButton) {
    ...
    const proceedHelp = texts[lang].restoreRehearsalProceedHelp
      ...
      || proceedLabel;
    coreSetButtonLabelWithIcon(restoreRehearsalProceedButton, proceedLabel, ICON_GLYPHS.check);
  ...
  if (restoreRehearsalAbortButton) {
    ...
    const abortHelp = texts[lang].restoreRehearsalAbortHelp
      ...
      || abortLabel;
    coreSetButtonLabelWithIcon(restoreRehearsalAbortButton, abortLabel, ICON_GLYPHS.circleX);
  ...
  if (factoryResetButton) {
    ...
    coreSetButtonLabelWithIcon(factoryResetButton, resetLabel, ICON_GLYPHS.reload);
  ...
  if (settingsSave) {
    ...
    coreSetButtonLabelWithIcon(settingsSave, label);
  ...
  if (settingsCancel) {
    ...
    coreSetButtonLabelWithIcon(settingsCancel, cancelLabel, ICON_GLYPHS.circleX);
    const cancelHelp =
  ...
  if (featureSearch) {
    ...
    if (hoverHelpButton) {
    coreSetButtonLabelWithIcon(hoverHelpButton, texts[lang].hoverHelpButtonLabel, ICON_GLYPHS.note);
    ...
    if (closeHelpBtn) {
      coreSetButtonLabelWithIcon(closeHelpBtn, texts[lang].helpClose, ICON_GLYPHS.circleX);
  ...
  if (exportRevert) {
    coreSetButtonLabelWithIcon(exportRevert, texts[lang].exportAndRevertBtn, ICON_GLYPHS.reload);
  ...
  if (gridSnapToggleBtn) {
    coreSetButtonLabelWithIcon(gridSnapToggleBtn, texts[lang].gridSnapToggle, ICON_GLYPHS.magnet);
  ...
  if (resetViewBtn) {
    coreSetButtonLabelWithIcon(resetViewBtn, texts[lang].resetViewBtn, ICON_GLYPHS.resetView);
  ...
  if (zoomInBtn) {
    coreSetButtonLabelWithIcon(zoomInBtn, '', ICON_GLYPHS.add);
  ...
  if (zoomOutBtn) {
    coreSetButtonLabelWithIcon(zoomOutBtn, '', ICON_GLYPHS.minus);
  ...
  if (projectFormTexts) {
    ...
    if (viewfinderExtensionSelect && viewfinderExtensionSelect.options.length >= 2) {
      ...
      if (projectCancelButton) {
        coreSetButtonLabelWithIcon(projectCancelButton, cancelText, ICON_GLYPHS.circleX);
      }
    ...
    if (projectSubmitBtn) {
      ...
      if (submitText) {
        coreSetButtonLabelWithIcon(projectSubmitBtn, submitText, ICON_GLYPHS.check);
    ...
    if (avatarOptionsDeleteButton && contactsTexts.avatarDelete) {
      coreSetButtonLabelWithIcon(avatarOptionsDeleteButton, contactsTexts.avatarDelete, ICON_GLYPHS.trash);
    ...
    if (avatarOptionsEditButton && contactsTexts.avatarEditAction) {
      coreSetButtonLabelWithIcon(avatarOptionsEditButton, contactsTexts.avatarEditAction, ICON_GLYPHS.sliders);
    ...
    if (avatarOptionsChangeButton && contactsTexts.avatarChange) {
      coreSetButtonLabelWithIcon(avatarOptionsChangeButton, contactsTexts.avatarChange, ICON_GLYPHS.camera);
    ...
    if (avatarEditCancelButton && contactsTexts.avatarEditCancel) {
      coreSetButtonLabelWithIcon(avatarEditCancelButton, contactsTexts.avatarEditCancel, ICON_GLYPHS.circleX);
    ...
    if (avatarEditApplyButton && contactsTexts.avatarEditApply) {
      coreSetButtonLabelWithIcon(avatarEditApplyButton, contactsTexts.avatarEditApply, ICON_GLYPHS.check);
    ...
    document.querySelectorAll('#crewContainer .person-row').forEach(row => {
      ...
      if (saveButton) {
        coreSetButtonLabelWithIcon(saveButton, getContactsText('saveContact', 'Save to contacts'), ICON_GLYPHS.save);
      }
      const manageButton = row.querySelector('.person-manage-contacts');
      if (manageButton) {
        coreSetButtonLabelWithIcon(manageButton, getContactsText('openManager', 'Open contacts'), ICON_GLYPHS.gears);
      }
    ...
    if (addPersonBtn) {
      ...
      coreSetButtonLabelWithIcon(addPersonBtn, label, ICON_GLYPHS.add);
    ...
    if (addPrepBtn) {
      ...
      coreSetButtonLabelWithIcon(addPrepBtn, label, ICON_GLYPHS.add);
    ...
    if (addShootBtn) {
      ...
      coreSetButtonLabelWithIcon(addShootBtn, label, ICON_GLYPHS.add);
    ...
    if (addReturnBtn) {
      ...
      coreSetButtonLabelWithIcon(addReturnBtn, label, ICON_GLYPHS.add);
    ...
    if (addStorageNeedBtn) {
      ...
      coreSetButtonLabelWithIcon(addStorageNeedBtn, label, ICON_GLYPHS.add);
  ...
  if (iosPwaHelpClose) {
    ...
    coreSetButtonLabelWithIcon(iosPwaHelpClose, closeText, ICON_GLYPHS.check);
...
function configureIconOnlyButton(button, glyph, options = {}) {
  ...
  coreSetButtonLabelWithIcon(button, '', glyph || ICON_GLYPHS.add);
...
function createContactCard(contact) {
  ...
  coreSetButtonLabelWithIcon(useButton, getContactsText('useInProject', 'Add to project crew'), ICON_GLYPHS.add);
  ...
  coreSetButtonLabelWithIcon(deleteButton, getContactsText('deleteContact', 'Delete contact'), ICON_GLYPHS.trash);
...
function createCrewRow(data = {}) {
  ...
  coreSetButtonLabelWithIcon(saveContactBtn, getContactsText('saveContact', 'Save to contacts'), ICON_GLYPHS.save);
  ...
  coreSetButtonLabelWithIcon(manageContactsBtn, getContactsText('openManager', 'Open contacts'), ICON_GLYPHS.gears);
...
function applyInstallTexts(lang) {
  ...
  if (installPromptBannerDismiss) {
    ...
    if (typeof coreSetButtonLabelWithIcon === 'function') {
      coreSetButtonLabelWithIcon(installPromptBannerDismiss, '', ICON_GLYPHS.circleX);
    }
  ...
  if (installGuideClose) {
    if (closeLabel && typeof coreSetButtonLabelWithIcon === 'function') {
      coreSetButtonLabelWithIcon(installGuideClose, closeLabel, ICON_GLYPHS.circleX);
...
function configureAutoGearConditionButtons() {
  ...
  AUTO_GEAR_CONDITION_KEYS.forEach(key => {
    ...
    if (config.addShortcut) {
      coreSetButtonLabelWithIcon(config.addShortcut, '', ICON_GLYPHS.add);
    ...
    if (config.removeButton) {
      coreSetButtonLabelWithIcon(config.removeButton, '', ICON_GLYPHS.minus);
