...
var CORE_RUNTIME_CANDIDATE_SCOPE_LIST = (function initialiseCoreRuntimeCandidateScopes() {
  var primaryScope =
  ...
  if (publishScope && typeof publishScope === 'object') {
    try {
...
const CORE_RUNTIME_STATE = ensureCoreGlobalValue('__cineRuntimeState', () => {
  const candidateScopes = CORE_RUNTIME_CANDIDATE_SCOPE_LIST.length
