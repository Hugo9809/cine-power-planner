...
export const data = {
  "texts": {
    ...
    "v2HelpTopics": {
      "dataProtection": {
        "title": "Salvataggio, condivisione e protezione offline",
        "keywords": "salvataggio salvataggio manuale salvataggio automatico backup automatici esporta condividi importa backup ripristino prova offline sicurezza integrità dati",
        "content": "<p>Usa questa guida per mantenere sicura ogni copia offline.</p>\n\n<h4>Salvataggio, salvataggio automatico, backup automatici</h4>\n<ul>\n<li><strong>Salva</strong> (Ctrl/⌘+S) crea un nuovo snapshot con data e ora; non sovrascrive un altro progetto senza conferma.</li>\n<li><strong>Salvataggio automatico</strong> cattura snapshot continui mentre lavori per poter tornare indietro dopo chiusure inattese.</li>\n<li><strong>Backup automatici</strong> creano snapshot in background. Attiva <strong>Mostra backup automatici nella lista progetti</strong> in Impostazioni → Backup e Ripristino per vederli.</li>\n</ul>\n\n<h4>Esporta, condividi, importa</h4>\n<ul>\n<li><strong>Esporta progetto</strong> scarica una copia di sicurezza JSON per l'archiviazione offline.</li>\n<li><strong>Condividi progetto</strong> prepara un file di consegna; i destinatari lo aprono con <strong>Importa progetto</strong>.</li>\n<li>Le importazioni si caricano nell'area di lavoro senza sovrascrivere i progetti salvati. Se il nome è in conflitto, devi confermare la sovrascrittura o salvare con un nuovo nome.</li>\n</ul>\n\n<h4>Backup, ripristino e prova</h4>\n<ul>\n<li><strong>Scarica Backup</strong> crea un backup completo dell'app (progetti, attrezzatura, regole, preferenze).</li>\n<li><strong>Ripristina</strong> sostituisce i dati locali solo dopo aver creato uno snapshot di sicurezza.</li>\n<li><strong>Ripristino di Prova</strong> apre un confronto in sandbox per verificare le differenze prima della promozione.</li>\n</ul>\n\n<h4>Garanzie di integrità offline</h4>\n<ul>\n<li>Tutti i salvataggi, export e backup restano su questo dispositivo; l'app funziona senza rete.</li>\n<li>Il salvataggio sicuro mantiene snapshot con data e ora e le azioni distruttive creano uno snapshot di backup prima dell'eliminazione quando possibile.</li>\n<li>Conserva almeno due copie offline di export o backup prima di eliminare qualcosa.</li>\n</ul>"
      }
    },
