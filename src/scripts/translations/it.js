...
export const data = {
  "texts": {
    ...
    "themeVariantLabel": "Tema",
    "themeVariantHelp": "Passa tra tema chiaro, scuro, rosa chiaro e rosa scuro.",
    "themeVariantLight": "Chiaro",
    "themeVariantDark": "Scuro",
    "themeVariantPinkLight": "Rosa chiaro",
    "themeVariantPinkDark": "Rosa scuro",
    ...
    "deleteGearListDialogTitle": "Elimina elenco attrezzatura",
    "deleteGearListConfirmLabel": "Elimina",
    "confirmDeleteGearList": "Eliminare elenco attrezzatura?",
    "deleteGearListConfirmAgainTitle": "Sei sicuro?",
    "deleteGearListConfirmAgainLabel": "Conferma eliminazione",
    ...
    "helpGroupEssentials": "Essenziali",
    "helpGroupGuides": "Guide",
    "helpGroupReference": "Riferimento argomenti",
    ...
    "helpV2WelcomeContent": "<p>Benvenuto nella nuova interfaccia Cine Power Planner V2! Abbiamo riprogettato l’esperienza per essere più veloce, intuitiva e completamente responsive.</p>\n<h4>Migliorie principali</h4>\n<ul>\n<li><strong>Nuova navigazione laterale:</strong> Accedi rapidamente a Progetti, Strumenti e Impostazioni dalla barra laterale dedicata. Su mobile usa il pulsante menu nell’intestazione.</li>\n<li><strong>Visual migliorati:</strong> Un look moderno e pulito con supporto migliorato per Dark Mode e Pink Mode.</li>\n<li><strong>Prestazioni migliori:</strong> Tempi di caricamento più rapidi e transizioni più fluide tra le viste.</li>\n</ul>\n<h4>Orientamento</h4>\n<p>La barra laterale è il tuo centro di controllo:</p>\n<ul>\n<li><strong>Progetti:</strong> Visualizza e gestisci tutti i piani di alimentazione. Filtra per Attivi o Archivio.</li>\n<li><strong>Strumenti:</strong> Accedi alla Libreria dispositivi, Contatti e Regole Auto Gear.</li>\n<li><strong>Impostazioni:</strong> Configura preferenze, esegui backup e gestisci l’archiviazione.</li>\n</ul>",
    "helpV2ProjectsTitle": "Gestire i progetti",
    "helpV2ProjectsKeywords": "progetti crea nuovo elimina archivio filtra attivi dashboard",
    "helpV2ProjectsContent": "<p>La dashboard Progetti è il punto di partenza del tuo lavoro.</p>\n<h4>Creare un progetto</h4>\n<p>Fai clic sul pulsante <strong>+ Nuovo progetto</strong> in alto a destra per iniziare un nuovo piano. Ti verrà richiesto un nome e dettagli opzionali.</p>\n<h4>Stato e filtri</h4>\n<p>Usa la barra laterale per filtrare i tuoi progetti:</p>\n<ul>\n<li><strong>Tutti i progetti:</strong> Tutto ciò che hai creato.</li>\n<li><strong>Progetti attivi:</strong> Progetti su cui stai lavorando.</li>\n<li><strong>Archivio:</strong> Progetti completati o in pausa. Puoi archiviare un progetto dal menu contestuale.</li>\n</ul>\n<h4>Azioni progetto</h4>\n<p>Fai clic con il tasto destro (o pressione prolungata su touchscreen) su una scheda progetto per aprire il menu contestuale:</p>\n<ul>\n<li><strong>Rinomina:</strong> Modifica i dettagli del progetto.</li>\n<li><strong>Duplica:</strong> Crea una copia esatta del progetto.</li>\n<li><strong>Archivia/Ripristina:</strong> Sposta il progetto nell’archivio o riportalo indietro.</li>\n<li><strong>Elimina:</strong> Rimuovi definitivamente il progetto.</li>\n</ul>",
    "helpV2SidebarSearchTitle": "Ricerca nella barra laterale",
    "helpV2SidebarSearchKeywords": "ricerca barra laterale funzioni dispositivi azioni aiuto tastiera offline",
    "helpV2SidebarSearchContent": "<p>La ricerca nella barra laterale funziona completamente offline e combina funzioni, dispositivi, azioni e temi di aiuto in un’unica lista veloce.</p>\n<h4>Cosa copre</h4>\n<ul>\n<li><strong>Funzioni:</strong> Vai direttamente a input, sezioni e finestre.</li>\n<li><strong>Dispositivi:</strong> Cerca nel catalogo locale e apri la corrispondenza.</li>\n<li><strong>Azioni:</strong> Attiva comandi rapidi come Salva, Esporta o Impostazioni.</li>\n<li><strong>Aiuto:</strong> Apri l’argomento più rilevante senza lasciare il planner.</li>\n</ul>\n<h4>Navigazione da tastiera</h4>\n<ul>\n<li><strong>Frecce:</strong> Scorri i suggerimenti.</li>\n<li><strong>Invio:</strong> Attiva il risultato evidenziato.</li>\n<li><strong>Esc:</strong> Pulisci la ricerca e chiudi l’elenco.</li>\n</ul>",
    "helpV2DeviceLibraryTitle": "Libreria dispositivi",
    "helpV2DeviceLibraryKeywords": "dispositivi libreria attrezzatura gear personalizzato aggiungi modifica database",
    "helpV2DeviceLibraryContent": "<p>La Libreria dispositivi ti permette di gestire l’attrezzatura disponibile per i tuoi piani di alimentazione.</p>\n<h4>Esplorare i dispositivi</h4>\n<p>I dispositivi sono organizzati per categoria (Camere, Monitor, ecc.). Usa schede o menu a tendina per cambiare categoria. Puoi anche usare la barra di ricerca per trovare l’attrezzatura subito.</p>\n<h4>Aggiungere gear personalizzato</h4>\n<p>Non trovi la tua attrezzatura? Fai clic su <strong>Aggiungi dispositivo</strong> per creare una voce personalizzata. Dovrai specificare:</p>\n<ul>\n<li><strong>Nome:</strong> Il modello.</li>\n<li><strong>Assorbimento:</strong> Consumo tipico in watt (W).</li>\n<li><strong>Voltaggio:</strong> Intervallo di tensione (opzionale ma consigliato).</li>\n</ul>\n<p>Dopo l’aggiunta, i dispositivi personalizzati sono disponibili per tutti i progetti.</p>",
    "helpV2ContactsTitle": "Contatti",
    "helpV2ContactsKeywords": "contatti persone troupe noleggi lista",
    "helpV2ContactsContent": "<p>Tieni traccia di noleggi, membri della troupe e clienti direttamente nell’app.</p>\n<h4>Gestire i contatti</h4>\n<ul>\n<li><strong>Aggiungi contatto:</strong> Fai clic su <strong>Nuovo contatto</strong> per aggiungere Nome, Ruolo, Telefono ed Email.</li>\n<li><strong>Modifica/Elimina:</strong> Usa i pulsanti di azione su ogni scheda contatto.</li>\n</ul>\n<p>I contatti possono essere assegnati ai progetti per riferimenti rapidi (presto nei dettagli progetto).</p>",
    "helpV2SettingsTitle": "Impostazioni e dati",
    "helpV2SettingsKeywords": "impostazioni preferenze backup ripristino dati archiviazione tema lingua",
    "helpV2SettingsContent": "<p>Personalizza la tua esperienza e mantieni i dati al sicuro.</p>\n<h4>Gestione dati</h4>\n<ul>\n<li><strong>Backup:</strong> Scarica un backup completo di tutti i progetti e dei dispositivi personalizzati. Consigliamo di farlo regolarmente.</li>\n<li><strong>Ripristino:</strong> Carica un file di backup salvato. <em>Nota: sostituisce i dati correnti.</em></li>\n<li><strong>Auto-Backups:</strong> Abilita snapshot automatici per proteggerti da perdite accidentali.</li>\n</ul>\n<h4>Preferenze</h4>\n<ul>\n<li><strong>Unità:</strong> Alterna tra unità metriche e imperiali (se applicabile).</li>\n<li><strong>Tema:</strong> Forza Dark Mode, Light Mode o Pink Mode.</li>\n</ul>",
    "helpV2SaveShareBackupTitle": "Salvataggio, condivisione e ripristino sicuri",
    "helpV2SaveShareBackupKeywords": "salva manuale autosave auto backup condividi esporta importa json ripristino prova offline sicurezza istantanea",
    "helpV2SaveShareBackupContent": "<p>Ogni salvataggio, esportazione e backup resta su questo dispositivo per mantenere i dati privati e completamente offline.</p>\n<h4>Livelli di salvataggio</h4>\n<ul>\n<li><strong>Salvataggio manuale:</strong> Usa <strong>Salva</strong> nell’intestazione del progetto (o <kbd>Ctrl</kbd>/<kbd>⌘</kbd>+<kbd>S</kbd>) per creare uno snapshot nominato nella libreria locale.</li>\n<li><strong>Autosave:</strong> Durante la modifica, lo stato di autosave nell’intestazione si aggiorna in background così le ultime modifiche restano recuperabili.</li>\n<li><strong>Backup automatici:</strong> Ogni salvataggio manuale mette in coda uno snapshot con timestamp. Attiva <strong>Mostra backup automatici nella lista progetti</strong> in <em>Impostazioni → Backup e Ripristino</em> per visualizzarli e nota che viene creato uno snapshot di sicurezza prima delle azioni distruttive.</li>\n</ul>\n<h4>Esporta e importa (JSON)</h4>\n<ul>\n<li><strong>Esporta progetto:</strong> Nel progetto, scegli <strong>Esporta progetto</strong> per scaricare un file JSON per la condivisione offline.</li>\n<li><strong>Importa progetto:</strong> Dal dashboard Progetti, fai clic su <strong>Importa progetto</strong> e seleziona il JSON. Il progetto si apre nell’editor; nulla sostituisce i dati salvati finché non premi <strong>Salva</strong>.</li>\n<li><strong>Gestione conflitti:</strong> Se le regole Auto Gear condivise differiscono, il dialogo di importazione chiede se applicarle solo a questo progetto o globalmente. Se il nome del progetto esiste già, rinomina prima di salvare per evitare sovrascritture.</li>\n</ul>\n<h4>Backup completo e ripristino</h4>\n<ul>\n<li><strong>Scarica Backup:</strong> <em>Impostazioni → Backup e Ripristino → Scarica Backup</em> salva progetti, dispositivi, regole e preferenze.</li>\n<li><strong>Scarica Backup Completo:</strong> <em>Impostazioni → Dati e Archiviazione → Scarica Backup Completo</em> crea una copia di archivio per la rotazione.</li>\n<li><strong>Ripristina:</strong> <em>Impostazioni → Backup e Ripristino → Ripristina</em> carica un backup e crea prima uno snapshot di sicurezza per poter tornare indietro.</li>\n<li><strong>Ripristino di Prova:</strong> Usa <strong>Ripristino di Prova</strong> per provare un ripristino in un ambiente sicuro prima di confermare.</li>\n</ul>\n<h4>Garanzie di integrità offline</h4>\n<ul>\n<li><strong>Offline-first:</strong> Salvataggi, esportazioni, backup e importazioni non escono mai da questo dispositivo.</li>\n<li><strong>Safe-save:</strong> Le scritture sono protette così i salvataggi parziali non sostituiscono i dati validi.</li>\n<li><strong>Backup prima dell’eliminazione:</strong> Eliminazioni o reset acquisiscono prima uno snapshot di sicurezza.</li>\n</ul>",
    "helpV2AutoGearTitle": "Regole Auto Gear",
    "helpV2AutoGearKeywords": "auto gear regole automazione lista kit scenari requisiti produzione",
    "helpV2AutoGearContent": "<p>Automatizza la generazione della lista kit con regole intelligenti basate su scenari di produzione.</p>\n<h4>Come funziona</h4>\n<p>Le regole Auto Gear monitorano i <strong>Requisiti di produzione</strong> del progetto (es. \"Handheld\", \"Studio\", \"Car Rig\") e aggiungono o rimuovono automaticamente elementi dalla lista kit.</p>\n<h4>Creare regole</h4>\n<p>Vai su <strong>Regole Auto Gear</strong> e fai clic su <strong>Aggiungi regola</strong>. Puoi definire:</p>\n<ul>\n<li><strong>Condizioni:</strong> Trigger basati su scenari, modelli di camera o altre selezioni di gear.</li>\n<li><strong>Azioni:</strong> Elementi da <strong>Aggiungere</strong> (es. \"Shoulder Pad\" per \"Handheld\") o <strong>Rimuovere</strong>.</li>\n</ul>\n<h4>Preset</h4>\n<p>Salva i tuoi set di regole preferiti come <strong>Preset</strong> per passare velocemente tra diversi stili di produzione (es. \"Narrative Feature\" vs \"Commercial\").</p>",
    "helpV2PrintExportTitle": "Stampa ed esportazione",
    "helpV2PrintExportKeywords": "stampa pdf esporta condividi report lista kit diagramma",
    "helpV2PrintExportContent": "<p>Condividi i tuoi piani di alimentazione con il team o la casa di noleggio.</p>\n<h4>Panoramica progetto</h4>\n<p>Dalla vista dettaglio progetto, usa il pulsante <strong>Print / Export PDF</strong> per generare un riepilogo pulito con totali di potenza e stime batterie.</p>\n<h4>Lista kit</h4>\n<p>Genera una lista attrezzatura dedicata per preventivi e preparazione. Puoi filtrare per reparto e personalizzare le colonne prima della stampa.</p>\n<h4>Diagramma di alimentazione</h4>\n<p>Serve un supporto visivo? Esporta il <strong>Connection Diagram</strong> come immagine (PNG/JPG) o SVG per il tuo tech pack.</p>\n<h4>Consigli PDF</h4>\n<p>Per salvare come PDF, fai clic su \"Print\" e seleziona <strong>\"Save as PDF\"</strong> come destinazione nella finestra di stampa.</p>",
    "helpV2QuickStartTitle": "Checklist di avvio rapido",
...
<p class="help-callout-note">Suggerimento: esegui <strong>Ripristino di Prova</strong> dopo i traguardi principali per verificare il backup completamente offline.</p>`,
    ...
    "helpV2FeaturesTitle": "Funzionalità in sintesi",
    "helpV2FeaturesKeywords": "panoramica funzionalità evidenza offline preferiti ricerca",
    "helpV2FeaturesContent": "<ul>\n<li><strong>Pianificazione rig:</strong> Configura camere, monitor e accessori in <em>Configura dispositivi</em>.</li>\n<li><strong>Analisi potenza:</strong> Controlla assorbimento e autonomia in <em>Power Summary</em>.</li>\n<li><strong>Diagramma visivo:</strong> Mappa le connessioni con il <em>Connection Diagram</em> interattivo.</li>\n<li><strong>Confronto batterie:</strong> Confronta autonomie e limiti di uscita.</li>\n<li><strong>Libreria dispositivi:</strong> Personalizza il database con il tuo gear.</li>\n<li><strong>Contatti e gear personale:</strong> Gestisci info della troupe e kit personali.</li>\n<li><strong>Stampa ed esportazione:</strong> Genera riepiloghi PDF puliti e liste kit.</li>\n<li><strong>Offline:</strong> Funziona completamente senza connessione a internet.</li>\n<li><strong>Personalizzabile:</strong> Regola temi (Scuro, Chiaro, Rosa), font e colori di accento.</li>\n</ul>",
    "helpTopics": {
      "projectManagement": {
    ...
    "backupVaultHeading": "Archivio dati (backup)",
    "backupVaultLoading": "Caricamento dei backup…",
    "backupVaultEmptyTitle": "Nessun backup trovato nell'archivio.",
    "backupVaultEmptySubtitle": "I backup vengono creati automaticamente quando salvi i progetti.",
    "backupVaultLoadError": "Impossibile caricare i backup: {message}",
    "backupVaultLoadErrorFallback": "Impossibile caricare i backup.",
    "backupVaultRestoreAriaLabel": "Ripristina {name}",
    "backupVaultDeleteAriaLabel": "Elimina {name}",
    "backupVaultRestoreConfirm": "Ripristinare {name}? Questo sovrascriverà i dati attuali.",
    "backupVaultUnknownFormat": "Formato di backup sconosciuto.",
    "backupVaultRestoreSuccess": "Progetto ripristinato con successo!",
    "backupVaultRestoreLocked": "Questo progetto è bloccato da un'altra sessione.",
    "backupVaultRestoreUnknownError": "Errore sconosciuto.",
    "backupVaultRestoreFailed": "Ripristino non riuscito. {reason}",
    "backupVaultRestoreError": "Impossibile ripristinare: {message}",
    "backupVaultDeleteConfirm": "Eliminare {name}?",
    "backupVaultDeleteError": "Impossibile eliminare il backup: {message}",
    "backupVaultDeleteErrorFallback": "Impossibile eliminare il backup.",
