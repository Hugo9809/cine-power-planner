...
export const data = {
  "texts": {
    ...
    "v2HelpTopics": {
      "dataProtection": {
        "title": "Speichern, Teilen & Offline-Schutz",
        "keywords": "speichern manuelles speichern autospeichern automatische sicherungen export teilen import backup wiederherstellung probe offline sicherheit datenintegrität",
        "content": "<p>Nutze diesen Leitfaden, damit jede Offline-Kopie sicher bleibt.</p>\n\n<h4>Speichern, Autospeichern, automatische Sicherungen</h4>\n<ul>\n<li><strong>Speichern</strong> (Strg/⌘+S) erstellt einen neuen, zeitgestempelten Projektschnappschuss; nichts wird ohne Bestätigung überschrieben.</li>\n<li><strong>Autospeichern</strong> legt fortlaufende Schnappschüsse an, damit du nach unerwartetem Schließen zurückrollen kannst.</li>\n<li><strong>Automatische Sicherungen</strong> erstellen Hintergrund-Snapshots. Aktiviere <strong>Automatische Sicherungen in Projektliste anzeigen</strong> in Einstellungen → Sicherung &amp; Wiederherstellung, um sie zu sehen.</li>\n</ul>\n\n<h4>Exportieren, teilen, importieren</h4>\n<ul>\n<li><strong>Projekt exportieren</strong> lädt eine JSON-Sicherheitskopie für die Offline-Ablage herunter.</li>\n<li><strong>Projekt teilen</strong> erstellt eine Übergabedatei; Empfänger öffnen sie mit <strong>Projekt importieren</strong>.</li>\n<li>Importe laden in den Arbeitsbereich, ohne gespeicherte Projekte zu überschreiben. Bei Namenskonflikten musst du das Überschreiben bestätigen oder unter neuem Namen speichern.</li>\n</ul>\n\n<h4>Backup, Wiederherstellen &amp; Probe</h4>\n<ul>\n<li><strong>Sicherung herunterladen</strong> erstellt ein vollständiges App-Backup (Projekte, Geräte, Regeln, Einstellungen).</li>\n<li><strong>Wiederherstellen</strong> ersetzt lokale Daten erst, nachdem ein Sicherheits-Snapshot erstellt wurde.</li>\n<li><strong>Probe-Wiederherstellung</strong> öffnet einen Sandbox-Vergleich, damit du Unterschiede vor der Übernahme prüfen kannst.</li>\n</ul>\n\n<h4>Offline-Integrität</h4>\n<ul>\n<li>Alle Saves, Exporte und Sicherungen bleiben auf diesem Gerät; die App funktioniert ohne Netzwerk.</li>\n<li>Sicheres Speichern hält zeitgestempelte Snapshots, und destruktive Aktionen erstellen nach Möglichkeit einen Backup-vor-Löschen-Snapshot.</li>\n<li>Bewahre mindestens zwei Offline-Kopien von Exporten oder Backups auf, bevor du etwas löschst.</li>\n</ul>"
      }
    },
