...
export const data = {
  "texts": {
    ...
    "themeVariantLabel": "Design",
    "themeVariantHelp": "Wechsle zwischen hellem, dunklem, pink-hellem und pink-dunklem Design.",
    "themeVariantLight": "Hell",
    "themeVariantDark": "Dunkel",
    "themeVariantPinkLight": "Pink hell",
    "themeVariantPinkDark": "Pink dunkel",
    ...
    "featureSearchPlaceholder": "Funktionen, Geräte, Aktionen oder Hilfe durchsuchen...",
    "featureSearchLabel": "Funktionen, Geräte, Aktionen und Hilfe durchsuchen",
    ...
    "deleteGearListDialogTitle": "Kit-Liste löschen",
    "deleteGearListConfirmLabel": "Löschen",
    "confirmDeleteGearList": "Kit-Liste löschen?",
    "deleteGearListConfirmAgainTitle": "Bist du sicher?",
    "deleteGearListConfirmAgainLabel": "Löschen bestätigen",
    ...
    "helpGroupEssentials": "Grundlagen",
    "helpGroupGuides": "Leitfäden",
    "helpGroupReference": "Themenreferenz",
    ...
    "helpV2WelcomeContent": "<p>Willkommen in der neuen Cine Power Planner V2-Oberfläche! Wir haben das Erlebnis schneller, intuitiver und vollständig responsiv gestaltet.</p>\n<h4>Wichtige Verbesserungen</h4>\n<ul>\n<li><strong>Neue Seitenleisten-Navigation:</strong> Greife schnell auf Projekte, Tools und Einstellungen in der eigenen Seitenleiste zu. Mobile Nutzer erreichen sie über die Menü-Schaltfläche im Header.</li>\n<li><strong>Verbesserte Optik:</strong> Ein moderner, klarer Look mit optimiertem Dark Mode und Pink Mode.</li>\n<li><strong>Mehr Leistung:</strong> Schnellere Ladezeiten und weichere Übergänge zwischen Ansichten.</li>\n</ul>\n<h4>Orientierung</h4>\n<p>Die Seitenleiste ist dein Haupt-Kontrollzentrum:</p>\n<ul>\n<li><strong>Projekte:</strong> Verwalte alle deine Power-Pläne. Filtere nach Aktiv oder Archiv.</li>\n<li><strong>Tools:</strong> Öffne Gerätebibliothek, Kontakte und Auto-Gear-Regeln.</li>\n<li><strong>Einstellungen:</strong> Passe App-Präferenzen an, sichere Daten und verwalte den Speicher.</li>\n</ul>",
    "helpV2ProjectsTitle": "Projekte verwalten",
    "helpV2ProjectsKeywords": "projekte erstellen neu löschen archiv filter aktiv dashboard",
    "helpV2ProjectsContent": "<p>Das Projekt-Dashboard ist der Startpunkt deiner Arbeit.</p>\n<h4>Projekt erstellen</h4>\n<p>Klicke oben rechts auf <strong>+ Neues Projekt</strong>, um einen neuen Plan zu starten. Du wirst nach einem Namen und optionalen Details gefragt.</p>\n<h4>Projektstatus & Filter</h4>\n<p>Nutze die Seitenleiste, um deine Projekte zu filtern:</p>\n<ul>\n<li><strong>Alle Projekte:</strong> Alles, was du erstellt hast.</li>\n<li><strong>Aktive Projekte:</strong> Projekte, an denen du aktuell arbeitest.</li>\n<li><strong>Archiv:</strong> Abgeschlossene oder pausierte Projekte. Du kannst ein Projekt über das Kontextmenü archivieren.</li>\n</ul>\n<h4>Projektaktionen</h4>\n<p>Klicke mit der rechten Maustaste (oder halte auf Touch-Geräten gedrückt) auf eine Projektkarte, um das Kontextmenü zu öffnen:</p>\n<ul>\n<li><strong>Umbenennen:</strong> Projektdetails ändern.</li>\n<li><strong>Duplizieren:</strong> Eine exakte Kopie erstellen.</li>\n<li><strong>Archivieren/Entarchivieren:</strong> Projekte ins Archiv verschieben oder zurückholen.</li>\n<li><strong>Löschen:</strong> Ein Projekt dauerhaft entfernen.</li>\n</ul>",
    "helpV2SidebarSearchTitle": "Seitenleisten-Suche",
    "helpV2SidebarSearchKeywords": "suche seitenleiste funktionen geräte aktionen hilfe tastatur offline",
    "helpV2SidebarSearchContent": "<p>Die Seitenleisten-Suche läuft komplett offline und bündelt Funktionen, Geräte, Aktionen und Hilfethemen in einer schnellen Liste.</p>\n<h4>Was enthalten ist</h4>\n<ul>\n<li><strong>Funktionen:</strong> Springe direkt zu Eingaben, Bereichen und Dialogen.</li>\n<li><strong>Geräte:</strong> Durchsuche den lokalen Gerätekatalog und öffne den passenden Eintrag.</li>\n<li><strong>Aktionen:</strong> Starte Schnellbefehle wie Speichern, Exportieren oder Einstellungen.</li>\n<li><strong>Hilfe:</strong> Öffne das relevanteste Hilfethema, ohne den Planner zu verlassen.</li>\n</ul>\n<h4>Tastaturnavigation</h4>\n<ul>\n<li><strong>Pfeiltasten:</strong> Durch Vorschläge navigieren.</li>\n<li><strong>Enter:</strong> Hervorgehobenes Ergebnis öffnen.</li>\n<li><strong>Esc:</strong> Suchbegriff löschen und Liste schließen.</li>\n</ul>",
    "helpV2DeviceLibraryTitle": "Gerätebibliothek",
    "helpV2DeviceLibraryKeywords": "geräte bibliothek ausrüstung eigenes gear hinzufügen bearbeiten datenbank",
    "helpV2DeviceLibraryContent": "<p>Die Gerätebibliothek hilft dir, die Ausrüstung für deine Power-Pläne zu verwalten.</p>\n<h4>Geräte durchsuchen</h4>\n<p>Geräte sind nach Kategorie organisiert (Kameras, Monitore usw.). Wechsle per Tabs oder Dropdowns zwischen Kategorien. Du kannst auch die Suchleiste nutzen, um Ausrüstung sofort zu finden.</p>\n<h4>Eigenes Gear hinzufügen</h4>\n<p>Deine Ausrüstung fehlt? Klicke auf <strong>Gerät hinzufügen</strong>, um einen eigenen Eintrag zu erstellen. Du gibst an:</p>\n<ul>\n<li><strong>Name:</strong> Modellbezeichnung.</li>\n<li><strong>Leistungsaufnahme:</strong> Typischer Verbrauch in Watt (W).</li>\n<li><strong>Spannung:</strong> Spannungsbereich (optional, aber empfohlen).</li>\n</ul>\n<p>Nach dem Hinzufügen sind eigene Geräte in allen Projekten verfügbar.</p>",
    "helpV2ContactsTitle": "Kontakte",
    "helpV2ContactsKeywords": "kontakte personen crew verleihfirmen liste",
    "helpV2ContactsContent": "<p>Behalte Verleihfirmen, Crew-Mitglieder und Kunden direkt in der App im Blick.</p>\n<h4>Kontakte verwalten</h4>\n<ul>\n<li><strong>Kontakt hinzufügen:</strong> Klicke auf <strong>Neuer Kontakt</strong>, um Name, Rolle, Telefon und E-Mail zu speichern.</li>\n<li><strong>Bearbeiten/Löschen:</strong> Nutze die Aktionsschaltflächen auf jeder Kontaktkarte.</li>\n</ul>\n<p>Kontakte können Projekten zugewiesen werden (kommt bald in den Projektdetails).</p>",
    "helpV2SettingsTitle": "Einstellungen & Daten",
    "helpV2SettingsKeywords": "einstellungen präferenzen backup wiederherstellung daten speicher thema sprache",
    "helpV2SettingsContent": "<p>Passe dein Erlebnis an und halte deine Daten sicher.</p>\n<h4>Datenverwaltung</h4>\n<ul>\n<li><strong>Backup:</strong> Lade eine vollständige Sicherung aller Projekte und eigenen Geräte herunter. Das empfehlen wir regelmäßig.</li>\n<li><strong>Wiederherstellen:</strong> Lade eine gespeicherte Sicherungsdatei. <em>Hinweis: Dies ersetzt die aktuellen Daten.</em></li>\n<li><strong>Auto-Backups:</strong> Aktiviere automatische Snapshots, um Datenverlust vorzubeugen.</li>\n</ul>\n<h4>Präferenzen</h4>\n<ul>\n<li><strong>Einheiten:</strong> Zwischen metrischen und imperialen Einheiten umschalten (falls verfügbar).</li>\n<li><strong>Design:</strong> Dark Mode, Light Mode oder den Pink Mode erzwingen.</li>\n</ul>",
    "helpV2SaveShareBackupTitle": "Speichern, Teilen & Wiederherstellungs-Sicherheit",
    "helpV2SaveShareBackupKeywords": "speichern manuell autosave auto backup teilen export import json wiederherstellen probe offline sicherheit snapshot",
    "helpV2SaveShareBackupContent": "<p>Jeder Speicher-, Export- und Sicherungsschritt bleibt auf diesem Gerät, damit deine Daten privat und vollständig offline bleiben.</p>\n<h4>Speicher-Ebenen</h4>\n<ul>\n<li><strong>Manuelles Speichern:</strong> Verwende <strong>Speichern</strong> im Projekt-Header (oder <kbd>Ctrl</kbd>/<kbd>⌘</kbd>+<kbd>S</kbd>), um einen benannten Snapshot in deiner lokalen Projektbibliothek zu sichern.</li>\n<li><strong>Autosave:</strong> Während der Bearbeitung aktualisiert sich der Autosave-Status im Header im Hintergrund, sodass die neuesten Änderungen wiederherstellbar bleiben.</li>\n<li><strong>Auto-Backups:</strong> Jeder manuelle Speichervorgang stellt einen zeitgestempelten Snapshot in die Warteschlange. Aktiviere <strong>Automatische Sicherungen in Projektliste anzeigen</strong> in <em>Einstellungen → Sicherung & Wiederherstellung</em>, um sie anzuzeigen, und beachte, dass vor destruktiven Aktionen ein Sicherheitssnapshot erstellt wird.</li>\n</ul>\n<h4>Export & Import (JSON)</h4>\n<ul>\n<li><strong>Projekt exportieren:</strong> Im Projekt <strong>Projekt exportieren</strong> wählen, um eine JSON-Datei für das Offline-Teilen herunterzuladen.</li>\n<li><strong>Projekt importieren:</strong> Im Projekt-Dashboard auf <strong>Projekt importieren</strong> klicken und die JSON-Datei auswählen. Das Projekt öffnet sich im Editor; nichts ersetzt deine gespeicherten Daten, bis du <strong>Speichern</strong> bestätigst.</li>\n<li><strong>Konfliktbehandlung:</strong> Wenn geteilte Auto-Gear-Regeln abweichen, fragt der Importdialog, ob sie nur für dieses Projekt oder global gelten sollen. Wenn der Projektname bereits existiert, benenne vor dem Speichern um, um Überschreiben zu vermeiden.</li>\n</ul>\n<h4>Vollständige Sicherung & Wiederherstellung</h4>\n<ul>\n<li><strong>Sicherung herunterladen:</strong> <em>Einstellungen → Sicherung & Wiederherstellung → Sicherung herunterladen</em> speichert Projekte, Geräte, Regeln und Einstellungen.</li>\n<li><strong>Vollständige Sicherung herunterladen:</strong> <em>Einstellungen → Daten & Speicher → Vollständige Sicherung herunterladen</em> erstellt eine Archivkopie für Rotationen.</li>\n<li><strong>Wiederherstellen:</strong> <em>Einstellungen → Sicherung & Wiederherstellung → Wiederherstellen</em> lädt eine Sicherungsdatei und erstellt vorher einen Sicherheitssnapshot, damit du zurückrollen kannst.</li>\n<li><strong>Probe-Wiederherstellung:</strong> Verwende <strong>Probe-Wiederherstellung</strong>, um eine Wiederherstellung in einer sicheren Sandbox zu testen, bevor du sie bestätigst.</li>\n</ul>\n<h4>Offline-Integrität</h4>\n<ul>\n<li><strong>Offline-first:</strong> Speicherungen, Exporte, Sicherungen und Importe verlassen dieses Gerät nie.</li>\n<li><strong>Safe-save:</strong> Schreibvorgänge sind geschützt, sodass unvollständige Speicherungen keine guten Daten ersetzen.</li>\n<li><strong>Backup vor dem Löschen:</strong> Löschen oder Zurücksetzen erstellt zuerst einen Sicherheitssnapshot.</li>\n</ul>",
    "helpV2AutoGearTitle": "Auto-Gear-Regeln",
    "helpV2AutoGearKeywords": "auto gear regeln automatisierung kitliste szenarien produktionsanforderungen",
    "helpV2AutoGearContent": "<p>Automatisiere die Kitlisten-Erstellung mit smarten Regeln basierend auf Produktionsszenarien.</p>\n<h4>So funktioniert es</h4>\n<p>Auto-Gear-Regeln überwachen die <strong>Produktionsanforderungen</strong> deines Projekts (z. B. \"Handheld\", \"Studio\", \"Car Rig\") und fügen automatisch passende Elemente zur Kitliste hinzu oder entfernen sie.</p>\n<h4>Regeln erstellen</h4>\n<p>Öffne <strong>Auto-Gear-Regeln</strong> und klicke auf <strong>Regel hinzufügen</strong>. Du kannst definieren:</p>\n<ul>\n<li><strong>Bedingungen:</strong> Auslöser basierend auf Szenarien, Kameramodellen oder anderem Gear.</li>\n<li><strong>Aktionen:</strong> Elemente zum <strong>Hinzufügen</strong> (z. B. \"Shoulder Pad\" für \"Handheld\") oder <strong>Entfernen</strong>.</li>\n</ul>\n<h4>Presets</h4>\n<p>Speichere Lieblings-Regelsätze als <strong>Presets</strong>, um schnell zwischen Produktionsstilen zu wechseln (z. B. \"Narrative Feature\" vs. \"Commercial\").</p>",
    "helpV2PrintExportTitle": "Drucken & Exportieren",
    "helpV2PrintExportKeywords": "druck pdf export teilen bericht kitliste diagramm",
    "helpV2PrintExportContent": "<p>Teile deine Power-Pläne mit deinem Team oder der Verleihfirma.</p>\n<h4>Projektübersicht</h4>\n<p>Im Projekt-Detail nutzt du <strong>Print / Export PDF</strong>, um eine saubere Zusammenfassung mit Leistungswerten und Batterie-Schätzungen zu erstellen.</p>\n<h4>Kitliste</h4>\n<p>Erzeuge eine eigene Ausrüstungsliste für Angebote und Prep. Du kannst nach Abteilung filtern und Spalten vor dem Drucken anpassen.</p>\n<h4>Power-Diagramm</h4>\n<p>Du brauchst eine visuelle Hilfe? Exportiere das <strong>Connection Diagram</strong> als Bild (PNG/JPG) oder SVG für dein Tech-Paket.</p>\n<h4>PDF-Tipps</h4>\n<p>Um als PDF zu speichern, klicke auf \"Print\" und wähle <strong>\"Save as PDF\"</strong> als Ziel im Druckdialog.</p>",
    "helpV2QuickStartTitle": "Schnellstart-Checkliste",
...
<p class="help-callout-note">Tipp: Führe die <strong>Probe-Wiederherstellung</strong> nach wichtigen Meilensteinen aus, um das Backup vollständig offline zu prüfen.</p>`,
    ...
    "helpV2FeaturesTitle": "Funktionen im Überblick",
    "helpV2FeaturesKeywords": "übersicht funktionen highlights offline favoriten suche",
    "helpV2FeaturesContent": "<ul>\n<li><strong>Rig-Planung:</strong> Konfiguriere Kameras, Monitore und Zubehör in <em>Geräte konfigurieren</em>.</li>\n<li><strong>Leistungsanalyse:</strong> Prüfe Verbrauch und Laufzeit in der <em>Power Summary</em>.</li>\n<li><strong>Visuelles Diagramm:</strong> Kartenverbindungen im interaktiven <em>Connection Diagram</em>.</li>\n<li><strong>Batterievergleich:</strong> Vergleiche Laufzeiten und Ausgangsgrenzen.</li>\n<li><strong>Gerätebibliothek:</strong> Passe die Datenbank mit eigenem Gear an.</li>\n<li><strong>Kontakte & Eigenes Gear:</strong> Verwalte Crew-Infos und persönliche Kits.</li>\n<li><strong>Print & Export:</strong> Erstelle saubere PDF-Zusammenfassungen und Kitlisten.</li>\n<li><strong>Offline-fähig:</strong> Funktioniert vollständig ohne Internetverbindung.</li>\n<li><strong>Anpassbar:</strong> Themes (Dark, Light, Pink), Schriftarten und Akzentfarben anpassen.</li>\n</ul>",
    "helpTopics": {
      "projectManagement": {
    ...
    "backupVaultHeading": "Datentresor (Backups)",
    "backupVaultLoading": "Backups werden geladen…",
    "backupVaultEmptyTitle": "Keine Backups im Tresor gefunden.",
    "backupVaultEmptySubtitle": "Backups werden automatisch erstellt, wenn du Projekte speicherst.",
    "backupVaultLoadError": "Backups konnten nicht geladen werden: {message}",
    "backupVaultLoadErrorFallback": "Backups konnten nicht geladen werden.",
    "backupVaultRestoreAriaLabel": "{name} wiederherstellen",
    "backupVaultDeleteAriaLabel": "{name} löschen",
    "backupVaultRestoreConfirm": "{name} wiederherstellen? Dadurch werden aktuelle Daten überschrieben.",
    "backupVaultUnknownFormat": "Unbekanntes Backup-Format.",
    "backupVaultRestoreSuccess": "Projekt erfolgreich wiederhergestellt!",
    "backupVaultRestoreLocked": "Dieses Projekt ist durch eine andere Sitzung gesperrt.",
    "backupVaultRestoreUnknownError": "Unbekannter Fehler.",
    "backupVaultRestoreFailed": "Wiederherstellung fehlgeschlagen. {reason}",
    "backupVaultRestoreError": "Wiederherstellung fehlgeschlagen: {message}",
    "backupVaultDeleteConfirm": "{name} löschen?",
    "backupVaultDeleteError": "Backup konnte nicht gelöscht werden: {message}",
    "backupVaultDeleteErrorFallback": "Backup konnte nicht gelöscht werden.",
    ...
    "v2": {
      ...
      "sidebar": {
        ...
        "search": {
          "placeholder": "Funktionen, Geräte, Aktionen suchen...",
          "label": "Funktionen, Geräte, Aktionen und Hilfe durchsuchen"
        }
      },
      "detail": {
