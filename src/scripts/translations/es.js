...
export const data = {
  "texts": {
    ...
    "themeVariantHelp": "Cambia entre temas claro, oscuro, rosa claro y rosa oscuro.",
    "themeVariantLight": "Claro",
    "themeVariantDark": "Oscuro",
    "themeVariantPinkLight": "Rosa claro",
    "themeVariantPinkDark": "Rosa oscuro",
    ...
    "featureSearchPlaceholder": "Buscar funciones, dispositivos, acciones o ayuda…",
    "featureSearchLabel": "Buscar funciones, dispositivos, acciones y ayuda",
    ...
    "deleteGearListDialogTitle": "Eliminar lista de kit",
    "deleteGearListConfirmLabel": "Eliminar",
    "confirmDeleteGearList": "¿Eliminar lista de kit?",
    "deleteGearListConfirmAgainTitle": "¿Estás seguro?",
    "deleteGearListConfirmAgainLabel": "Confirmar eliminación",
    ...
    "helpGroupEssentials": "Esenciales",
    "helpGroupGuides": "Guías",
    "helpGroupReference": "Referencia de temas",
    "helpServiceUnavailable": "Servicio de ayuda no disponible.",
    "helpSearchNoResultsTitle": "No se encontraron resultados",
    "helpSearchNoResultsHint": "Intenta ajustar tus términos de búsqueda.",
    "helpSearchClearLabel": "Borrar búsqueda",
    "helpV2WelcomeTitle": "Bienvenido a V2",
    "helpV2WelcomeKeywords": "v2 nueva interfaz actualización resumen navegación barra lateral",
    "helpV2WelcomeContent": "<p>¡Bienvenido a la nueva interfaz de Cine Power Planner V2! Rediseñamos la experiencia para que sea más rápida, intuitiva y totalmente adaptable.</p>\n<h4>Mejoras clave</h4>\n<ul>\n<li><strong>Nueva navegación lateral:</strong> Accede rápidamente a Proyectos, Herramientas y Ajustes desde la barra lateral. En móviles, usa el botón de menú del encabezado.</li>\n<li><strong>Visuales mejorados:</strong> Un aspecto moderno y limpio con mejor soporte para Modo Oscuro y Modo Rosa.</li>\n<li><strong>Mejor rendimiento:</strong> Cargas más rápidas y transiciones más fluidas entre vistas.</li>\n</ul>\n<h4>Cómo moverse</h4>\n<p>La barra lateral es tu centro de control principal:</p>\n<ul>\n<li><strong>Proyectos:</strong> Ver y administrar todos tus planes de energía. Filtra por Activos o Archivo.</li>\n<li><strong>Herramientas:</strong> Accede a la Biblioteca de Dispositivos, Contactos y Reglas de Auto Gear.</li>\n<li><strong>Ajustes:</strong> Configura preferencias, respalda datos y gestiona el almacenamiento.</li>\n</ul>",
    "helpV2ProjectsTitle": "Gestionar proyectos",
    "helpV2ProjectsKeywords": "proyectos crear nuevo eliminar archivo filtrar activo panel",
    "helpV2ProjectsContent": "<p>El panel de Proyectos es donde comienza tu trabajo.</p>\n<h4>Crear un proyecto</h4>\n<p>Haz clic en el botón <strong>+ Nuevo proyecto</strong> en la parte superior derecha para iniciar un plan. Se te pedirá un nombre y detalles opcionales.</p>\n<h4>Estado y filtros</h4>\n<p>Usa la barra lateral para filtrar tus proyectos:</p>\n<ul>\n<li><strong>Todos los proyectos:</strong> Todo lo que has creado.</li>\n<li><strong>Proyectos activos:</strong> Proyectos en los que estás trabajando.</li>\n<li><strong>Archivo:</strong> Proyectos completados o en pausa. Puedes archivar un proyecto desde su menú contextual.</li>\n</ul>\n<h4>Acciones del proyecto</h4>\n<p>Haz clic derecho (o pulsa prolongadamente en pantallas táctiles) sobre una tarjeta para abrir el menú contextual:</p>\n<ul>\n<li><strong>Renombrar:</strong> Cambia los detalles del proyecto.</li>\n<li><strong>Duplicar:</strong> Crea una copia exacta del proyecto.</li>\n<li><strong>Archivar/Desarchivar:</strong> Mueve el proyecto al archivo o de vuelta.</li>\n<li><strong>Eliminar:</strong> Elimina el proyecto de forma permanente.</li>\n</ul>",
    "helpV2SidebarSearchTitle": "Búsqueda en la barra lateral",
    "helpV2SidebarSearchKeywords": "búsqueda barra lateral funciones dispositivos acciones ayuda teclado sin conexión",
    "helpV2SidebarSearchContent": "<p>La búsqueda en la barra lateral funciona totalmente offline y combina funciones, dispositivos, acciones y temas de ayuda en una lista rápida.</p>\n<h4>Qué incluye</h4>\n<ul>\n<li><strong>Funciones:</strong> Ve directo a entradas, secciones y diálogos.</li>\n<li><strong>Dispositivos:</strong> Busca en el catálogo local y abre la coincidencia.</li>\n<li><strong>Acciones:</strong> Ejecuta comandos rápidos como Guardar, Exportar o Ajustes.</li>\n<li><strong>Ayuda:</strong> Abre el tema más relevante sin salir del planificador.</li>\n</ul>\n<h4>Navegación con teclado</h4>\n<ul>\n<li><strong>Flechas:</strong> Moverse por las sugerencias.</li>\n<li><strong>Enter:</strong> Activar el resultado destacado.</li>\n<li><strong>Esc:</strong> Borrar la consulta y cerrar la lista.</li>\n</ul>",
    "helpV2DeviceLibraryTitle": "Biblioteca de dispositivos",
    "helpV2DeviceLibraryKeywords": "dispositivos biblioteca equipo gear personalizado añadir editar base de datos",
    "helpV2DeviceLibraryContent": "<p>La Biblioteca de Dispositivos te permite gestionar el equipo disponible para tus planes de energía.</p>\n<h4>Explorar dispositivos</h4>\n<p>Los dispositivos están organizados por categoría (Cámaras, Monitores, etc.). Usa las pestañas o menús para cambiar de categoría. También puedes usar la barra de búsqueda para encontrar equipo al instante.</p>\n<h4>Agregar equipo personalizado</h4>\n<p>¿No encuentras tu equipo? Haz clic en <strong>Añadir dispositivo</strong> para crear una entrada personalizada. Debes indicar:</p>\n<ul>\n<li><strong>Nombre:</strong> El nombre del modelo.</li>\n<li><strong>Consumo:</strong> Consumo típico en vatios (W).</li>\n<li><strong>Voltaje:</strong> Rango de voltaje (opcional pero recomendado).</li>\n</ul>\n<p>Una vez añadido, el equipo personalizado está disponible para todos tus proyectos.</p>",
    "helpV2ContactsTitle": "Contactos",
    "helpV2ContactsKeywords": "contactos personas equipo casas de alquiler lista",
    "helpV2ContactsContent": "<p>Registra casas de alquiler, miembros del equipo y clientes directamente en la app.</p>\n<h4>Gestionar contactos</h4>\n<ul>\n<li><strong>Añadir contacto:</strong> Haz clic en <strong>Nuevo contacto</strong> para agregar Nombre, Rol, Teléfono y Email.</li>\n<li><strong>Editar/Eliminar:</strong> Usa los botones de acción en cada tarjeta.</li>\n</ul>\n<p>Los contactos se podrán asignar a proyectos para consulta rápida (pronto en detalles del proyecto).</p>",
    "helpV2SettingsTitle": "Ajustes y datos",
    "helpV2SettingsKeywords": "ajustes preferencias respaldo restaurar datos almacenamiento tema idioma",
    "helpV2SettingsContent": "<p>Personaliza tu experiencia y mantén tus datos seguros.</p>\n<h4>Gestión de datos</h4>\n<ul>\n<li><strong>Respaldo:</strong> Descarga una copia completa de todos tus proyectos y dispositivos personalizados. Recomendamos hacerlo regularmente.</li>\n<li><strong>Restaurar:</strong> Carga un archivo de respaldo guardado. <em>Nota: Esto reemplaza los datos actuales.</em></li>\n<li><strong>Auto-Backups:</strong> Activa instantáneas automáticas para protegerte contra pérdidas accidentales.</li>\n</ul>\n<h4>Preferencias</h4>\n<ul>\n<li><strong>Unidades:</strong> Cambia entre Métrico e Imperial (si aplica).</li>\n<li><strong>Tema:</strong> Forzar modo Oscuro, Claro o el modo Rosa.</li>\n</ul>",
    "helpV2SaveShareBackupTitle": "Guardar, compartir y restaurar con seguridad",
    "helpV2SaveShareBackupKeywords": "guardar manual autoguardado auto backup compartir exportar importar json restaurar ensayo offline seguridad instantánea",
    "helpV2SaveShareBackupContent": "<p>Cada guardado, exportación y copia permanece en este dispositivo para mantener tus datos privados y totalmente offline.</p>\n<h4>Capas de guardado</h4>\n<ul>\n<li><strong>Guardado manual:</strong> Usa <strong>Guardar</strong> en el encabezado del proyecto (o <kbd>Ctrl</kbd>/<kbd>⌘</kbd>+<kbd>S</kbd>) para confirmar una instantánea con nombre en tu biblioteca local.</li>\n<li><strong>Autoguardado:</strong> Mientras editas, el estado de autoguardado del encabezado se actualiza en segundo plano para que los cambios recientes siempre sean recuperables.</li>\n<li><strong>Copias automáticas:</strong> Cada guardado manual pone en cola una instantánea con marca de tiempo. Activa <strong>Mostrar copias automáticas en lista de proyectos</strong> en <em>Ajustes → Copia de Seguridad y Restauración</em> para verlas, y ten en cuenta que se captura una instantánea de seguridad antes de acciones destructivas.</li>\n</ul>\n<h4>Exportar e importar (JSON)</h4>\n<ul>\n<li><strong>Exportar proyecto:</strong> En un proyecto, elige <strong>Exportar proyecto</strong> para descargar un archivo JSON de compartición offline.</li>\n<li><strong>Importar proyecto:</strong> Desde el panel de Proyectos, haz clic en <strong>Importar proyecto</strong> y selecciona el JSON. El proyecto se abre en el editor; nada reemplaza tus datos guardados hasta que pulses <strong>Guardar</strong>.</li>\n<li><strong>Gestión de conflictos:</strong> Si las reglas de Auto Gear compartidas difieren, el diálogo de importación pregunta si aplicarlas solo a este proyecto o de forma global. Si ya existe un nombre de proyecto, cámbialo antes de guardar para evitar sobrescribir.</li>\n</ul>\n<h4>Copia completa y restauración</h4>\n<ul>\n<li><strong>Descargar Copia de Seguridad:</strong> <em>Ajustes → Copia de Seguridad y Restauración → Descargar Copia de Seguridad</em> guarda proyectos, dispositivos, reglas y preferencias.</li>\n<li><strong>Descargar Copia Completa:</strong> <em>Ajustes → Datos y Almacenamiento → Descargar Copia Completa</em> crea una copia de archivo para rotación.</li>\n<li><strong>Restaurar:</strong> <em>Ajustes → Copia de Seguridad y Restauración → Restaurar</em> carga un respaldo y crea primero una instantánea de seguridad para poder volver atrás.</li>\n<li><strong>Restauración de Prueba:</strong> Usa <strong>Restauración de Prueba</strong> para ensayar una restauración en un entorno seguro antes de confirmarla.</li>\n</ul>\n<h4>Garantías de integridad offline</h4>\n<ul>\n<li><strong>Offline-first:</strong> Guardados, exportaciones, copias e importaciones no salen de este dispositivo.</li>\n<li><strong>Safe-save:</strong> Las escrituras están protegidas para que los guardados parciales no sustituyan datos buenos.</li>\n<li><strong>Backup antes de borrar:</strong> Al eliminar o restablecer datos se captura primero una instantánea de seguridad.</li>\n</ul>",
    "helpV2AutoGearTitle": "Reglas de Auto Gear",
    "helpV2AutoGearKeywords": "auto gear reglas automatización lista equipo escenarios requisitos de producción",
    "helpV2AutoGearContent": "<p>Automatiza la generación de tu lista de equipo con reglas inteligentes basadas en escenarios de producción.</p>\n<h4>Cómo funciona</h4>\n<p>Las reglas de Auto Gear supervisan los <strong>Requisitos de producción</strong> del proyecto (por ejemplo, \"Handheld\", \"Studio\", \"Car Rig\") y agregan o eliminan elementos de la lista automáticamente.</p>\n<h4>Crear reglas</h4>\n<p>Ve a <strong>Reglas de Auto Gear</strong> y haz clic en <strong>Agregar regla</strong>. Puedes definir:</p>\n<ul>\n<li><strong>Condiciones:</strong> Disparadores basados en escenarios, modelos de cámara u otra selección de equipo.</li>\n<li><strong>Acciones:</strong> Elementos para <strong>Agregar</strong> (p. ej., \"Shoulder Pad\" para \"Handheld\") o <strong>Eliminar</strong>.</li>\n</ul>\n<h4>Presets</h4>\n<p>Guarda tus reglas favoritas como <strong>Presets</strong> para alternar rápidamente entre estilos de producción (p. ej., \"Narrative Feature\" vs \"Commercial\").</p>",
    "helpV2PrintExportTitle": "Imprimir y exportar",
    "helpV2PrintExportKeywords": "imprimir pdf exportar compartir informe lista equipo diagrama",
    "helpV2PrintExportContent": "<p>Comparte tus planes de energía con tu equipo o la casa de alquiler.</p>\n<h4>Resumen del proyecto</h4>\n<p>Desde el detalle del proyecto, usa el botón <strong>Imprimir / Exportar PDF</strong> para generar un resumen limpio con totales de energía y estimaciones de baterías.</p>\n<h4>Lista de equipo</h4>\n<p>Genera una lista de equipo dedicada para presupuestos y preparación. Puedes filtrar por departamento y personalizar columnas antes de imprimir.</p>\n<h4>Diagrama de energía</h4>\n<p>¿Necesitas una ayuda visual? Exporta el <strong>Connection Diagram</strong> como imagen (PNG/JPG) o SVG para tu tech pack.</p>\n<h4>Consejos PDF</h4>\n<p>Para guardar como PDF, haz clic en \"Print\" y selecciona <strong>\"Save as PDF\"</strong> como destino en el diálogo de impresión.</p>",
    "helpV2QuickStartTitle": "Lista de inicio rápido",
...
<p class="help-callout-note">Consejo: Ejecuta <strong>Restauración de Prueba</strong> después de hitos importantes para verificar la copia completamente offline.</p>`,
    ...
    "helpV2FeaturesTitle": "Funciones de un vistazo",
    "helpV2FeaturesKeywords": "resumen capacidades destacados offline favoritos búsqueda",
    "helpV2FeaturesContent": "<ul>\n<li><strong>Planificación de rig:</strong> Configura cámaras, monitores y accesorios en <em>Configurar dispositivos</em>.</li>\n<li><strong>Análisis de energía:</strong> Revisa consumo y autonomía en <em>Power Summary</em>.</li>\n<li><strong>Diagrama visual:</strong> Mapea conexiones con el <em>Connection Diagram</em> interactivo.</li>\n<li><strong>Comparación de baterías:</strong> Compara autonomías y límites de salida.</li>\n<li><strong>Biblioteca de dispositivos:</strong> Personaliza la base con tu propio equipo.</li>\n<li><strong>Contactos y equipo propio:</strong> Gestiona info del equipo y kits personales.</li>\n<li><strong>Imprimir y exportar:</strong> Genera resúmenes PDF limpios y listas de equipo.</li>\n<li><strong>Funciona offline:</strong> Opera completamente sin conexión a internet.</li>\n<li><strong>Personalizable:</strong> Ajusta temas (Oscuro, Claro, Rosa), tipografías y colores de acento.</li>\n</ul>",
    "helpTopics": {
      "projectManagement": {
    ...
    "backupVaultHeading": "Bóveda de datos (copias de seguridad)",
    "backupVaultLoading": "Cargando copias de seguridad…",
    "backupVaultEmptyTitle": "No se encontraron copias en la bóveda.",
    "backupVaultEmptySubtitle": "Las copias se crean automáticamente al guardar proyectos.",
    "backupVaultLoadError": "No se pudieron cargar las copias: {message}",
    "backupVaultLoadErrorFallback": "No se pudieron cargar las copias.",
    "backupVaultRestoreAriaLabel": "Restaurar {name}",
    "backupVaultDeleteAriaLabel": "Eliminar {name}",
    "backupVaultRestoreConfirm": "¿Restaurar {name}? Esto sobrescribirá los datos actuales.",
    "backupVaultUnknownFormat": "Formato de copia desconocido.",
    "backupVaultRestoreSuccess": "¡Proyecto restaurado correctamente!",
    "backupVaultRestoreLocked": "Este proyecto está bloqueado por otra sesión.",
    "backupVaultRestoreUnknownError": "Error desconocido.",
    "backupVaultRestoreFailed": "La restauración falló. {reason}",
    "backupVaultRestoreError": "No se pudo restaurar: {message}",
    "backupVaultDeleteConfirm": "¿Eliminar {name}?",
    "backupVaultDeleteError": "No se pudo eliminar la copia: {message}",
    "backupVaultDeleteErrorFallback": "No se pudo eliminar la copia.",
    ...
    "v2": {
      "dashboard": {
        ...
        "emptyState": {
          ...
          "subtitle": "Crea tu primer plan de energía para comenzar.",
          "help": "¿Necesitas ayuda para empezar?",
          "archiveTitle": "No hay proyectos archivados",
          "archiveSubtitle": "Los proyectos que archives aparecerán aquí."
        },
        "search": {
          "noResults": {
            "title": "Sin resultados",
            "subtitle": "Ningún proyecto coincide con \"{query}\""
          },
        ...
        "projectTile": {
          ...
          "renameAndEdit": "Renombrar y editar",
          "moreOptions": "Más opciones",
          "actionsFor": "Acciones para {project}"
        },
        "contextMenu": {
          "open": "Abrir proyecto",
          "rename": "Renombrar y editar",
          "duplicate": "Duplicar",
          "archive": "Archivar",
          "unarchive": "Restaurar",
          "delete": "Eliminar",
      ...
      "sidebar": {
        "nav": {
          ...
          "archive": "Archivo",
          "autoBackups": "Copias de seguridad",
          "deviceLibrary": "Biblioteca de dispositivos",
          "contacts": "Contactos",
          "autoGearRules": "Reglas automáticas",
          "ownedGear": "Equipo propio",
        ...
        "search": {
          "placeholder": "Buscar funciones, dispositivos, acciones...",
          "label": "Buscar funciones, dispositivos, acciones y ayuda"
        }
      },
      "detail": {
        ...
        "header": {
          ...
          "generateReqs": "Requisitos y Equipo",
          "generateOverview": "Generar resumen",
          "save": "Guardar"
        },
        "tabs": {
          "cameraPackage": "Paquete de cámara",
          "powerSummary": "Resumen de potencia",
          "requirements": "Requisitos",
          "gearList": "Lista de equipo"
        },
        "actions": {
          "projectRequirements": "Requisitos de producción",
          "generateRequirements": "Generar requisitos",
          "generateRequirementsHelp": "Haz clic en \"Generar requisitos\" para crear tu informe de producción.",
          "gearList": "Lista de equipo",
          "generateGearList": "Generar lista de equipo",
          "generateGearListHelp": "Haz clic en \"Generar lista de equipo\" para crear tu lista de equipamiento."
        },
        "diagram": {
          "zoomIn": "Acercar",
          "zoomOut": "Alejar",
    ...
    "printPreview": {
      ...
      "layoutModeTitle": "Modo de Diseño",
      "layoutRentalLabel": "Optimizado para Alquiler",
      "layoutRentalDescription": "Optimiza el diseño para alquiler agrupando artículos por categoría.",
      "sectionsTitle": "Secciones",
      "sectionProject": "Requisitos de Producción",
      "sectionDevices": "Dispositivos del Paquete de Cámara",
      "sectionDiagram": "Diagrama de Potencia",
      "sectionGearList": "Lista de Kit",
      "sectionBattery": "Comparación de Baterías",
      "exportPdfButton": "Exportar PDF",
      "printButton": "Imprimir",
      "generatedTitle": "Resumen",
      "generatedProjectNameLabel": "Nombre del Proyecto:",
      "generatedProductionLabel": "Producción:",
      "generatedDateLabel": "Fecha:",
      "generatedNoProjectRequirements": "Sin datos de requisitos de producción.",
      "generatedDeviceSelectionTitle": "Dispositivos del Paquete de Cámara",
      "generatedNoDevicesSelected": "Ningún dispositivo seleccionado.",
      "generatedPowerDiagramTitle": "Diagrama de Potencia",
      "generatedPowerSummaryTitle": "Resumen de Potencia",
      "generatedGearListTitle": "Lista de Kit",
      "generatedTotalLoad": "Carga Total",
      "generatedPeak": "Pico:",
      "generatedEstRuntime": "Tiempo Est.",
      "generatedWith": "con",
      "generatedDailyNeeds": "Necesidades Diarias",
      "generatedBatts": "Baterías",
      "generatedFor12hDay": "para día de 12h"
    },
