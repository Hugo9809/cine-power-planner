...
export const data = {
  "texts": {
    ...
    "v2HelpTopics": {
      "dataProtection": {
        "title": "Guardado, compartición y protección sin conexión",
        "keywords": "guardar guardado manual autoguardado copias automáticas exportar compartir importar copia de seguridad restaurar ensayo sin conexión seguridad integridad de datos",
        "content": "<p>Usa esta guía para mantener segura cada copia offline.</p>\n\n<h4>Guardar, autoguardado, copias automáticas</h4>\n<ul>\n<li><strong>Guardar</strong> (Ctrl/⌘+S) crea una nueva instantánea con marca de tiempo; no sobrescribe otro proyecto sin confirmación.</li>\n<li><strong>Autoguardado</strong> captura instantáneas continuas mientras trabajas para poder volver atrás tras cierres inesperados.</li>\n<li><strong>Copias automáticas</strong> crean instantáneas en segundo plano. Activa <strong>Mostrar copias automáticas en lista de proyectos</strong> en Ajustes → Copia de Seguridad y Restauración para revisarlas.</li>\n</ul>\n\n<h4>Exportar, compartir, importar</h4>\n<ul>\n<li><strong>Exportar proyecto</strong> descarga una copia de seguridad JSON para almacenamiento offline.</li>\n<li><strong>Compartir proyecto</strong> prepara un archivo de entrega; quien lo reciba lo abre con <strong>Importar proyecto</strong>.</li>\n<li>Las importaciones se cargan en el área de trabajo sin sobrescribir proyectos guardados. Si hay conflicto de nombre, debes confirmar la sobrescritura o guardar con otro nombre.</li>\n</ul>\n\n<h4>Copia de seguridad, restaurar y ensayo</h4>\n<ul>\n<li><strong>Descargar Copia de Seguridad</strong> crea un backup completo de la app (proyectos, equipo, reglas, preferencias).</li>\n<li><strong>Restaurar</strong> reemplaza los datos locales solo después de crear una instantánea de seguridad.</li>\n<li><strong>Restauración de Prueba</strong> abre una comparación en sandbox para verificar diferencias antes de promocionar.</li>\n</ul>\n\n<h4>Garantías de integridad offline</h4>\n<ul>\n<li>Todos los guardados, exportaciones y copias se mantienen en este dispositivo; la app funciona sin conexión.</li>\n<li>El guardado seguro mantiene instantáneas con marca de tiempo y las acciones destructivas crean una instantánea de respaldo antes de borrar cuando es posible.</li>\n<li>Conserva al menos dos copias offline de exportaciones o backups antes de borrar algo.</li>\n</ul>"
      }
    },
