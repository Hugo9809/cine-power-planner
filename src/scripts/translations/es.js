(function registerLocale() {
  ...
  var data = {
    "texts": {
      ...
      "batteryComparisonDescription": "Revisa cada batería compatible para ver las estimaciones de autonomía con tu rig actual.",
      "batteryComparisonDescriptionHelp": "Esta tabla reúne todas las baterías compatibles y se actualiza al cambiar tu rig. Pasa el cursor por los encabezados para saber qué representa cada dato.",
      ...
      "setupDiagramHeading": "Diagrama de alimentación",
      "diagramPdfNote": "El diagrama de alimentación no se incluye en la exportación PDF. Abre la vista de impresión para ver el diseño.",
      ...
      "deviceSelectionHeadingHelp": "Elige cámaras, monitores y accesorios para tu rig.",
      ...
      "resultsPlainSummaryNeedBattery": "Elige una batería para saber cuánto durará tu rig y cuántos packs debes llevar.",
      "resultsPlainSummaryRuntime": "Con {batteryName} tendrás unas {hours} horas de autonomía. Para una jornada de 10 horas lleva {batteryCount} baterías. Tu rig consume ahora {totalPower} W.",
      "resultsPlainSummaryUnlimited": "Con {batteryName} tu rig consume {totalPower} W, así que la autonomía es prácticamente ilimitada. Asegúrate de tener una batería cargada conectada antes de grabar.",
      ...
      "batteryTableBatteryHelp": "Nombre de la batería y montura capaces de alimentar tu rig.",
      ...
      "setupDiagramHeadingHelp": "Visualiza cómo se conectan los dispositivos en el diagrama de alimentación.",
      "setupDiagramPlaceholder": "Selecciona dispositivos para ver el diagrama de alimentación.",
      "diagramLegendPower": "Energía",
      "diagramLegendVideo": "Vídeo",
      "diagramLegendFIZ": "FIZ",
      "downloadDiagramBtn": "Descargar el diagrama de alimentación",
      ...
      "gearListAutosaveNote": "Se guarda automáticamente tras cada ajuste del rig para que la lista de equipo offline refleje el último paquete de cámara.",
      ...
      "rentalPrintSectionDiagram": "Diagrama de alimentación",
      ...
      "accentColorHelp": "Selecciona el color de acento usado en botones, destacados y el diagrama de alimentación. Se guarda con tus ajustes.",
        ...
        "steps": {
          "intro": {
            ...
            "hero": {
              ...
              "subheading": "Protege cada paquete de cámara con comprobaciones de potencia, kits AutoGear y entregas listas para alquiler—todo se mantiene sin conexión.",
              "summary": "Planifica paquetes de cámara seguros, verifica límites de potencia, genera automáticamente listas de equipo desde los requisitos del proyecto y exporta PDF listos para renta—cada guardado permanece local antes del llamado.",
              "badgeIcon": "",
          ...
          "addCamera": {
            ...
            "body": "Elige el cuerpo de cámara que estás planificando. La búsqueda dentro del menú funciona sin conexión. Así se habilitan accesorios, consumos y el diagrama de alimentación correspondiente."
          },
          "addMonitoring": {
            "title": "Añade monitores, video inalámbrico y FIZ",
            "body": "Añade monitores abordo, transmisores inalámbricos y motores o controladores FIZ. Cada selección alimenta los cálculos de autonomía, el diagrama de alimentación y las reglas automáticas para que el kit generado represente todo el montaje."
          },
          "selectBattery": {
          ...
          "connectionDiagram": {
            "title": "Inspecciona el diagrama de alimentación",
            "body": "El diagrama de alimentación interactivo traza la ruta de energía, video y control del rig. Acomoda los nodos para planear el plano de cámara, haz doble clic en los dispositivos para abrir los detalles flotantes y luego guarda para que la disposición y las anotaciones permanezcan en exportaciones y restauraciones."
          },
          "connectionDiagramDetails": {
            "title": "Abre los detalles flotantes del dispositivo",
            "body": "Haz doble clic en cualquier nodo de dispositivo del diagrama de alimentación para mostrar el popup de detalles flotantes. Revisa notas de consumo, avisos de conectores y anotaciones guardadas, y ciérralo para seguir organizando el plano antes de guardar."
          },
          "editDeviceDataAdd": {
      ...
      "cameraSelectHelp": "Selecciona la cámara para tu rig.",
      ...
      "distanceSelectHelp": "Selecciona un sensor de distancia para tu rig.",
      "batterySelectHelp": "Selecciona la batería que alimenta el rig.",
      ...
      "runtimeFeedbackBtnHelp": "Envía la duración de funcionamiento medida para este rig.",
      "zoomOutHelp": "Aleja el diagrama de alimentación.",
      "zoomInHelp": "Acerca el diagrama de alimentación.",
      "downloadDiagramHelp": "Descarga el diagrama de alimentación como imagen.",
      "gridSnapToggleHelp": "Activa o desactiva el ajuste a la cuadrícula de los nodos del diagrama de alimentación.",
      "resetViewBtn": "Restablecer vista",
      "resetViewHelp": "Restablece el zoom y la posición del diagrama de alimentación.",
      ...
      "diagramDetailDefaultHeading": "Detalles del diagrama de alimentación",
      "diagramMoveHint": "Mueve los nodos arrastrándolos. Arrastra un espacio vacío para desplazar el diagrama de alimentación."
    },
    "categoryNames": {
      "cameras": "Cámara",
      "viewfinders": "Visor",
