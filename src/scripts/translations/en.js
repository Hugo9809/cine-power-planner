(function registerLocale() {
  ...
  "texts": {
    ...
    "offlineIndicatorHelp": "Appears when the planner is offline. All projects, backups and device data stay stored on this device so you can keep working. Force reload requires an internet connection, so reconnect before using it.",
    ...
    "reloadAppOfflineNotice": "Offline — force reload pings the server first, so reconnect and try again.",
