...
export const data = {
  "texts": {
    ...
    "v2HelpTopics": {
      "dataProtection": {
        "title": "Sauvegarde, partage et protection hors ligne",
        "keywords": "enregistrer sauvegarde manuelle sauvegarde automatique export partager importer sauvegarde restauration répétition hors ligne sécurité intégrité des données",
        "content": "<p>Utilisez ce guide pour garder chaque copie hors ligne en sécurité.</p>\n\n<h4>Enregistrement, sauvegarde automatique, sauvegardes automatiques</h4>\n<ul>\n<li><strong>Enregistrer</strong> (Ctrl/⌘+S) écrit un nouvel instantané horodaté du projet ; rien n'est écrasé sans confirmation.</li>\n<li><strong>Sauvegarde automatique</strong> capture des instantanés continus pendant le travail pour revenir en arrière après une fermeture inattendue.</li>\n<li><strong>Sauvegardes automatiques</strong> créent des instantanés en arrière-plan. Activez <strong>Afficher les sauvegardes auto dans la liste des projets</strong> dans Paramètres → Sauvegarde et Restauration pour les consulter.</li>\n</ul>\n\n<h4>Exporter, partager, importer</h4>\n<ul>\n<li><strong>Exporter le projet</strong> télécharge une copie JSON de sécurité pour le stockage hors ligne.</li>\n<li><strong>Partager le projet</strong> prépare un fichier de transfert ; les destinataires l'ouvrent avec <strong>Importer le projet</strong>.</li>\n<li>Les imports se chargent dans l'espace de travail sans écraser les projets enregistrés. En cas de conflit de nom, vous devez confirmer l'écrasement ou enregistrer sous un autre nom.</li>\n</ul>\n\n<h4>Sauvegarde, restauration &amp; répétition</h4>\n<ul>\n<li><strong>Télécharger la Sauvegarde</strong> crée une sauvegarde complète de l'application (projets, matériel, règles, préférences).</li>\n<li><strong>Restaurer</strong> remplace les données locales uniquement après avoir créé un instantané de sécurité.</li>\n<li><strong>Restauration de Test</strong> ouvre une comparaison en sandbox pour vérifier les différences avant la promotion.</li>\n</ul>\n\n<h4>Garanties d'intégrité hors ligne</h4>\n<ul>\n<li>Toutes les sauvegardes, exportations et copies restent sur cet appareil ; l'application fonctionne sans réseau.</li>\n<li>Le safe-save conserve des instantanés horodatés, et les actions destructives créent un instantané de sauvegarde avant suppression lorsque c'est possible.</li>\n<li>Conservez au moins deux copies hors ligne des exports ou sauvegardes avant de supprimer quoi que ce soit.</li>\n</ul>"
      }
    },
