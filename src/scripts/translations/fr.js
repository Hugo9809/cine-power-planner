(function registerLocale() {
  ...
  "texts": {
    ...
    "gearListEditProviderHelp": "Choisissez qui fournit cet élément. La maison de location reste le choix par défaut sauf si l’élément est dans votre liste de matériel personnel.",
