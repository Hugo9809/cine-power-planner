...
export const data = {
  "texts": {
    ...
    "themeVariantLabel": "Thème",
    "themeVariantHelp": "Basculer entre clair, sombre, rose clair et rose sombre.",
    "themeVariantLight": "Clair",
    "themeVariantDark": "Sombre",
    "themeVariantPinkLight": "Rose clair",
    "themeVariantPinkDark": "Rose sombre",
    ...
    "featureSearchPlaceholder": "Rechercher des fonctionnalités, des appareils, des actions ou de l’aide...",
    "featureSearchLabel": "Rechercher des fonctionnalités, des appareils, des actions et de l’aide",
    ...
    "pinkModeHelp": "Ajoute un thème rose ludique. Lorsque le mode rose est actif, l’icône de licorne change toutes les 30 secondes avec une animation de pop douce, et le réglage fonctionne en mode clair ou sombre et est mémorisé pour la prochaine fois.",
    ...
    "deleteGearListDialogTitle": "Supprimer la liste de kit",
    "deleteGearListConfirmLabel": "Supprimer",
    "confirmDeleteGearList": "Supprimer la liste de kit ?",
    "deleteGearListConfirmAgainTitle": "Êtes-vous sûr ?",
    "deleteGearListConfirmAgainLabel": "Confirmer la suppression",
    ...
    "helpGroupEssentials": "Essentiels",
    "helpGroupGuides": "Guides",
    "helpGroupReference": "Référence des sujets",
    "helpServiceUnavailable": "Service d’aide indisponible.",
    "helpSearchNoResultsTitle": "Aucun résultat trouvé",
    "helpSearchNoResultsHint": "Essayez d’ajuster vos termes de recherche.",
    "helpSearchClearLabel": "Effacer la recherche",
    "helpV2WelcomeTitle": "Bienvenue dans V2",
    "helpV2WelcomeKeywords": "v2 nouvelle interface mise à jour aperçu navigation barre latérale",
    "helpV2WelcomeContent": "<p>Bienvenue dans la nouvelle interface Cine Power Planner V2 ! Nous avons repensé l’expérience pour qu’elle soit plus rapide, plus intuitive et entièrement responsive.</p>\n<h4>Améliorations clés</h4>\n<ul>\n<li><strong>Nouvelle navigation latérale :</strong> Accédez rapidement aux Projets, Outils et Réglages depuis la barre latérale dédiée. Sur mobile, utilisez le bouton menu de l’en-tête.</li>\n<li><strong>Visuels améliorés :</strong> Un look moderne et épuré avec un meilleur support du mode sombre et du mode rose.</li>\n<li><strong>Meilleures performances :</strong> Chargements plus rapides et transitions plus fluides entre les vues.</li>\n</ul>\n<h4>Se repérer</h4>\n<p>La barre latérale est votre centre de contrôle :</p>\n<ul>\n<li><strong>Projets :</strong> Consultez et gérez tous vos plans d’alimentation. Filtrez par Actif ou Archive.</li>\n<li><strong>Outils :</strong> Accédez à la bibliothèque d’appareils, aux contacts et aux règles Auto Gear.</li>\n<li><strong>Réglages :</strong> Configurez les préférences, sauvegardez les données et gérez le stockage.</li>\n</ul>",
    "helpV2ProjectsTitle": "Gérer les projets",
    "helpV2ProjectsKeywords": "projets créer nouveau supprimer archive filtrer actif tableau",
    "helpV2ProjectsContent": "<p>Le tableau de bord des projets est le point de départ de votre travail.</p>\n<h4>Créer un projet</h4>\n<p>Cliquez sur le bouton <strong>+ Nouveau projet</strong> en haut à droite pour démarrer un nouveau plan. Vous serez invité à saisir un nom et des détails optionnels.</p>\n<h4>Statut et filtres</h4>\n<p>Utilisez la barre latérale pour filtrer vos projets :</p>\n<ul>\n<li><strong>Tous les projets :</strong> Tout ce que vous avez créé.</li>\n<li><strong>Projets actifs :</strong> Projets en cours.</li>\n<li><strong>Archive :</strong> Projets terminés ou en pause. Vous pouvez archiver un projet depuis son menu contextuel.</li>\n</ul>\n<h4>Actions sur les projets</h4>\n<p>Cliquez droit (ou appui long sur écran tactile) sur une tuile pour ouvrir le menu contextuel :</p>\n<ul>\n<li><strong>Renommer :</strong> Modifier les détails du projet.</li>\n<li><strong>Dupliquer :</strong> Créer une copie exacte du projet.</li>\n<li><strong>Archiver/Désarchiver :</strong> Déplacer le projet vers/depuis l’archive.</li>\n<li><strong>Supprimer :</strong> Retirer le projet définitivement.</li>\n</ul>",
    "helpV2SidebarSearchTitle": "Recherche de la barre latérale",
    "helpV2SidebarSearchKeywords": "recherche barre latérale fonctions appareils actions aide clavier hors ligne",
    "helpV2SidebarSearchContent": "<p>La recherche de la barre latérale fonctionne entièrement hors ligne et regroupe fonctions, appareils, actions et sujets d’aide dans une liste rapide.</p>\n<h4>Ce qu’elle couvre</h4>\n<ul>\n<li><strong>Fonctions :</strong> Accédez directement aux champs, sections et boîtes de dialogue.</li>\n<li><strong>Appareils :</strong> Recherchez dans le catalogue local et ouvrez l’entrée correspondante.</li>\n<li><strong>Actions :</strong> Lancez des commandes rapides comme Enregistrer, Exporter ou Réglages.</li>\n<li><strong>Aide :</strong> Ouvrez le sujet d’aide le plus pertinent sans quitter le planificateur.</li>\n</ul>\n<h4>Navigation au clavier</h4>\n<ul>\n<li><strong>Flèches :</strong> Parcourir les suggestions.</li>\n<li><strong>Entrée :</strong> Activer le résultat sélectionné.</li>\n<li><strong>Échap :</strong> Effacer la requête et fermer la liste.</li>\n</ul>",
    "helpV2DeviceLibraryTitle": "Bibliothèque d’appareils",
    "helpV2DeviceLibraryKeywords": "appareils bibliothèque équipement gear personnalisé ajouter modifier base de données",
    "helpV2DeviceLibraryContent": "<p>La bibliothèque d’appareils vous permet de gérer l’équipement disponible pour vos plans d’alimentation.</p>\n<h4>Parcourir les appareils</h4>\n<p>Les appareils sont organisés par catégorie (Caméras, Moniteurs, etc.). Utilisez les onglets ou les menus pour changer de catégorie. Vous pouvez aussi utiliser la barre de recherche pour trouver un équipement immédiatement.</p>\n<h4>Ajouter du gear personnalisé</h4>\n<p>Vous ne trouvez pas votre équipement ? Cliquez sur <strong>Ajouter un appareil</strong> pour créer une entrée personnalisée. Vous devrez préciser :</p>\n<ul>\n<li><strong>Nom :</strong> Le modèle.</li>\n<li><strong>Consommation :</strong> Consommation typique en watts (W).</li>\n<li><strong>Tension :</strong> Plage de tension (optionnelle mais recommandée).</li>\n</ul>\n<p>Une fois ajouté, l’équipement personnalisé est disponible pour tous vos projets.</p>",
    "helpV2ContactsTitle": "Contacts",
    "helpV2ContactsKeywords": "contacts personnes équipe sociétés de location liste",
    "helpV2ContactsContent": "<p>Suivez les loueurs, les membres d’équipe et les clients directement dans l’app.</p>\n<h4>Gérer les contacts</h4>\n<ul>\n<li><strong>Ajouter un contact :</strong> Cliquez sur <strong>Nouveau contact</strong> pour ajouter Nom, Rôle, Téléphone et Email.</li>\n<li><strong>Modifier/Supprimer :</strong> Utilisez les boutons d’action sur chaque carte.</li>\n</ul>\n<p>Les contacts pourront être associés aux projets pour un accès rapide (bientôt dans les détails du projet).</p>",
    "helpV2SettingsTitle": "Réglages et données",
    "helpV2SettingsKeywords": "réglages préférences sauvegarde restauration données stockage thème langue",
    "helpV2SettingsContent": "<p>Personnalisez votre expérience et protégez vos données.</p>\n<h4>Gestion des données</h4>\n<ul>\n<li><strong>Sauvegarde :</strong> Téléchargez une sauvegarde complète de tous vos projets et appareils personnalisés. Nous recommandons de le faire régulièrement.</li>\n<li><strong>Restaurer :</strong> Chargez un fichier de sauvegarde enregistré. <em>Note : cela remplace les données actuelles.</em></li>\n<li><strong>Auto-Backups :</strong> Activez des instantanés automatiques pour éviter toute perte accidentelle.</li>\n</ul>\n<h4>Préférences</h4>\n<ul>\n<li><strong>Unités :</strong> Basculer entre métrique et impérial (si applicable).</li>\n<li><strong>Thème :</strong> Forcer le mode sombre, clair ou le mode rose.</li>\n</ul>",
    "helpV2SaveShareBackupTitle": "Sauvegarder, partager et restaurer en toute sécurité",
    "helpV2SaveShareBackupKeywords": "sauvegarder manuel autosave auto backup partager export importer json restauration essai hors ligne sécurité instantané",
    "helpV2SaveShareBackupContent": "<p>Chaque sauvegarde, export et backup reste sur cet appareil afin que vos données restent privées et totalement hors ligne.</p>\n<h4>Les niveaux de sauvegarde</h4>\n<ul>\n<li><strong>Sauvegarde manuelle :</strong> Utilisez <strong>Enregistrer</strong> dans l’en-tête du projet (ou <kbd>Ctrl</kbd>/<kbd>⌘</kbd>+<kbd>S</kbd>) pour créer un instantané nommé dans votre bibliothèque locale.</li>\n<li><strong>Autosave :</strong> Pendant l’édition, l’état d’autosave dans l’en-tête se met à jour en arrière-plan pour que les dernières modifications restent récupérables.</li>\n<li><strong>Sauvegardes automatiques :</strong> Chaque sauvegarde manuelle met en file un instantané horodaté. Activez <strong>Afficher les sauvegardes auto dans la liste des projets</strong> dans <em>Réglages → Sauvegarde et Restauration</em> pour les afficher, et notez qu’un instantané de sécurité est créé avant les actions destructives.</li>\n</ul>\n<h4>Exporter et importer (JSON)</h4>\n<ul>\n<li><strong>Exporter le projet :</strong> Dans un projet, choisissez <strong>Exporter le projet</strong> pour télécharger un fichier JSON de partage hors ligne.</li>\n<li><strong>Importer un projet :</strong> Depuis le tableau de bord Projets, cliquez sur <strong>Importer un projet</strong> et sélectionnez le JSON. Le projet s’ouvre dans l’éditeur ; rien ne remplace vos données enregistrées tant que vous n’appuyez pas sur <strong>Enregistrer</strong>.</li>\n<li><strong>Gestion des conflits :</strong> Si les règles Auto Gear partagées diffèrent, la boîte de dialogue d’importation demande si elles doivent s’appliquer uniquement à ce projet ou globalement. Si un nom de projet existe déjà, renommez avant d’enregistrer pour éviter l’écrasement.</li>\n</ul>\n<h4>Sauvegarde complète et restauration</h4>\n<ul>\n<li><strong>Télécharger la Sauvegarde :</strong> <em>Réglages → Sauvegarde et Restauration → Télécharger la Sauvegarde</em> enregistre projets, appareils, règles et préférences.</li>\n<li><strong>Télécharger la Sauvegarde Complète :</strong> <em>Réglages → Données et Stockage → Télécharger la Sauvegarde Complète</em> crée une copie d’archive pour la rotation.</li>\n<li><strong>Restaurer :</strong> <em>Réglages → Sauvegarde et Restauration → Restaurer</em> charge une sauvegarde et crée d’abord un instantané de sécurité pour pouvoir revenir en arrière.</li>\n<li><strong>Restauration de Test :</strong> Utilisez <strong>Restauration de Test</strong> pour répéter une restauration dans un environnement sécurisé avant de valider.</li>\n</ul>\n<h4>Garanties d’intégrité hors ligne</h4>\n<ul>\n<li><strong>Offline-first :</strong> Les sauvegardes, exports et imports ne quittent jamais cet appareil.</li>\n<li><strong>Safe-save :</strong> Les écritures sont protégées pour que les sauvegardes partielles ne remplacent pas les bonnes données.</li>\n<li><strong>Backup avant suppression :</strong> Toute suppression ou remise à zéro capture d’abord un instantané de sécurité.</li>\n</ul>",
    "helpV2AutoGearTitle": "Règles Auto Gear",
    "helpV2AutoGearKeywords": "auto gear règles automatisation liste kit scénarios exigences de production",
    "helpV2AutoGearContent": "<p>Automatisez la génération de votre liste de kit grâce à des règles intelligentes basées sur des scénarios de production.</p>\n<h4>Comment ça marche</h4>\n<p>Les règles Auto Gear surveillent les <strong>exigences de production</strong> du projet (par ex. \"Handheld\", \"Studio\", \"Car Rig\") et ajoutent ou retirent automatiquement des éléments de la liste.</p>\n<h4>Créer des règles</h4>\n<p>Allez dans <strong>Règles Auto Gear</strong> et cliquez sur <strong>Ajouter une règle</strong>. Vous pouvez définir :</p>\n<ul>\n<li><strong>Conditions :</strong> Déclencheurs basés sur des scénarios, des modèles de caméra ou d’autres choix d’équipement.</li>\n<li><strong>Actions :</strong> Éléments à <strong>Ajouter</strong> (par ex. \"Shoulder Pad\" pour \"Handheld\") ou à <strong>Retirer</strong>.</li>\n</ul>\n<h4>Préréglages</h4>\n<p>Enregistrez vos ensembles de règles en tant que <strong>Préréglages</strong> pour basculer rapidement entre styles de production (par ex. \"Narrative Feature\" vs \"Commercial\").</p>",
    "helpV2PrintExportTitle": "Impression et export",
    "helpV2PrintExportKeywords": "impression pdf export partage rapport liste kit diagramme",
    "helpV2PrintExportContent": "<p>Partagez vos plans d’alimentation avec votre équipe ou votre loueur.</p>\n<h4>Résumé du projet</h4>\n<p>Depuis la vue détail, utilisez le bouton <strong>Print / Export PDF</strong> pour générer un résumé propre avec les totaux de puissance et les estimations de batteries.</p>\n<h4>Liste de kit</h4>\n<p>Générez une liste d’équipement dédiée pour les devis et la préparation. Vous pouvez filtrer par département et personnaliser les colonnes avant l’impression.</p>\n<h4>Diagramme d’alimentation</h4>\n<p>Besoin d’un visuel ? Exportez le <strong>Connection Diagram</strong> en image (PNG/JPG) ou SVG pour votre dossier technique.</p>\n<h4>Conseils PDF</h4>\n<p>Pour enregistrer en PDF, cliquez sur \"Print\" et choisissez <strong>\"Save as PDF\"</strong> comme destination dans la boîte d’impression.</p>",
    "helpV2QuickStartTitle": "Liste de démarrage rapide",
    "helpV2QuickStartKeywords": "démarrage rapide onboarding tutoriel premières étapes workflow bases démarrer nouveau projet guide",
...
<li><strong>Autosauvegarde :</strong> Fonctionne en arrière-plan pendant l’édition et conserve des instantanés continus pour une récupération rapide.</li>
<li><strong>Liste des sauvegardes automatiques :</strong> Activez <strong>Afficher les sauvegardes auto dans la liste des projets</strong> et ajustez <strong>Rétention des Sauvegardes (copies par projet)</strong> pour contrôler le nombre d’instantanés visibles.</li>
</ul>
<h4>Exporter/Partager un projet (JSON) & Importer</h4>
<ul>
...
<ul>
<li><strong>Télécharger la Sauvegarde :</strong> Créez un instantané manuel complet depuis <strong>Paramètres → Sauvegarde et Restauration</strong>.</li>
<li><strong>Télécharger la Sauvegarde Complète :</strong> Récupérez un export complet supplémentaire depuis <strong>Paramètres → Données et Stockage</strong> pour une redondance.</li>
<li><strong>Restaurer :</strong> Chargez un fichier de sauvegarde ; le planificateur capture d’abord un instantané de sécurité. Utilisez <strong>Comparer les Versions</strong> pour vérifier les différences.</li>
<li><strong>Restauration de Test :</strong> Ouvre un sandbox qui compare les comptes, s’efface automatiquement et garde les données actives intactes jusqu’à ce que vous décidiez de restaurer.</li>
</ul>
<h4>Hors ligne & intégrité des données</h4>
<ul>
<li><strong>Offline-first :</strong> Enregistrements, exports, imports et sauvegardes fonctionnent sans connexion réseau.</li>
...
<p class="help-callout-note">Astuce : lancez <strong>Restauration de Test</strong> après les jalons importants pour vérifier la sauvegarde entièrement hors ligne.</p>`,
    ...
    "helpV2FeaturesTitle": "Fonctionnalités en un coup d’œil",
    "helpV2FeaturesKeywords": "aperçu capacités points forts hors ligne favoris recherche",
    "helpV2FeaturesContent": "<ul>\n<li><strong>Planification de rig :</strong> Configurez caméras, moniteurs et accessoires dans <em>Configurer les appareils</em>.</li>\n<li><strong>Analyse d’alimentation :</strong> Consultez la consommation et l’autonomie dans <em>Power Summary</em>.</li>\n<li><strong>Diagramme visuel :</strong> Cartographiez les connexions avec le <em>Connection Diagram</em> interactif.</li>\n<li><strong>Comparaison des batteries :</strong> Comparez les autonomies et les limites de sortie.</li>\n<li><strong>Bibliothèque d’appareils :</strong> Personnalisez la base avec votre propre équipement.</li>\n<li><strong>Contacts et équipement perso :</strong> Gérez les infos d’équipe et les kits personnels.</li>\n<li><strong>Imprimer & exporter :</strong> Générez des résumés PDF propres et des listes de kit.</li>\n<li><strong>Hors ligne :</strong> Fonctionne entièrement sans connexion internet.</li>\n<li><strong>Personnalisable :</strong> Ajustez les thèmes (Sombre, Clair, Rose), polices et couleurs d’accent.</li>\n</ul>",
    "helpTopics": {
      "projectManagement": {
    ...
    "backupVaultHeading": "Coffre de données (sauvegardes)",
    "backupVaultLoading": "Chargement des sauvegardes…",
    "backupVaultEmptyTitle": "Aucune sauvegarde trouvée dans le coffre.",
    "backupVaultEmptySubtitle": "Les sauvegardes sont créées automatiquement quand vous enregistrez des projets.",
    "backupVaultLoadError": "Échec du chargement des sauvegardes : {message}",
    "backupVaultLoadErrorFallback": "Impossible de charger les sauvegardes.",
    "backupVaultRestoreAriaLabel": "Restaurer {name}",
    "backupVaultDeleteAriaLabel": "Supprimer {name}",
    "backupVaultRestoreConfirm": "Restaurer {name} ? Cela écrasera les données actuelles.",
    "backupVaultUnknownFormat": "Format de sauvegarde inconnu.",
    "backupVaultRestoreSuccess": "Projet restauré avec succès !",
    "backupVaultRestoreLocked": "Ce projet est verrouillé par une autre session.",
    "backupVaultRestoreUnknownError": "Erreur inconnue.",
    "backupVaultRestoreFailed": "Échec de la restauration. {reason}",
    "backupVaultRestoreError": "Échec de la restauration : {message}",
    "backupVaultDeleteConfirm": "Supprimer {name} ?",
    "backupVaultDeleteError": "Impossible de supprimer la sauvegarde : {message}",
    "backupVaultDeleteErrorFallback": "Impossible de supprimer la sauvegarde.",
    ...
    "onboardingTour": {
      ...
      "userProfileInteractionIntro": "Saisissez une fois les informations de votre équipe. Chaque mise à jour se synchronise immédiatement avec Contacts, reste mise en cache hors ligne et se retrouve dans les exports pour que l’équipe sache toujours qui possède la configuration caméra.",
      ...
      "steps": {
        "intro": {
          ...
          "hero": {
            ...
            "subheading": "Sécurisez chaque configuration caméra avec des contrôles d’alimentation, des kits AutoGear et des handoffs prêts pour la location—le tout reste hors ligne.",
            "summary": "Planifiez des configurations caméra sûres, vérifiez les limites de puissance, générez automatiquement des listes de matériel à partir des exigences projet et exportez des PDF prêts pour la location—chaque sauvegarde reste locale avant l’appel.",
            "badgeIcon": "",
    ...
    "v2": {
      ...
      "sidebar": {
        ...
        "search": {
          "placeholder": "Rechercher des fonctionnalités, des appareils, des actions...",
          "label": "Rechercher des fonctionnalités, des appareils, des actions et de l’aide"
        }
      },
      "detail": {
    ...
    "printPreview": {
      ...
      "layoutModeTitle": "Mode de Mise en Page",
      "layoutRentalLabel": "Optimisé pour la Location",
      "layoutRentalDescription": "Optimise la mise en page pour la location en regroupant les articles par catégorie.",
      "sectionsTitle": "Sections",
      "sectionProject": "Besoins de Production",
      "sectionDevices": "Équipements du Pack Caméra",
      "sectionDiagram": "Schéma d'Alimentation",
      "sectionGearList": "Liste de Kit",
      "sectionBattery": "Comparaison de Batteries",
      "exportPdfButton": "Exporter PDF",
      "printButton": "Imprimer",
      "generatedTitle": "Aperçu",
      "generatedProjectNameLabel": "Nom du Projet :",
      "generatedProductionLabel": "Production :",
      "generatedDateLabel": "Date :",
      "generatedNoProjectRequirements": "Aucune donnée de besoins de production.",
      "generatedDeviceSelectionTitle": "Équipements du Pack Caméra",
      "generatedNoDevicesSelected": "Aucun appareil sélectionné.",
      "generatedPowerDiagramTitle": "Schéma d'Alimentation",
      "generatedPowerSummaryTitle": "Résumé d'Alimentation",
      "generatedGearListTitle": "Liste de Kit",
      "generatedTotalLoad": "Charge Totale",
      "generatedPeak": "Pic :",
      "generatedEstRuntime": "Durée Est.",
      "generatedWith": "avec",
      "generatedDailyNeeds": "Besoins Quotidiens",
      "generatedBatts": "Batteries",
      "generatedFor12hDay": "pour journée de 12h"
    },
