(function registerLocale() {
  ...
  "texts": {
    ...
    "offlineIndicatorHelp": "S’affiche lorsque le planificateur est hors ligne. Tous les projets, sauvegardes et données d’appareil restent stockés sur cet appareil afin que vous puissiez continuer à travailler. Le rechargement forcé nécessite une connexion Internet ; reconnectez-vous avant de l’utiliser.",
    ...
    "reloadAppHelp": "Efface le cache, annule l’enregistrement des service workers obsolètes et recharge l’application sans supprimer les données enregistrées. Le navigateur précharge désormais le nouveau lot pendant le nettoyage, ce qui affiche plus rapidement la nouvelle version.",
    "reloadAppOfflineNotice": "Hors ligne : le rechargement forcé nécessite une connexion Internet. Reconnectez-vous puis réessayez.",
