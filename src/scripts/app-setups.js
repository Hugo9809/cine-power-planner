...
const setupsSetButtonLabelWithIcon = (function resolveSetButtonLabelWithIconForSetups() {
...
if (cineResultsModule && typeof cineResultsModule.setupRuntimeFeedback === 'function') {
  cineResultsModule.setupRuntimeFeedback({
    ...
    setButtonLabelWithIcon:
      typeof setupsSetButtonLabelWithIcon === 'function' ? setupsSetButtonLabelWithIcon : null,
...
function ensureGearItemEditButton(element) {
  ...
  if (typeof setupsSetButtonLabelWithIcon === 'function' && sliderGlyph) {
    setupsSetButtonLabelWithIcon(button, '', sliderGlyph);
...
function ensureGearListCustomControls(container) {
  ...
  scope.querySelectorAll('tbody.category-group').forEach(group => {
    ...
    if (typeof setupsSetButtonLabelWithIcon === 'function' && hasIconRegistry && addGlyph) {
      setupsSetButtonLabelWithIcon(addButton, '', addGlyph);
...
function applyGearItemEditDialogTexts(context) {
  ...
  if (context.resetButton) {
    ...
    if (typeof setupsSetButtonLabelWithIcon === 'function' && typeof ICON_GLYPHS === 'object' && ICON_GLYPHS) {
      const resetGlyph = ICON_GLYPHS.reload || ICON_GLYPHS.save;
      setupsSetButtonLabelWithIcon(context.resetButton, resetLabel, resetGlyph);
    } else {
  ...
  if (context.cancelButton) {
    ...
    if (typeof setupsSetButtonLabelWithIcon === 'function' && typeof ICON_GLYPHS === 'object' && ICON_GLYPHS) {
      setupsSetButtonLabelWithIcon(context.cancelButton, cancelLabel, ICON_GLYPHS.circleX || ICON_GLYPHS.minus);
    } else {
  ...
  if (context.saveButton) {
    ...
    if (typeof setupsSetButtonLabelWithIcon === 'function' && typeof ICON_GLYPHS === 'object' && ICON_GLYPHS) {
      setupsSetButtonLabelWithIcon(context.saveButton, saveLabel, ICON_GLYPHS.save);
    } else {
...
function ensureGearListActions() {
    ...
    if (typeof setupsSetButtonLabelWithIcon === 'function' && typeof ICON_GLYPHS === 'object') {
        setupsSetButtonLabelWithIcon(deleteBtn, deleteLabel, ICON_GLYPHS.trash);
    } else {
