...
(function () {
  ...
  var modernScriptBundle = {
    core: [
      ...
      'src/scripts/core/modules/core/pink-mode.js?v=10',
      ...
      'src/scripts/shims/legacy-globals-shim.js?v=10',
      'src/scripts/globals-bootstrap.js',
      'src/scripts/core/app-core-new-1.js?v=10',
      'src/scripts/core/app-core-new-2.js?v=10',

      'src/scripts/core/modules/ui-cache.js',
      'src/scripts/core/app-events.js?v=10',
      'src/scripts/core/app-setups.js?v=10',
      'src/scripts/core/app-session.js?v=10',
  ...
  var legacyScriptBundle = {
    core: [
      ...
      'legacy/scripts/core/restore-verification.js',
