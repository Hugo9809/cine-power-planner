...
(function () {
  ...
  var modernScriptBundle = {
    core: [
      ...
      'src/scripts/modules/core/runtime-state/temperature-keys.js',
      'src/scripts/modules/core/runtime-state/local-runtime-state.js',
      'src/scripts/modules/core/runtime-state.js',
      'src/scripts/modules/core/runtime-shared/scope-detection.js',
      'src/scripts/modules/core/runtime-shared/scope-registration.js',
      'src/scripts/modules/core/runtime-shared/scope-snapshot.js',
      'src/scripts/modules/core/runtime-shared/temperature-tools.js',
      'src/scripts/modules/core/runtime-shared/value-access.js',
  ...
  var legacyScriptBundle = {
    core: [
      ...
      'legacy/scripts/modules/core/runtime-state/scope-utils.js',
      'legacy/scripts/modules/core/runtime-state/safe-freeze-registry.js',
      ...
      'legacy/scripts/modules/core/runtime-shared/scope-detection.js',
      'legacy/scripts/modules/core/runtime-shared/scope-registration.js',
      'legacy/scripts/modules/core/runtime-shared/scope-snapshot.js',
      'legacy/scripts/modules/core/runtime-shared/temperature-tools.js',
      'legacy/scripts/modules/core/runtime-shared/value-access.js',
      'legacy/scripts/modules/core/runtime-shared.js',
