...
(function () {
  ...
  var modernScriptBundle = {
    core: [
      ...
      'src/scripts/legacy-globals-shim.js?v=5',
      'src/scripts/app-core-new-1.js?v=5',
      'src/scripts/app-core-new-2.js?v=5',

      'src/scripts/app-events.js?v=5',
      'src/scripts/app-setups.js?v=5',
      'src/scripts/app-session.js?v=5',
