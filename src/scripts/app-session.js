...
if (typeof module !== "undefined" && module.exports) {
  const featureSearchInternals = {};

  const sessionModuleExports = {
    APP_VERSION,
    closeSideMenu,
    openSideMenu,
    setupSideMenu,
  ...
  const defineRuntimeGetter = (target, property, resolver) => {
  ...
  defineRuntimeGetter(sessionModuleExports, 'searchKey', () => {
    const runtime = getSessionRuntimeFunction('searchKey');
  ...
  defineRuntimeGetter(sessionModuleExports, 'searchTokens', () => {
    const runtime = getSessionRuntimeFunction('searchTokens');
    if (typeof runtime === 'function') {
      return runtime;
    }
    return value => {
  ...
  defineRuntimeGetter(sessionModuleExports, 'findBestSearchMatch', () => {
    const runtime = getSessionRuntimeFunction('findBestSearchMatch');
    if (typeof runtime === 'function') {
      return runtime;
    }
    return () => null;
  ...
  defineRuntimeGetter(sessionModuleExports, 'runFeatureSearch', () => {
    const runtime = getSessionRuntimeFunction('runFeatureSearch');
    if (typeof runtime === 'function') {
  ...
  defineRuntimeGetter(featureSearchInternals, 'featureMap', () =>
    getSessionRuntimeValue('featureMap', () => new Map())
  );

  defineRuntimeGetter(featureSearchInternals, 'deviceMap', () =>
    getSessionRuntimeValue('deviceMap', () => new Map())
  );

  defineRuntimeGetter(featureSearchInternals, 'helpMap', () =>
    getSessionRuntimeValue('helpMap', () => new Map())
  );

  defineRuntimeGetter(featureSearchInternals, 'featureSearchEntries', () =>
    getSessionRuntimeValue('featureSearchEntries', () => [])
  );

  defineRuntimeGetter(featureSearchInternals, 'featureSearchDefaultOptions', () =>
    getSessionRuntimeValue('featureSearchDefaultOptions', () => [])
  );

  defineRuntimeGetter(featureSearchInternals, 'featureSearchInput', () =>
    getSessionRuntimeValue('featureSearch', () => null)
  );

  defineRuntimeGetter(featureSearchInternals, 'featureListElement', () =>
    getSessionRuntimeValue('featureList', () => null)
  );

  defineRuntimeGetter(featureSearchInternals, 'restoreFeatureSearchDefaults', () => {
    const runtime = getSessionRuntimeFunction('restoreFeatureSearchDefaults');
    if (typeof runtime === 'function') {
      return runtime;
    }
    return () => {};
  ...
  defineRuntimeGetter(featureSearchInternals, 'updateFeatureSearchSuggestions', () => {
    const runtime = getSessionRuntimeFunction('updateFeatureSearchSuggestions');
    if (typeof runtime === 'function') {
      return runtime;
    }
    return () => {};
