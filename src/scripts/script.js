...
if (typeof require === 'function' && typeof module !== 'undefined' && module && module.exports) {
  ...
  const parts = [
    ...
    'modules/core/runtime-shared/scope-detection.js',
    'modules/core/runtime-shared/scope-registration.js',
    'modules/core/runtime-shared/scope-snapshot.js',
    'modules/core/runtime-shared/temperature-tools.js',
    'modules/core/runtime-shared/value-access.js',
  ...
  const APP_VERSION = "1.0.21"; // Version marker for consistency checks
