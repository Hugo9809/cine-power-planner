    ...
    if (connectionDiagramModule && typeof connectionDiagramModule.createConnectionDiagram === 'function') {
      try {
        ...
        const diagramContext = {
          ...
          getDevices: () => devices,
          getCameraSelect: () => document.getElementById('cameraSelect'),
          getMonitorSelect: () => document.getElementById('monitorSelect'),
          getVideoSelect: () => document.getElementById('videoSelect'),
          getDistanceSelect: () => document.getElementById('distanceSelect'),
          getBatterySelect: () => document.getElementById('batterySelect'),
          getMotorSelects: () => [
          ...
          getSetupDiagramContainer: () => document.getElementById('diagramArea'),
          getDiagramLegend: () => document.getElementById('diagramLegend'),
          getDiagramHint: () => document.getElementById('diagramHint'),
          getDownloadDiagramBtn: () => document.getElementById('downloadDiagramBtn'),
          getZoomInBtn: () => document.getElementById('zoomIn'),
          getZoomOutBtn: () => document.getElementById('zoomOut'),
          getResetViewBtn: () => document.getElementById('resetView'),
          getGridSnapToggleBtn: () => document.getElementById('gridSnapToggle'),
          getCurrentGridSnap,
