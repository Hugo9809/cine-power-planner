...
// ESM Export
// We can't use module.exports logic easily if we want strict ESM.
// Instead we can just attach to global scope (done above) and return/export an object if needed.
// However, for consistency with conversion, let's remove the wrapper and export const.
// }) ();

export const cineCoreRuntimeLocalization = target;
