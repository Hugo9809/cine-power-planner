...
// Register the inputs with the manager
if (restoreRehearsalModeInputs) {
  RestoreRehearsalManager.registerRestoreRehearsalModeInputs(restoreRehearsalModeInputs);
}
...
function renderRestoreRehearsalResults(rows, ruleDiff) {
  ...
  RestoreRehearsalManager.renderRestoreRehearsalRuleDiff(Array.isArray(ruleDiff) ? ruleDiff : [], {
    ruleSectionEl: restoreRehearsalRuleSectionEl,
    ruleListEl: restoreRehearsalRuleListEl,
    ruleEmptyEl: restoreRehearsalRuleEmptyEl,
    actionsEl: restoreRehearsalActionsEl
  });
}
