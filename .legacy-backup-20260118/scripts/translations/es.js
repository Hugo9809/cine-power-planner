...
(function registerLocale() {
  ...
  var data = {
    "texts": {
      ...
      "tagline": "Planifica tu rig de cámara y calcula el consumo de energía y la autonomía de las baterías.",
      "skipToContent": "Saltar al contenido",
      "offlineIndicator": "Sin conexión",
      "offlineIndicatorHelp": "Aparece cuando el planificador está sin conexión o cuando el service worker detecta una conexión degradada. Todos los proyectos, copias de seguridad y datos de dispositivos permanecen guardados en este dispositivo para que puedas seguir trabajando. La recarga forzada y otras acciones de red permanecen deshabilitadas hasta que se recupere la conectividad.",
      "offlineIndicatorDegraded": "Conectividad degradada: trabajando con la copia en caché.",
      "offlineIndicatorDegradedHelp": "El service worker entregó contenido en caché tras fallar la comprobación. Sigue trabajando con la copia sin conexión y vuelve a intentarlo cuando desaparezca el aviso.",
      "offlineIndicatorReasonCacheFallback": "El service worker entregó el paquete en caché tras un error de red.",
      "offlineIndicatorReasonGetFailed": "La solicitud de red para la comprobación de recarga falló.",
      "offlineIndicatorReasonTimeout": "La comprobación de conectividad se agotó antes de que respondiera el servidor.",
      "offlineIndicatorReasonUnreachable": "La comprobación no pudo comunicarse con el servidor.",
      "offlineIndicatorReasonReloadBlocked": "La recarga queda en pausa hasta confirmar una conexión estable.",
      "offlineIndicatorReasonUnknown": "Conectividad degradada. Sigue trabajando sin conexión hasta que desaparezca el aviso.",
      ...
      "installHelpStepsIos": ["Abre Cine Power Planner en Safari.", "Toca el botón Compartir.", "Elige Añadir a la pantalla de inicio y confirma."],
      "installHelpStepsAndroid": ["Abre Cine Power Planner en Chrome.", "Toca el menú del navegador (⋮).", "Elige Añadir a la pantalla de inicio y confirma."],
      ...
      "warnPinExceeded": "ADVERTENCIA: la corriente ({current}A a ~12V) supera el límite de los pines ({max}A)!",
      ...
      "lensSpecMinFocusLabel": "Distancia mínima de enfoque",
      "lensSpecWeightLabel": "Peso",
      "lensSpecRodStandardLabel": "Estándar de barras",
      "lensSpecRodLengthLabel": "Longitud de barras",
      "lensSpecClampOnLabel": "Clamp-on",
      "lensSpecSupportLabel": "Soporte de óptica",
      "lensSpecCategoryGeneralLabel": "General",
      "lensSpecCategoryOpticsLabel": "Óptica",
      "lensSpecCategoryPhysicalLabel": "Físico",
      "lensSpecCategorySupportLabel": "Soporte",
      "lensSpecCategoryNotesLabel": "Notas",
      ...
      "projectForm": {
        ...
        "slowMotionHeading": "Velocidad de cámara lenta",
        "slowMotionRecordingResolution": "Resolución de grabación en cámara lenta:",
        "slowMotionSensorMode": "Modo de sensor en cámara lenta:",
        "slowMotionAspectRatio": "Relación de aspecto en cámara lenta:",
        "slowMotionBaseFrameRate": "Velocidad base en cámara lenta:",
        "slowMotionRecordingFrameRate": "Velocidad de grabación en cámara lenta:",
        "slowMotionRecordingFrameRateRangeHint": "Introduce una velocidad de grabación en cámara lenta entre 1 y {max} fps.",
        "slowMotionRecordingFrameRateDefaultHint": "Introduce la velocidad de grabación en cámara lenta en fotogramas por segundo.",
        ...
        "requiredScenarios": "Escenarios y Entornos de Rodaje",
        "cameraHandle": "Empuñadura de cámara:",
        "viewfinderExtension": "Extensor de visor:",
        ...
        "userButtonFunctions": {
          ...
          "user3": "Usuario 3",
          "user4": "Usuario 4",
          "toggleLut": "Activar/Desactivar LUT",
        ...
        "tripodBowl": "Tipo de copa:",
        "tripodTypes": "Tipos de trípode:",
        "tripodSpreader": "Tipo de triángulo:",
        "cancel": "Cancelar",
        "addEntry": "Añadir",
      ...
      "crewRoles": {
        ...
        "B-Camera Operator": "Operador cámara B",
        "Steadicam Operator": "Operador de Steadicam",
        "Drone Operator": "Operador de drone",
        "1st AC": "Foquista",
        "2nd AC": "Auxiliar de cámara",
        "DIT": "DIT",
        "Video Operator": "Video Assist",
        "Key Gaffer": "Jefe de eléctricos",
        "Gaffer": "Eléctrico",
        "Best Boy Electric": "Primer ayudante de eléctricos",
        "Electrician": "Eléctrico",
        "Rigging Gaffer": "Gaffer de Rigging",
        "Key Grip": "Jefe de maquinistas",
        "Best Boy Grip": "Primer ayudante de maquinista",
        "Grip": "Maquinista",
        "Dolly Grip": "Maquinista de Dolly",
        "Rigging Grip": "Maquinista de Rigging"
      },
      "scenarios": {
        "Indoor": "Interior",
        "Outdoor": "Exterior",
        ...
        "Rain Machine": "Máquina de lluvia",
        "Slow Motion": "Cámara lenta / Alta velocidad",
        "Battery Belt": "Cinturón de baterías"
      },
      ...
      "gearListExcludeRentalToggle": "Excluir del rental",
      "gearListIncludeRentalToggle": "Incluir para el rental",
      "gearListRentalNote": "Proporcionado por el rental",
      "gearListEditProviderLabel": "Proveedor",
      "gearListEditProviderHelp": "Selecciona quién aporta este elemento. El rental es el valor predeterminado salvo que esté en tu lista de equipo propio.",
      ...
      "documentationTrackerDescription": "Usa este registro para marcar las actualizaciones de traducciones, artículos de ayuda y guías impresas antes de distribuir paquetes offline.",
      ...
      "documentationTrackerSummaryIntro": "Crea registros de versión para seguir traducciones, temas de ayuda, README y guías impresas hasta verificarlas todas.",
      ...
      "backupHeadingHelp": "Gestiona copias de seguridad completas de ajustes, proyectos guardados, dispositivos personalizados, entradas en la bóveda local y comentarios.",
      ...
      "storageStatusReminderConnectivity": "Conectividad degradada: {reason} Sigue trabajando con la copia sin conexión y evita vaciar cachés hasta que desaparezca el aviso.",
      ...
      "storageKeyFullBackupsDesc": "Descargas creadas en Copia de seguridad y restaurar o por las copias horarias, incluidas las entradas de la bóveda local.",
      "storageFullBackupsCountOne": "%s copia completa",
      "storageFullBackupsCountOther": "%s copias completas",
      "queuedBackupDownloadDeferred": "Se bloquearon las descargas automáticas. Guardamos {fileName} en la bóveda local para que el siguiente toque pueda exportarla con seguridad.",
      "queuedBackupVaultEmpty": "No hay copias pendientes en la bóveda local.",
      "queuedBackupVaultTitle": "Bóveda de copias local",
      "queuedBackupVaultIntro": "Las descargas automáticas se bloquearon. Revisa las siguientes copias y descárgalas manualmente mientras el navegador esté listo sin conexión.",
      "queuedBackupVaultPopupBlocked": "Activa las ventanas emergentes para revisar las copias guardadas en la bóveda local.",
      "queuedBackupBannerMessageOne": "1 copia guardada en la bóveda local.",
      ...
      "onboardingTour": {
        ...
        "steps": {
          ...
          "exportImport": {
            ...
            "body": "Usa Exportar proyecto para descargar una copia de seguridad JSON y Importar proyecto para ensayar restauraciones. Guarda las exportaciones en soportes redundantes para que ninguna estación pierda datos si el perfil del navegador se restablece. Conserva la exportación original sin cambios para poder reimportarla en cualquier momento, incluso si una copia de trabajo se edita."
          },
          "overviewAndPrint": {
