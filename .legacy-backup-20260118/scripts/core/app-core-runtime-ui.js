...
(function createCineCoreRuntimeUiBridge() {
  ...
  function resolveCoreUiHelpers(existingBridge, scopes) {
    var candidates = [];
    if (existingBridge && existingBridge.helpers && _typeof(existingBridge.helpers) === 'object') {
    ...
    for (var scopeIndex = 0; scopeIndex < scopes.length; scopeIndex += 1) {
      ...
      try {
        var _bridge = scope.cineCoreRuntimeUiBridge;
        if (_bridge && _bridge !== existingBridge && _typeof(_bridge) === 'object') {
          if (_bridge.helpers && _typeof(_bridge.helpers) === 'object') {
            candidates.push(_bridge.helpers);
          }
        }
    ...
    for (var _scopeIndex = 0; _scopeIndex < scopes.length; _scopeIndex += 1) {
      var _scope = scopes[_scopeIndex];
      if (!_scope) {
        continue;
      }
      try {
        var _helpers = _scope.cineCoreUiHelpers;
        if (_helpers && _typeof(_helpers) === 'object') {
          candidates.push(_helpers);
        }
  ...
  var bridge = null;
  if (primaryScope && _typeof(primaryScope.cineCoreRuntimeUiBridge) === 'object' && primaryScope.cineCoreRuntimeUiBridge) {
    bridge = primaryScope.cineCoreRuntimeUiBridge;
  }
  if (!bridge && typeof CORE_GLOBAL_SCOPE !== 'undefined' && CORE_GLOBAL_SCOPE && _typeof(CORE_GLOBAL_SCOPE.cineCoreRuntimeUiBridge) === 'object') {
  ...
  function escapeButtonLabelSafelyFallback(text) {
    ...
    var escape = typeof bridge.escapeHtml === 'function' ? bridge.escapeHtml : typeof helpers.escapeHtml === 'function' ? helpers.escapeHtml : escapeHtmlFallback;
    return escape(text);
  }
  ...
  function setButtonLabelWithIconFallback(button, label, glyph) {
    ...
    var iconHtml = (typeof bridge.resolveButtonIconMarkup === 'function' ? bridge.resolveButtonIconMarkup : typeof helpers.resolveButtonIconMarkup === 'function' ? helpers.resolveButtonIconMarkup : resolveButtonIconMarkupFallback)(resolvedGlyph);
    var escapeButtonLabelSafely = typeof bridge.escapeButtonLabelSafely === 'function' ? bridge.escapeButtonLabelSafely : typeof helpers.escapeButtonLabelSafely === 'function' ? helpers.escapeButtonLabelSafely : escapeButtonLabelSafelyFallback;
  ...
  var escapeHtml = typeof bridge.escapeHtml === 'function' ? bridge.escapeHtml : typeof helpers.escapeHtml === 'function' ? helpers.escapeHtml : escapeHtmlFallback;
  var escapeButtonLabelSafely = typeof bridge.escapeButtonLabelSafely === 'function' ? bridge.escapeButtonLabelSafely : typeof helpers.escapeButtonLabelSafely === 'function' ? helpers.escapeButtonLabelSafely : function fallbackEscapeButtonLabelSafely(text) {
    return escapeButtonLabelSafelyFallback(text);
  };
  var resolveButtonIconMarkup = typeof bridge.resolveButtonIconMarkup === 'function' ? bridge.resolveButtonIconMarkup : typeof helpers.resolveButtonIconMarkup === 'function' ? helpers.resolveButtonIconMarkup : resolveButtonIconMarkupFallback;
