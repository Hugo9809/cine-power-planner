...
(function () {
  ...
  function generatePowerSummary() {
    ...
    var totalWatt = ((_document$getElementB = document.getElementById('heroTotalDraw')) === null || _document$getElementB === void 0 ? void 0 : _document$getElementB.textContent) || ((_document$getElementB2 = document.getElementById('totalPower')) === null || _document$getElementB2 === void 0 ? void 0 : _document$getElementB2.textContent) || '0 W';
    var runtime = ((_document$getElementB3 = document.getElementById('heroRuntime')) === null || _document$getElementB3 === void 0 ? void 0 : _document$getElementB3.textContent) || ((_document$getElementB4 = document.getElementById('batteryLife')) === null || _document$getElementB4 === void 0 ? void 0 : _document$getElementB4.textContent) || '—';
    var batteryCount = ((_document$getElementB5 = document.getElementById('heroBatteryCount')) === null || _document$getElementB5 === void 0 ? void 0 : _document$getElementB5.textContent) || ((_document$getElementB6 = document.getElementById('batteryCount')) === null || _document$getElementB6 === void 0 ? void 0 : _document$getElementB6.textContent) || '0';
    var batteryName = ((_document$getElementB7 = document.getElementById('batterySelect')) === null || _document$getElementB7 === void 0 || (_document$getElementB7 = _document$getElementB7.selectedOptions[0]) === null || _document$getElementB7 === void 0 ? void 0 : _document$getElementB7.text) || 'Battery';
    var peakLoad = ((_document$getElementB8 = document.getElementById('heroCurrent144')) === null || _document$getElementB8 === void 0 ? void 0 : _document$getElementB8.textContent) || ((_document$getElementB9 = document.getElementById('totalCurrent144Elem')) === null || _document$getElementB9 === void 0 ? void 0 : _document$getElementB9.textContent) || '';
  ...
  function renderPreviewContent() {
    ...
    var projectName = ((_document$getElementB0 = document.getElementById('setupName')) === null || _document$getElementB0 === void 0 ? void 0 : _document$getElementB0.value) || 'Untitled Project';
    var production = ((_document$getElementB1 = document.getElementById('productionInput')) === null || _document$getElementB1 === void 0 ? void 0 : _document$getElementB1.value) || '';
