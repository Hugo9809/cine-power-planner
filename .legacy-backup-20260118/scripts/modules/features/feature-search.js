...
(function () {
  ...
  function resolveNormalizationApi(scope) {
    ...
    if (!api && typeof MODULE_BASE.getModuleRegistry === 'function') {
      var registry = MODULE_BASE.getModuleRegistry(targetScope);
  ...
  var normalizationApi = resolveNormalizationApi(GLOBAL_SCOPE);
  var normalizeSearchValueCore = normalizationApi && typeof normalizationApi.normalizeSearchValue === 'function' ? normalizationApi.normalizeSearchValue : function (value) {
  ...
  function normalizeSearchValue(value) {
    ...
    var normalized = normalizeSearchValueCore(value);
