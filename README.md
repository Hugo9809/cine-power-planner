...
- Runtime estimates draw on a weighted average of user-submitted runtimes, normalized for temperature and adjusted for resolution, frame rate, Wi-Fi, codec and monitor brightness.
