...
function save() {
  ...
  const filePath = path.join(__dirname, '../web/data/index.js');
  ...
  if (args.includes('--help') || args.includes('-h')) {
    console.log(
      [
        ...
        '',
        'Cleans and expands device data, then overwrites web/data/index.js with the result.',
        '',
        'What it does:',
        ...
        '  1. Run `npm run check-consistency` after editing web/data/devices/ files to catch missing metadata.',
        ...
        '',
        'The script modifies web/data/index.js in place. Review the diff and commit it together with schema updates.',
        '',
        'Examples:',
        '  npm run normalize',
