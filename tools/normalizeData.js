...
let devices = require('../public/data');
...
function save() {
  ...
  const filePath = path.join(__dirname, '../public/data/index.js');
  ...
  if (args.includes('--help') || args.includes('-h')) {
    console.log(
      [
        ...
        '',
        'Cleans and expands device data, then overwrites public/data/index.js with the result.',
        '',
        'What it does:',
        ...
        '  1. Run `npm run check-consistency` after editing public/data/devices/ files to catch missing metadata.',
        ...
        '',
        'The script modifies public/data/index.js in place. Review the diff and commit it together with schema updates.',
        '',
        'Examples:',
        '  npm run normalize',
