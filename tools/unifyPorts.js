...
if (require.main === module) {
  ...
  if (args.includes('--help') || args.includes('-h')) {
    console.log(
      [
        ...
        '',
        'Normalizes connector and port definitions in web/data/index.js and overwrites the file.',
        '',
        'Key actions:',
        ...
        '',
        'The script updates web/data/index.js in place. Review the diff and commit it together with schema changes.',
        '',
        'Examples:',
        '  npm run unify-ports',
  ...
  deepClean(devices);
  fs.writeFileSync(
    path.join(__dirname, '../web/data/index.js'),
    'let devices=' +
