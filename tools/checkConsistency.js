function checkConsistency(devices = require('../public/data')) {
  const rules = {
    cameras: [
      'powerDrawWatts',
      'power',
  ...
  if (args.includes('--help') || args.includes('-h')) {
    console.log(
      [
        ...
        '',
        'Validates device entries in public/data/index.js before normalization scripts touch the dataset.',
        '',
        ...
        '  1. Run after editing files in public/data/devices/ to catch omissions early.',
