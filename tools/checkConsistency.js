function checkConsistency(devices = require('../web/data')) {
  const rules = {
    cameras: [
      'powerDrawWatts',
      'power',
  ...
  if (args.includes('--help') || args.includes('-h')) {
    console.log(
      [
        ...
        '',
        'Validates device entries in web/data/index.js before normalization scripts touch the dataset.',
        '',
        ...
        '  1. Run after editing files in web/data/devices/ to catch omissions early.',
