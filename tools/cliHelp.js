...
const lines = [
  ...
  '',
  'Data maintenance pipeline (run after editing public/data/devices/):',
  '  npm run check-consistency   Report missing required fields in public/data/devices/.',
  '  npm run normalize           Normalize metadata and rebuild derived data into public/data/index.js.',
  '  npm run unify-ports         Standardize connector and port definitions across public/data/index.js.',
  '  npm run generate-schema     Refresh public/data/schema.json based on the latest data.',
  '',
  'Housekeeping tips:',
