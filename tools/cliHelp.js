...
const lines = [
  ...
  '',
  'Data maintenance pipeline (run after editing assets/data/devices/):',
  '  npm run check-consistency   Report missing required fields in assets/data/devices/.',
  '  npm run normalize           Normalize metadata and rebuild derived data into assets/data/index.js.',
  '  npm run unify-ports         Standardize connector and port definitions across assets/data/index.js.',
  '  npm run generate-schema     Refresh assets/data/schema.json based on the latest data.',
  '',
  'Housekeeping tips:',
