...
4. **Documenta requisitos.** Introduce equipo, escenarios, agarres, matte boxes y configuraciones de monitoreo. Tu perfil de usuario guardado aparece automáticamente en la lista de equipo; ajusta el cargo o los datos de contacto según cada proyecto. Los botones de bifurcar duplican entradas. Usa **Configuración → Reglas automáticas** para agregar o quitar elementos según escenarios antes de exportar.
