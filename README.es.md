...
- **Búsqueda global** (`/`, `Ctrl+K`, `⌘K`) salta a funciones, selectores o temas de ayuda, incluso con navegación oculta. Las
  ...
  con teclado lleguen a los controles principales. Las palabras coincidentes se resaltan en el desplegable para que veas al instante
  por qué aparece cada resultado. Al vaciar el campo, las coincidencias usadas recientemente aparecen arriba para repetir rutinas
  del equipo sin perder tiempo.
