...
5. Abre **Ayuda → Lista de comprobación de inicio rápido** y lanza el tutorial guiado. Repasa creación de proyectos, selección de dispositivos, listas de equipo, contactos, equipo propio, reglas automáticas y los flujos de exportación, importación y respaldo. El nuevo navegador de pasos permite volver a los flujos completados sin reiniciar y, si lo dejas a medias, aparecerá automáticamente **Reanudar tutorial guiado** para conservar el progreso sin conexión.
